...
class CopyVisitor(MetamathVisitor):
    ...
    def postvisit_application(
        self, application: Application, subterms: List[Term]
    ) -> Application:
    ...
    def postvisit_structured_statement(
        self, stmt: StructuredStatement, terms: List[Term]
    ) -> StructuredStatement:
    ...
    def postvisit_database(
        self, database: Database, statements: List[Statement]
    ) -> Database:
