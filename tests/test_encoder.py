...
class TestKorePatternEncoder(unittest.TestCase):
    ...
    def test_kore_axiom_encoding(self):
        ...
        self.assertAxiomEncodingEqual(module, r"axiom{} \top{Int{}}() []", r"( \kore-valid \kore-sort-Int ( \kore-top \kore-sort-Int ) )")
        self.assertAxiomEncodingEqual(module, r"axiom{S} \top{S}() []", r"( \kore-forall-sort kore-sort-var-S ( \kore-valid kore-sort-var-S ( \kore-top kore-sort-var-S ) ) )")

        self.assertAxiomEncodingEqual(module, r"axiom{} X:Int{} []", r"( \kore-valid \kore-sort-Int ( \kore-forall \kore-sort-Int \kore-sort-Int kore-element-var-X kore-element-var-X ) )")
        self.assertAxiomEncodingEqual(module, r"axiom{S} X:S []", r"( \kore-forall-sort kore-sort-var-S ( \kore-valid kore-sort-var-S ( \kore-forall kore-sort-var-S kore-sort-var-S kore-element-var-X kore-element-var-X ) ) )")
