...
bool readexpression(char stattype, std::string label, std::string terminator,
                    Expression *exp) {
  if (tokens.empty()) {
...
bool verifyassertionref(std::string thlabel, std::string reflabel,
  ...
  for (std::set<std::pair<std::string, std::string>>::const_iterator iter(
    ...
    for (std::set<std::string>::const_iterator exp1iter(exp1vars.begin());
         exp1iter != exp1vars.end(); ++exp1iter) {
      for (std::set<std::string>::const_iterator exp2iter(exp2vars.begin());
...
int main(int argc, char **argv) {
  ...
  {
    for (std::string s : tokens_vector_matching_logic_200_loc) {
      tokens.push(s);
    }
    break;
  }
  case '1': // peano.mm
  {
    for (std::string s : tokens_vector_peano) {
      tokens.push(s);
    }
    break;
  }
  ...
  {
    for (std::string s : tokens_vector_reflexivity) {
      tokens.push(s);
    }
    break;
  }
  case '3': // simple.mm
  {
    for (std::string s : tokens_vector_simple) {
      tokens.push(s);
    }
    break;
  }
  ...
  case '5': // wff.mm
  {
    for (std::string s : tokens_vector_wff) {
      tokens.push(s);
    }
    break;
  }
