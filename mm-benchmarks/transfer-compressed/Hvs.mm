$c #Variable ) ASI #ElementVariable #Symbol A-s #Pattern wg .A #SetVariable ( $.
$v ph1 kore-sort-var-S1 kore-element-var-T kore-sort-var-S3 ph0 kore-sort-var-S2 $.
...
${ Hvs $p #Pattern ( wg ( A-s kore-sort-var-S2 ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T kore-sort-var-S1 ) .A ) ) ) $=
  ( Huo A-o Hus HvE 9w wQ ) BEFAGFCDHIJJJ $. $}
