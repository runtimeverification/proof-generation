$c Zw #Variable ) #ElementVariable CVo #Symbol HaM #Pattern #SetVariable A-c ( $.
...
${ IL0 $p Zw kore-element-var-Val kore-element-var-Val ( A-c CVo HaM ) kore-element-var-From $=
  ( IHs CVk HaI A-Y Jw Afg ) ACDEFBGH $. $}
