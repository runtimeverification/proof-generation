...
${ KRY $p rg ( Lg ( wg ( A-s kore-sort-var-R ) .A ) ( ASI ( FDE ( BAM CUE CHs ( A-c CUE HoQ ) ) ( BAM CXQ CHs ( A-c CXQ Hlo ) ) ) CSc ) ) $=
  ( Huk A-o 9w wQ CUA CHo HoM A-Y BAI ASE CXM Hlk FDA CSY JgI KQs AZk FD0 AW8 )
