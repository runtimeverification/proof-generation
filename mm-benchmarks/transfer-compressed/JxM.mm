$c Zw BAM CHs #Variable ) #ElementVariable Cbk #Symbol Dt8 #Pattern CIM CJY #SetVariable ( $.
...
${ JxM $p Zw ( Dt8 ( CIM ( BAM Cbk CHs kore-element-var-VE2 ) CJY ) ) ( Dt8 ( CIM ( BAM Cbk CHs kore-element-var-VE2 ) kore-element-var-VE1 ) ) CJY kore-element-var-VE1 $=
  ( Jw CJU Cbg CHo JOw BAI CII JwQ I5I Afg bQ CIw DuQ ) BCZDEFAGHZDIABJPDQDQBKQ
  DPLDPMNO $. $}
