...
${ Nd4 $p rg ( Lg ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K2 CSc ) ( wg ( ASI kore-element-var-K3 CSc ) .A ) ) ) ( wg ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K2 CSc ) ( wg ( ASI kore-element-var-K3 CSc ) .A ) ) ) ( wg ( ASI ( Eq0 ( Eq0 ( FDE ( BAM CUE CHs ( A-c CUE Hn0 ) ) ( BAM CXQ CHs ( A-c CXQ IGI ) ) ) ( FDE ( BAM CUE CHs ( A-c CUE Hmg ) ) ( BAM CXQ CHs ( A-c CXQ HmE ) ) ) ) ( FDE ( BAM CUE CHs ( A-c CUE HoQ ) ) ( BAM CXQ CHs ( A-c CXQ Hlo ) ) ) ) CSc ) .A ) ) ) $=
  ( Jj8 CUA CHo Hnw A-Y BAI CXM IGE FDA Hmc Eqw CSY ASE 9w wQ AZk AW8 HmA HoM
  Hlk Huk A-o Io4 Jj4 JkA Jk0 NdU KR4 FD0 Erk AXM Aw8 ) ABCDZUPEFEGHIJFJKHILEFE
