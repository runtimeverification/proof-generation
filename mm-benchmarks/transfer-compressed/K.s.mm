...
${ K.s $p #Pattern ( DpI ( Dt8 ( CIM ( BAM CW0 CHs ( Eo0 kore-element-var-VE4 ( BAM CUE CSA ( A-c CUE Hkw ) ) ) ) kore-element-var-x0 ) ) kore-element-var-VE3 ) $=
  ( CWw CHo JO4 CUA CR8 Hks A-Y BAI Eow H3g CII Dt4 JO0 DpE ) DEBFGHGIJKLKCMNOA
  PQ $. $}
