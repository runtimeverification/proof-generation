...
${ NSc $p rg ( Lg ( wg ( ASI kore-element-var-VE4 CXQ ) .A ) ( ASI ( BAM CXQ CHs ( A-c CXQ ICM ) ) CHs ) ) $=
  ( JO4 CXM ASE 9w wQ A-o CHo ICI A-Y BAI Lw8 NSY AZk CMA AW8 ) ABCDEFZCGHGFZCI
