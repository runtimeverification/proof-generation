...
${ LiU $p #Pattern ( DpI ( Dt8 ( CIM ( BAM CW0 CHs ( Eo0 ( BAM CXQ CSA ( A-c CXQ HmE ) ) kore-element-var-VE4 ) ) kore-element-var-x0 ) ) kore-element-var-VE3 ) $=
  ( CWw CHo CXM CR8 HmA A-Y BAI JO4 Eow H3g CII Dt4 JO0 DpE ) DEFGFHIJBKLJCMNOA
  PQ $. $}
