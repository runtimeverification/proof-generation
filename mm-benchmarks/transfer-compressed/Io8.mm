$c #Variable ) ASI #ElementVariable #Symbol A-s #Pattern wg .A CUw #SetVariable ( $.
...
${ Io8 $p #Pattern ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K1 CUw ) ( wg ( ASI kore-element-var-K2 CUw ) .A ) ) ) $=
  ( Huk A-o IM4 CUs ASE Io4 9w wQ ) ADEBFGHCIGHJKKK $. $}
