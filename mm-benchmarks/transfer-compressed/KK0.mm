...
${ KK0 $p Zw ( Duw ( Eq0 ( FDE ( BAM CUE CHs kore-element-var-VE3 ) ( BAM CXQ CHs ( A-c CXQ Hlo ) ) ) kore-element-var-VE5 ) ) ( Duw ( Eq0 ( FDE ( BAM CUE CHs kore-element-var-VE3 ) ( BAM CXQ CHs kore-element-var-VE2 ) ) kore-element-var-VE5 ) ) ( A-c CXQ Hlo ) kore-element-var-VE2 $=
  ( Jw CXM Hlk A-Y CUA CHo JO0 BAI FDA KFk Eqw KGo JOw Afg bQ BG4 FDc KKw ErM
