$c #Variable ) ASI #ElementVariable CMQ #Symbol A-s #Pattern wg .A #SetVariable ( $.
...
${ IPE $p #Pattern ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K1 CMQ ) .A ) ) $=
  ( Huk A-o IM4 CMM ASE 9w wQ ) ACDBEFGHII $. $}
