...
${ NY4 $p rg ( Lg ( wg ( ASI kore-element-var-VE2 CXQ ) ( wg ( ASI kore-element-var-VE3 CUE ) ( wg ( ASI kore-element-var-VE4 CHs ) ( wg ( ASI kore-element-var-VE5 CSc ) .A ) ) ) ) ( Mg kore-element-var-V0 ( ARU kore-element-var-V0 ( CIM ( BAM Cbk CHs ( Eh0 ( A-c CUE HlM ) ( BAM CXQ CSA ( A-c CXQ HMc ) ) ) ) CJY ) ) ) ) $=
  ( JOw CXM ASE JO0 CUA KFo wQ 9w IJI Cbg CHo HlI A-Y CR8 BAI HMY Ehw CJU CII
  ARQ MQ AXM Aw8 CHE IAI MRc Bpg AW8 ) AFGHBIJHCEKLLZMDNOPJQRGSGUARTUBTUCUDZUED
  UFUNMUGUHUIUOMDUJDUKULUM $. $}
