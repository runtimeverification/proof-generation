...
$v ph1 ph0 kore-element-var-K1 kore-sort-var-R kore-element-var-K2 $.
...
${ JZw $p #Pattern ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K1 CSc ) ( wg ( ASI kore-element-var-K2 CSc ) .A ) ) ) $=
  ( Huk A-o IM4 CSY ASE Io4 9w wQ ) ADEBFGHCIGHJKKK $. $}
