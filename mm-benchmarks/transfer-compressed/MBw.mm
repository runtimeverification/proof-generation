...
${ MBw $p rg ( Lg ( wg ( wg ( A-s kore-sort-var-R ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) ( wg ( A-s kore-sort-var-S2 ) .A ) ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) $=
  ( Huk A-o MA4 wQ Huo 9w HvA Cb8 ASE MBs AXM Aw8 AZk ) AEFBDGHCIFJHHZDKLMJABCD
  NRJOPQ $. $}
