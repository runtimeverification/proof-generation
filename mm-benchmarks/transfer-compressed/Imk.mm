$c #Variable ) ASI #ElementVariable #Symbol A-s #Pattern CSA wg .A #SetVariable ( $.
...
${ Imk $p #Pattern ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K0 CSA ) ( wg ( ASI kore-element-var-K1 CSA ) .A ) ) ) $=
  ( Huk A-o INE CR8 ASE IM4 9w wQ ) ADEBFGHCIGHJKKK $. $}
