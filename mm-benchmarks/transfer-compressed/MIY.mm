...
${ MIY $p #Pattern ( DpI ( Dt8 ( CIM ( BAM Cbk CHs ( FZM ( BAM CcA CW0 ( A-c CcA HPI ) ) kore-element-var-VE4 kore-element-var-VE2 ) ) CJY ) ) kore-element-var-VE3 ) $=
  ( Cbg CHo Cb8 CWw HPE A-Y BAI JO4 JOw FZI CJU CII Dt4 JO0 DpE ) DEFGFHIJCKALM
  JNOPBQR $. $}
