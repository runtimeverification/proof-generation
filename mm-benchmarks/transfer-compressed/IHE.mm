$c Duw BAM FDE Hn0 HoQ ICM CSc ) Eq0 #Pattern Hlo wg .A IGI rg A-c Lg HlM CHs #Variable HKc Hkw ASI #ElementVariable HmE #Symbol CUE Hmg CXQ #SetVariable ( CQM $.
...
${ IHE $p rg ( Lg .A ( ASI ( Duw ( Eq0 ( FDE ( BAM CUE CHs ( A-c CUE Hn0 ) ) ( BAM CXQ CHs ( A-c CXQ IGI ) ) ) ( Eq0 ( FDE ( BAM CUE CHs ( A-c CUE HlM ) ) ( BAM CXQ CHs ( A-c CXQ HKc ) ) ) ( Eq0 ( FDE ( BAM CUE CHs ( A-c CUE Hkw ) ) ( BAM CXQ CHs ( A-c CXQ ICM ) ) ) ( Eq0 ( FDE ( BAM CUE CHs ( A-c CUE HoQ ) ) ( BAM CXQ CHs ( A-c CXQ Hlo ) ) ) ( FDE ( BAM CUE CHs ( A-c CUE Hmg ) ) ( BAM CXQ CHs ( A-c CXQ HmE ) ) ) ) ) ) ) ) CQM ) ) $=
  ( 9w CUA CHo Hnw A-Y BAI CXM IGE FDA HlI HKY Hks ICI Eqw CSY ASE AZk Erk AW8
  wQ HoM Hlk Hmc HmA Dus CQI IHA HsY IDE HtM HtY DvU ) ABCBDEFGCGHEFIZBCBJEFGCG
