...
${ MqI $p Zw ( Dr8 ( DpI ( Dt8 ( CIM ( BAM CXQ CHs ( EK0 kore-element-var-VE4 ( A-c CXQ HmE ) ) ) kore-element-var-x0 ) ) kore-element-var-VE3 ) ( DrI ( A-c CXQ HKc ) ) ) ( Dr8 ( DpI ( Dt8 ( CIM ( BAM CXQ CHs ( EK0 kore-element-var-VE4 ( A-c CXQ HmE ) ) ) kore-element-var-VE2 ) ) kore-element-var-VE3 ) ( DrI ( A-c CXQ HKc ) ) ) kore-element-var-x0 kore-element-var-VE2 $=
  ( Jw H3g MqE CXM HKY A-Y DrE Mo8 CHo JO4 HmA EKw BAI CII Dt4 Afg JO0 JOw CIw
  bQ DuQ JSQ Dpg DsU ) AEZDFZBCDGHIJKZABCLUKUIUJHMCNHOJPQZUJRZSBUAZULAUBZRZSUNU
  IUJUMUPUIUJULUJULUOULUJUITUJUIUDUCUEABDUFUGUKUJUITUH $. $}
