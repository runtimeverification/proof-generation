...
${ H1s $p Zw ( BAM CUE kore-sort-var-x0 kore-element-var-T ) ( BAM CUE kore-sort-var-S3 kore-element-var-T ) kore-sort-var-x0 kore-sort-var-S3 $=
  ( CUA HwM HvA Hus Jw H1k bQ H1o BG4 ) DAEZCFZDBGNMBHZABIMOJABCKL $. $}
