...
${ MqE $p #Pattern ( DpI ( Dt8 ( CIM ( BAM CXQ CHs ( EK0 kore-element-var-VE4 ( A-c CXQ HmE ) ) ) kore-element-var-x0 ) ) kore-element-var-VE3 ) $=
  ( CXM CHo JO4 HmA A-Y EKw BAI H3g CII Dt4 JO0 DpE ) DEBFDGHIJCKLMANO $. $}
