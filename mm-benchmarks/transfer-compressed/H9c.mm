...
H9Y $a Zw CXQ CXQ kore-sort-var-x0 kore-sort-var-S3 $.
${ H9c $p Zw ( BAM CXQ kore-sort-var-x0 kore-element-var-T ) ( BAM CXQ kore-sort-var-S3 kore-element-var-T ) kore-sort-var-x0 kore-sort-var-S3 $=
  ( CXM HwM HvA Hus Jw H9Y bQ H1o BG4 ) DAEZCFZDBGNMBHZABIMOJABCKL $. $}
