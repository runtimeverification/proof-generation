...
${ MBs $p rg ( Lg ( wg ( wg ( A-s kore-sort-var-R ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) ( wg ( A-s kore-sort-var-S2 ) .A ) ) ( ASI kore-element-var-T CcA ) ) $=
  ( Huk A-o MA4 wQ Huo 9w HvA Cb8 ASE AZE AZI MBM AW8 ) AEFZBDGZHZCIFJHZHTDKLMZ
  TUANTSUBRSOBDPQQ $. $}
