$c Lg #Variable ) ASI #ElementVariable #Symbol A-s #Pattern wg CXQ .A CUw rg #SetVariable ( $.
...
${ MLA $p rg ( Lg ( wg ( ASI kore-element-var-VE4 CUw ) .A ) ( A-s CXQ ) ) $=
  ( CXM A-o JO4 CUs ASE 9w wQ LQ xA CXc yQ ) BCZADEFGHZMIMNJKL $. $}
