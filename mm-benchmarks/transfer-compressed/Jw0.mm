$c DpI BAM CHs #Variable ) #ElementVariable Cbk #Symbol Dt8 #Pattern CIM CJY #SetVariable ( $.
...
${ Jw0 $p #Pattern ( DpI ( Dt8 ( CIM ( BAM Cbk CHs kore-element-var-VE2 ) CJY ) ) kore-element-var-VE3 ) $=
  ( Cbg CHo JOw BAI CJU CII Dt4 JO0 DpE ) CDAEFGHIBJK $. $}
