...
${ Ltw $p #Pattern ( DpI ( Dt8 ( CIM ( BAM CcA CHs ( Em0 kore-element-var-VE4 kore-element-var-x0 ) ) kore-element-var-VE2 ) ) kore-element-var-VE3 ) $=
  ( Cb8 CHo Lts BAI JOw CII Dt4 JO0 DpE ) EFCDGHAIJKBLM $. $}
