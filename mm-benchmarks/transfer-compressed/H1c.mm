...
$v ph1 kore-sort-var-x0 ph0 kore-sort-var-S3 x kore-sort-var-R xX $.
...
${ H1c $p Zw kore-sort-var-R kore-sort-var-R kore-sort-var-x0 kore-sort-var-S3 $=
  ( Huk HwM Jw Afg ) ADBECFG $. $}
