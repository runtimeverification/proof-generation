...
${ MIg $p #Pattern ( CIM ( BAM Cbk CHs ( FZM ( BAM CcA CW0 ( A-c CcA HPI ) ) kore-element-var-VE4 kore-element-var-VE2 ) ) kore-element-var-x0 ) $=
  ( Cbg CHo Cb8 CWw HPE A-Y BAI JO4 JOw FZI H3g CII ) DEFGFHIJBKALMJCNO $. $}
