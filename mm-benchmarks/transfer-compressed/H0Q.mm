...
${ H0Q $p Zw ( BAM CUE kore-sort-var-x0 kore-element-var-T ) ( BAM CUE kore-sort-var-S2 kore-element-var-T ) kore-sort-var-x0 kore-sort-var-S2 $=
  ( CUA HwM HvA Huo Jw H0I bQ H0M BG4 ) DAEZCFZDBGNMBHZABIMOJABCKL $. $}
