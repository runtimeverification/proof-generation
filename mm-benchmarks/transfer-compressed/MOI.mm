...
${ MOI $p Zw ( Dt8 ( CIM ( BAM CUw CHs ( G2w kore-element-var-VE2 ) ) kore-element-var-x0 ) ) ( Dt8 ( CIM ( BAM CUw CHs ( G2w kore-element-var-VE2 ) ) kore-element-var-VE1 ) ) kore-element-var-x0 kore-element-var-VE1 $=
  ( Jw H3g MOA MNw CUs CHo JOw G2s BAI I5I Afg bQ CIw DuQ ) BDZCEZACFABGRSHIAJK
  LZSTBMTSRNSROPQ $. $}
