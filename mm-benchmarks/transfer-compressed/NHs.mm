...
${ NHs $p rg ( Lg ( wg ( A-s kore-sort-var-R ) .A ) ( Mg kore-element-var-Val ( ARU kore-element-var-Val ( FDE ( BAM CUE CHs ( A-c CUE Hkw ) ) ( BAM CXQ CHs ( A-c CXQ ICM ) ) ) ) ) ) $=
  ( Huk A-o 9w wQ IHs CUA CHo Hks A-Y BAI CXM ICI FDA ARQ MQ AXM Aw8 CSY IDE
  M1A Bpg AW8 ) ACDEFZEBGHIHJKLMIMNKLOZPBQUEERSTUFEBUABUBUCUD $. $}
