...
${ JbY $p Zw ( wg ( ASI DoQ CSc ) .A ) ( wg ( ASI kore-element-var-K2 CSc ) .A ) DoQ kore-element-var-K2 $=
  ( DoM CSY ASE 9w Io4 Jw bQ Afg AhM AgE ) BBCDEAFZCDEAGZBBCLCMBMHCBMIJEBMIK $. $}
