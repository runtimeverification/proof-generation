$c Zw BAM CHs #Variable ) #ElementVariable #Symbol Dt8 #Pattern CIM CUw #SetVariable ( $.
...
${ MI0 $p Zw ( Dt8 ( CIM ( BAM CUw CHs kore-element-var-VE2 ) kore-element-var-x0 ) ) ( Dt8 ( CIM ( BAM CUw CHs kore-element-var-VE2 ) kore-element-var-VE1 ) ) kore-element-var-x0 kore-element-var-VE1 $=
  ( Jw H3g MIk MHs CUs CHo JOw BAI I5I Afg bQ CIw DuQ ) BDZCEZACFABGQRHIAJKZRSB
  LSRQMRQNOP $. $}
