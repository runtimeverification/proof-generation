...
MBo $a rg ( Lg ( wg ( wg ( A-s kore-sort-var-R ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) ( wg ( A-s kore-sort-var-S2 ) .A ) ) ( A-s kore-sort-var-S3 ) ) $.
MBw $a rg ( Lg ( wg ( wg ( A-s kore-sort-var-R ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) ( wg ( A-s kore-sort-var-S2 ) .A ) ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) $.
${ MB0 $p rg ( Lg ( wg ( wg ( A-s kore-sort-var-R ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) ( wg ( A-s kore-sort-var-S2 ) .A ) ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) $=
  ( Huk A-o MA4 wQ Huo 9w Hus HvA Cb8 ASE MBo MBw AZk ) AEFBDGHCIFJHHBKFDLMNJHA
  BCDOABCDPQ $. $}
