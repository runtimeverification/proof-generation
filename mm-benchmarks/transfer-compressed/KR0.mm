...
${ KR0 $p rg ( Lg ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K2 CSc ) ( wg ( ASI kore-element-var-K3 CSc ) .A ) ) ) ( wg ( wg ( A-s CXQ ) ( A-s CHs ) ) ( ASI ( A-c CXQ Hlo ) CXQ ) ) ) $=
  ( Jj8 CXM A-o CHo wQ Hlk A-Y ASE LQ xA CXc yQ CH4 AZk A-k ) ABCDZEFZGFZHEIJEK
