...
JlA $a rg ( Lg ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K2 CSc ) ( wg ( ASI kore-element-var-K3 CSc ) .A ) ) ) ( wg ( ASI ( BAM CUE CHs ( A-c CUE HoQ ) ) CHs ) ( ASI ( BAM CXQ CHs ( A-c CXQ HKc ) ) CHs ) ) ) $.
${ JlE $p rg ( Lg ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K2 CSc ) ( wg ( ASI kore-element-var-K3 CSc ) .A ) ) ) ( wg ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K2 CSc ) ( wg ( ASI kore-element-var-K3 CSc ) .A ) ) ) ( wg ( ASI ( FDE ( BAM CUE CHs ( A-c CUE HoQ ) ) ( BAM CXQ CHs ( A-c CXQ HKc ) ) ) CSc ) .A ) ) ) $=
  ( Jj8 CUA CHo HoM A-Y BAI CXM HKY FDA CSY ASE 9w wQ Huk A-o Io4 AZk Jj4 JkA
  Jk0 JlA FD0 AW8 AXM Aw8 ) ABCDZUIEFEGHIZJFJKHIZLMNZOPUIAQRBSMNCUAMNOPPABCUBAB
