...
MDY $a rg ( Lg ( wg ( wg ( A-s kore-sort-var-R ) .A ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ( A-s kore-sort-var-R ) ) $.
MDc $a rg ( Lg ( wg ( wg ( A-s kore-sort-var-R ) .A ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ( ASI kore-element-var-T CcA ) ) $.
${ MDg $p rg ( Lg ( wg ( wg ( A-s kore-sort-var-R ) .A ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) $=
  ( Huk A-o 9w wQ HvA Cb8 ASE MDY MDc AXM Aw8 AZk ) ACDZEFBGHIZEFZFZOQABJRPEABK
  RELMNN $. $}
