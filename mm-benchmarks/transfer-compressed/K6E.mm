$c BAM CHs #Variable ) #ElementVariable #Symbol #Pattern A6o CUw #SetVariable ( $.
...
${ K6E $p #Pattern ( A6o CHs kore-sort-var-R kore-element-var-Val ( BAM CUw CHs kore-element-var-From ) ) $=
  ( CHo Huk IHs CUs ILQ BAI A6k ) DAEBFGDCHIJ $. $}
