$c ) #ElementVariable #Symbol Duw #Pattern A6o #Variable #SetVariable ( CQM $.
...
${ J3k $p #Pattern ( A6o CQM kore-sort-var-R kore-element-var-Val ( Duw kore-element-var-K0 ) ) $=
  ( CQI Huk IHs INE Dus A6k ) DAEBFCGHI $. $}
