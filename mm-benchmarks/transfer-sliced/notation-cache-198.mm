...
${ notation-cache-198 $p #Notation ( \kore-symbol-LblSet'Coln'difference ptn3 ptn4 ) ( \app ( \app \kore-symbol-LblSet'Coln'difference-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-144-is-symbol symbol-is-pattern IMP-symbol-144-is-pattern IMP-symbol-144-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
