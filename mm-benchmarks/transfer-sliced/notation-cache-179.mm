...
${ notation-cache-179 $p #Notation ( \kore-symbol-LblFloat2String'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'Float'Unds'String ptn0 ptn1 ) ( \app ( \app \kore-symbol-LblFloat2String'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'Float'Unds'String-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-136-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-136-is-pattern IMP-symbol-136-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
