...
${ sorting-cache-280 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortIds ) \top ) ) ( \in-sort kore-element-var-K1 \kore-sort-SortIds ) ) $= ( typecode-cache-Pattern-49 IMP-sort-0-is-pattern in-sort-is-pattern top-is-pattern and-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern rule-imp-transitivity and-elim-right-sugar and-elim-left-sugar imp-reflexivity ) AHIFGBCDEFGGBCDEFGBCDEAHIFGBCDEFGKBCDEFGBCDEBCDEBCDEFLBCDEMJJ $. $}
