$c \top #SetVariable #ElementVariable #Symbol #Variable #Pattern \and \kore-sort-SortKItem \imp \kore-dv \kore-is-sort |- \kore-sort-SortId ) \kore-sort-SortInt \in-sort \kore-sort-SortStateCell "balanceTo" ( $.
