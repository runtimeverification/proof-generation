...
${ notation-cache-52 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'Unds-LT-EqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp0'Unds' ptn1 ) ( \app \kore-symbol-Lbl'Hash'freezer'Unds-LT-EqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp0'Unds'-symbol ptn1 ) $= ( IMP-symbol-85-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-85-is-pattern IMP-symbol-85-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
