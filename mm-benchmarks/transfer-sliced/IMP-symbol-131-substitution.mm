$c #Substitution #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'-LT-'k'-GT-'-symbol #Variable #Pattern \app ) \kore-symbol-Lbl'-LT-'k'-GT-' ( $.
...
notation-cache-162 $a #Notation ( \kore-symbol-Lbl'-LT-'k'-GT-' ptn1 ) ( \app \kore-symbol-Lbl'-LT-'k'-GT-'-symbol ptn1 ) $.
notation-cache-163 $a #Notation ( \kore-symbol-Lbl'-LT-'k'-GT-' ptn2 ) ( \app \kore-symbol-Lbl'-LT-'k'-GT-'-symbol ptn2 ) $.
${ IMP-symbol-131-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-131-substitution $p #Substitution ( \kore-symbol-Lbl'-LT-'k'-GT-' ptn1 ) ( \kore-symbol-Lbl'-LT-'k'-GT-' ptn2 ) ptn0 xX0 $= ( IMP-symbol-131-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-131-is-pattern substitution-disjoint substitution-app notation-cache-162 notation-cache-163 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
