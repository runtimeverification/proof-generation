...
${ notation-cache-68 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'UndsEqlsEqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds' ptn2 ) ( \app \kore-symbol-Lbl'Hash'freezer'UndsEqlsEqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds'-symbol ptn2 ) $= ( IMP-symbol-90-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-90-is-pattern IMP-symbol-90-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
