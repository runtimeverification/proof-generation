...
${ notation-cache-633 $p #Notation ( \kore-symbol-Lblproject'Coln'BExp ptn2 ) ( \app \kore-symbol-Lblproject'Coln'BExp-symbol ptn2 ) $= ( IMP-symbol-304-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-304-is-pattern IMP-symbol-304-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
