...
${ sorting-cache-1389 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \and ( \kore-is-sort \kore-sort-SortBlock ) ( \kore-is-sort \kore-sort-SortKItem ) ) ( \in-sort ( \kore-symbol-Lbl'LBraUndsRBraUnds'IMP-SYNTAX'Unds'Block'Unds'Stmt ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "ret" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "0" ) ) ) ) \kore-sort-SortBlock ) ) ) $= ( kore-is-sort-is-pattern and-is-pattern IMP-sort-18-is-pattern kore-dv-is-pattern IMP-sort-23-is-pattern typecode-cache-Pattern-0 top-is-pattern BASIC-K-sort-1-is-pattern IMP-sort-17-is-pattern string-literal-11-is-pattern IMP-sort-13-is-pattern string-literal-1-is-pattern kore-inj-is-pattern IMP-symbol-185-is-pattern IMP-symbol-354-is-pattern in-sort-is-pattern sorting-cache-1282 sorting-cache-412 rule-and-intro-alt2-sugar ) AGBHCDBIBCJKEFLFMENOPDQARAST $. $}
