...
${ notation-cache-215 $p #Notation ( \kore-symbol-LblString2Id'LParUndsRParUnds'ID-COMMON'Unds'Id'Unds'String ptn1 ) ( \app \kore-symbol-LblString2Id'LParUndsRParUnds'ID-COMMON'Unds'Id'Unds'String-symbol ptn1 ) $= ( IMP-symbol-150-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-150-is-pattern IMP-symbol-150-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
