...
substitution-1052 $a #Substitution ( \in-sort kore-element-var-T \kore-sort-SortBool ) ( \in-sort kore-element-var-T kore-sort-var-S1 ) \kore-sort-SortBool kore-sort-var-S1 $.
${ substitution-1053 $p #Substitution ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ( \and ( \in-sort kore-element-var-T kore-sort-var-S1 ) \top ) \kore-sort-SortBool kore-sort-var-S1 $= ( IMP-sort-32-is-pattern top-is-pattern element-var-is-var typecode-cache-Pattern-6 in-sort-is-pattern typecode-cache-Pattern-7 substitution-1052 substitution-disjoint substitution-and ) CBFCGDABHDAEABIDCAEJK $. $}
