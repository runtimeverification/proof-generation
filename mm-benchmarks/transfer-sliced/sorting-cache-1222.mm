...
sorting-cache-1221 $a |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ( \kore-is-sort \kore-sort-SortBExp ) ) $.
${ sorting-cache-1222 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ( \and ( \kore-is-sort \kore-sort-SortBExp ) ( \kore-is-sort \kore-sort-SortKItem ) ) ) $= ( kore-is-sort-is-pattern top-is-pattern and-is-pattern typecode-cache-Pattern-0 IMP-sort-22-is-pattern BASIC-K-sort-1-is-pattern sorting-cache-1221 sorting-cache-475 rule-and-intro-alt2-sugar ) AEBCDCDFBGBAHAIJ $. $}
