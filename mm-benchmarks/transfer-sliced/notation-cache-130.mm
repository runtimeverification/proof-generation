...
${ notation-cache-130 $p #Notation ( \kore-symbol-Lbl'Hash'tell'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'Int ptn2 ) ( \app \kore-symbol-Lbl'Hash'tell'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'Int-symbol ptn2 ) $= ( IMP-symbol-115-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-115-is-pattern IMP-symbol-115-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
