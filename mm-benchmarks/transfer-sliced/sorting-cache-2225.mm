...
${ sorting-cache-2225 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-V2 \kore-sort-SortK ) \top ) ) ( \in-sort ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "200" ) ) \kore-symbol-dotk ) \kore-sort-SortK ) ) $= ( IMP-sort-23-is-pattern in-sort-is-pattern KSEQ-symbol-1-is-pattern BASIC-K-sort-1-is-pattern BASIC-K-sort-0-is-pattern typecode-cache-Pattern-156 string-literal-15-is-pattern kore-dv-is-pattern kore-inj-is-pattern and-is-pattern KSEQ-symbol-0-is-pattern sorting-cache-2203 imp-is-pattern proof-rule-prop-1 KSEQ-symbol-1-sorting proof-rule-mp rule-and-intro-alt2-sugar KSEQ-symbol-0-sorting rule-imp-transitivity ) ABHCFCIJKFDEGDLCFCIJKEMGDABHCFCIJKFDEGDABNEGDABHEGDOEGDABHPQRSCFCIJKETUA $. $}
