$c #Notation #SetVariable \kore-symbol-Lbl'Hash'freezer'UndsPercUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp0'Unds'-symbol #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-Lbl'Hash'freezer'UndsPercUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp0'Unds' ( $.
...
${ notation-cache-21 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'UndsPercUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp0'Unds' ptn0 ) ( \app \kore-symbol-Lbl'Hash'freezer'UndsPercUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp0'Unds'-symbol ptn0 ) $= ( IMP-symbol-74-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-74-is-pattern IMP-symbol-74-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
