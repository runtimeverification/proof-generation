...
${ substitution-88 $p #Substitution \kore-sort-SortKItem \kore-sort-SortKItem kore-sort-var-x0 kore-sort-var-R $= ( BASIC-K-sort-1-is-pattern typecode-cache-Pattern-14 element-var-is-var substitution-disjoint ) CBDAEF $. $}
