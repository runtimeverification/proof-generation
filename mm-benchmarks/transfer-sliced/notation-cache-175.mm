...
${ notation-cache-175 $p #Notation ( \kore-symbol-LblFloat2String'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Float ptn2 ) ( \app \kore-symbol-LblFloat2String'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Float-symbol ptn2 ) $= ( IMP-symbol-135-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-135-is-pattern IMP-symbol-135-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
