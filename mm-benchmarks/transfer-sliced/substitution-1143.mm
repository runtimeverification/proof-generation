$c #Substitution \kore-symbol-Lbl'Hash'freezer'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp1'Unds' #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-exists \kore-sort-SortKItem \kore-valid ) \kore-equals ( $.
