...
${ notation-cache-333 $p #Notation ( \kore-symbol-Lbl'Unds-GT--GT-'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds-GT--GT-'Int'Unds'-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-189-is-symbol symbol-is-pattern IMP-symbol-189-is-pattern IMP-symbol-189-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
