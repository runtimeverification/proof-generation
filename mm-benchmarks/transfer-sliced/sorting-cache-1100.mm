...
${ sorting-cache-1100 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortBlock ) \top ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortBlock ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-253 IMP-sort-18-is-pattern top-is-pattern and-is-pattern rule-imp-transitivity typecode-cache-Pattern-263 typecode-cache-Pattern-179 IMP-sort-22-is-pattern and-elim-right-sugar and-elim-left-sugar imp-reflexivity ) ABIBDECFGBDECAJKCBDECFGLBDECFGBDECBDECBDECFMBDECNHH $. $}
