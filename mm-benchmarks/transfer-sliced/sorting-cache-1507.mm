$c \top #SetVariable \kore-sort-SortAExp #ElementVariable #Symbol #Variable #Pattern \and \kore-sort-SortKItem \imp \kore-dv "0" \kore-is-sort |- ) \kore-inj \kore-sort-SortInt \in-sort \kore-sort-SortStateCell ( $.
...
${ sorting-cache-1507 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ) ( \in-sort ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "0" ) ) \kore-sort-SortAExp ) ) $= ( IMP-sort-23-is-pattern in-sort-is-pattern string-literal-1-is-pattern and-is-pattern kore-dv-is-pattern IMP-sort-13-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-324 kore-is-sort-is-pattern kore-inj-is-pattern sorting-cache-1506 imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp rule-and-intro-alt2-sugar INJ-symbol-0-sorting rule-imp-transitivity ) AJKEBCLGDMIMGDFHDEGDIDFHNIEAJKEBCLGDMIMGDFHDEABCODFHDEAJKEBCLGDFHDEPDFHDEAJKEBCLGQDFRSTDIDFHUAUB $. $}
