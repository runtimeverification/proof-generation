$c \kore-symbol-Lbl'UndsPlus'Int'Unds' #Substitution #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'UndsPlus'Int'Unds'-symbol #Variable #Pattern \app ) ( $.
...
notation-cache-239 $a #Notation ( \kore-symbol-Lbl'UndsPlus'Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsPlus'Int'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-240 $a #Notation ( \kore-symbol-Lbl'UndsPlus'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsPlus'Int'Unds'-symbol ptn3 ) ptn4 ) $.
