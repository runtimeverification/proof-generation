...
${ notation-cache-680 $p #Notation ( \kore-symbol-Lblproject'Coln'KCell ptn1 ) ( \app \kore-symbol-Lblproject'Coln'KCell-symbol ptn1 ) $= ( IMP-symbol-320-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-320-is-pattern IMP-symbol-320-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
