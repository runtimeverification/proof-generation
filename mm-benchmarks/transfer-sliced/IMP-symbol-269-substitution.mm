$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-LblisKConfigVar \app ) \kore-symbol-LblisKConfigVar-symbol ( $.
...
notation-cache-542 $a #Notation ( \kore-symbol-LblisKConfigVar ptn1 ) ( \app \kore-symbol-LblisKConfigVar-symbol ptn1 ) $.
notation-cache-543 $a #Notation ( \kore-symbol-LblisKConfigVar ptn2 ) ( \app \kore-symbol-LblisKConfigVar-symbol ptn2 ) $.
${ IMP-symbol-269-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-269-substitution $p #Substitution ( \kore-symbol-LblisKConfigVar ptn1 ) ( \kore-symbol-LblisKConfigVar ptn2 ) ptn0 xX0 $= ( IMP-symbol-269-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-269-is-pattern substitution-disjoint substitution-app notation-cache-542 notation-cache-543 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
