...
sorting-cache-1288 $a |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) \top ) ) ( \and ( \in-sort ( \kore-dv \kore-sort-SortId "ret" ) \kore-sort-SortId ) ( \in-sort ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "0" ) ) \kore-sort-SortAExp ) ) ) $.
${ sorting-cache-1289 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) \top ) ) ( \in-sort ( \kore-symbol-Lbl'LBraUndsRBraUnds'IMP-SYNTAX'Unds'Block'Unds'Stmt ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "ret" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "0" ) ) ) ) \kore-sort-SortBlock ) ) $= ( kore-dv-is-pattern IMP-sort-23-is-pattern IMP-sort-17-is-pattern IMP-sort-13-is-pattern string-literal-11-is-pattern string-literal-1-is-pattern kore-inj-is-pattern in-sort-is-pattern IMP-symbol-185-is-pattern typecode-cache-Pattern-286 IMP-sort-31-is-pattern rule-imp-transitivity IMP-symbol-354-is-pattern IMP-sort-18-is-pattern and-is-pattern sorting-cache-1288 IMP-symbol-185-sorting IMP-symbol-354-sorting ) ABLEGCDFDHCIKMJEGCDFDHCIKOPJABLEGCEJDFDHCIFJQEGCDFDHCIKMJABREGCDFDHCISNEGCDFDHCIKTN $. $}
