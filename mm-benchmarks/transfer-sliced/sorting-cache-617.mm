...
${ sorting-cache-617 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortMap ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStmt ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortIds ) \top ) ) ) ) ( \and ( \in-sort kore-element-var-VE0 \kore-sort-SortGeneratedCounterCell ) \top ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortIds ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-146 IMP-sort-14-is-pattern typecode-cache-Pattern-177 IMP-sort-17-is-pattern typecode-cache-Pattern-180 typecode-cache-Pattern-148 IMP-sort-10-is-pattern top-is-pattern typecode-cache-Pattern-179 IMP-sort-0-is-pattern and-elim-left-sugar sorting-cache-616 rule-imp-transitivity ) CHIFBJKFDELGGAMNFOGGCHIFBJKFDELGGEPQFCHIFBJKFDELGGAMNFOGRBCDEST $. $}
