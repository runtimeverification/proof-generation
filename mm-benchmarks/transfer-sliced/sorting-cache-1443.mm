$c \top #SetVariable #ElementVariable #Symbol #Variable #Pattern \and \kore-sort-SortKItem \imp \kore-dv \kore-is-sort |- \kore-sort-SortId ) "addressTo" \in-sort \kore-sort-SortMap ( $.
...
${ sorting-cache-1443 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) \top ) ) ) ( \and ( \and ( \kore-is-sort \kore-sort-SortId ) ( \kore-is-sort \kore-sort-SortKItem ) ) ( \in-sort ( \kore-dv \kore-sort-SortId "addressTo" ) \kore-sort-SortId ) ) ) $= ( IMP-sort-17-is-pattern BASIC-K-sort-1-is-pattern in-sort-is-pattern kore-is-sort-is-pattern and-is-pattern typecode-cache-Pattern-178 typecode-cache-Pattern-308 string-literal-18-is-pattern kore-dv-is-pattern imp-is-pattern proof-rule-prop-1 proof-rule-mp rule-and-intro-alt2-sugar IMP-sort-17-sort BASIC-K-sort-1-sort kore-dv-sorting ) AIEFBCJHDGEGHDKLDFAIEFBCJHDGEGDGAIEFBCJHDGMDGAIEFBCJHNQOEGAIEFBCJHEGMEGAIEFBCJHNROPDKLDFAIEFBCJHDKLDFMDKLDFAIEFBCJHNDKSOP $. $}
