...
${ sorting-rearrange-1367 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ( \kore-valid kore-sort-var-R ( \kore-forall \kore-sort-SortKResult kore-sort-var-R kore-element-var-VE2 ( \kore-not kore-sort-var-R ( \kore-and kore-sort-var-R ( \kore-top kore-sort-var-R ) ( \kore-and kore-sort-var-R ( \kore-in \kore-sort-SortK kore-sort-var-R ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "balanceTo" ) ) \kore-symbol-dotk ) ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortKResult \kore-sort-SortKItem kore-element-var-VE2 ) \kore-symbol-dotk ) ) ( \kore-top kore-sort-var-R ) ) ) ) ) ) ) $= ( typecode-cache-Pattern-0 top-is-pattern and-is-pattern kore-is-sort-is-pattern kore-top-is-pattern IMP-sort-17-is-pattern BASIC-K-sort-1-is-pattern kore-inj-is-pattern KSEQ-symbol-1-is-pattern KSEQ-symbol-0-is-pattern kore-and-is-pattern IMP-sort-28-is-pattern BASIC-K-sort-0-is-pattern string-literal-17-is-pattern kore-dv-is-pattern typecode-cache-Pattern-177 kore-in-is-pattern kore-not-is-pattern kore-valid-is-pattern rule-imp-transitivity kore-forall-is-pattern sorting-cache-527 top-intro rule-weakening rule-and-intro-alt2-sugar typecode-cache-Pattern-285 typecode-cache-Pattern-284 sorting-cache-1219 sorting-rearrange-1366 kore-forall-intro-alt ) ACFDEDEACFDEACNACACACACGACOACHIHPQJKLNIBRJKLSACGMMTBUCUAACFDEDEACFDAUDACFDEDEDUEUFUGACACACACGACOACHIHPQJKLNIBRJKLSACGMMTNACFDEBABUHABUIACACACACGACOACHIHPQJKLNIBRJKLSACGMMTUAABUJABUKUBULUB $. $}
