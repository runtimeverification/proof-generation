$c #Substitution \kore-symbol-LblisBlock #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-LblisBlock-symbol \app ) ( $.
...
notation-cache-491 $a #Notation ( \kore-symbol-LblisBlock ptn1 ) ( \app \kore-symbol-LblisBlock-symbol ptn1 ) $.
notation-cache-492 $a #Notation ( \kore-symbol-LblisBlock ptn2 ) ( \app \kore-symbol-LblisBlock-symbol ptn2 ) $.
${ IMP-symbol-252-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-252-substitution $p #Substitution ( \kore-symbol-LblisBlock ptn1 ) ( \kore-symbol-LblisBlock ptn2 ) ptn0 xX0 $= ( IMP-symbol-252-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-252-is-pattern substitution-disjoint substitution-app notation-cache-491 notation-cache-492 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
