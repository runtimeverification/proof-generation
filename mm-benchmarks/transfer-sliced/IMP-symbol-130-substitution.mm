$c #Substitution \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment-symbol ( $.
...
notation-cache-159 $a #Notation ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment-symbol ptn1 ) ptn2 ) $.
notation-cache-160 $a #Notation ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment-symbol ptn3 ) ptn4 ) $.
${ IMP-symbol-130-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   IMP-symbol-130-substitution $p #Substitution ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment ptn1 ptn2 ) ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment ptn3 ptn4 ) ptn0 xX0 $= ( IMP-symbol-130-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-130-is-pattern substitution-app substitution-disjoint notation-cache-159 notation-cache-160 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
