$c \exists #Substitution \top #Variable "10" \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals \and \unit-sort \kore-sort-SortKResult #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-inj \kore-sort-SortInt ( $.
...
sorting-rearrange-934 $a |- ( \imp ( \and \top ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortKResult kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortKResult kore-sort-var-R kore-element-var-Val ( \kore-inj \kore-sort-SortInt \kore-sort-SortKResult ( \kore-dv \kore-sort-SortInt "10" ) ) ) ) ) ) $.
