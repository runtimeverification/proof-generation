...
${ sorting-cache-163 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ( \and ( \kore-is-sort kore-sort-var-S3 ) \top ) ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) $= ( and-is-pattern top-is-pattern typecode-cache-Pattern-30 typecode-cache-Pattern-2 kore-is-sort-is-pattern typecode-cache-Pattern-6 IMP-sort-23-is-pattern in-sort-is-pattern and-elim-left-sugar sorting-cache-162 rule-imp-transitivity top-intro rule-weakening rule-and-intro-alt2-sugar ) ACFBGHEDDCIJKEACFBGHEDDACFCIJKACFBGHEDLACMNACFBGHEDDEOPQ $. $}
