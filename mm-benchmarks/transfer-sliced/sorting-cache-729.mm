...
${ sorting-cache-729 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortMap ) ( \and ( \in-sort kore-element-var-K3 \kore-sort-SortMap ) \top ) ) ) ( \kore-is-sort kore-sort-var-R ) ) $= ( typecode-cache-Pattern-0 kore-is-sort-is-pattern IMP-sort-14-is-pattern in-sort-is-pattern and-is-pattern typecode-cache-Pattern-210 typecode-cache-Pattern-120 typecode-cache-Pattern-209 top-is-pattern and-elim-left-sugar imp-reflexivity rule-imp-transitivity ) ABCIADEADEADEBJFGCKFGLHHMADENO $. $}
