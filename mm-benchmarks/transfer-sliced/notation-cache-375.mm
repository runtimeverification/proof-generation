...
${ notation-cache-375 $p #Notation ( \kore-symbol-Lbl'Unds'andThenBool'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds'andThenBool'Unds'-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-206-is-symbol symbol-is-pattern IMP-symbol-206-is-pattern IMP-symbol-206-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
