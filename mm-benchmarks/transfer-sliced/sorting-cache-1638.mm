...
${ sorting-cache-1638 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortInt ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortInt ) \top ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-347 typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern and-is-pattern typecode-cache-Pattern-179 IMP-sort-23-is-pattern top-is-pattern and-elim-right-sugar sorting-cache-1627 rule-imp-transitivity top-intro rule-weakening rule-and-intro-alt2-sugar ) AFGDBCEHCIJDKAFGDBCEHBCECIJDAFGDBCELBCMNAFGDBCEHKOPQ $. $}
