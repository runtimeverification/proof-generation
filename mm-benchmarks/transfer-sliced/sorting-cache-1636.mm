...
${ sorting-cache-1636 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortInt ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortInt ) \top ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortInt ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-347 typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern IMP-sort-23-is-pattern typecode-cache-Pattern-146 top-is-pattern typecode-cache-Pattern-179 rule-imp-transitivity and-elim-left-sugar and-elim-right-sugar sorting-cache-1627 ) AHIECDGFBKJELFFAHIECDGFDMJEAHIECDGFBKJELFOAHIECDGFCDGDMJEAHIECDGPCDQNN $. $}
