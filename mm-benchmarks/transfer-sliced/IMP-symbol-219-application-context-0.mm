...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-219-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsPipe'Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-219-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-219-is-pattern application-context-app-right application-context-app-left notation-cache-416 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
