...
${ notation-cache-473 $p #Notation ( \kore-symbol-LblinitTCell ptn1 ) ( \app \kore-symbol-LblinitTCell-symbol ptn1 ) $= ( IMP-symbol-246-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-246-is-pattern IMP-symbol-246-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
