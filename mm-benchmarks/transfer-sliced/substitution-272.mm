$c #Substitution #SetVariable #ElementVariable #Symbol \kore-sort-SortStmt #Variable #Pattern \kore-exists ) \kore-equals \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( $.
