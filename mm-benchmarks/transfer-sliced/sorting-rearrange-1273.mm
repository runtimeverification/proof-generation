$c \exists #Substitution \top #Variable "90" \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals \and \unit-sort \kore-sort-SortKResult #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-inj \kore-sort-SortInt ( $.
