$c "amount" \top "balanceSender" \kore-sort-SortAExp \kore-sort-SortStmt #Variable \imp \kore-dv |- \kore-sort-SortId ) \and #SetVariable #ElementVariable #Symbol #Pattern \kore-inj \kore-symbol-Lbl'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp \in-sort \kore-sort-SortStateCell ( $.
...
${ sorting-cache-938 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortStmt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortStmt ) \top ) ) ) ( \in-sort ( \kore-symbol-Lbl'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) ) \kore-sort-SortAExp ) ) $= ( IMP-sort-17-is-pattern IMP-sort-13-is-pattern kore-dv-is-pattern kore-inj-is-pattern in-sort-is-pattern string-literal-10-is-pattern string-literal-14-is-pattern and-is-pattern typecode-cache-Pattern-177 IMP-sort-31-is-pattern typecode-cache-Pattern-239 IMP-symbol-164-is-pattern sorting-cache-933 sorting-cache-932 rule-and-intro-alt2-sugar IMP-symbol-164-sorting rule-imp-transitivity ) ALMHBCNKDEDIFGEHDEDJFGEHKDEDIFGDEDJFGOEHALMHBCNKDEDIFGEHDEDJFGEHABCPABCQRDEDIFGDEDJFGST $. $}
