...
${ $d xX0 ptn0 $.
   $d xX0 ptn2 $.
   IMP-symbol-202-application-context-1.0 $e #ApplicationContext xX0 ptn1 $.
   IMP-symbol-202-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsXor-Perc'Int'UndsUnds' ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-202-is-symbol symbol-is-pattern IMP-symbol-202-is-pattern application-context-app-right application-context-app-left notation-cache-365 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAGHBFCAEJKBCDLM $. $}
