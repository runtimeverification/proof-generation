...
${ notation-cache-49 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'UndsSlshUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp1'Unds' ptn1 ) ( \app \kore-symbol-Lbl'Hash'freezer'UndsSlshUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp1'Unds'-symbol ptn1 ) $= ( IMP-symbol-84-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-84-is-pattern IMP-symbol-84-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
