$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-LblisTCell-symbol \kore-symbol-LblisTCell #Variable #Pattern #ApplicationContext \app ) ( $.
...
notation-cache-580 $a #Notation ( \kore-symbol-LblisTCell ptn0 ) ( \app \kore-symbol-LblisTCell-symbol ptn0 ) $.
${ IMP-symbol-281-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-281-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblisTCell ptn0 ) $= ( IMP-symbol-281-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-281-is-pattern application-context-app-right notation-cache-580 notation-application-context ) DEBFBGADEBACHBIJ $. $}
