...
${ notation-cache-173 $p #Notation ( \kore-symbol-LblBool2String'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Bool ptn0 ) ( \app \kore-symbol-LblBool2String'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Bool-symbol ptn0 ) $= ( IMP-symbol-134-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-134-is-pattern IMP-symbol-134-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
