...
${ typecode-cache-Pattern-114 $p #Pattern ( \kore-symbol-Lbl'Unds-GT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp kore-element-var-K0 kore-element-var-K1 ) $= ( typecode-cache-Pattern-51 typecode-cache-Pattern-49 IMP-symbol-192-is-pattern ) ACBDE $. $}
