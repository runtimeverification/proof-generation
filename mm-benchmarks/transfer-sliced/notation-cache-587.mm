...
${ notation-cache-587 $p #Notation ( \kore-symbol-Lblkeys'LParUndsRParUnds'MAP'Unds'Set'Unds'Map ptn1 ) ( \app \kore-symbol-Lblkeys'LParUndsRParUnds'MAP'Unds'Set'Unds'Map-symbol ptn1 ) $= ( IMP-symbol-284-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-284-is-pattern IMP-symbol-284-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
