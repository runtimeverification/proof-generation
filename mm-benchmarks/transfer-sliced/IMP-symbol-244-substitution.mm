$c #Substitution #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-LblinitKCell \kore-symbol-LblinitKCell-symbol #Variable #Pattern \app ) ( $.
...
notation-cache-470 $a #Notation ( \kore-symbol-LblinitKCell ptn1 ) ( \app \kore-symbol-LblinitKCell-symbol ptn1 ) $.
notation-cache-471 $a #Notation ( \kore-symbol-LblinitKCell ptn2 ) ( \app \kore-symbol-LblinitKCell-symbol ptn2 ) $.
${ IMP-symbol-244-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-244-substitution $p #Substitution ( \kore-symbol-LblinitKCell ptn1 ) ( \kore-symbol-LblinitKCell ptn2 ) ptn0 xX0 $= ( IMP-symbol-244-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-244-is-pattern substitution-disjoint substitution-app notation-cache-470 notation-cache-471 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
