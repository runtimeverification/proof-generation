...
${ notation-cache-542 $p #Notation ( \kore-symbol-LblisKConfigVar ptn1 ) ( \app \kore-symbol-LblisKConfigVar-symbol ptn1 ) $= ( IMP-symbol-269-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-269-is-pattern IMP-symbol-269-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
