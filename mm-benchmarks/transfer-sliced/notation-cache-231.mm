...
${ notation-cache-231 $p #Notation ( \kore-symbol-Lbl'UndsAnd-'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsAnd-'Int'Unds'-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-155-is-symbol symbol-is-pattern IMP-symbol-155-is-pattern IMP-symbol-155-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
