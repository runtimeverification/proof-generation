...
${ notation-cache-211 $p #Notation ( \kore-symbol-LblString2Bool'LParUndsRParUnds'STRING-COMMON'Unds'Bool'Unds'String ptn0 ) ( \app \kore-symbol-LblString2Bool'LParUndsRParUnds'STRING-COMMON'Unds'Bool'Unds'String-symbol ptn0 ) $= ( IMP-symbol-148-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-148-is-pattern IMP-symbol-148-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
