...
${ notation-cache-717 $p #Notation ( \kore-symbol-Lblproject'Coln'String ptn2 ) ( \app \kore-symbol-Lblproject'Coln'String-symbol ptn2 ) $= ( IMP-symbol-332-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-332-is-pattern IMP-symbol-332-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
