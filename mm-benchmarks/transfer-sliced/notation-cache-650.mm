...
${ notation-cache-650 $p #Notation ( \kore-symbol-Lblproject'Coln'GeneratedTopCell ptn1 ) ( \app \kore-symbol-Lblproject'Coln'GeneratedTopCell-symbol ptn1 ) $= ( IMP-symbol-310-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-310-is-pattern IMP-symbol-310-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
