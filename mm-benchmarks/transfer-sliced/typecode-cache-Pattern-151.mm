$c \kore-symbol-LblinitGeneratedTopCell #SetVariable \kore-sort-SortGeneratedTopCell \kore-symbol-LblinitTCell #ElementVariable \kore-symbol-LblinitGeneratedCounterCell #Symbol \kore-symbol-Lbl'-LT-'generatedTop'-GT-' #Variable #Pattern ) \kore-equals ( $.
...
${ typecode-cache-Pattern-151 $p #Pattern ( \kore-equals \kore-sort-SortGeneratedTopCell kore-sort-var-R ( \kore-symbol-LblinitGeneratedTopCell kore-element-var-VE0 ) ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-' ( \kore-symbol-LblinitTCell kore-element-var-VE1 ) \kore-symbol-LblinitGeneratedCounterCell ) ) $= ( IMP-sort-8-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-148 IMP-symbol-243-is-pattern typecode-cache-Pattern-146 IMP-symbol-246-is-pattern IMP-symbol-242-is-pattern IMP-symbol-129-is-pattern kore-equals-is-pattern ) DAEBFGCHIJKL $. $}
