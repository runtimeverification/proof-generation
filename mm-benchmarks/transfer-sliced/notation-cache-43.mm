...
${ notation-cache-43 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp1'Unds' ptn1 ) ( \app \kore-symbol-Lbl'Hash'freezer'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp1'Unds'-symbol ptn1 ) $= ( IMP-symbol-82-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-82-is-pattern IMP-symbol-82-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
