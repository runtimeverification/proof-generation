$c #Substitution #Notation #SetVariable \kore-symbol-append #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-append-symbol ( $.
...
notation-cache-3 $a #Notation ( \kore-symbol-append ptn1 ptn2 ) ( \app ( \app \kore-symbol-append-symbol ptn1 ) ptn2 ) $.
notation-cache-4 $a #Notation ( \kore-symbol-append ptn3 ptn4 ) ( \app ( \app \kore-symbol-append-symbol ptn3 ) ptn4 ) $.
${ KSEQ-symbol-2-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   KSEQ-symbol-2-substitution $p #Substitution ( \kore-symbol-append ptn1 ptn2 ) ( \kore-symbol-append ptn3 ptn4 ) ptn0 xX0 $= ( KSEQ-symbol-2-is-symbol symbol-is-pattern app-is-pattern KSEQ-symbol-2-is-pattern substitution-app substitution-disjoint notation-cache-3 notation-cache-4 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
