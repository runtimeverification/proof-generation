$c #Substitution #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'Unds-GT--GT-'Int'Unds' #Variable #Pattern \app ) \kore-symbol-Lbl'Unds-GT--GT-'Int'Unds'-symbol ( $.
...
notation-cache-332 $a #Notation ( \kore-symbol-Lbl'Unds-GT--GT-'Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds-GT--GT-'Int'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-333 $a #Notation ( \kore-symbol-Lbl'Unds-GT--GT-'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds-GT--GT-'Int'Unds'-symbol ptn3 ) ptn4 ) $.
${ IMP-symbol-189-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   IMP-symbol-189-substitution $p #Substitution ( \kore-symbol-Lbl'Unds-GT--GT-'Int'Unds' ptn1 ptn2 ) ( \kore-symbol-Lbl'Unds-GT--GT-'Int'Unds' ptn3 ptn4 ) ptn0 xX0 $= ( IMP-symbol-189-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-189-is-pattern substitution-app substitution-disjoint notation-cache-332 notation-cache-333 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
