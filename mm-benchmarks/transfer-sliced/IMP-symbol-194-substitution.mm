$c #Substitution #Notation #SetVariable #ElementVariable \kore-symbol-Lbl'Unds'Map'Unds' #Symbol #Variable #Pattern \kore-symbol-Lbl'Unds'Map'Unds'-symbol \app ) ( $.
...
notation-cache-347 $a #Notation ( \kore-symbol-Lbl'Unds'Map'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds'Map'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-348 $a #Notation ( \kore-symbol-Lbl'Unds'Map'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds'Map'Unds'-symbol ptn3 ) ptn4 ) $.
${ IMP-symbol-194-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   IMP-symbol-194-substitution $p #Substitution ( \kore-symbol-Lbl'Unds'Map'Unds' ptn1 ptn2 ) ( \kore-symbol-Lbl'Unds'Map'Unds' ptn3 ptn4 ) ptn0 xX0 $= ( IMP-symbol-194-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-194-is-pattern substitution-app substitution-disjoint notation-cache-347 notation-cache-348 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
