...
${ sorting-cache-1393 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) \top ) ) ) ) ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortK ) \top ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-177 IMP-sort-9-is-pattern typecode-cache-Pattern-178 BASIC-K-sort-1-is-pattern typecode-cache-Pattern-308 typecode-cache-Pattern-146 BASIC-K-sort-0-is-pattern top-is-pattern typecode-cache-Pattern-179 IMP-sort-17-is-pattern and-elim-left-sugar sorting-cache-1366 rule-imp-transitivity ) AHIFCJKFDELGGBMNFOGGAHIFCJKFDELGGDPQFAHIFCJKFDELGGBMNFOGRACDEST $. $}
