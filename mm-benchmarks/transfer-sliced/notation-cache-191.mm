...
${ notation-cache-191 $p #Notation ( \kore-symbol-LblListItem ptn2 ) ( \app \kore-symbol-LblListItem-symbol ptn2 ) $= ( IMP-symbol-141-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-141-is-pattern IMP-symbol-141-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
