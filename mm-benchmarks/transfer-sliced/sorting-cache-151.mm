...
${ sorting-cache-151 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S2 ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ) ) ( \in-sort kore-element-var-T \kore-sort-SortInt ) ) $= ( kore-is-sort-is-pattern typecode-cache-Pattern-28 typecode-cache-Pattern-1 and-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-6 IMP-sort-23-is-pattern in-sort-is-pattern and-elim-right-sugar rule-imp-transitivity sorting-cache-150 ) AIECGEBDFHHCGEBDFHDJKLAIECGEBDFHMCGEBDFHBDFDJKLCGEBDFMBDONN $. $}
