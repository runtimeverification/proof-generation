$c #Substitution #Notation \kore-symbol-LblinitGeneratedTopCell #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-LblinitGeneratedTopCell-symbol \app ) ( $.
...
notation-cache-467 $a #Notation ( \kore-symbol-LblinitGeneratedTopCell ptn1 ) ( \app \kore-symbol-LblinitGeneratedTopCell-symbol ptn1 ) $.
notation-cache-468 $a #Notation ( \kore-symbol-LblinitGeneratedTopCell ptn2 ) ( \app \kore-symbol-LblinitGeneratedTopCell-symbol ptn2 ) $.
${ IMP-symbol-243-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-243-substitution $p #Substitution ( \kore-symbol-LblinitGeneratedTopCell ptn1 ) ( \kore-symbol-LblinitGeneratedTopCell ptn2 ) ptn0 xX0 $= ( IMP-symbol-243-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-243-is-pattern substitution-disjoint substitution-app notation-cache-467 notation-cache-468 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
