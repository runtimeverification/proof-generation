...
sorting-rearrange-1229 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-V2 \kore-sort-SortK ) \top ) ) ( \exists kore-element-var-Val ( \eq kore-element-var-Val ( \kore-symbol-Lbl'Hash'freezer'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp1'Unds' ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "100" ) ) \kore-symbol-dotk ) ) ) ) ) $.
...
sorting-cache-2064 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-V2 \kore-sort-SortK ) \top ) ) ( \in-sort ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "100" ) ) \kore-symbol-dotk ) \kore-sort-SortK ) ) $.
${ sorting-rearrange-1230 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-V2 \kore-sort-SortK ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortK kore-sort-var-R kore-element-var-V0 ( \kore-equals \kore-sort-SortK kore-sort-var-R kore-element-var-V0 ( \kore-symbol-kseq ( \kore-symbol-Lbl'Hash'freezer'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp1'Unds' ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "100" ) ) \kore-symbol-dotk ) ) kore-element-var-V2 ) ) ) ) ) $= ( IMP-sort-23-is-pattern BASIC-K-sort-1-is-pattern kore-element-var-V1-elementvariable KSEQ-symbol-0-is-pattern string-literal-16-is-pattern kore-dv-is-pattern kore-inj-is-pattern KSEQ-symbol-1-is-pattern IMP-symbol-82-is-pattern typecode-cache-Pattern-0 element-var-is-var BASIC-K-sort-0-is-pattern in-sort-is-pattern top-is-pattern and-is-pattern kore-exists-is-pattern substitution-disjoint typecode-cache-Pattern-156 kore-valid-is-pattern kore-element-var-x0-elementvariable typecode-cache-Pattern-37 typecode-cache-Pattern-429 typecode-cache-Pattern-159 typecode-cache-Pattern-35 typecode-cache-Pattern-25 typecode-cache-Pattern-39 rule-imp-transitivity rule-and-intro-alt2-sugar typecode-cache-Pattern-161 kore-element-var-Val-elementvariable substitution-var-same substitution-imp sorting-cache-537 sorting-cache-2064 IMP-symbol-82-sorting top-intro rule-weakening sorting-rearrange-1229 sorting-rearrange-273 substitution-in-sort substitution-and typecode-cache-Pattern-158 KSEQ-symbol-0-substitution substitution-kore-equals substitution-kore-exists-alt substitution-kore-valid substitution-474 substitution-479 functional-substitution-alt )  $. $}
