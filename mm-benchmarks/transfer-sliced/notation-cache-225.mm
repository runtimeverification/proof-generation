...
${ notation-cache-225 $p #Notation ( \kore-symbol-Lbl'UndsPercUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsPercUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-153-is-symbol symbol-is-pattern IMP-symbol-153-is-pattern IMP-symbol-153-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
