$c #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \kore-symbol-LblisString \app ) \kore-symbol-LblisString-symbol ( $.
...
notation-cache-577 $a #Notation ( \kore-symbol-LblisString ptn0 ) ( \app \kore-symbol-LblisString-symbol ptn0 ) $.
${ IMP-symbol-280-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-280-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblisString ptn0 ) $= ( IMP-symbol-280-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-280-is-pattern application-context-app-right notation-cache-577 notation-application-context ) DEBFBGADEBACHBIJ $. $}
