$c \top \kore-sort-SortKConfigVar #Variable \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals \and #SetVariable #ElementVariable "%24PGM" #Symbol #Pattern \kore-exists \kore-sort-SortKItem \kore-inj ( $.
