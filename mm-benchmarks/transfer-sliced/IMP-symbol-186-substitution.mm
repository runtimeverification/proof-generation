$c #Substitution \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds' #Notation #SetVariable \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds'-symbol #ElementVariable #Symbol #Variable #Pattern \app ) ( $.
...
notation-cache-323 $a #Notation ( \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-324 $a #Notation ( \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds'-symbol ptn3 ) ptn4 ) $.
${ IMP-symbol-186-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   IMP-symbol-186-substitution $p #Substitution ( \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds' ptn1 ptn2 ) ( \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds' ptn3 ptn4 ) ptn0 xX0 $= ( IMP-symbol-186-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-186-is-pattern substitution-app substitution-disjoint notation-cache-323 notation-cache-324 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
