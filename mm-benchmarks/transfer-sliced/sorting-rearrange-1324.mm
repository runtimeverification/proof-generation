$c #Substitution #Notation "amount" \iff \top \ceil \kore-sort-SortAExp \or \kore-symbol-kseq #Variable #ApplicationContext \included \floor \inh \kore-sort-SortBool \kore-sort-SortK \imp \kore-dv \kore-is-sort |- \kore-sort-SortId \kore-valid \bot ) \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp \and \kore-sort-SortKResult #SetVariable #ElementVariable #Symbol \eq \sorted-exists #Pattern \is-predicate \kore-not \kore-sort-SortKItem \kore-in \not \kore-inj \kore-sort-SortInt \in-sort \kore-symbol-dotk "balanceTo" ( $.
