...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-181-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsEqlsEqls'Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-181-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-181-is-pattern application-context-app-right application-context-app-left notation-cache-310 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
