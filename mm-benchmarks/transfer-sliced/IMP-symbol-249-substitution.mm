$c #Substitution #Notation \kore-symbol-LblisAExp-symbol #SetVariable \kore-symbol-LblisAExp #ElementVariable #Symbol #Variable #Pattern \app ) ( $.
...
notation-cache-482 $a #Notation ( \kore-symbol-LblisAExp ptn1 ) ( \app \kore-symbol-LblisAExp-symbol ptn1 ) $.
notation-cache-483 $a #Notation ( \kore-symbol-LblisAExp ptn2 ) ( \app \kore-symbol-LblisAExp-symbol ptn2 ) $.
${ IMP-symbol-249-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-249-substitution $p #Substitution ( \kore-symbol-LblisAExp ptn1 ) ( \kore-symbol-LblisAExp ptn2 ) ptn0 xX0 $= ( IMP-symbol-249-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-249-is-pattern substitution-disjoint substitution-app notation-cache-482 notation-cache-483 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
