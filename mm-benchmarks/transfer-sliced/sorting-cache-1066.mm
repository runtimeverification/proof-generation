$c \top #SetVariable #ElementVariable #Symbol #Variable #Pattern "10" \and \kore-sort-SortKItem \imp \kore-dv \kore-is-sort |- ) \kore-sort-SortInt \in-sort \kore-sort-SortMap ( $.
