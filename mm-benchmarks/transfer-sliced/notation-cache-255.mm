...
${ notation-cache-255 $p #Notation ( \kore-symbol-Lbl'Unds'-Map'UndsUnds'MAP'Unds'Map'Unds'Map'Unds'Map ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds'-Map'UndsUnds'MAP'Unds'Map'Unds'Map'Unds'Map-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-163-is-symbol symbol-is-pattern IMP-symbol-163-is-pattern IMP-symbol-163-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
