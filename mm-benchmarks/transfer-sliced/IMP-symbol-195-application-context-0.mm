$c #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-Lbl'Unds'Set'Unds' #ApplicationContext \kore-symbol-Lbl'Unds'Set'Unds'-symbol \app ) ( $.
...
notation-cache-352 $a #Notation ( \kore-symbol-Lbl'Unds'Set'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'Set'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-195-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-195-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds'Set'Unds' ptn0 ptn1 ) $= ( IMP-symbol-195-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-195-is-pattern application-context-app-right application-context-app-left notation-cache-352 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
