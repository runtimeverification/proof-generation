$c \top #SetVariable \kore-sort-SortAExp #ElementVariable #Symbol #Variable #Pattern \and \kore-sort-SortK \imp \kore-dv \kore-is-sort |- "100" ) \kore-inj \kore-sort-SortInt \in-sort \kore-sort-SortStateCell ( $.
...
${ sorting-cache-2060 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) \top ) ) ) ( \in-sort ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "100" ) ) \kore-sort-SortAExp ) ) $= ( IMP-sort-23-is-pattern in-sort-is-pattern string-literal-16-is-pattern and-is-pattern kore-dv-is-pattern IMP-sort-13-is-pattern typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-286 kore-is-sort-is-pattern kore-inj-is-pattern sorting-cache-1581 imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp rule-and-intro-alt2-sugar INJ-symbol-0-sorting rule-imp-transitivity ) AJKEBCLGDMIMGDFHDEGDIDFHNIEAJKEBCLGDMIMGDFHDEABCODFHDEAJKEBCLGDFHDEPDFHDEAJKEBCLGQDFRSTDIDFHUAUB $. $}
