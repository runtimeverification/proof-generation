...
${ sorting-cache-1800 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S2 ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) ) ( \in-sort kore-element-var-T \kore-sort-SortBool ) ) $= ( kore-is-sort-is-pattern typecode-cache-Pattern-379 typecode-cache-Pattern-1 and-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-6 IMP-sort-32-is-pattern in-sort-is-pattern and-elim-right-sugar rule-imp-transitivity sorting-cache-1799 ) AIECGEBDFHHCGEBDFHDJKLAIECGEBDFHMCGEBDFHBDFDJKLCGEBDFMBDONN $. $}
