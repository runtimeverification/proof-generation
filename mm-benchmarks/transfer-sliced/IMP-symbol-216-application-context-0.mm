...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-216-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds'xorBool'Unds' ptn0 ptn1 ) $= ( IMP-symbol-216-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-216-is-pattern application-context-app-right application-context-app-left notation-cache-407 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
