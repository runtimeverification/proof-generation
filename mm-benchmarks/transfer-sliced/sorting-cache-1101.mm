...
${ sorting-cache-1101 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortBlock ) \top ) ) ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortBlock ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-263 typecode-cache-Pattern-178 IMP-sort-9-is-pattern and-is-pattern typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-253 IMP-sort-18-is-pattern and-elim-right-sugar rule-imp-transitivity sorting-cache-1100 ) AJKEBGHECDFIIBGHECDFIDLMEAJKEBGHECDFINBGHECDFICDFDLMEBGHECDFNCDPOO $. $}
