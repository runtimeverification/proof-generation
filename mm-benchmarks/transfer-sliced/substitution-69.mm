$c #Substitution "amount" #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-dv \kore-sort-SortId ) \kore-equals ( $.
...
${ substitution-69 $p #Substitution ( \kore-equals \kore-sort-SortId kore-sort-var-x1 kore-element-var-x1 ( \kore-dv \kore-sort-SortId "amount" ) ) ( \kore-equals \kore-sort-SortId kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortId "amount" ) ) kore-sort-var-x1 kore-sort-var-x0 $= ( IMP-sort-17-is-pattern typecode-cache-Pattern-24 string-literal-14-is-pattern kore-dv-is-pattern element-var-is-var typecode-cache-Pattern-23 typecode-cache-Pattern-14 substitution-67 substitution-var-same substitution-68 substitution-disjoint substitution-kore-equals ) DCEBIDFGDAJBIDFGCEAHACKCEAHLABCMDFGCEAHNO $. $}
