...
${ notation-cache-566 $p #Notation ( \kore-symbol-LblisStateCellOpt ptn1 ) ( \app \kore-symbol-LblisStateCellOpt-symbol ptn1 ) $= ( IMP-symbol-277-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-277-is-pattern IMP-symbol-277-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
