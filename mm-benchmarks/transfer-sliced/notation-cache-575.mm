...
${ notation-cache-575 $p #Notation ( \kore-symbol-LblisString ptn1 ) ( \app \kore-symbol-LblisString-symbol ptn1 ) $= ( IMP-symbol-280-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-280-is-pattern IMP-symbol-280-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
