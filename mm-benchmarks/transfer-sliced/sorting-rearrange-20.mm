$c \exists \top #SetVariable \kore-sort-SortAExp #ElementVariable #Symbol \eq #Variable #Pattern \and \imp \kore-is-sort |- ) \kore-sort-SortInt \in-sort ( $.
