$c \exists \top #Variable "10" \imp \kore-dv |- \kore-sort-SortId \kore-valid ) \kore-equals \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-sort-SortKItem \kore-sort-SortInt \in-sort \kore-sort-SortMap ( $.
...
${ sorting-rearrange-536 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) \top ) ) ) ( \exists kore-element-var-x1 ( \eq kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "10" ) ) ) ) $= ( top-is-pattern IMP-sort-23-is-pattern typecode-cache-Pattern-178 IMP-sort-17-is-pattern in-sort-is-pattern typecode-cache-Pattern-254 and-is-pattern string-literal-13-is-pattern kore-dv-is-pattern typecode-cache-Pattern-23 eq-is-pattern exists-is-pattern top-intro rule-weakening sorting-cache-18 sorting-rearrange-26 kore-functional rule-imp-transitivity ) AGHIBDJKECNFLMOCPAGHIBDJKEQRFFLMECSCTUAUB $. $}
