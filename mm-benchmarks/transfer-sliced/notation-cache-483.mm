...
${ notation-cache-483 $p #Notation ( \kore-symbol-LblisAExp ptn2 ) ( \app \kore-symbol-LblisAExp-symbol ptn2 ) $= ( IMP-symbol-249-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-249-is-pattern IMP-symbol-249-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
