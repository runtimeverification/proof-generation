...
sorting-cache-1709 $a |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) \top ) ) ) ) ) ) ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) ) $.
${ sorting-cache-1710 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) \top ) ) ) ) ) ) ( \and ( \in-sort kore-element-var-VE0 \kore-sort-SortGeneratedCounterCell ) \top ) ) ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) ) $= ( in-sort-is-pattern and-is-pattern IMP-sort-18-is-pattern typecode-cache-Pattern-146 typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-179 IMP-sort-22-is-pattern typecode-cache-Pattern-357 typecode-cache-Pattern-148 IMP-sort-10-is-pattern top-is-pattern typecode-cache-Pattern-356 and-elim-left-sugar sorting-cache-1709 rule-imp-transitivity ) CKJHBLMHDNOHEPQHFGRIIIIASTHUAIICKJHBLMHDNOHEPQHFGRIIIIGUBJHCKJHBLMHDNOHEPQHFGRIIIIASTHUAIUCBCDEFGUDUE $. $}
