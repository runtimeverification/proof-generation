$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'Unds-LT-Eqls'Map'UndsUnds'MAP'Unds'Bool'Unds'Map'Unds'Map #Variable #Pattern #ApplicationContext \app \kore-symbol-Lbl'Unds-LT-Eqls'Map'UndsUnds'MAP'Unds'Bool'Unds'Map'Unds'Map-symbol ) ( $.
...
notation-cache-274 $a #Notation ( \kore-symbol-Lbl'Unds-LT-Eqls'Map'UndsUnds'MAP'Unds'Bool'Unds'Map'Unds'Map ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds-LT-Eqls'Map'UndsUnds'MAP'Unds'Bool'Unds'Map'Unds'Map-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-169-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-169-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds-LT-Eqls'Map'UndsUnds'MAP'Unds'Bool'Unds'Map'Unds'Map ptn0 ptn1 ) $= ( IMP-symbol-169-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-169-is-pattern application-context-app-right application-context-app-left notation-cache-274 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
