...
${ notation-cache-518 $p #Notation ( \kore-symbol-LblisIOInt ptn1 ) ( \app \kore-symbol-LblisIOInt-symbol ptn1 ) $= ( IMP-symbol-261-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-261-is-pattern IMP-symbol-261-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
