$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-LblensureOffsetList'LParUndsCommUndsCommUndsRParUnds'ARRAY-IN-K'Unds'List'Unds'List'Unds'Int'Unds'KItem \app \kore-symbol-LblensureOffsetList'LParUndsCommUndsCommUndsRParUnds'ARRAY-IN-K'Unds'List'Unds'List'Unds'Int'Unds'KItem-symbol ) ( $.
...
${ IMP-symbol-231-substitution.0 $e #Substitution ptn1 ptn4 ptn0 xX0 $.
   IMP-symbol-231-substitution.1 $e #Substitution ptn2 ptn5 ptn0 xX0 $.
   IMP-symbol-231-substitution.2 $e #Substitution ptn3 ptn6 ptn0 xX0 $.
   IMP-symbol-231-substitution $p #Substitution ( \kore-symbol-LblensureOffsetList'LParUndsCommUndsCommUndsRParUnds'ARRAY-IN-K'Unds'List'Unds'List'Unds'Int'Unds'KItem ptn1 ptn2 ptn3 ) ( \kore-symbol-LblensureOffsetList'LParUndsCommUndsCommUndsRParUnds'ARRAY-IN-K'Unds'List'Unds'List'Unds'Int'Unds'KItem ptn4 ptn5 ptn6 ) ptn0 xX0 $= ( app-is-pattern IMP-symbol-231-is-symbol symbol-is-pattern IMP-symbol-231-is-pattern substitution-app notation-reflexivity IMP-symbol-231-is-sugar notation-transitivity substitution-disjoint notation-substitution ) MNCLDLELMNFLGLHLBCDEOFGHOBABMNCLDLEMNFLGLHABMNCLDMNFLGABMNCMNFAMNBATIPJPKPCDEOMNCLDLELMNCLDLELCDERMNCLDLELQSFGHOMNFLGLHLMNFLGLHLFGHRMNFLGLHLQSBQUA $. $}
