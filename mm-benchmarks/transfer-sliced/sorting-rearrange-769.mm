$c \exists #Substitution \top #Variable \kore-sort-SortBool \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern "true" \kore-symbol-Lbl'Unds'andBool'Unds' ( $.
...
${ sorting-rearrange-769 $p |- ( \imp \top ( \kore-valid \unit-sort ( \kore-equals \kore-sort-SortBool \unit-sort ( \kore-symbol-Lbl'Unds'andBool'Unds' ( \kore-dv \kore-sort-SortBool "true" ) ( \kore-dv \kore-sort-SortBool "true" ) ) ( \kore-dv \kore-sort-SortBool "true" ) ) ) ) $= ( IMP-sort-32-is-pattern string-literal-0-is-pattern kore-dv-is-pattern kore-sort-var-R-elementvariable top-is-pattern typecode-cache-Pattern-0 unit-sort-is-symbol symbol-is-pattern IMP-symbol-205-is-pattern kore-sort-var-x0-elementvariable and-is-pattern typecode-cache-Pattern-14 kore-is-sort-is-pattern element-var-is-var kore-equals-is-pattern kore-valid-is-pattern x-is-element-var substitution-var-same substitution-disjoint rule-weakening top-intro rule-and-intro-alt2-sugar rule-imp-transitivity substitution-kore-equals substitution-kore-valid substitution-imp sorting-cache-129 typecode-cache-Pattern-22 exists-is-pattern unit-sort-is-functional sorting-cache-136 LblUndsandBoolUnds-domain-fact-0 substitution-83 substitution-127 substitution-87 substitution-128 functional-substitution-alt )  $. $}
