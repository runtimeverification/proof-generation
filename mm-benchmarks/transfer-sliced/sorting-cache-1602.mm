...
${ sorting-cache-1602 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) \top ) ( \in-sort ( \kore-dv \kore-sort-SortId "balanceSender" ) \kore-sort-SortId ) ) $= ( IMP-sort-17-is-pattern in-sort-is-pattern string-literal-10-is-pattern kore-dv-is-pattern typecode-cache-Pattern-253 IMP-sort-14-is-pattern top-is-pattern and-is-pattern imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp ) BDEBCAFGCHIBDEBCJBDEBCAFGCHIKBDLM $. $}
