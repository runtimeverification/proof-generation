$c #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-LblisMap \kore-symbol-LblisMap-symbol ( $.
...
notation-cache-556 $a #Notation ( \kore-symbol-LblisMap ptn0 ) ( \app \kore-symbol-LblisMap-symbol ptn0 ) $.
${ IMP-symbol-273-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-273-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblisMap ptn0 ) $= ( IMP-symbol-273-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-273-is-pattern application-context-app-right notation-cache-556 notation-application-context ) DEBFBGADEBACHBIJ $. $}
