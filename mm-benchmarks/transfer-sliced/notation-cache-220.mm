$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-LblString2Int'LParUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String #Variable #Pattern \app \kore-symbol-LblString2Int'LParUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String-symbol ) ( $.
...
${ notation-cache-220 $p #Notation ( \kore-symbol-LblString2Int'LParUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String ptn0 ) ( \app \kore-symbol-LblString2Int'LParUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String-symbol ptn0 ) $= ( IMP-symbol-151-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-151-is-pattern IMP-symbol-151-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
