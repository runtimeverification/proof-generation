...
${ sorting-cache-358 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortBlock ) \top ) ) ) ( \kore-is-sort kore-sort-var-R ) ) $= ( typecode-cache-Pattern-0 kore-is-sort-is-pattern IMP-sort-18-is-pattern in-sort-is-pattern and-is-pattern typecode-cache-Pattern-121 typecode-cache-Pattern-49 typecode-cache-Pattern-120 top-is-pattern and-elim-left-sugar imp-reflexivity rule-imp-transitivity ) ABCIADEADEADEBJFGCKFGLHHMADENO $. $}
