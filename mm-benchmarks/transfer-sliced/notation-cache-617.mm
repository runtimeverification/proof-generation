...
${ notation-cache-617 $p #Notation ( \kore-symbol-Lblproject'ColnHash'tempFile'Coln'fd ptn1 ) ( \app \kore-symbol-Lblproject'ColnHash'tempFile'Coln'fd-symbol ptn1 ) $= ( IMP-symbol-299-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-299-is-pattern IMP-symbol-299-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
