...
${ notation-cache-531 $p #Notation ( \kore-symbol-LblisInt ptn2 ) ( \app \kore-symbol-LblisInt-symbol ptn2 ) $= ( IMP-symbol-265-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-265-is-pattern IMP-symbol-265-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
