$c #Notation #SetVariable \kore-symbol-LblisBExp #ElementVariable #Symbol \kore-symbol-LblisBExp-symbol #Variable #Pattern #ApplicationContext \app ) ( $.
...
notation-cache-490 $a #Notation ( \kore-symbol-LblisBExp ptn0 ) ( \app \kore-symbol-LblisBExp-symbol ptn0 ) $.
${ IMP-symbol-251-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-251-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblisBExp ptn0 ) $= ( IMP-symbol-251-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-251-is-pattern application-context-app-right notation-cache-490 notation-application-context ) DEBFBGADEBACHBIJ $. $}
