...
${ notation-cache-755 $p #Notation ( \kore-symbol-LblupdateMap'LParUndsCommUndsRParUnds'MAP'Unds'Map'Unds'Map'Unds'Map ptn1 ptn2 ) ( \app ( \app \kore-symbol-LblupdateMap'LParUndsCommUndsRParUnds'MAP'Unds'Map'Unds'Map'Unds'Map-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-351-is-symbol symbol-is-pattern IMP-symbol-351-is-pattern IMP-symbol-351-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
