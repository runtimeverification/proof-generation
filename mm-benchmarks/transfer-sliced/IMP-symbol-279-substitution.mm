$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-LblisStream-symbol \kore-symbol-LblisStream ( $.
...
notation-cache-572 $a #Notation ( \kore-symbol-LblisStream ptn1 ) ( \app \kore-symbol-LblisStream-symbol ptn1 ) $.
notation-cache-573 $a #Notation ( \kore-symbol-LblisStream ptn2 ) ( \app \kore-symbol-LblisStream-symbol ptn2 ) $.
${ IMP-symbol-279-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-279-substitution $p #Substitution ( \kore-symbol-LblisStream ptn1 ) ( \kore-symbol-LblisStream ptn2 ) ptn0 xX0 $= ( IMP-symbol-279-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-279-is-pattern substitution-disjoint substitution-app notation-cache-572 notation-cache-573 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
