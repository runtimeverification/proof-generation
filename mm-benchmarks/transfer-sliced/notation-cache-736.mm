$c #Notation \kore-symbol-LblreplaceFirst'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String-symbol #SetVariable #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-LblreplaceFirst'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String ( $.
...
${ notation-cache-736 $p #Notation ( \kore-symbol-LblreplaceFirst'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String ptn0 ptn1 ptn2 ) ( \app ( \app ( \app \kore-symbol-LblreplaceFirst'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String-symbol ptn0 ) ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-340-is-symbol symbol-is-pattern notation-reflexivity notation-app IMP-symbol-340-is-pattern IMP-symbol-340-is-sugar notation-transitivity ) ABCIEFADBDCDEFADBDCDABCJEFADBDCEFADBDCEFADBEFADBEFAEFAEFGAGHBGHCGHK $. $}
