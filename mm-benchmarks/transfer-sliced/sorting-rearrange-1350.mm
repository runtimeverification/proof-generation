...
sorting-rearrange-1349 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \exists kore-element-var-V0 ( \eq kore-element-var-V0 ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "balanceTo" ) ) \kore-symbol-dotk ) ) ) ) $.
sorting-cache-2155 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \in-sort ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "balanceTo" ) ) \kore-symbol-dotk ) \kore-sort-SortK ) \top ) ) $.
${ sorting-rearrange-1350 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortKItem kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortKItem kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'Hash'freezer'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp1'Unds' ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "balanceTo" ) ) \kore-symbol-dotk ) ) ) ) ) ) $= ( IMP-sort-17-is-pattern BASIC-K-sort-1-is-pattern typecode-cache-Pattern-0 kore-element-var-K0-elementvariable string-literal-17-is-pattern kore-dv-is-pattern kore-inj-is-pattern KSEQ-symbol-1-is-pattern KSEQ-symbol-0-is-pattern element-var-is-var top-is-pattern and-is-pattern BASIC-K-sort-0-is-pattern in-sort-is-pattern kore-exists-is-pattern typecode-cache-Pattern-31 kore-valid-is-pattern kore-element-var-x0-elementvariable substitution-disjoint IMP-symbol-91-is-pattern typecode-cache-Pattern-51 kore-is-sort-is-pattern kore-equals-is-pattern typecode-cache-Pattern-413 typecode-cache-Pattern-25 typecode-cache-Pattern-414 kore-element-var-V0-elementvariable substitution-var-same substitution-imp sorting-cache-133 sorting-cache-2155 rule-and-intro-alt2-sugar sorting-rearrange-1349 sorting-rearrange-1191 substitution-in-sort substitution-and IMP-symbol-91-substitution substitution-kore-equals substitution-kore-exists-alt substitution-kore-valid substitution-882 substitution-1143 functional-substitution-alt rule-imp-transitivity )  $. $}
