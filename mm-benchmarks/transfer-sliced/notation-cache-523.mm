...
${ notation-cache-523 $p #Notation ( \kore-symbol-LblisIOString ptn0 ) ( \app \kore-symbol-LblisIOString-symbol ptn0 ) $= ( IMP-symbol-262-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-262-is-pattern IMP-symbol-262-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
