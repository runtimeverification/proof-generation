$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'-LT-'T'-GT-'-fragment-symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-Lbl'-LT-'T'-GT-'-fragment ( $.
...
notation-cache-152 $a #Notation ( \kore-symbol-Lbl'-LT-'T'-GT-'-fragment ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'-LT-'T'-GT-'-fragment-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-127-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-127-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'-LT-'T'-GT-'-fragment ptn0 ptn1 ) $= ( IMP-symbol-127-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-127-is-pattern application-context-app-right application-context-app-left notation-cache-152 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
