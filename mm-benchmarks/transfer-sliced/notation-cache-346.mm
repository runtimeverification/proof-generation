...
${ notation-cache-346 $p #Notation ( \kore-symbol-Lbl'Unds'List'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'List'Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-193-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-193-is-pattern IMP-symbol-193-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
