...
${ notation-cache-516 $p #Notation ( \kore-symbol-LblisIOFile ptn2 ) ( \app \kore-symbol-LblisIOFile-symbol ptn2 ) $= ( IMP-symbol-260-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-260-is-pattern IMP-symbol-260-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
