...
${ sorting-cache-968 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortInt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) \top ) ) ) ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-177 IMP-sort-23-is-pattern typecode-cache-Pattern-178 IMP-sort-17-is-pattern typecode-cache-Pattern-254 typecode-cache-Pattern-146 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-253 IMP-sort-14-is-pattern and-elim-right-sugar sorting-cache-967 rule-imp-transitivity ) BMNFAHIFCJKFDELGGGAHIFCJKFDELGGEOPFBMNFAHIFCJKFDELGGQACDERS $. $}
