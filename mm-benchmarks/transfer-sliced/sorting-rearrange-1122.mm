$c \kore-sort-SortBExp \top #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-sort-SortBool \and \imp \kore-is-sort |- \kore-valid ) \kore-equals \kore-inj \in-sort ( $.
