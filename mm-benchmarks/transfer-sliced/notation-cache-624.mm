...
${ notation-cache-624 $p #Notation ( \kore-symbol-Lblproject'ColnHash'unknownIOError'Coln'errno ptn2 ) ( \app \kore-symbol-Lblproject'ColnHash'unknownIOError'Coln'errno-symbol ptn2 ) $= ( IMP-symbol-301-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-301-is-pattern IMP-symbol-301-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
