...
${ sorting-cache-1975 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) \top ) ( \kore-is-sort \kore-sort-SortKItem ) ) $= ( BASIC-K-sort-1-is-pattern kore-is-sort-is-pattern typecode-cache-Pattern-179 IMP-sort-17-is-pattern in-sort-is-pattern top-is-pattern and-is-pattern imp-is-pattern proof-rule-prop-1 BASIC-K-sort-1-sort proof-rule-mp ) BCADEFGHBCIBCADEFGHJKL $. $}
