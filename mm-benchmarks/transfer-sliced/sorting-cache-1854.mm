$c "amount" \top \kore-sort-SortAExp \kore-sort-SortStmt #Variable \imp \kore-dv |- \kore-sort-SortId ) \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp \and #SetVariable #ElementVariable #Symbol #Pattern \kore-sort-SortBlock \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp \kore-inj \in-sort \kore-sort-SortStateCell "balanceTo" ( $.
...
sorting-cache-1853 $a |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) \top ) ) ( \and ( \in-sort ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceTo" ) ) \kore-sort-SortAExp ) ( \in-sort ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) \kore-sort-SortAExp ) ) ) $.
${ sorting-cache-1854 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) \top ) ) ( \in-sort ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "balanceTo" ) ( \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceTo" ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) ) ) \kore-sort-SortStmt ) ) $= ( IMP-sort-17-is-pattern kore-dv-is-pattern IMP-sort-13-is-pattern string-literal-17-is-pattern kore-inj-is-pattern in-sort-is-pattern string-literal-14-is-pattern typecode-cache-Pattern-382 IMP-symbol-160-is-pattern and-is-pattern rule-imp-transitivity IMP-symbol-185-is-pattern IMP-sort-31-is-pattern imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp sorting-cache-1853 IMP-symbol-160-sorting rule-and-intro-alt2-sugar IMP-symbol-185-sorting ) ABJCFDCHCECFDGCECIDGKEHLCFDCECFDGCECIDGKNOHABJCFDCHCECFDGCECIDGKEHCFDCHABJCFDCHPCFDCHABJQCFRSABJCECFDGEHCECIDGEHLCECFDGCECIDGKEHABTCECFDGCECIDGUAMUBCFDCECFDGCECIDGKUCM $. $}
