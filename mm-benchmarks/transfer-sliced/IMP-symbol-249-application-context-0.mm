$c #Notation \kore-symbol-LblisAExp-symbol #SetVariable \kore-symbol-LblisAExp #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) ( $.
...
notation-cache-484 $a #Notation ( \kore-symbol-LblisAExp ptn0 ) ( \app \kore-symbol-LblisAExp-symbol ptn0 ) $.
${ IMP-symbol-249-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-249-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblisAExp ptn0 ) $= ( IMP-symbol-249-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-249-is-pattern application-context-app-right notation-cache-484 notation-application-context ) DEBFBGADEBACHBIJ $. $}
