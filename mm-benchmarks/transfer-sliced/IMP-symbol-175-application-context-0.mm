...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-175-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds-LT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp ptn0 ptn1 ) $= ( IMP-symbol-175-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-175-is-pattern application-context-app-right application-context-app-left notation-cache-292 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
