...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-145-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblSet'Coln'in ptn0 ptn1 ) $= ( IMP-symbol-145-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-145-is-pattern application-context-app-right application-context-app-left notation-cache-202 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
