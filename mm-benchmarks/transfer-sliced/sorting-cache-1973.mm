...
${ sorting-cache-1973 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) \top ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) \top ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-179 IMP-sort-17-is-pattern top-is-pattern and-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern and-elim-left-sugar rule-imp-transitivity imp-reflexivity ) BDECFGAHICFGGBDECFGBDECBDECFGAHICFGJBDECFGBDECBDECBDECFJBDECLKK $. $}
