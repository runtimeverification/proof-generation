...
${ notation-cache-55 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'Unds-LT-EqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds' ptn1 ) ( \app \kore-symbol-Lbl'Hash'freezer'Unds-LT-EqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds'-symbol ptn1 ) $= ( IMP-symbol-86-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-86-is-pattern IMP-symbol-86-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
