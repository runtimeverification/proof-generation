...
sorting-cache-107 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortId ) \top ) ) ( \kore-is-sort kore-sort-var-S3 ) ) $.
sorting-cache-120 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortId ) \top ) ) ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortId ) \top ) ) $.
${ sorting-cache-121 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortId ) \top ) ) ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortId ) \top ) ) ) $= ( kore-is-sort-is-pattern typecode-cache-Pattern-19 typecode-cache-Pattern-0 and-is-pattern typecode-cache-Pattern-2 typecode-cache-Pattern-6 IMP-sort-17-is-pattern in-sort-is-pattern top-is-pattern and-elim-right-sugar sorting-cache-107 rule-imp-transitivity sorting-cache-120 rule-and-intro-alt2-sugar ) AFDBCEGBHDCIJKLGAFDBCEGBCEBHDAFDBCEMBCNOABCPQ $. $}
