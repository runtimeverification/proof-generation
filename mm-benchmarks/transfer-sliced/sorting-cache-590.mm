$c \top #SetVariable \kore-sort-SortAExp #ElementVariable #Symbol #Variable #Pattern "200" \and \imp \kore-dv \kore-sort-SortPgm \kore-is-sort |- ) \kore-inj \kore-sort-SortInt \in-sort ( $.
...
${ sorting-cache-590 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortPgm ) \top ) ) ( \in-sort ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "200" ) ) \kore-sort-SortAExp ) ) $= ( IMP-sort-23-is-pattern string-literal-15-is-pattern kore-dv-is-pattern in-sort-is-pattern IMP-sort-13-is-pattern typecode-cache-Pattern-165 kore-is-sort-is-pattern and-is-pattern kore-inj-is-pattern sorting-cache-582 imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp rule-and-intro-alt2-sugar INJ-symbol-0-sorting rule-imp-transitivity ) ABHCIGIJCDECFJCGCDEKGFABHCIGIJCDECFABLCDECFABHCDECFMCDECFABHNCDOPQCGCDERS $. $}
