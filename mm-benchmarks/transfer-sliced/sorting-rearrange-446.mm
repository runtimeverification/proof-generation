$c \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' \top #Variable \imp \kore-dv "0" \kore-is-sort |- \kore-sort-SortId \kore-valid ) \kore-equals \and #SetVariable #ElementVariable \kore-symbol-Lbl'Unds'Map'Unds' #Symbol #Pattern \kore-exists \kore-sort-SortKItem "ret" \kore-inj \kore-sort-SortInt \in-sort \kore-sort-SortMap ( $.
...
sorting-rearrange-445 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-V2 \kore-sort-SortMap ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortMap kore-sort-var-R kore-element-var-V0 ( \kore-equals \kore-sort-SortMap kore-sort-var-R kore-element-var-V0 ( \kore-symbol-Lbl'Unds'Map'Unds' ( \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "ret" ) ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "0" ) ) ) kore-element-var-V2 ) ) ) ) ) $.
${ sorting-rearrange-446 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \in-sort kore-element-var-V2 \kore-sort-SortMap ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortMap kore-sort-var-R kore-element-var-V0 ( \kore-equals \kore-sort-SortMap kore-sort-var-R kore-element-var-V0 ( \kore-symbol-Lbl'Unds'Map'Unds' ( \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "ret" ) ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "0" ) ) ) kore-element-var-V2 ) ) ) ) ) $= ( typecode-cache-Pattern-0 and-is-pattern IMP-sort-14-is-pattern top-is-pattern typecode-cache-Pattern-35 IMP-sort-17-is-pattern BASIC-K-sort-1-is-pattern kore-dv-is-pattern kore-inj-is-pattern IMP-sort-23-is-pattern kore-is-sort-is-pattern in-sort-is-pattern typecode-cache-Pattern-36 typecode-cache-Pattern-39 string-literal-11-is-pattern string-literal-1-is-pattern IMP-symbol-218-is-pattern IMP-symbol-194-is-pattern kore-equals-is-pattern kore-exists-is-pattern kore-valid-is-pattern sorting-cache-429 sorting-rearrange-445 rule-imp-transitivity ) ADNGECHFOGEEACPADFADFADBQIJIRKLMJMSKLTCHUAUBBUCUDACUEABCUFUG $. $}
