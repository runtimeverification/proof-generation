...
sorting-cache-285 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \in-sort ( \kore-dv \kore-sort-SortId "ret" ) \kore-sort-SortId ) ( \in-sort \kore-symbol-Lbl'Stop'List'LBraQuotUndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids'QuotRBraUnds'Ids \kore-sort-SortIds ) ) ) $.
${ sorting-cache-286 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \in-sort ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "ret" ) \kore-symbol-Lbl'Stop'List'LBraQuotUndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids'QuotRBraUnds'Ids ) \kore-sort-SortIds ) ) $= ( IMP-sort-17-is-pattern string-literal-11-is-pattern kore-dv-is-pattern in-sort-is-pattern IMP-symbol-123-is-pattern and-is-pattern IMP-sort-0-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern top-is-pattern IMP-symbol-161-is-pattern sorting-cache-285 IMP-symbol-161-sorting rule-imp-transitivity ) AIJKGBCDBEFHEGBCDFLHEAMBCDFNO $. $}
