...
${ sorting-cache-1543 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ( \kore-is-sort \kore-sort-SortInt ) ) $= ( IMP-sort-23-is-pattern kore-is-sort-is-pattern typecode-cache-Pattern-253 BASIC-K-sort-1-is-pattern in-sort-is-pattern top-is-pattern and-is-pattern imp-is-pattern proof-rule-prop-1 IMP-sort-23-sort proof-rule-mp ) BCADEFGHBCIBCADEFGHJKL $. $}
