...
${ sorting-cache-420 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \in-sort ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "addressTo" ) ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "amount" ) ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "balanceSender" ) ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "balanceTo" ) ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "ret" ) \kore-symbol-Lbl'Stop'List'LBraQuotUndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids'QuotRBraUnds'Ids ) ) ) ) ) \kore-sort-SortIds ) ) $= ( IMP-sort-17-is-pattern kore-dv-is-pattern IMP-symbol-161-is-pattern in-sort-is-pattern string-literal-18-is-pattern string-literal-14-is-pattern string-literal-10-is-pattern string-literal-17-is-pattern string-literal-11-is-pattern IMP-symbol-123-is-pattern and-is-pattern IMP-sort-0-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern top-is-pattern sorting-cache-413 sorting-cache-292 rule-and-intro-alt2-sugar IMP-symbol-161-sorting rule-imp-transitivity ) ANOPLBFCBEBGCBHCBICBJCKDDDDMELBFCBGCBHCBICBJCKDDDDDMEANOPLBFCBEBGCBHCBICBJCKDDDDMEAQARSBFCBGCBHCBICBJCKDDDDTUA $. $}
