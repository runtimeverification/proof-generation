...
${ notation-cache-463 $p #Notation ( \kore-symbol-LblgetGeneratedCounterCell ptn1 ) ( \app \kore-symbol-LblgetGeneratedCounterCell-symbol ptn1 ) $= ( IMP-symbol-240-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-240-is-pattern IMP-symbol-240-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
