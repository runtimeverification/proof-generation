$c #Substitution \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' "amount" #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-exists \kore-sort-SortKItem \kore-dv \kore-sort-SortId ) \kore-equals \kore-inj \kore-sort-SortMap ( $.
...
${ substitution-636 $p #Substitution ( \kore-exists \kore-sort-SortMap kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortMap kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "amount" ) ) kore-element-var-K1 ) ) ) ( \kore-exists \kore-sort-SortMap kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortMap kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' kore-element-var-K0 kore-element-var-K1 ) ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "amount" ) ) kore-element-var-K0 $= ( IMP-sort-17-is-pattern BASIC-K-sort-1-is-pattern string-literal-14-is-pattern kore-dv-is-pattern kore-inj-is-pattern element-var-is-var IMP-sort-14-is-pattern typecode-cache-Pattern-0 substitution-disjoint typecode-cache-Pattern-49 typecode-cache-Pattern-31 typecode-cache-Pattern-205 typecode-cache-Pattern-54 IMP-symbol-218-is-pattern typecode-cache-Pattern-53 typecode-cache-Pattern-51 substitution-var-same IMP-symbol-218-substitution substitution-kore-equals substitution-kore-exists-alt ) KALABDPKALABCDQEFEGHIBCJKEFEGHICJMALEFEGHICJMKALBOEFEGHIDNRKALBOCDSEFEGHICJKEFEGHICJMALEFEGHICJMBOEFEGHICJMCJEFEGHIEFEGHIDNCTDNEFEGHICJUADNEFEGHICJMUBUCUD $. $}
