$c #Substitution #Notation #SetVariable \kore-symbol-Lblproject'Coln'Ids #ElementVariable #Symbol #Variable #Pattern \kore-symbol-Lblproject'Coln'Ids-symbol \app ) ( $.
...
notation-cache-671 $a #Notation ( \kore-symbol-Lblproject'Coln'Ids ptn1 ) ( \app \kore-symbol-Lblproject'Coln'Ids-symbol ptn1 ) $.
notation-cache-672 $a #Notation ( \kore-symbol-Lblproject'Coln'Ids ptn2 ) ( \app \kore-symbol-Lblproject'Coln'Ids-symbol ptn2 ) $.
${ IMP-symbol-317-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-317-substitution $p #Substitution ( \kore-symbol-Lblproject'Coln'Ids ptn1 ) ( \kore-symbol-Lblproject'Coln'Ids ptn2 ) ptn0 xX0 $= ( IMP-symbol-317-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-317-is-pattern substitution-disjoint substitution-app notation-cache-671 notation-cache-672 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
