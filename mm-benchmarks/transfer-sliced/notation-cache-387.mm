...
${ notation-cache-387 $p #Notation ( \kore-symbol-Lbl'Unds'in'UndsUnds'LIST'Unds'Bool'Unds'KItem'Unds'List ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds'in'UndsUnds'LIST'Unds'Bool'Unds'KItem'Unds'List-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-210-is-symbol symbol-is-pattern IMP-symbol-210-is-pattern IMP-symbol-210-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
