...
${ sorting-cache-2114 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortInt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) \top ) ) ) ) ( \in-sort ( \kore-inj \kore-sort-SortStmt \kore-sort-SortKItem ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "balanceTo" ) ( \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceTo" ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) ) ) ) \kore-sort-SortKItem ) ) $= ( IMP-sort-17-is-pattern kore-dv-is-pattern kore-inj-is-pattern string-literal-17-is-pattern IMP-sort-13-is-pattern in-sort-is-pattern and-is-pattern IMP-sort-31-is-pattern BASIC-K-sort-1-is-pattern kore-is-sort-is-pattern string-literal-14-is-pattern IMP-symbol-160-is-pattern IMP-symbol-185-is-pattern typecode-cache-Pattern-177 IMP-sort-23-is-pattern typecode-cache-Pattern-178 typecode-cache-Pattern-254 sorting-cache-987 sorting-cache-1008 rule-and-intro-alt2-sugar INJ-symbol-0-sorting rule-imp-transitivity ) ARSJBTEJCDUAKKLNMNKEHFEIEHFGEIEOFGPQLJKLMEHFEIEHFGEIEOFGPQGMJARSJBTEJCDUAKKLNMNKEHFEIEHFGEIEOFGPQLJABCDUBABCDUCUDLMEHFEIEHFGEIEOFGPQUEUF $. $}
