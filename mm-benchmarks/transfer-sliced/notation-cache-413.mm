...
${ notation-cache-413 $p #Notation ( \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsPipe'-'-GT-Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-218-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-218-is-pattern IMP-symbol-218-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
