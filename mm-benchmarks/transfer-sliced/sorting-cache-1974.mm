...
${ sorting-cache-1974 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) \top ) ( \kore-is-sort \kore-sort-SortId ) ) $= ( IMP-sort-17-is-pattern kore-is-sort-is-pattern typecode-cache-Pattern-179 in-sort-is-pattern top-is-pattern and-is-pattern imp-is-pattern proof-rule-prop-1 IMP-sort-17-sort proof-rule-mp ) BCADBEFGBCHBCADBEFGIJK $. $}
