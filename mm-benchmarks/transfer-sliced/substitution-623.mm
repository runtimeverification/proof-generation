$c #Substitution \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-exists \kore-sort-SortKItem \kore-dv \kore-sort-SortId ) \kore-equals \kore-inj "addressTo" \kore-sort-SortMap ( $.
