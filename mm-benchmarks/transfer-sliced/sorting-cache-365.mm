...
${ sorting-cache-365 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortBlock ) \top ) ) ) ( \and ( \and ( \kore-is-sort \kore-sort-SortId ) ( \kore-is-sort \kore-sort-SortAExp ) ) ( \in-sort ( \kore-dv \kore-sort-SortId "amount" ) \kore-sort-SortId ) ) ) $= ( IMP-sort-17-is-pattern kore-is-sort-is-pattern typecode-cache-Pattern-121 IMP-sort-13-is-pattern string-literal-14-is-pattern kore-dv-is-pattern in-sort-is-pattern imp-is-pattern proof-rule-prop-1 proof-rule-mp rule-and-intro-alt2-sugar and-is-pattern IMP-sort-17-sort IMP-sort-13-sort kore-dv-sorting ) ABCFDEGEODHIDJABCFDEGEDEABCFDEKDEABCFLPMGEABCFGEKGEABCFLQMNDHIDJABCFDHIDJKDHIDJABCFLDHRMN $. $}
