$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds'-symbol #Variable #Pattern \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds' #ApplicationContext \app ) ( $.
...
notation-cache-298 $a #Notation ( \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-177-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-177-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-177-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-177-is-pattern application-context-app-right application-context-app-left notation-cache-298 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
