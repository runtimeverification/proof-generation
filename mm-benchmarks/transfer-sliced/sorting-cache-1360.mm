...
${ sorting-cache-1360 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ( \and ( \kore-is-sort \kore-sort-SortId ) ( \kore-is-sort \kore-sort-SortKItem ) ) ) $= ( kore-is-sort-is-pattern top-is-pattern and-is-pattern typecode-cache-Pattern-0 IMP-sort-17-is-pattern BASIC-K-sort-1-is-pattern sorting-cache-510 sorting-cache-475 rule-and-intro-alt2-sugar ) AEBCDCDFBGBAHAIJ $. $}
