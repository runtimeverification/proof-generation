...
${ notation-cache-157 $p #Notation ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-129-is-symbol symbol-is-pattern IMP-symbol-129-is-pattern IMP-symbol-129-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
