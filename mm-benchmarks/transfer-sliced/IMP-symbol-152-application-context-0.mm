$c #Notation #SetVariable \kore-symbol-Lbl'UndsPerc'Int'Unds'-symbol \kore-symbol-Lbl'UndsPerc'Int'Unds' #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) ( $.
...
notation-cache-223 $a #Notation ( \kore-symbol-Lbl'UndsPerc'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsPerc'Int'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-152-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-152-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsPerc'Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-152-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-152-is-pattern application-context-app-right application-context-app-left notation-cache-223 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
