$c #Substitution #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-sort-SortBool \kore-dv ) \kore-equals "false" ( $.
...
${ substitution-1017 $p #Substitution ( \kore-equals \kore-sort-SortBool kore-sort-var-x1 kore-element-var-x1 ( \kore-dv \kore-sort-SortBool "false" ) ) ( \kore-equals \kore-sort-SortBool kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortBool "false" ) ) kore-sort-var-x1 kore-sort-var-x0 $= ( IMP-sort-32-is-pattern typecode-cache-Pattern-24 string-literal-5-is-pattern kore-dv-is-pattern element-var-is-var typecode-cache-Pattern-23 typecode-cache-Pattern-14 substitution-1016 substitution-var-same substitution-68 substitution-disjoint substitution-kore-equals ) DCEBIDFGDAJBIDFGCEAHACKCEAHLABCMDFGCEAHNO $. $}
