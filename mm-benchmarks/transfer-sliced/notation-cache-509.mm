...
${ notation-cache-509 $p #Notation ( \kore-symbol-LblisGeneratedTopCellFragment ptn1 ) ( \app \kore-symbol-LblisGeneratedTopCellFragment-symbol ptn1 ) $= ( IMP-symbol-258-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-258-is-pattern IMP-symbol-258-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
