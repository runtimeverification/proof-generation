$c #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \kore-symbol-Lbl'Hash'buffer'LParUndsRParUnds'K-IO'Unds'Stream'Unds'K-symbol \app \kore-symbol-Lbl'Hash'buffer'LParUndsRParUnds'K-IO'Unds'Stream'Unds'K ) ( $.
...
notation-cache-15 $a #Notation ( \kore-symbol-Lbl'Hash'buffer'LParUndsRParUnds'K-IO'Unds'Stream'Unds'K ptn0 ) ( \app \kore-symbol-Lbl'Hash'buffer'LParUndsRParUnds'K-IO'Unds'Stream'Unds'K-symbol ptn0 ) $.
