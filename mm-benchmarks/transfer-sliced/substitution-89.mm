$c #Substitution \unit-sort "balanceSender" #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-dv \kore-sort-SortId ) \kore-equals ( $.
...
${ substitution-89 $p #Substitution ( \kore-equals \kore-sort-SortId \unit-sort kore-element-var-x1 ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ( \kore-equals \kore-sort-SortId kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortId "balanceSender" ) ) \unit-sort kore-sort-var-x0 $= ( IMP-sort-17-is-pattern unit-sort-is-symbol symbol-is-pattern string-literal-10-is-pattern kore-dv-is-pattern element-var-is-var typecode-cache-Pattern-23 typecode-cache-Pattern-14 substitution-61 substitution-var-same substitution-62 substitution-disjoint substitution-kore-equals ) CDEBICFGCAJBICFGDEAHAKDEAHLABMCFGDEAHNO $. $}
