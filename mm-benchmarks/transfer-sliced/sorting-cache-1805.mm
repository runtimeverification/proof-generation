...
sorting-cache-1799 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ( \in-sort kore-element-var-T \kore-sort-SortBool ) ) $.
${ sorting-cache-1805 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) ( \and ( \kore-is-sort kore-sort-var-S2 ) \top ) ) ( \in-sort kore-element-var-T \kore-sort-SortBool ) ) $= ( kore-is-sort-is-pattern and-is-pattern typecode-cache-Pattern-379 typecode-cache-Pattern-0 typecode-cache-Pattern-1 top-is-pattern typecode-cache-Pattern-6 IMP-sort-32-is-pattern in-sort-is-pattern rule-imp-transitivity and-elim-left-sugar and-elim-right-sugar sorting-cache-1799 ) AHEBDGFCIEJFFAHEBDGFDKLMAHEBDGFCIEJFOAHEBDGFBDGDKLMAHEBDGPBDQNN $. $}
