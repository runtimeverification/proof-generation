$c "amount" \top #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-exists \and \imp \kore-dv \kore-is-sort |- \kore-sort-SortId \kore-valid ) \kore-equals ( $.
...
${ sorting-rearrange-8 $p |- ( \imp ( \and \top ( \and ( \kore-is-sort kore-sort-var-x0 ) \top ) ) ( \kore-valid kore-sort-var-x0 ( \kore-exists \kore-sort-SortId kore-sort-var-x0 kore-element-var-x1 ( \kore-equals \kore-sort-SortId kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortId "amount" ) ) ) ) ) $= ( top-is-pattern typecode-cache-Pattern-14 and-is-pattern kore-is-sort-is-pattern IMP-sort-17-is-pattern typecode-cache-Pattern-23 string-literal-14-is-pattern kore-dv-is-pattern kore-equals-is-pattern kore-exists-is-pattern kore-valid-is-pattern sorting-cache-127 top-intro rule-weakening rule-and-intro-alt2-sugar domain-value-16-functional rule-imp-transitivity ) CADFCEEADFCEADGADGADBHGIJKBLMCADFCEEADFCANCADFCEECOPQABRS $. $}
