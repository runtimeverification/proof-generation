$c #Notation \kore-symbol-Lbl'UndsEqlsEqls'K'Unds' #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app \kore-symbol-Lbl'UndsEqlsEqls'K'Unds'-symbol ) ( $.
...
notation-cache-313 $a #Notation ( \kore-symbol-Lbl'UndsEqlsEqls'K'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsEqls'K'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-182-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-182-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsEqlsEqls'K'Unds' ptn0 ptn1 ) $= ( IMP-symbol-182-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-182-is-pattern application-context-app-right application-context-app-left notation-cache-313 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
