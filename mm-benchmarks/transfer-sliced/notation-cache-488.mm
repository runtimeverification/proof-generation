...
${ notation-cache-488 $p #Notation ( \kore-symbol-LblisBExp ptn1 ) ( \app \kore-symbol-LblisBExp-symbol ptn1 ) $= ( IMP-symbol-251-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-251-is-pattern IMP-symbol-251-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
