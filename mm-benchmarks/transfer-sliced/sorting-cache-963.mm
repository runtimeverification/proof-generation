...
${ sorting-cache-963 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortInt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) \top ) ) ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortKItem ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-254 typecode-cache-Pattern-178 IMP-sort-17-is-pattern and-is-pattern typecode-cache-Pattern-177 IMP-sort-23-is-pattern typecode-cache-Pattern-179 BASIC-K-sort-1-is-pattern and-elim-right-sugar rule-imp-transitivity sorting-cache-962 ) AJKEBGHECDFIIBGHECDFICLMEAJKEBGHECDFINBGHECDFICDFCLMEBGHECDFNCDPOO $. $}
