$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-LblreplaceAll'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String-symbol #Variable #Pattern #ApplicationContext \app \kore-symbol-LblreplaceAll'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String ) ( $.
...
notation-cache-735 $a #Notation ( \kore-symbol-LblreplaceAll'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String ptn0 ptn1 ptn2 ) ( \app ( \app ( \app \kore-symbol-LblreplaceAll'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String-symbol ptn0 ) ptn1 ) ptn2 ) $.
${ $d xX0 ptn0 $.
   $d xX0 ptn2 $.
   IMP-symbol-339-application-context-1.0 $e #ApplicationContext xX0 ptn1 $.
   IMP-symbol-339-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-LblreplaceAll'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-339-is-symbol symbol-is-pattern IMP-symbol-339-is-pattern application-context-app-right application-context-app-left notation-cache-735 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAGHBFCAEJKBCDLM $. $}
