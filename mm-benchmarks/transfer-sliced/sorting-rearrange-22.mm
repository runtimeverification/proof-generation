$c \exists #Substitution \top \kore-sort-SortAExp #Variable \imp \kore-is-sort |- \kore-valid ) \kore-equals \and #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-inj \kore-sort-SortInt \in-sort ( $.
...
sorting-rearrange-20 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ) ( \exists x ( \eq x \kore-sort-SortAExp ) ) ) $.
...
substitution-107 $a #Substitution ( \kore-equals kore-sort-var-S3 kore-sort-var-R ( \kore-inj \kore-sort-SortAExp kore-sort-var-S3 ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp kore-element-var-T ) ) ( \kore-inj \kore-sort-SortInt kore-sort-var-S3 kore-element-var-T ) ) ( \kore-equals kore-sort-var-S3 kore-sort-var-R ( \kore-inj kore-sort-var-S2 kore-sort-var-S3 ( \kore-inj \kore-sort-SortInt kore-sort-var-S2 kore-element-var-T ) ) ( \kore-inj \kore-sort-SortInt kore-sort-var-S3 kore-element-var-T ) ) \kore-sort-SortAExp kore-sort-var-S2 $.
...
${ sorting-rearrange-22 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ) ( \kore-valid kore-sort-var-R ( \kore-equals kore-sort-var-S3 kore-sort-var-R ( \kore-inj \kore-sort-SortAExp kore-sort-var-S3 ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp kore-element-var-T ) ) ( \kore-inj \kore-sort-SortInt kore-sort-var-S3 kore-element-var-T ) ) ) ) $= ( typecode-cache-Pattern-0 kore-is-sort-is-pattern kore-sort-var-S2-elementvariable typecode-cache-Pattern-2 and-is-pattern IMP-sort-13-is-pattern kore-inj-is-pattern kore-sort-var-x0-elementvariable typecode-cache-Pattern-28 typecode-cache-Pattern-27 kore-equals-is-pattern top-is-pattern kore-valid-is-pattern typecode-cache-Pattern-1 typecode-cache-Pattern-14 typecode-cache-Pattern-26 IMP-sort-23-is-pattern typecode-cache-Pattern-6 element-var-is-var rule-and-intro-alt2-sugar typecode-cache-Pattern-29 rule-imp-transitivity x-is-element-var substitution-kore-valid substitution-imp and-elim-left-sugar imp-reflexivity sorting-cache-160 imp-is-pattern proof-rule-prop-1 IMP-sort-13-sort proof-rule-mp top-intro rule-weakening sorting-rearrange-20 sorting-rearrange-21 substitution-28 substitution-29 substitution-107 substitution-37 substitution-38 substitution-111 functional-substitution-alt )  $. $}
