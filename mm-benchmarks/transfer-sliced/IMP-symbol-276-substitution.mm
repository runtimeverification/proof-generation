$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-LblisStateCell-symbol \app ) \kore-symbol-LblisStateCell ( $.
...
notation-cache-563 $a #Notation ( \kore-symbol-LblisStateCell ptn1 ) ( \app \kore-symbol-LblisStateCell-symbol ptn1 ) $.
notation-cache-564 $a #Notation ( \kore-symbol-LblisStateCell ptn2 ) ( \app \kore-symbol-LblisStateCell-symbol ptn2 ) $.
${ IMP-symbol-276-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-276-substitution $p #Substitution ( \kore-symbol-LblisStateCell ptn1 ) ( \kore-symbol-LblisStateCell ptn2 ) ptn0 xX0 $= ( IMP-symbol-276-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-276-is-pattern substitution-disjoint substitution-app notation-cache-563 notation-cache-564 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
