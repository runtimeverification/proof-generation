...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-119-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Hash'unlock'LParUndsCommUndsRParUnds'K-IO'Unds'K'Unds'Int'Unds'Int ptn0 ptn1 ) $= ( IMP-symbol-119-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-119-is-pattern application-context-app-right application-context-app-left notation-cache-140 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
