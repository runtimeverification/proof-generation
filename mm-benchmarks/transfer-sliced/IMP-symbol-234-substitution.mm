...
${ IMP-symbol-234-substitution.0 $e #Substitution ptn1 ptn5 ptn0 xX0 $.
   IMP-symbol-234-substitution.1 $e #Substitution ptn2 ptn6 ptn0 xX0 $.
   IMP-symbol-234-substitution.2 $e #Substitution ptn3 ptn7 ptn0 xX0 $.
   IMP-symbol-234-substitution.3 $e #Substitution ptn4 ptn8 ptn0 xX0 $.
   IMP-symbol-234-substitution $p #Substitution ( \kore-symbol-LblfillList'LParUndsCommUndsCommUndsCommUndsRParUnds'LIST'Unds'List'Unds'List'Unds'Int'Unds'Int'Unds'KItem ptn1 ptn2 ptn3 ptn4 ) ( \kore-symbol-LblfillList'LParUndsCommUndsCommUndsCommUndsRParUnds'LIST'Unds'List'Unds'List'Unds'Int'Unds'Int'Unds'KItem ptn5 ptn6 ptn7 ptn8 ) ptn0 xX0 $= ( app-is-pattern IMP-symbol-234-is-symbol symbol-is-pattern IMP-symbol-234-is-pattern substitution-app notation-reflexivity IMP-symbol-234-is-sugar notation-transitivity substitution-disjoint notation-substitution ) PQCODOEOFOPQGOHOIOJOBCDEFRGHIJRBABPQCODOEOFPQGOHOIOJABPQCODOEPQGOHOIABPQCODPQGOHABPQCPQGAPQBAUCKSLSMSNSCDEFRPQCODOEOFOPQCODOEOFOCDEFUAPQCODOEOFOTUBGHIJRPQGOHOIOJOPQGOHOIOJOGHIJUAPQGOHOIOJOTUBBTUD $. $}
