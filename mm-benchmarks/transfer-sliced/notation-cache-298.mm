...
${ notation-cache-298 $p #Notation ( \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-177-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-177-is-pattern IMP-symbol-177-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
