...
${ notation-cache-477 $p #Notation ( \kore-symbol-Lblint'UndsSClnUndsUnds'IMP-SYNTAX'Unds'Pgm'Unds'Ids'Unds'Stmt ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lblint'UndsSClnUndsUnds'IMP-SYNTAX'Unds'Pgm'Unds'Ids'Unds'Stmt-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-247-is-symbol symbol-is-pattern IMP-symbol-247-is-pattern IMP-symbol-247-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
