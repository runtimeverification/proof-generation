$c \top #Variable \imp \kore-dv "0" \kore-is-sort |- \kore-valid ) \kore-equals \and \kore-and #SetVariable #ElementVariable \kore-symbol-LblinitGeneratedCounterCell #Symbol #Pattern \kore-symbol-Lbl'-LT-'generatedCounter'-GT-' \kore-sort-SortGeneratedCounterCell \kore-sort-SortInt \in-sort \kore-top ( $.
...
sorting-rearrange-289 $a |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-and kore-sort-var-R ( \kore-equals \kore-sort-SortGeneratedCounterCell kore-sort-var-R \kore-symbol-LblinitGeneratedCounterCell ( \kore-symbol-Lbl'-LT-'generatedCounter'-GT-' ( \kore-dv \kore-sort-SortInt "0" ) ) ) ( \kore-top kore-sort-var-R ) ) ) ) $.
${ sorting-rearrange-290 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \kore-valid kore-sort-var-R ( \kore-equals \kore-sort-SortGeneratedCounterCell kore-sort-var-R \kore-symbol-LblinitGeneratedCounterCell ( \kore-symbol-Lbl'-LT-'generatedCounter'-GT-' ( \kore-dv \kore-sort-SortInt "0" ) ) ) ) ) $= ( typecode-cache-Pattern-0 and-is-pattern top-is-pattern kore-is-sort-is-pattern IMP-sort-10-is-pattern IMP-symbol-242-is-pattern IMP-sort-23-is-pattern string-literal-1-is-pattern kore-dv-is-pattern IMP-symbol-128-is-pattern kore-equals-is-pattern in-sort-is-pattern sorting-cache-133 rule-and-intro-alt2-sugar kore-valid-is-pattern top-intro rule-weakening imp-is-pattern proof-rule-prop-1 kore-equals-sorting proof-rule-mp sorting-rearrange-289 kore-anp-top rule-imp-transitivity ) ABEDCABEDCABEDCDCCABFABGHIJKLPABEDCABEDCABEDCDCANABEDCABEDCDANABEDCDQROOABFABGHIJKLABEDCABEDCDCCFABGHIJKLABMABEDCABEDCDCCFABGHIJKLABMSFABGHIJKLABMABEDCABEDCDCCTFABGHIJKUAUBAUCUDUE $. $}
