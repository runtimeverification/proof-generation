$c #Notation #SetVariable \kore-symbol-Lbl'Hash'mkstemp'LParUndsRParUnds'K-IO'Unds'IOFile'Unds'String-symbol #ElementVariable #Symbol #Variable #Pattern \kore-symbol-Lbl'Hash'mkstemp'LParUndsRParUnds'K-IO'Unds'IOFile'Unds'String \app ) ( $.
...
${ notation-cache-100 $p #Notation ( \kore-symbol-Lbl'Hash'mkstemp'LParUndsRParUnds'K-IO'Unds'IOFile'Unds'String ptn0 ) ( \app \kore-symbol-Lbl'Hash'mkstemp'LParUndsRParUnds'K-IO'Unds'IOFile'Unds'String-symbol ptn0 ) $= ( IMP-symbol-101-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-101-is-pattern IMP-symbol-101-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
