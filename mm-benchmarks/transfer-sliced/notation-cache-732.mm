...
${ notation-cache-732 $p #Notation ( \kore-symbol-LblremoveAll'LParUndsCommUndsRParUnds'MAP'Unds'Map'Unds'Map'Unds'Set ptn3 ptn4 ) ( \app ( \app \kore-symbol-LblremoveAll'LParUndsCommUndsRParUnds'MAP'Unds'Map'Unds'Map'Unds'Set-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-337-is-symbol symbol-is-pattern IMP-symbol-337-is-pattern IMP-symbol-337-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
