...
${ notation-cache-479 $p #Notation ( \kore-symbol-LblintersectSet'LParUndsCommUndsRParUnds'SET'Unds'Set'Unds'Set'Unds'Set ptn1 ptn2 ) ( \app ( \app \kore-symbol-LblintersectSet'LParUndsCommUndsRParUnds'SET'Unds'Set'Unds'Set'Unds'Set-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-248-is-symbol symbol-is-pattern IMP-symbol-248-is-pattern IMP-symbol-248-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
