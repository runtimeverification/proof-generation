$c \kore-sort-SortKResult \top #SetVariable #ElementVariable #Symbol #Variable #Pattern \and \imp \kore-is-sort |- \kore-valid ) \kore-sort-SortInt \kore-equals \kore-inj \in-sort ( $.
...
sorting-rearrange-939 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ) ( \kore-valid kore-sort-var-R ( \kore-equals kore-sort-var-S3 kore-sort-var-R ( \kore-inj \kore-sort-SortKResult kore-sort-var-S3 ( \kore-inj \kore-sort-SortInt \kore-sort-SortKResult kore-element-var-T ) ) ( \kore-inj \kore-sort-SortInt kore-sort-var-S3 kore-element-var-T ) ) ) ) $.
${ sorting-rearrange-940 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ( \and ( \kore-is-sort kore-sort-var-S3 ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-equals kore-sort-var-S3 kore-sort-var-R ( \kore-inj \kore-sort-SortKResult kore-sort-var-S3 ( \kore-inj \kore-sort-SortInt \kore-sort-SortKResult kore-element-var-T ) ) ( \kore-inj \kore-sort-SortInt kore-sort-var-S3 kore-element-var-T ) ) ) ) $= ( and-is-pattern kore-is-sort-is-pattern typecode-cache-Pattern-2 typecode-cache-Pattern-30 typecode-cache-Pattern-0 top-is-pattern typecode-cache-Pattern-28 IMP-sort-28-is-pattern kore-inj-is-pattern rule-imp-transitivity IMP-sort-23-is-pattern typecode-cache-Pattern-6 typecode-cache-Pattern-27 kore-equals-is-pattern kore-valid-is-pattern and-elim-left-sugar sorting-cache-161 sorting-cache-164 rule-and-intro-alt2-sugar sorting-rearrange-939 ) ACGBFEIDDAHEBCJDAHBFAHKBFNKCOLLBCPQRACGBFEIDDAHEBCJACGBFEIDDACGAHEACGBFEIDSACTMABCUAUBABCUCM $. $}
