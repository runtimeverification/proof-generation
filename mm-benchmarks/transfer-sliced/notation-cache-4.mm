...
${ notation-cache-4 $p #Notation ( \kore-symbol-append ptn3 ptn4 ) ( \app ( \app \kore-symbol-append-symbol ptn3 ) ptn4 ) $= ( app-is-pattern KSEQ-symbol-2-is-symbol symbol-is-pattern KSEQ-symbol-2-is-pattern KSEQ-symbol-2-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
