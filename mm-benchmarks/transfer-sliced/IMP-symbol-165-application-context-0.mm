$c #Notation #SetVariable \kore-symbol-Lbl'UndsSlsh'Int'Unds' #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-Lbl'UndsSlsh'Int'Unds'-symbol ( $.
...
notation-cache-262 $a #Notation ( \kore-symbol-Lbl'UndsSlsh'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsSlsh'Int'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-165-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-165-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsSlsh'Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-165-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-165-is-pattern application-context-app-right application-context-app-left notation-cache-262 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
