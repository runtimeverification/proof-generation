...
${ notation-cache-622 $p #Notation ( \kore-symbol-Lblproject'ColnHash'tempFile'Coln'path ptn0 ) ( \app \kore-symbol-Lblproject'ColnHash'tempFile'Coln'path-symbol ptn0 ) $= ( IMP-symbol-300-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-300-is-pattern IMP-symbol-300-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
