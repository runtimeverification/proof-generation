$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-LblListItem \kore-symbol-LblListItem-symbol ( $.
...
notation-cache-190 $a #Notation ( \kore-symbol-LblListItem ptn1 ) ( \app \kore-symbol-LblListItem-symbol ptn1 ) $.
notation-cache-191 $a #Notation ( \kore-symbol-LblListItem ptn2 ) ( \app \kore-symbol-LblListItem-symbol ptn2 ) $.
${ IMP-symbol-141-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-141-substitution $p #Substitution ( \kore-symbol-LblListItem ptn1 ) ( \kore-symbol-LblListItem ptn2 ) ptn0 xX0 $= ( IMP-symbol-141-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-141-is-pattern substitution-disjoint substitution-app notation-cache-190 notation-cache-191 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
