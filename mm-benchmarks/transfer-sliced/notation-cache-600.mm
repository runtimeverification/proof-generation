...
${ notation-cache-600 $p #Notation ( \kore-symbol-LblmakeArray'LParUndsCommUndsRParUnds'ARRAY-IN-K'Unds'Array'Unds'Int'Unds'KItem ptn3 ptn4 ) ( \app ( \app \kore-symbol-LblmakeArray'LParUndsCommUndsRParUnds'ARRAY-IN-K'Unds'Array'Unds'Int'Unds'KItem-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-288-is-symbol symbol-is-pattern IMP-symbol-288-is-pattern IMP-symbol-288-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
