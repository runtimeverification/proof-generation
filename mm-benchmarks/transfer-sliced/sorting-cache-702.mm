$c \top #SetVariable #ElementVariable #Symbol #Variable #Pattern \and \kore-sort-SortKItem \imp \kore-dv "0" \kore-is-sort |- ) \kore-sort-SortInt \in-sort ( $.
...
${ sorting-cache-702 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \and ( \kore-is-sort \kore-sort-SortInt ) ( \kore-is-sort \kore-sort-SortKItem ) ) ( \in-sort ( \kore-dv \kore-sort-SortInt "0" ) \kore-sort-SortInt ) ) ) $= ( kore-is-sort-is-pattern IMP-sort-23-is-pattern and-is-pattern typecode-cache-Pattern-0 top-is-pattern BASIC-K-sort-1-is-pattern string-literal-1-is-pattern kore-dv-is-pattern in-sort-is-pattern sorting-cache-701 sorting-cache-369 rule-and-intro-alt2-sugar ) AEBFDCBGBDCHICJAKALM $. $}
