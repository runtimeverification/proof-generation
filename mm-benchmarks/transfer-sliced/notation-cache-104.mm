...
${ notation-cache-104 $p #Notation ( \kore-symbol-Lbl'Hash'open'LParUndsCommUndsRParUnds'K-IO'Unds'IOInt'Unds'String'Unds'String ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Hash'open'LParUndsCommUndsRParUnds'K-IO'Unds'IOInt'Unds'String'Unds'String-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-103-is-symbol symbol-is-pattern IMP-symbol-103-is-pattern IMP-symbol-103-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
