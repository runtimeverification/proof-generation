$c #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-LblSetItem \kore-symbol-LblSetItem-symbol ( $.
...
notation-cache-205 $a #Notation ( \kore-symbol-LblSetItem ptn0 ) ( \app \kore-symbol-LblSetItem-symbol ptn0 ) $.
${ IMP-symbol-146-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-146-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblSetItem ptn0 ) $= ( IMP-symbol-146-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-146-is-pattern application-context-app-right notation-cache-205 notation-application-context ) DEBFBGADEBACHBIJ $. $}
