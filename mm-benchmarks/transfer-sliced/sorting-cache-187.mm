...
${ sorting-cache-187 $p |- ( \imp \top ( \in-sort ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortStmt \kore-sort-SortKItem ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "balanceTo" ) ( \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceTo" ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) ) ) ) ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortStmt \kore-sort-SortKItem ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "ret" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "1" ) ) ) ) \kore-symbol-dotk ) ) \kore-sort-SortK ) ) $= ( IMP-sort-17-is-pattern kore-dv-is-pattern kore-inj-is-pattern IMP-sort-13-is-pattern BASIC-K-sort-1-is-pattern string-literal-17-is-pattern IMP-sort-31-is-pattern IMP-symbol-185-is-pattern IMP-sort-23-is-pattern string-literal-14-is-pattern IMP-symbol-160-is-pattern in-sort-is-pattern KSEQ-symbol-0-is-pattern string-literal-11-is-pattern string-literal-4-is-pattern KSEQ-symbol-1-is-pattern top-is-pattern BASIC-K-sort-0-is-pattern and-is-pattern kore-is-sort-is-pattern rule-imp-transitivity sorting-cache-186 INJ-symbol-0-sorting sorting-cache-184 rule-and-intro-alt2-sugar KSEQ-symbol-0-sorting ) QGEAFBADAFBCADAJBCKHCELGEANBIDIOBCHCPMRLSGEAFBADAFBCADAJBCKHCGEANBIDIOBCHCPMMRLQGEAFBADAFBCADAJBCKHCELGEANBIDIOBCHCPMRLQGTETSAFBADAFBCADAJBCKHGLSGEAFBADAFBCADAJBCKHCELUBGEAFBADAFBCADAJBCKHUCUAUDUEGEAFBADAFBCADAJBCKHCGEANBIDIOBCHCPMUFUA $. $}
