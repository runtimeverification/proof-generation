...
${ notation-cache-193 $p #Notation ( \kore-symbol-LblMap'Coln'lookup ptn1 ptn2 ) ( \app ( \app \kore-symbol-LblMap'Coln'lookup-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-142-is-symbol symbol-is-pattern IMP-symbol-142-is-pattern IMP-symbol-142-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
