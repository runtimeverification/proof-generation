$c #Substitution #Notation #SetVariable \kore-symbol-Lbl'UndsAnd-'Int'Unds'-symbol #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-Lbl'UndsAnd-'Int'Unds' ( $.
...
notation-cache-230 $a #Notation ( \kore-symbol-Lbl'UndsAnd-'Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsAnd-'Int'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-231 $a #Notation ( \kore-symbol-Lbl'UndsAnd-'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsAnd-'Int'Unds'-symbol ptn3 ) ptn4 ) $.
