$c #Substitution #Notation #SetVariable #ElementVariable \kore-symbol-LblisKResult #Symbol \kore-symbol-LblisKResult-symbol #Variable #Pattern \app ) ( $.
...
notation-cache-548 $a #Notation ( \kore-symbol-LblisKResult ptn1 ) ( \app \kore-symbol-LblisKResult-symbol ptn1 ) $.
notation-cache-549 $a #Notation ( \kore-symbol-LblisKResult ptn2 ) ( \app \kore-symbol-LblisKResult-symbol ptn2 ) $.
${ IMP-symbol-271-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-271-substitution $p #Substitution ( \kore-symbol-LblisKResult ptn1 ) ( \kore-symbol-LblisKResult ptn2 ) ptn0 xX0 $= ( IMP-symbol-271-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-271-is-pattern substitution-disjoint substitution-app notation-cache-548 notation-cache-549 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
