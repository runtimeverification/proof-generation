...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-206-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds'andThenBool'Unds' ptn0 ptn1 ) $= ( IMP-symbol-206-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-206-is-pattern application-context-app-right application-context-app-left notation-cache-377 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
