...
${ sorting-rearrange-464 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortStmt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortStmt ) \top ) ) ) ( \exists kore-element-var-V0 ( \eq kore-element-var-V0 \kore-symbol-dotk ) ) ) $= ( top-is-pattern typecode-cache-Pattern-177 IMP-sort-31-is-pattern in-sort-is-pattern typecode-cache-Pattern-239 and-is-pattern KSEQ-symbol-1-is-pattern typecode-cache-Pattern-39 eq-is-pattern exists-is-pattern top-intro rule-weakening BASIC-K-sort-0-is-pattern sorting-cache-43 sorting-rearrange-275 kore-functional rule-imp-transitivity ) AFGHBCIJEDLKMDNAFGHBCIJEOPQKEDRDSTUA $. $}
