$c #Substitution \kore-sort-SortBExp #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'Unds-GT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp #Variable #Pattern \kore-exists \kore-valid ) \kore-equals ( $.
