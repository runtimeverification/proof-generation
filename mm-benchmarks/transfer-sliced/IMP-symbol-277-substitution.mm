$c #Substitution #Notation \kore-symbol-LblisStateCellOpt-symbol #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-LblisStateCellOpt \app ) ( $.
...
notation-cache-566 $a #Notation ( \kore-symbol-LblisStateCellOpt ptn1 ) ( \app \kore-symbol-LblisStateCellOpt-symbol ptn1 ) $.
notation-cache-567 $a #Notation ( \kore-symbol-LblisStateCellOpt ptn2 ) ( \app \kore-symbol-LblisStateCellOpt-symbol ptn2 ) $.
${ IMP-symbol-277-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-277-substitution $p #Substitution ( \kore-symbol-LblisStateCellOpt ptn1 ) ( \kore-symbol-LblisStateCellOpt ptn2 ) ptn0 xX0 $= ( IMP-symbol-277-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-277-is-pattern substitution-disjoint substitution-app notation-cache-566 notation-cache-567 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
