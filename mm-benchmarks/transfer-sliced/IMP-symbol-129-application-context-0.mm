...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-129-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-' ptn0 ptn1 ) $= ( IMP-symbol-129-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-129-is-pattern application-context-app-right application-context-app-left notation-cache-158 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
