...
${ notation-cache-159 $p #Notation ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-130-is-symbol symbol-is-pattern IMP-symbol-130-is-pattern IMP-symbol-130-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
