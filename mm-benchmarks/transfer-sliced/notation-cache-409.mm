...
${ notation-cache-409 $p #Notation ( \kore-symbol-Lbl'Unds'xorInt'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds'xorInt'Unds'-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-217-is-symbol symbol-is-pattern IMP-symbol-217-is-pattern IMP-symbol-217-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
