...
${ notation-cache-658 $p #Notation ( \kore-symbol-Lblproject'Coln'IOError ptn0 ) ( \app \kore-symbol-Lblproject'Coln'IOError-symbol ptn0 ) $= ( IMP-symbol-312-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-312-is-pattern IMP-symbol-312-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
