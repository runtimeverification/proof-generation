...
${ notation-cache-580 $p #Notation ( \kore-symbol-LblisTCell ptn0 ) ( \app \kore-symbol-LblisTCell-symbol ptn0 ) $= ( IMP-symbol-281-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-281-is-pattern IMP-symbol-281-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
