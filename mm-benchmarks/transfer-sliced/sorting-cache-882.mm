...
${ sorting-cache-882 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortStmt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortStmt ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortStmt ) \top ) ) ) $= ( in-sort-is-pattern IMP-sort-31-is-pattern typecode-cache-Pattern-239 typecode-cache-Pattern-177 and-is-pattern typecode-cache-Pattern-179 top-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern and-elim-right-sugar rule-imp-transitivity rule-and-intro-alt2-sugar sorting-cache-867 sorting-cache-870 top-intro rule-weakening ) AGEDBCFHBKLDCIEDJHAGEDBCFHBCFBKLDAGEDBCFMBCPNAGEDBCFHCIEDJAGEDBCFHBCFCIEDAGEDBCFMBCQNAGEDBCFHJRSOO $. $}
