...
${ $d xX0 ptn0 $.
   $d xX0 ptn1 $.
   IMP-symbol-339-application-context-2.0 $e #ApplicationContext xX0 ptn2 $.
   IMP-symbol-339-application-context-2 $p #ApplicationContext xX0 ( \kore-symbol-LblreplaceAll'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-339-is-symbol symbol-is-pattern IMP-symbol-339-is-pattern application-context-app-right notation-cache-735 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAEJBCDKL $. $}
