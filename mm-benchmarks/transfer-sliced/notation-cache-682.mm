...
${ notation-cache-682 $p #Notation ( \kore-symbol-Lblproject'Coln'KCell ptn0 ) ( \app \kore-symbol-Lblproject'Coln'KCell-symbol ptn0 ) $= ( IMP-symbol-320-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-320-is-pattern IMP-symbol-320-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
