...
${ sorting-cache-871 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortStmt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortStmt ) \top ) ) ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortStmt ) ) $= ( in-sort-is-pattern IMP-sort-31-is-pattern typecode-cache-Pattern-239 typecode-cache-Pattern-177 and-is-pattern typecode-cache-Pattern-146 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-179 and-elim-right-sugar rule-imp-transitivity sorting-cache-870 ) BJKEAHFECDGIIAHFECDGIDLFEBJKEAHFECDGIMAHFECDGICDGDLFEAHFECDGMCDONN $. $}
