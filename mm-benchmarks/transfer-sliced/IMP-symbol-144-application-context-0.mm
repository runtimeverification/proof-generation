$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-LblSet'Coln'difference #Variable #Pattern #ApplicationContext \kore-symbol-LblSet'Coln'difference-symbol \app ) ( $.
...
notation-cache-199 $a #Notation ( \kore-symbol-LblSet'Coln'difference ptn0 ptn1 ) ( \app ( \app \kore-symbol-LblSet'Coln'difference-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-144-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-144-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblSet'Coln'difference ptn0 ptn1 ) $= ( IMP-symbol-144-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-144-is-pattern application-context-app-right application-context-app-left notation-cache-199 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
