...
${ notation-cache-569 $p #Notation ( \kore-symbol-LblisStmt ptn1 ) ( \app \kore-symbol-LblisStmt-symbol ptn1 ) $= ( IMP-symbol-278-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-278-is-pattern IMP-symbol-278-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
