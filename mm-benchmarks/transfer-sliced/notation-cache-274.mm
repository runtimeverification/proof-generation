...
${ notation-cache-274 $p #Notation ( \kore-symbol-Lbl'Unds-LT-Eqls'Map'UndsUnds'MAP'Unds'Bool'Unds'Map'Unds'Map ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds-LT-Eqls'Map'UndsUnds'MAP'Unds'Bool'Unds'Map'Unds'Map-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-169-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-169-is-pattern IMP-symbol-169-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
