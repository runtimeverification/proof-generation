...
${ notation-cache-276 $p #Notation ( \kore-symbol-Lbl'Unds-LT-Eqls'Set'UndsUnds'SET'Unds'Bool'Unds'Set'Unds'Set ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds-LT-Eqls'Set'UndsUnds'SET'Unds'Bool'Unds'Set'Unds'Set-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-170-is-symbol symbol-is-pattern IMP-symbol-170-is-pattern IMP-symbol-170-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
