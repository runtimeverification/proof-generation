...
${ notation-cache-177 $p #Notation ( \kore-symbol-LblFloat2String'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'Float'Unds'String ptn1 ptn2 ) ( \app ( \app \kore-symbol-LblFloat2String'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'Float'Unds'String-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-136-is-symbol symbol-is-pattern IMP-symbol-136-is-pattern IMP-symbol-136-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
