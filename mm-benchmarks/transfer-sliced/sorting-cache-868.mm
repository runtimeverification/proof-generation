...
${ sorting-cache-868 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortStmt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortStmt ) \top ) ) ) ) ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-239 typecode-cache-Pattern-177 IMP-sort-31-is-pattern and-is-pattern typecode-cache-Pattern-146 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern and-elim-right-sugar rule-imp-transitivity sorting-cache-867 ) BJKEAGHECDFIIAGHECDFICLMEBJKEAGHECDFINAGHECDFICDFCLMEAGHECDFNCDPOO $. $}
