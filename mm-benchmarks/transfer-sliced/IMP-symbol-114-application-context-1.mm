...
${ $d xX0 ptn0 $.
   ...
   IMP-symbol-114-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Hash'systemResult ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-114-is-symbol symbol-is-pattern IMP-symbol-114-is-pattern application-context-app-right application-context-app-left notation-cache-128 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAGHBFCAEJKBCDLM $. $}
