...
${ notation-cache-621 $p #Notation ( \kore-symbol-Lblproject'ColnHash'tempFile'Coln'path ptn2 ) ( \app \kore-symbol-Lblproject'ColnHash'tempFile'Coln'path-symbol ptn2 ) $= ( IMP-symbol-300-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-300-is-pattern IMP-symbol-300-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
