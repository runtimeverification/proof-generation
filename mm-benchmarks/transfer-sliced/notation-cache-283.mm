...
${ notation-cache-283 $p #Notation ( \kore-symbol-Lbl'Unds-LT-EqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds-LT-EqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-172-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-172-is-pattern IMP-symbol-172-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
