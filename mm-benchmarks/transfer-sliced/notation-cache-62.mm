...
${ notation-cache-62 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'Unds-LT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds' ptn2 ) ( \app \kore-symbol-Lbl'Hash'freezer'Unds-LT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds'-symbol ptn2 ) $= ( IMP-symbol-88-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-88-is-pattern IMP-symbol-88-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
