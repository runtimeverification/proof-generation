...
sorting-cache-1294 $a |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) \top ) ) ( \and ( \in-sort ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ) \kore-sort-SortAExp ) ( \in-sort ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) \kore-sort-SortAExp ) ) ) $.
${ sorting-cache-1295 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) \top ) ) ( \in-sort ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ( \kore-symbol-Lbl'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) ) ) \kore-sort-SortStmt ) ) $= ( IMP-sort-17-is-pattern kore-dv-is-pattern IMP-sort-13-is-pattern string-literal-10-is-pattern kore-inj-is-pattern in-sort-is-pattern string-literal-14-is-pattern typecode-cache-Pattern-286 IMP-symbol-164-is-pattern and-is-pattern rule-imp-transitivity IMP-symbol-185-is-pattern IMP-sort-31-is-pattern imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp sorting-cache-1294 IMP-symbol-164-sorting rule-and-intro-alt2-sugar IMP-symbol-185-sorting ) ABJCFDCHCECFDGCECIDGKEHLCFDCECFDGCECIDGKNOHABJCFDCHCECFDGCECIDGKEHCFDCHABJCFDCHPCFDCHABJQCFRSABJCECFDGEHCECIDGEHLCECFDGCECIDGKEHABTCECFDGCECIDGUAMUBCFDCECFDGCECIDGKUCM $. $}
