$c #Substitution \unit-sort #SetVariable \kore-sort-SortKConfigVar #ElementVariable "%24PGM" #Symbol #Variable #Pattern \kore-dv ) \kore-equals ( $.
...
${ substitution-168 $p #Substitution ( \kore-equals \kore-sort-SortKConfigVar \unit-sort kore-element-var-x1 ( \kore-dv \kore-sort-SortKConfigVar "%24PGM" ) ) ( \kore-equals \kore-sort-SortKConfigVar kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortKConfigVar "%24PGM" ) ) \unit-sort kore-sort-var-x0 $= ( IMP-sort-20-is-pattern unit-sort-is-symbol symbol-is-pattern string-literal-9-is-pattern kore-dv-is-pattern element-var-is-var typecode-cache-Pattern-23 typecode-cache-Pattern-14 substitution-167 substitution-var-same substitution-62 substitution-disjoint substitution-kore-equals ) CDEBICFGCAJBICFGDEAHAKDEAHLABMCFGDEAHNO $. $}
