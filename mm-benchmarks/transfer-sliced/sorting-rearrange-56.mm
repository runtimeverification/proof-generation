$c \top #SetVariable \kore-sort-SortKConfigVar #ElementVariable "%24PGM" #Symbol #Variable #Pattern \kore-exists \and \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals ( $.
