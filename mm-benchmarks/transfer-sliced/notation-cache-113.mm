...
${ notation-cache-113 $p #Notation ( \kore-symbol-Lbl'Hash'remove'LParUndsRParUnds'K-IO'Unds'K'Unds'String ptn1 ) ( \app \kore-symbol-Lbl'Hash'remove'LParUndsRParUnds'K-IO'Unds'K'Unds'String-symbol ptn1 ) $= ( IMP-symbol-106-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-106-is-pattern IMP-symbol-106-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
