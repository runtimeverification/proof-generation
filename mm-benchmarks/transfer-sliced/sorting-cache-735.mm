...
${ sorting-cache-735 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortMap ) ( \and ( \in-sort kore-element-var-K3 \kore-sort-SortMap ) \top ) ) ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortMap ) ( \and ( \in-sort kore-element-var-K3 \kore-sort-SortMap ) \top ) ) ) $= ( typecode-cache-Pattern-210 IMP-sort-14-is-pattern in-sort-is-pattern top-is-pattern typecode-cache-Pattern-209 rule-and-intro-alt2-sugar typecode-cache-Pattern-120 and-is-pattern sorting-cache-730 sorting-cache-732 top-intro rule-weakening ) ABCDBJEFCHEFGKABCLABCDCHEFGABCMABCDGNOII $. $}
