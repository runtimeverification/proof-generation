...
${ notation-cache-392 $p #Notation ( \kore-symbol-Lbl'Unds'in'Unds'keys'LParUndsRParUnds'ARRAY-SYNTAX'Unds'Bool'Unds'Int'Unds'Array ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'in'Unds'keys'LParUndsRParUnds'ARRAY-SYNTAX'Unds'Bool'Unds'Int'Unds'Array-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-211-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-211-is-pattern IMP-symbol-211-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
