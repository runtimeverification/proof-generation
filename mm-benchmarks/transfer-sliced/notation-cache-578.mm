...
${ notation-cache-578 $p #Notation ( \kore-symbol-LblisTCell ptn1 ) ( \app \kore-symbol-LblisTCell-symbol ptn1 ) $= ( IMP-symbol-281-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-281-is-pattern IMP-symbol-281-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
