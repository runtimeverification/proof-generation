...
$v ph0 xX ph2 x kore-element-var-V1 ph3 ph4 ph1 $.
...
${ substitution-149 $p #Substitution ( \and ( \in-sort \kore-symbol-Lbl'Stop'Map \kore-sort-SortMap ) \top ) ( \and ( \in-sort kore-element-var-V1 \kore-sort-SortMap ) \top ) \kore-symbol-Lbl'Stop'Map kore-element-var-V1 $= ( IMP-symbol-124-is-pattern IMP-sort-14-is-pattern element-var-is-var top-is-pattern in-sort-is-pattern typecode-cache-Pattern-37 substitution-disjoint substitution-var-same substitution-in-sort substitution-and ) BBCFEAGCFEADBBCAGCADBADICBADHJEBADHK $. $}
