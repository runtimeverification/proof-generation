...
${ notation-cache-285 $p #Notation ( \kore-symbol-Lbl'Unds-LT-'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds-LT-'Int'Unds'-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-173-is-symbol symbol-is-pattern IMP-symbol-173-is-pattern IMP-symbol-173-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
