...
${ sorting-cache-730 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortMap ) ( \and ( \in-sort kore-element-var-K3 \kore-sort-SortMap ) \top ) ) ) ( \in-sort kore-element-var-K2 \kore-sort-SortMap ) ) $= ( IMP-sort-14-is-pattern in-sort-is-pattern typecode-cache-Pattern-120 and-is-pattern typecode-cache-Pattern-209 top-is-pattern rule-imp-transitivity typecode-cache-Pattern-210 typecode-cache-Pattern-0 kore-is-sort-is-pattern and-elim-right-sugar and-elim-left-sugar imp-reflexivity ) ABCKBFDECHDEIGGBFDEALMBFDECHDEIGGNBFDECHDEIGGBFDEBFDEBFDECHDEIGOBFDEPJJ $. $}
