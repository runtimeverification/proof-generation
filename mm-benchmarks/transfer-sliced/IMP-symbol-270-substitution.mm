$c #Substitution #Notation #SetVariable \kore-symbol-LblisKItem-symbol #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-LblisKItem ( $.
...
notation-cache-545 $a #Notation ( \kore-symbol-LblisKItem ptn1 ) ( \app \kore-symbol-LblisKItem-symbol ptn1 ) $.
notation-cache-546 $a #Notation ( \kore-symbol-LblisKItem ptn2 ) ( \app \kore-symbol-LblisKItem-symbol ptn2 ) $.
${ IMP-symbol-270-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-270-substitution $p #Substitution ( \kore-symbol-LblisKItem ptn1 ) ( \kore-symbol-LblisKItem ptn2 ) ptn0 xX0 $= ( IMP-symbol-270-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-270-is-pattern substitution-disjoint substitution-app notation-cache-545 notation-cache-546 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
