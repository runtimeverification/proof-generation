...
${ notation-cache-420 $p #Notation ( \kore-symbol-Lbl'UndsPipeUndsPipeUnds'IMP-SYNTAX'Unds'AExp'Unds'Id'Unds'Id ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsPipeUndsPipeUnds'IMP-SYNTAX'Unds'AExp'Unds'Id'Unds'Id-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-221-is-symbol symbol-is-pattern IMP-symbol-221-is-pattern IMP-symbol-221-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
