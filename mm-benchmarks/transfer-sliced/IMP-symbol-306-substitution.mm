$c #Substitution #Notation #SetVariable \kore-symbol-Lblproject'Coln'Bool #ElementVariable #Symbol #Variable #Pattern \kore-symbol-Lblproject'Coln'Bool-symbol \app ) ( $.
...
notation-cache-638 $a #Notation ( \kore-symbol-Lblproject'Coln'Bool ptn1 ) ( \app \kore-symbol-Lblproject'Coln'Bool-symbol ptn1 ) $.
notation-cache-639 $a #Notation ( \kore-symbol-Lblproject'Coln'Bool ptn2 ) ( \app \kore-symbol-Lblproject'Coln'Bool-symbol ptn2 ) $.
${ IMP-symbol-306-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-306-substitution $p #Substitution ( \kore-symbol-Lblproject'Coln'Bool ptn1 ) ( \kore-symbol-Lblproject'Coln'Bool ptn2 ) ptn0 xX0 $= ( IMP-symbol-306-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-306-is-pattern substitution-disjoint substitution-app notation-cache-638 notation-cache-639 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
