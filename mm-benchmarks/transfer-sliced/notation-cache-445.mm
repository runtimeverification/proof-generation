...
${ notation-cache-445 $p #Notation ( \kore-symbol-LbldirectionalityChar'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'String ptn0 ) ( \app \kore-symbol-LbldirectionalityChar'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'String-symbol ptn0 ) $= ( IMP-symbol-230-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-230-is-pattern IMP-symbol-230-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
