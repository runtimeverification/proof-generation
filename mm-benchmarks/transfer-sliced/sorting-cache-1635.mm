...
${ sorting-cache-1635 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortInt ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortInt ) \top ) ) ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-347 typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-146 IMP-sort-23-is-pattern top-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern rule-imp-transitivity and-elim-left-sugar and-elim-right-sugar sorting-cache-1624 ) AHIECDGFBJKELFFAHIECDGFCMNEAHIECDGFBJKELFPAHIECDGFCDGCMNEAHIECDGQCDROO $. $}
