$c #Substitution \top #SetVariable \kore-sort-SortAExp #ElementVariable #Symbol \kore-sort-SortStmt #Variable #Pattern \kore-exists \imp \kore-dv ( \kore-sort-SortId \kore-valid ) \kore-equals \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp \in-sort "balanceTo" \and $.
...
substitution-324 $a #Substitution ( \kore-equals \kore-sort-SortStmt kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "balanceTo" ) kore-element-var-x0 ) ) ( \kore-equals \kore-sort-SortStmt kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "balanceTo" ) kore-element-var-K1 ) ) kore-element-var-x0 kore-element-var-K1 $.
${ substitution-325 $p #Substitution ( \imp ( \and ( \in-sort kore-element-var-x0 \kore-sort-SortAExp ) \top ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortStmt kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortStmt kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "balanceTo" ) kore-element-var-x0 ) ) ) ) ) ( \imp ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortAExp ) \top ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortStmt kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortStmt kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "balanceTo" ) kore-element-var-K1 ) ) ) ) ) kore-element-var-x0 kore-element-var-K1 $= ( typecode-cache-Pattern-0 IMP-sort-31-is-pattern typecode-cache-Pattern-25 kore-exists-is-pattern typecode-cache-Pattern-109 typecode-cache-Pattern-108 element-var-is-var IMP-sort-13-is-pattern in-sort-is-pattern top-is-pattern and-is-pattern kore-valid-is-pattern substitution-249 typecode-cache-Pattern-49 substitution-290 substitution-291 substitution-324 substitution-kore-exists-alt substitution-kore-valid substitution-imp ) DGDGLMNOAEFAEABDIBHPCRLMNOAEFAEABCJBHPCKCDSAEFAEABDIBHAEFAEABCJBHDGCKACDQFAEABDIFAEABCJDGBCKCDTACDQABCDUAUBUCUD $. $}
