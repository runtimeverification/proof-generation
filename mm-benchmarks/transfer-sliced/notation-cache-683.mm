...
${ notation-cache-683 $p #Notation ( \kore-symbol-Lblproject'Coln'KCellOpt ptn1 ) ( \app \kore-symbol-Lblproject'Coln'KCellOpt-symbol ptn1 ) $= ( IMP-symbol-321-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-321-is-pattern IMP-symbol-321-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
