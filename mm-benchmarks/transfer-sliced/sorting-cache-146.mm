...
${ sorting-cache-146 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ( \kore-is-sort kore-sort-var-S3 ) ) $= ( typecode-cache-Pattern-2 kore-is-sort-is-pattern typecode-cache-Pattern-28 typecode-cache-Pattern-6 IMP-sort-23-is-pattern in-sort-is-pattern top-is-pattern and-is-pattern and-elim-left-sugar imp-reflexivity rule-imp-transitivity ) ABEACDACDACDBFGHIJKACDLM $. $}
