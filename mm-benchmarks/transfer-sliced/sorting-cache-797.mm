...
${ sorting-cache-797 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortStmt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) \top ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-225 typecode-cache-Pattern-146 BASIC-K-sort-0-is-pattern and-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern top-is-pattern and-elim-right-sugar sorting-cache-793 rule-imp-transitivity top-intro rule-weakening rule-and-intro-alt2-sugar ) BFGDACEHCIJDKBFGDACEHACECIJDBFGDACELACMNBFGDACEHKOPQ $. $}
