...
${ notation-cache-729 $p #Notation ( \kore-symbol-LblrandInt'LParUndsRParUnds'INT'Unds'Int'Unds'Int ptn2 ) ( \app \kore-symbol-LblrandInt'LParUndsRParUnds'INT'Unds'Int'Unds'Int-symbol ptn2 ) $= ( IMP-symbol-336-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-336-is-pattern IMP-symbol-336-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
