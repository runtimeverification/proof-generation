...
${ notation-cache-46 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'UndsSlshUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp0'Unds' ptn1 ) ( \app \kore-symbol-Lbl'Hash'freezer'UndsSlshUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp0'Unds'-symbol ptn1 ) $= ( IMP-symbol-83-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-83-is-pattern IMP-symbol-83-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
