...
${ sorting-cache-1707 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) \top ) ) ) ) ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-357 typecode-cache-Pattern-179 IMP-sort-22-is-pattern and-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-356 IMP-sort-18-is-pattern and-elim-right-sugar rule-imp-transitivity sorting-cache-1706 ) AJKEBGHECDFIIBGHECDFIDLMEAJKEBGHECDFINBGHECDFICDFDLMEBGHECDFNCDPOO $. $}
