...
${ sorting-cache-1480 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ) ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-324 typecode-cache-Pattern-146 IMP-sort-13-is-pattern typecode-cache-Pattern-253 BASIC-K-sort-1-is-pattern and-elim-right-sugar sorting-cache-1479 rule-imp-transitivity ) BMNFAHIFCJKFDELGGGAHIFCJKFDELGGEOPFBMNFAHIFCJKFDELGGQACDERS $. $}
