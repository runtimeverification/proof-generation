...
${ notation-cache-28 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'UndsStarUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp0'Unds' ptn1 ) ( \app \kore-symbol-Lbl'Hash'freezer'UndsStarUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp0'Unds'-symbol ptn1 ) $= ( IMP-symbol-77-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-77-is-pattern IMP-symbol-77-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
