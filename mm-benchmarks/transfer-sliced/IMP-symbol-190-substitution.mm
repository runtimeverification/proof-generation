$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-Lbl'Unds-GT-'Int'Unds'-symbol \app \kore-symbol-Lbl'Unds-GT-'Int'Unds' ) ( $.
...
notation-cache-335 $a #Notation ( \kore-symbol-Lbl'Unds-GT-'Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds-GT-'Int'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-336 $a #Notation ( \kore-symbol-Lbl'Unds-GT-'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds-GT-'Int'Unds'-symbol ptn3 ) ptn4 ) $.
${ IMP-symbol-190-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   IMP-symbol-190-substitution $p #Substitution ( \kore-symbol-Lbl'Unds-GT-'Int'Unds' ptn1 ptn2 ) ( \kore-symbol-Lbl'Unds-GT-'Int'Unds' ptn3 ptn4 ) ptn0 xX0 $= ( IMP-symbol-190-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-190-is-pattern substitution-app substitution-disjoint notation-cache-335 notation-cache-336 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
