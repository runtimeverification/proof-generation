...
${ $d xX0 ptn0 $.
   $d xX0 ptn2 $.
   IMP-symbol-342-application-context-1.0 $e #ApplicationContext xX0 ptn1 $.
   IMP-symbol-342-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-LblrfindString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String'Unds'Int ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-342-is-symbol symbol-is-pattern IMP-symbol-342-is-pattern application-context-app-right application-context-app-left notation-cache-738 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAGHBFCAEJKBCDLM $. $}
