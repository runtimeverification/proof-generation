$c \exists #Substitution \top #Variable \imp \kore-dv \kore-is-sort |- \kore-sort-SortId \kore-valid ) \kore-equals \and #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-sort-SortKItem \kore-inj \in-sort "balanceTo" ( $.
...
substitution-665 $a #Substitution ( \kore-equals \kore-sort-SortKItem kore-sort-var-R kore-element-var-Val ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "balanceTo" ) ) ) ( \kore-equals \kore-sort-SortKItem kore-sort-var-R kore-element-var-Val ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem kore-element-var-From ) ) ( \kore-dv \kore-sort-SortId "balanceTo" ) kore-element-var-From $.
${ sorting-rearrange-393 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortKItem kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortKItem kore-sort-var-R kore-element-var-Val ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "balanceTo" ) ) ) ) ) ) $= ( IMP-sort-17-is-pattern typecode-cache-Pattern-0 kore-element-var-From-elementvariable BASIC-K-sort-1-is-pattern string-literal-17-is-pattern kore-dv-is-pattern top-is-pattern and-is-pattern kore-exists-is-pattern in-sort-is-pattern kore-element-var-x0-elementvariable element-var-is-var kore-valid-is-pattern typecode-cache-Pattern-197 kore-is-sort-is-pattern typecode-cache-Pattern-31 kore-inj-is-pattern kore-equals-is-pattern typecode-cache-Pattern-45 typecode-cache-Pattern-25 typecode-cache-Pattern-198 substitution-disjoint kore-element-var-x1-elementvariable substitution-383 substitution-kore-valid substitution-imp sorting-cache-133 sorting-cache-221 rule-and-intro-alt2-sugar sorting-rearrange-41 sorting-rearrange-318 substitution-var-same substitution-in-sort substitution-and substitution-665 substitution-kore-exists-alt substitution-331 substitution-178 substitution-622 functional-substitution-alt rule-imp-transitivity )  $. $}
