$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-Lblproject'Coln'Id \app ) \kore-symbol-Lblproject'Coln'Id-symbol ( $.
...
notation-cache-668 $a #Notation ( \kore-symbol-Lblproject'Coln'Id ptn1 ) ( \app \kore-symbol-Lblproject'Coln'Id-symbol ptn1 ) $.
notation-cache-669 $a #Notation ( \kore-symbol-Lblproject'Coln'Id ptn2 ) ( \app \kore-symbol-Lblproject'Coln'Id-symbol ptn2 ) $.
${ IMP-symbol-316-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-316-substitution $p #Substitution ( \kore-symbol-Lblproject'Coln'Id ptn1 ) ( \kore-symbol-Lblproject'Coln'Id ptn2 ) ptn0 xX0 $= ( IMP-symbol-316-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-316-is-pattern substitution-disjoint substitution-app notation-cache-668 notation-cache-669 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
