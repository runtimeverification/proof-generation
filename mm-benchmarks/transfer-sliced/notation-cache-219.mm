...
${ notation-cache-219 $p #Notation ( \kore-symbol-LblString2Int'LParUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String ptn2 ) ( \app \kore-symbol-LblString2Int'LParUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String-symbol ptn2 ) $= ( IMP-symbol-151-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-151-is-pattern IMP-symbol-151-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
