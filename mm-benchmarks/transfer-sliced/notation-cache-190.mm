...
${ notation-cache-190 $p #Notation ( \kore-symbol-LblListItem ptn1 ) ( \app \kore-symbol-LblListItem-symbol ptn1 ) $= ( IMP-symbol-141-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-141-is-pattern IMP-symbol-141-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
