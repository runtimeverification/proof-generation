...
sorting-cache-424 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \kore-is-sort \kore-sort-SortPgm ) ) $.
sorting-cache-425 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \kore-is-sort \kore-sort-SortKItem ) ) $.
${ sorting-cache-426 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \kore-is-sort \kore-sort-SortPgm ) ( \kore-is-sort \kore-sort-SortKItem ) ) ) $= ( kore-is-sort-is-pattern typecode-cache-Pattern-0 top-is-pattern and-is-pattern IMP-sort-27-is-pattern BASIC-K-sort-1-is-pattern sorting-cache-424 sorting-cache-425 rule-and-intro-alt2-sugar ) ACBDEFBGBAHAIJ $. $}
