...
${ notation-cache-296 $p #Notation ( \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds'-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-177-is-symbol symbol-is-pattern IMP-symbol-177-is-pattern IMP-symbol-177-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
