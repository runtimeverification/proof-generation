$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-LblisString \app ) \kore-symbol-LblisString-symbol ( $.
...
notation-cache-575 $a #Notation ( \kore-symbol-LblisString ptn1 ) ( \app \kore-symbol-LblisString-symbol ptn1 ) $.
notation-cache-576 $a #Notation ( \kore-symbol-LblisString ptn2 ) ( \app \kore-symbol-LblisString-symbol ptn2 ) $.
${ IMP-symbol-280-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-280-substitution $p #Substitution ( \kore-symbol-LblisString ptn1 ) ( \kore-symbol-LblisString ptn2 ) ptn0 xX0 $= ( IMP-symbol-280-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-280-is-pattern substitution-disjoint substitution-app notation-cache-575 notation-cache-576 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
