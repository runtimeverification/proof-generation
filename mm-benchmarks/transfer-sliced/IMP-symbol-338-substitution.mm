$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-Lblreplace'LParUndsCommUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String'Unds'Int \app ) \kore-symbol-Lblreplace'LParUndsCommUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String'Unds'Int-symbol ( $.
...
${ IMP-symbol-338-substitution.0 $e #Substitution ptn1 ptn5 ptn0 xX0 $.
   IMP-symbol-338-substitution.1 $e #Substitution ptn2 ptn6 ptn0 xX0 $.
   IMP-symbol-338-substitution.2 $e #Substitution ptn3 ptn7 ptn0 xX0 $.
   IMP-symbol-338-substitution.3 $e #Substitution ptn4 ptn8 ptn0 xX0 $.
   IMP-symbol-338-substitution $p #Substitution ( \kore-symbol-Lblreplace'LParUndsCommUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String'Unds'Int ptn1 ptn2 ptn3 ptn4 ) ( \kore-symbol-Lblreplace'LParUndsCommUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String'Unds'Int ptn5 ptn6 ptn7 ptn8 ) ptn0 xX0 $= ( app-is-pattern IMP-symbol-338-is-symbol symbol-is-pattern IMP-symbol-338-is-pattern substitution-app notation-reflexivity IMP-symbol-338-is-sugar notation-transitivity substitution-disjoint notation-substitution ) PQCODOEOFOPQGOHOIOJOBCDEFRGHIJRBABPQCODOEOFPQGOHOIOJABPQCODOEPQGOHOIABPQCODPQGOHABPQCPQGAPQBAUCKSLSMSNSCDEFRPQCODOEOFOPQCODOEOFOCDEFUAPQCODOEOFOTUBGHIJRPQGOHOIOJOPQGOHOIOJOGHIJUAPQGOHOIOJOTUBBTUD $. $}
