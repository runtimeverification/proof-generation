...
${ notation-cache-37 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp1'Unds' ptn1 ) ( \app \kore-symbol-Lbl'Hash'freezer'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp1'Unds'-symbol ptn1 ) $= ( IMP-symbol-80-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-80-is-pattern IMP-symbol-80-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
