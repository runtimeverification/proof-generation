...
${ notation-cache-688 $p #Notation ( \kore-symbol-Lblproject'Coln'KItem ptn0 ) ( \app \kore-symbol-Lblproject'Coln'KItem-symbol ptn0 ) $= ( IMP-symbol-322-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-322-is-pattern IMP-symbol-322-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
