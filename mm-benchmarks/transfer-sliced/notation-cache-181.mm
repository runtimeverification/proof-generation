...
${ notation-cache-181 $p #Notation ( \kore-symbol-LblId2String'LParUndsRParUnds'ID-COMMON'Unds'String'Unds'Id ptn2 ) ( \app \kore-symbol-LblId2String'LParUndsRParUnds'ID-COMMON'Unds'String'Unds'Id-symbol ptn2 ) $= ( IMP-symbol-137-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-137-is-pattern IMP-symbol-137-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
