$c #Notation \kore-symbol-LblInt2String'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int #SetVariable #ElementVariable \kore-symbol-LblInt2String'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int-symbol #Symbol #Variable #Pattern \app ) ( $.
...
${ notation-cache-185 $p #Notation ( \kore-symbol-LblInt2String'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int ptn0 ) ( \app \kore-symbol-LblInt2String'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int-symbol ptn0 ) $= ( IMP-symbol-138-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-138-is-pattern IMP-symbol-138-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
