$c \top \kore-sort-SortAExp #Variable \imp \kore-is-sort |- \kore-valid ) \kore-equals \and #SetVariable #ElementVariable #Symbol #Pattern \kore-exists \kore-inj \kore-sort-SortInt \in-sort ( $.
