...
${ notation-cache-87 $p #Notation ( \kore-symbol-Lbl'Hash'freezerif'LParUndsRParUnds'else'UndsUnds'IMP-SYNTAX'Unds'Stmt'Unds'BExp'Unds'Block'Unds'Block0'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Hash'freezerif'LParUndsRParUnds'else'UndsUnds'IMP-SYNTAX'Unds'Stmt'Unds'BExp'Unds'Block'Unds'Block0'Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-96-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-96-is-pattern IMP-symbol-96-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
