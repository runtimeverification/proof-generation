$c #Notation \kore-symbol-Lbl'Hash'freezer'UndsStarUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp1'Unds'-symbol #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'Hash'freezer'UndsStarUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp1'Unds' #Variable #Pattern \app ) ( $.
...
${ notation-cache-33 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'UndsStarUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp1'Unds' ptn0 ) ( \app \kore-symbol-Lbl'Hash'freezer'UndsStarUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp1'Unds'-symbol ptn0 ) $= ( IMP-symbol-78-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-78-is-pattern IMP-symbol-78-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
