...
${ $d xX0 ptn0 $.
   $d xX0 ptn2 $.
   $d xX0 ptn3 $.
   IMP-symbol-338-application-context-1.0 $e #ApplicationContext xX0 ptn1 $.
   IMP-symbol-338-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-Lblreplace'LParUndsCommUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String'Unds'Int ptn0 ptn1 ptn2 ptn3 ) $= ( app-is-pattern IMP-symbol-338-is-symbol symbol-is-pattern application-context-app-left IMP-symbol-338-is-pattern application-context-app-right notation-cache-734 notation-application-context ) HIBGCGDGEGBCDEKAHIBGCGDGEAHIBGCGDAHIBGCAFLJJBCDEMN $. $}
