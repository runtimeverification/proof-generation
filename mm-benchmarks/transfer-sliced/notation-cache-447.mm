...
${ notation-cache-447 $p #Notation ( \kore-symbol-Lblexp'LParUndsCommUndsRParUnds'VERIFICAITON'Unds'Int'Unds'Int'Unds'Int ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lblexp'LParUndsCommUndsRParUnds'VERIFICAITON'Unds'Int'Unds'Int'Unds'Int-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-232-is-symbol symbol-is-pattern IMP-symbol-232-is-pattern IMP-symbol-232-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
