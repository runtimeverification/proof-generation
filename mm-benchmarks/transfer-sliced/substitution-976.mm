$c #Substitution \kore-symbol-Lbl'Hash'freezer'Unds-GT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds' #SetVariable #ElementVariable #Symbol \kore-symbol-kseq #Variable #Pattern "10" \kore-sort-SortK \kore-sort-SortKItem \kore-dv ) \kore-equals \kore-inj \kore-sort-SortInt \kore-symbol-dotk ( $.
...
${ substitution-976 $p #Substitution ( \kore-equals \kore-sort-SortK kore-sort-var-R kore-element-var-V0 ( \kore-symbol-kseq ( \kore-symbol-Lbl'Hash'freezer'Unds-GT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds' ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "10" ) ) \kore-symbol-dotk ) ) kore-element-var-x0 ) ) ( \kore-equals \kore-sort-SortK kore-sort-var-R kore-element-var-V0 ( \kore-symbol-kseq ( \kore-symbol-Lbl'Hash'freezer'Unds-GT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds' ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "10" ) ) \kore-symbol-dotk ) ) kore-element-var-V2 ) ) kore-element-var-x0 kore-element-var-V2 $= ( IMP-sort-23-is-pattern KSEQ-symbol-0-is-pattern typecode-cache-Pattern-25 BASIC-K-sort-1-is-pattern string-literal-13-is-pattern kore-dv-is-pattern kore-inj-is-pattern KSEQ-symbol-1-is-pattern IMP-symbol-95-is-pattern element-var-is-var BASIC-K-sort-0-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-39 typecode-cache-Pattern-35 substitution-490 substitution-421 substitution-422 substitution-disjoint substitution-var-same KSEQ-symbol-0-substitution substitution-kore-equals ) OAPBQEHEIJKLFMDGFOAPBQEHEIJKLFMCRFDGCNCDSACDTBCDUACNDGEHEIJKLFMDGEHEIJKLFMCREHEIJKLFMDGCNUBDGCNUCUDUE $. $}
