$c \exists \top #Variable \kore-sort-SortK \imp \kore-dv "0" |- \kore-valid ) \kore-equals \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-symbol-Lbl'-LT-'generatedCounter'-GT-' \kore-sort-SortInt \kore-sort-SortGeneratedCounterCell \in-sort \kore-sort-SortStateCell ( $.
...
${ sorting-rearrange-1060 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortInt ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortInt ) \top ) ) ) ) ( \exists kore-element-var-Val ( \eq kore-element-var-Val ( \kore-symbol-Lbl'-LT-'generatedCounter'-GT-' ( \kore-dv \kore-sort-SortInt "0" ) ) ) ) ) $= ( IMP-sort-23-is-pattern in-sort-is-pattern and-is-pattern top-is-pattern typecode-cache-Pattern-146 typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-347 string-literal-1-is-pattern kore-dv-is-pattern IMP-symbol-128-is-pattern typecode-cache-Pattern-31 eq-is-pattern exists-is-pattern top-intro rule-weakening IMP-sort-10-is-pattern sorting-cache-50 sorting-rearrange-295 kore-functional rule-imp-transitivity ) BJFGAKLGCDMHHIEQFNOPRESBJFGAKLGCDMHHITUAUBFNOPIEUCEUDUEUF $. $}
