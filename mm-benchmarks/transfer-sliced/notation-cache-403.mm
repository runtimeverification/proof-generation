...
${ notation-cache-403 $p #Notation ( \kore-symbol-Lbl'Unds'orElseBool'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds'orElseBool'Unds'-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-215-is-symbol symbol-is-pattern IMP-symbol-215-is-pattern IMP-symbol-215-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
