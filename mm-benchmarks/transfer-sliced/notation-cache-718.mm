...
${ notation-cache-718 $p #Notation ( \kore-symbol-Lblproject'Coln'String ptn0 ) ( \app \kore-symbol-Lblproject'Coln'String-symbol ptn0 ) $= ( IMP-symbol-332-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-332-is-pattern IMP-symbol-332-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
