...
${ $d xX0 ptn0 $.
   $d xX0 ptn1 $.
   IMP-symbol-202-application-context-2.0 $e #ApplicationContext xX0 ptn2 $.
   IMP-symbol-202-application-context-2 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsXor-Perc'Int'UndsUnds' ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-202-is-symbol symbol-is-pattern IMP-symbol-202-is-pattern application-context-app-right notation-cache-365 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAEJBCDKL $. $}
