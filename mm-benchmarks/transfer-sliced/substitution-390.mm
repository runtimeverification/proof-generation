$c #Substitution #SetVariable \kore-sort-SortAExp #ElementVariable #Symbol #Variable #Pattern \kore-dv \kore-sort-SortId ) \kore-equals \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp \kore-inj "balanceTo" ( $.
...
${ substitution-390 $p #Substitution ( \kore-equals \kore-sort-SortAExp kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceTo" ) ) kore-element-var-x0 ) ) ( \kore-equals \kore-sort-SortAExp kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceTo" ) ) kore-element-var-K1 ) ) kore-element-var-x0 kore-element-var-K1 $= ( IMP-sort-17-is-pattern IMP-sort-13-is-pattern typecode-cache-Pattern-25 string-literal-17-is-pattern kore-dv-is-pattern kore-inj-is-pattern element-var-is-var typecode-cache-Pattern-0 typecode-cache-Pattern-31 IMP-symbol-160-is-pattern typecode-cache-Pattern-49 substitution-288 substitution-249 substitution-250 substitution-disjoint substitution-var-same IMP-symbol-160-substitution substitution-kore-equals ) FALBMEFEHIJDGNFALBMEFEHIJCONDGCKCDPACDQBCDRCKDGEFEHIJDGEFEHIJCOEFEHIJDGCKSDGCKTUAUB $. $}
