...
${ notation-cache-708 $p #Notation ( \kore-symbol-Lblproject'Coln'StateCellOpt ptn2 ) ( \app \kore-symbol-Lblproject'Coln'StateCellOpt-symbol ptn2 ) $= ( IMP-symbol-329-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-329-is-pattern IMP-symbol-329-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
