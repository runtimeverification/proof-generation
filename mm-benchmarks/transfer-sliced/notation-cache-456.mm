...
${ notation-cache-456 $p #Notation ( \kore-symbol-LblfreshId'LParUndsRParUnds'ID-COMMON'Unds'Id'Unds'Int ptn0 ) ( \app \kore-symbol-LblfreshId'LParUndsRParUnds'ID-COMMON'Unds'Id'Unds'Int-symbol ptn0 ) $= ( IMP-symbol-237-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-237-is-pattern IMP-symbol-237-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
