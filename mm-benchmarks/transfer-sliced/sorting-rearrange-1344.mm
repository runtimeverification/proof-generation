$c \exists \top #Variable \kore-sort-SortK \imp \kore-dv \kore-is-sort |- \kore-sort-SortId \kore-valid ) \kore-equals \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-sort-SortKItem \kore-inj \in-sort "balanceTo" ( $.
...
${ sorting-rearrange-1344 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-V2 \kore-sort-SortK ) \top ) ) ( \exists kore-element-var-Val ( \eq kore-element-var-Val ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "balanceTo" ) ) ) ) ) $= ( IMP-sort-17-is-pattern top-is-pattern BASIC-K-sort-1-is-pattern typecode-cache-Pattern-156 string-literal-17-is-pattern kore-dv-is-pattern kore-inj-is-pattern typecode-cache-Pattern-31 eq-is-pattern exists-is-pattern top-intro rule-weakening sorting-cache-58 sorting-rearrange-395 kore-functional rule-imp-transitivity ) ABGECKDFDHIJLCMABGENOFDFDHIJECPCQRS $. $}
