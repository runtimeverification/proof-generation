$c #Substitution "amount" #SetVariable #ElementVariable #Symbol \kore-symbol-kseq #Variable #Pattern \kore-exists \kore-sort-SortK \kore-sort-SortKItem \kore-dv \kore-sort-SortId ) \kore-equals \kore-inj ( $.
...
${ substitution-897 $p #Substitution ( \kore-exists \kore-sort-SortK kore-sort-var-R kore-element-var-V0 ( \kore-equals \kore-sort-SortK kore-sort-var-R kore-element-var-V0 ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "amount" ) ) kore-element-var-V2 ) ) ) ( \kore-exists \kore-sort-SortK kore-sort-var-R kore-element-var-V0 ( \kore-equals \kore-sort-SortK kore-sort-var-R kore-element-var-V0 ( \kore-symbol-kseq kore-element-var-V1 kore-element-var-V2 ) ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "amount" ) ) kore-element-var-V1 $= ( IMP-sort-17-is-pattern BASIC-K-sort-1-is-pattern string-literal-14-is-pattern kore-dv-is-pattern kore-inj-is-pattern element-var-is-var BASIC-K-sort-0-is-pattern typecode-cache-Pattern-0 substitution-disjoint typecode-cache-Pattern-35 typecode-cache-Pattern-39 typecode-cache-Pattern-306 typecode-cache-Pattern-159 KSEQ-symbol-0-is-pattern typecode-cache-Pattern-158 typecode-cache-Pattern-37 substitution-var-same KSEQ-symbol-0-substitution substitution-kore-equals substitution-kore-exists-alt ) KALABDPKALABCDQEFEGHIBCJKEFEGHICJMALEFEGHICJMKALBOEFEGHIDNRKALBOCDSEFEGHICJKEFEGHICJMALEFEGHICJMBOEFEGHICJMCJEFEGHIEFEGHIDNCTDNEFEGHICJUADNEFEGHICJMUBUCUD $. $}
