...
${ $d xX0 ptn0 $.
   IMP-symbol-203-application-context-1.0 $e #ApplicationContext xX0 ptn1 $.
   IMP-symbol-203-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsXor-'Int'Unds' ptn0 ptn1 ) $= ( app-is-pattern IMP-symbol-203-is-symbol symbol-is-pattern IMP-symbol-203-is-pattern application-context-app-right notation-cache-368 notation-application-context ) FGBECEBCHAFGBECADIBCJK $. $}
