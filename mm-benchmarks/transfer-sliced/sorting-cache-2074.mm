...
sorting-cache-1655 $a |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortInt ) \top ) ) ( \and ( \in-sort ( \kore-dv \kore-sort-SortId "ret" ) \kore-sort-SortId ) ( \in-sort ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "1" ) ) \kore-sort-SortAExp ) ) ) $.
${ sorting-cache-2074 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortInt ) \top ) ) ( \and ( \and ( \kore-is-sort \kore-sort-SortStmt ) ( \kore-is-sort \kore-sort-SortKItem ) ) ( \in-sort ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "ret" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "1" ) ) ) \kore-sort-SortStmt ) ) ) $= ( kore-is-sort-is-pattern kore-dv-is-pattern IMP-sort-23-is-pattern typecode-cache-Pattern-347 IMP-sort-31-is-pattern BASIC-K-sort-1-is-pattern IMP-sort-17-is-pattern IMP-sort-13-is-pattern string-literal-11-is-pattern string-literal-4-is-pattern kore-inj-is-pattern in-sort-is-pattern and-is-pattern IMP-symbol-185-is-pattern imp-is-pattern proof-rule-prop-1 proof-rule-mp rule-and-intro-alt2-sugar IMP-sort-31-sort BASIC-K-sort-1-sort sorting-cache-1655 IMP-symbol-185-sorting rule-imp-transitivity ) ABFGCHCOIKDEJELDMPGNABFGCHCGCABFGCQGCABFRUASHCABFHCQHCABFRUBSTABFIKDINEJELDMJNOIKDEJELDMPGNABUCIKDEJELDMUDUET $. $}
