$c \exists \top \kore-sort-SortAExp #Variable \kore-sort-SortK \imp \kore-dv |- \kore-sort-SortId \kore-valid ) \kore-equals \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-sort-SortKItem \in-sort \kore-sort-SortStateCell "balanceTo" ( $.
...
${ sorting-rearrange-1522 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ) ) ( \exists kore-element-var-x1 ( \eq kore-element-var-x1 ( \kore-dv \kore-sort-SortId "balanceTo" ) ) ) ) $= ( in-sort-is-pattern and-is-pattern top-is-pattern IMP-sort-17-is-pattern typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-324 string-literal-17-is-pattern kore-dv-is-pattern typecode-cache-Pattern-23 eq-is-pattern exists-is-pattern top-intro rule-weakening sorting-cache-5 sorting-rearrange-40 kore-functional rule-imp-transitivity ) AJKFBLMFCENGGHDQIOPRDSAJKFBLMFCENGGHTUAIIOPHDUBDUCUDUE $. $}
