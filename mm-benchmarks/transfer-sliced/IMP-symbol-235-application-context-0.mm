...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-235-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblfindChar'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String'Unds'Int ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-235-is-symbol symbol-is-pattern application-context-app-left IMP-symbol-235-is-pattern application-context-app-right notation-cache-452 notation-application-context ) GHBFCFDFBCDJAGHBFCFDAGHBFCAGHBAEKIIBCDLM $. $}
