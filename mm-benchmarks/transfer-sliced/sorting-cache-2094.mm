...
${ sorting-cache-2094 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \in-sort ( \kore-dv \kore-sort-SortInt "90" ) \kore-sort-SortInt ) ) $= ( IMP-sort-23-is-pattern string-literal-19-is-pattern kore-dv-is-pattern in-sort-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern top-is-pattern and-is-pattern imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp ) BCDBEAFGHIBCDBEJBCDBEAFGHIKBCLM $. $}
