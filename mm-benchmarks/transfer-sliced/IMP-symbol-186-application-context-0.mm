$c \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds' #Notation #SetVariable \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds'-symbol #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) ( $.
...
notation-cache-325 $a #Notation ( \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-186-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-186-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds-GT-Eqls'Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-186-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-186-is-pattern application-context-app-right application-context-app-left notation-cache-325 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
