$c #Notation \kore-symbol-Lbl'Unds'orBool'Unds' #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-Lbl'Unds'orBool'Unds'-symbol ( $.
...
notation-cache-401 $a #Notation ( \kore-symbol-Lbl'Unds'orBool'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'orBool'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-214-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-214-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds'orBool'Unds' ptn0 ptn1 ) $= ( IMP-symbol-214-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-214-is-pattern application-context-app-right application-context-app-left notation-cache-401 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
