...
${ notation-cache-162 $p #Notation ( \kore-symbol-Lbl'-LT-'k'-GT-' ptn1 ) ( \app \kore-symbol-Lbl'-LT-'k'-GT-'-symbol ptn1 ) $= ( IMP-symbol-131-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-131-is-pattern IMP-symbol-131-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
