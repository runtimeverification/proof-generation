$c "amount" \top \kore-sort-SortAExp \kore-sort-SortStmt #Variable "10" \imp \kore-dv \kore-is-sort |- \kore-sort-SortId ) \and #SetVariable #ElementVariable #Symbol #Pattern \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp \kore-inj \kore-sort-SortInt \in-sort \kore-sort-SortMap ( $.
...
sorting-cache-449 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortMap ) \top ) ) ( \in-sort ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "10" ) ) \kore-sort-SortAExp ) ) $.
${ sorting-cache-450 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortMap ) \top ) ) ( \in-sort ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "amount" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "10" ) ) ) \kore-sort-SortStmt ) ) $= ( IMP-sort-17-is-pattern kore-dv-is-pattern string-literal-14-is-pattern in-sort-is-pattern IMP-sort-23-is-pattern IMP-sort-13-is-pattern typecode-cache-Pattern-147 string-literal-13-is-pattern kore-inj-is-pattern and-is-pattern IMP-symbol-185-is-pattern IMP-sort-31-is-pattern imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp sorting-cache-449 rule-and-intro-alt2-sugar IMP-symbol-185-sorting rule-imp-transitivity ) ABICEDCFGHGJDKHFLCEDGHGJDKMNFABICEDCFGHGJDKHFCEDCFABICEDCFOCEDCFABIPCEQRABSTCEDGHGJDKUAUB $. $}
