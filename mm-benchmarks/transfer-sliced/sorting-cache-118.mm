...
sorting-cache-117 $a |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortId ) \top ) ) ) ( \and ( \kore-is-sort kore-sort-var-S2 ) \top ) ) ( \in-sort kore-element-var-T \kore-sort-SortId ) ) $.
${ sorting-cache-118 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortId ) \top ) ) ) ( \and ( \kore-is-sort kore-sort-var-S2 ) \top ) ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortId ) \top ) ) $= ( and-is-pattern kore-is-sort-is-pattern top-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-19 typecode-cache-Pattern-1 typecode-cache-Pattern-6 IMP-sort-17-is-pattern in-sort-is-pattern sorting-cache-117 top-intro rule-weakening rule-and-intro-alt2-sugar ) AHFBDIECJFGEEDKLMGABCDNAHFBDIECJFGEEGOPQ $. $}
