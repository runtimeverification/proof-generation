$c \exists #Substitution "amount" \top \kore-sort-SortAExp \kore-symbol-LblisKResult \kore-symbol-dotk \kore-symbol-kseq #Variable \kore-implies \kore-sort-SortBool \kore-bottom \kore-sort-SortK \imp \kore-dv \kore-is-sort |- \kore-sort-SortId \kore-valid ) \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp \kore-equals "false" \and \kore-and \unit-sort \kore-sort-SortKResult #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-or \kore-exists \kore-not \kore-sort-SortKItem \kore-in \kore-inj \in-sort \kore-top "balanceTo" ( $.
