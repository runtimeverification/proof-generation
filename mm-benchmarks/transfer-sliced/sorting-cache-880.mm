...
${ sorting-cache-880 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortStmt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortStmt ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortK ) \top ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortStmt ) ) $= ( in-sort-is-pattern IMP-sort-31-is-pattern and-is-pattern typecode-cache-Pattern-239 typecode-cache-Pattern-177 typecode-cache-Pattern-146 BASIC-K-sort-0-is-pattern top-is-pattern typecode-cache-Pattern-179 rule-imp-transitivity and-elim-left-sugar and-elim-right-sugar sorting-cache-870 ) AIFECDHGBJKELGGAIFECDHGDMFEAIFECDHGBJKELGOAIFECDHGCDHDMFEAIFECDHPCDQNN $. $}
