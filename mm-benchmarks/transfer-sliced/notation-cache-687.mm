...
${ notation-cache-687 $p #Notation ( \kore-symbol-Lblproject'Coln'KItem ptn2 ) ( \app \kore-symbol-Lblproject'Coln'KItem-symbol ptn2 ) $= ( IMP-symbol-322-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-322-is-pattern IMP-symbol-322-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
