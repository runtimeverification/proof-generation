...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-143-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblMap'Coln'update ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-143-is-symbol symbol-is-pattern application-context-app-left IMP-symbol-143-is-pattern application-context-app-right notation-cache-196 notation-application-context ) GHBFCFDFBCDJAGHBFCFDAGHBFCAGHBAEKIIBCDLM $. $}
