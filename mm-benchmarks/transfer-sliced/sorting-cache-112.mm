...
${ sorting-cache-112 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S2 ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortId ) \top ) ) ) ) ( \in-sort kore-element-var-T \kore-sort-SortId ) ) $= ( kore-is-sort-is-pattern typecode-cache-Pattern-19 typecode-cache-Pattern-1 and-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-6 IMP-sort-17-is-pattern in-sort-is-pattern and-elim-right-sugar rule-imp-transitivity sorting-cache-111 ) AIECGEBDFHHCGEBDFHDJKLAIECGEBDFHMCGEBDFHBDFDJKLCGEBDFMBDONN $. $}
