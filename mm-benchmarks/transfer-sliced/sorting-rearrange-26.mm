$c \exists #Substitution \top #Variable "10" \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-sort-SortInt ( $.
...
sorting-rearrange-25 $a |- ( \imp ( \and \top ( \and ( \kore-is-sort kore-sort-var-x0 ) \top ) ) ( \kore-valid kore-sort-var-x0 ( \kore-exists \kore-sort-SortInt kore-sort-var-x0 kore-element-var-x1 ( \kore-equals \kore-sort-SortInt kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "10" ) ) ) ) ) $.
substitution-116 $a #Substitution \kore-sort-SortInt \kore-sort-SortInt \unit-sort kore-sort-var-x0 $.
substitution-117 $a #Substitution ( \kore-equals \kore-sort-SortInt \unit-sort kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "10" ) ) ( \kore-equals \kore-sort-SortInt kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "10" ) ) \unit-sort kore-sort-var-x0 $.
substitution-118 $a #Substitution \kore-sort-SortInt \kore-sort-SortInt kore-sort-var-x1 kore-sort-var-x0 $.
substitution-119 $a #Substitution ( \kore-equals \kore-sort-SortInt kore-sort-var-x1 kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "10" ) ) ( \kore-equals \kore-sort-SortInt kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "10" ) ) kore-sort-var-x1 kore-sort-var-x0 $.
${ sorting-rearrange-26 $p |- ( \imp \top ( \kore-valid \unit-sort ( \kore-exists \kore-sort-SortInt \unit-sort kore-element-var-x1 ( \kore-equals \kore-sort-SortInt \unit-sort kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "10" ) ) ) ) ) $= ( IMP-sort-23-is-pattern kore-sort-var-x0-elementvariable unit-sort-is-symbol symbol-is-pattern typecode-cache-Pattern-14 kore-sort-var-x1-elementvariable typecode-cache-Pattern-24 top-is-pattern typecode-cache-Pattern-23 string-literal-13-is-pattern kore-dv-is-pattern kore-equals-is-pattern kore-exists-is-pattern and-is-pattern element-var-is-var kore-is-sort-is-pattern kore-valid-is-pattern x-is-element-var substitution-var-same rule-weakening substitution-kore-exists-alt substitution-kore-valid substitution-imp top-intro sorting-cache-129 rule-and-intro-alt2-sugar typecode-cache-Pattern-22 exists-is-pattern unit-sort-is-functional sorting-rearrange-25 substitution-60 substitution-116 substitution-117 substitution-66 substitution-118 substitution-119 functional-substitution-alt rule-imp-transitivity )  $. $}
