...
${ sorting-cache-1566 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \kore-is-sort \kore-sort-SortInt ) ( \kore-is-sort \kore-sort-SortKResult ) ) ) $= ( kore-is-sort-is-pattern typecode-cache-Pattern-0 top-is-pattern and-is-pattern IMP-sort-23-is-pattern IMP-sort-28-is-pattern sorting-cache-316 sorting-cache-1565 rule-and-intro-alt2-sugar ) ACBDEFBGBAHAIJ $. $}
