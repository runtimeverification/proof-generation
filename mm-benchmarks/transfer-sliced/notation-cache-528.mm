...
${ notation-cache-528 $p #Notation ( \kore-symbol-LblisIds ptn2 ) ( \app \kore-symbol-LblisIds-symbol ptn2 ) $= ( IMP-symbol-264-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-264-is-pattern IMP-symbol-264-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
