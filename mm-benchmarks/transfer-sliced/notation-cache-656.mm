...
${ notation-cache-656 $p #Notation ( \kore-symbol-Lblproject'Coln'IOError ptn1 ) ( \app \kore-symbol-Lblproject'Coln'IOError-symbol ptn1 ) $= ( IMP-symbol-312-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-312-is-pattern IMP-symbol-312-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
