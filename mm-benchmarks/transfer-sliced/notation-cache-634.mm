...
${ notation-cache-634 $p #Notation ( \kore-symbol-Lblproject'Coln'BExp ptn0 ) ( \app \kore-symbol-Lblproject'Coln'BExp-symbol ptn0 ) $= ( IMP-symbol-304-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-304-is-pattern IMP-symbol-304-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
