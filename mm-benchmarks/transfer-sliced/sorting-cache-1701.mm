...
${ sorting-cache-1701 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) \top ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-253 BASIC-K-sort-1-is-pattern typecode-cache-Pattern-357 typecode-cache-Pattern-356 IMP-sort-18-is-pattern top-is-pattern and-is-pattern and-elim-left-sugar imp-reflexivity rule-imp-transitivity ) ABFADECADECADECBGHCIJKADECLM $. $}
