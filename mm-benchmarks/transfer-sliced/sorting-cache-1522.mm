...
${ sorting-cache-1522 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) \top ) ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ) $= ( and-is-pattern in-sort-is-pattern top-is-pattern typecode-cache-Pattern-324 typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-253 BASIC-K-sort-1-is-pattern typecode-cache-Pattern-179 IMP-sort-13-is-pattern and-elim-left-sugar rule-imp-transitivity rule-and-intro-alt2-sugar sorting-cache-1474 sorting-cache-1478 top-intro rule-weakening ) BCGAHIEFDDBLMECJKEFDBCGAHIEFDDBCGBLMEBCGAHIEFDNBCQOBCGAHIEFDDCJKEFBCGAHIEFDDBCGCJKEBCGAHIEFDNBCROBCGAHIEFDDFSTPP $. $}
