...
${ notation-cache-242 $p #Notation ( \kore-symbol-Lbl'UndsPlus'String'UndsUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsPlus'String'UndsUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-159-is-symbol symbol-is-pattern IMP-symbol-159-is-pattern IMP-symbol-159-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
