...
${ sorting-cache-1955 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) \top ) ) ) ( \and ( \and ( \kore-is-sort \kore-sort-SortId ) ( \kore-is-sort \kore-sort-SortAExp ) ) ( \in-sort ( \kore-dv \kore-sort-SortId "balanceTo" ) \kore-sort-SortId ) ) ) $= ( IMP-sort-17-is-pattern IMP-sort-13-is-pattern in-sort-is-pattern kore-is-sort-is-pattern and-is-pattern typecode-cache-Pattern-177 typecode-cache-Pattern-397 string-literal-17-is-pattern kore-dv-is-pattern imp-is-pattern proof-rule-prop-1 proof-rule-mp rule-and-intro-alt2-sugar IMP-sort-17-sort IMP-sort-13-sort kore-dv-sorting ) AIEFBCJHDGEGHDKLDFAIEFBCJHDGEGDGAIEFBCJHDGMDGAIEFBCJHNQOEGAIEFBCJHEGMEGAIEFBCJHNROPDKLDFAIEFBCJHDKLDFMDKLDFAIEFBCJHNDKSOP $. $}
