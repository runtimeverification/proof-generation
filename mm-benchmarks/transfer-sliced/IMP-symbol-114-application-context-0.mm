$c #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app \kore-symbol-Lbl'Hash'systemResult-symbol ) \kore-symbol-Lbl'Hash'systemResult ( $.
...
notation-cache-128 $a #Notation ( \kore-symbol-Lbl'Hash'systemResult ptn0 ptn1 ptn2 ) ( \app ( \app ( \app \kore-symbol-Lbl'Hash'systemResult-symbol ptn0 ) ptn1 ) ptn2 ) $.
${ $d xX0 ptn1 $.
   $d xX0 ptn2 $.
   IMP-symbol-114-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-114-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Hash'systemResult ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-114-is-symbol symbol-is-pattern application-context-app-left IMP-symbol-114-is-pattern application-context-app-right notation-cache-128 notation-application-context ) GHBFCFDFBCDJAGHBFCFDAGHBFCAGHBAEKIIBCDLM $. $}
