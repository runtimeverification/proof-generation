...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-100-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Hash'logToFile ptn0 ptn1 ) $= ( IMP-symbol-100-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-100-is-pattern application-context-app-right application-context-app-left notation-cache-97 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
