...
${ sorting-rearrange-304 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \exists kore-element-var-Val ( \eq kore-element-var-Val \kore-symbol-Lbl'Stop'Map ) ) ) $= ( top-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern and-is-pattern IMP-symbol-124-is-pattern typecode-cache-Pattern-31 eq-is-pattern exists-is-pattern top-intro rule-weakening IMP-sort-14-is-pattern sorting-cache-44 sorting-rearrange-52 kore-functional rule-imp-transitivity ) ADECFCBHGIBJADECFCKLMGCBNBOPQ $. $}
