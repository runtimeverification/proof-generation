...
${ notation-cache-206 $p #Notation ( \kore-symbol-LblString2Base'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'Int ptn1 ptn2 ) ( \app ( \app \kore-symbol-LblString2Base'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'Int-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-147-is-symbol symbol-is-pattern IMP-symbol-147-is-pattern IMP-symbol-147-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
