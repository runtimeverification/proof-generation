...
${ notation-cache-2 $p #Notation ( \kore-symbol-kseq ptn0 ptn1 ) ( \app ( \app \kore-symbol-kseq-symbol ptn0 ) ptn1 ) $= ( KSEQ-symbol-0-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app KSEQ-symbol-0-is-pattern KSEQ-symbol-0-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
