...
${ $d xX0 ptn0 $.
   ...
   IMP-symbol-183-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsEqlsEqls'String'UndsUnds'STRING-COMMON'Unds'Bool'Unds'String'Unds'String ptn0 ptn1 ) $= ( app-is-pattern IMP-symbol-183-is-symbol symbol-is-pattern IMP-symbol-183-is-pattern application-context-app-right notation-cache-316 notation-application-context ) FGBECEBCHAFGBECADIBCJK $. $}
