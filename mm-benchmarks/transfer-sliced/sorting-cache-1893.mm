...
${ sorting-cache-1893 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) \top ) ( \in-sort ( \kore-dv \kore-sort-SortId "amount" ) \kore-sort-SortId ) ) $= ( IMP-sort-17-is-pattern in-sort-is-pattern string-literal-14-is-pattern kore-dv-is-pattern typecode-cache-Pattern-179 IMP-sort-18-is-pattern top-is-pattern and-is-pattern imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp ) BDEBCAFGCHIBDEBCJBDEBCAFGCHIKBDLM $. $}
