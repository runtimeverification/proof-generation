...
sorting-cache-1087 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K3 \kore-sort-SortMap ) \top ) ) ( \in-sort ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "100" ) ) \kore-sort-SortKItem ) ) $.
${ sorting-cache-1088 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K3 \kore-sort-SortMap ) \top ) ) ( \in-sort ( \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "100" ) ) ) \kore-sort-SortMap ) ) $= ( BASIC-K-sort-1-is-pattern IMP-sort-17-is-pattern kore-dv-is-pattern kore-inj-is-pattern IMP-sort-23-is-pattern in-sort-is-pattern string-literal-10-is-pattern string-literal-16-is-pattern typecode-cache-Pattern-215 and-is-pattern IMP-symbol-218-is-pattern IMP-sort-14-is-pattern sorting-cache-1033 sorting-cache-1087 rule-and-intro-alt2-sugar IMP-symbol-218-sorting rule-imp-transitivity ) ABKDCDIEFCHGCGJEFCHLDCDIEFGCGJEFMNHABKDCDIEFCHGCGJEFCHABOABPQDCDIEFGCGJEFRS $. $}
