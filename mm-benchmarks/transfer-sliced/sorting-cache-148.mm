...
sorting-cache-147 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S2 ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ) ) ( \kore-is-sort kore-sort-var-S3 ) ) $.
${ sorting-cache-148 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S2 ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ) ) ( \and ( \kore-is-sort kore-sort-var-S3 ) \top ) ) $= ( kore-is-sort-is-pattern and-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-1 typecode-cache-Pattern-28 top-is-pattern typecode-cache-Pattern-2 sorting-cache-147 top-intro rule-weakening rule-and-intro-alt2-sugar ) AGECHEBDIFFBKEJABCDLAGECHEBDIFFJMNO $. $}
