$c #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-Lbl'Unds'impliesBool'Unds'-symbol \kore-symbol-Lbl'Unds'impliesBool'Unds' ( $.
...
notation-cache-386 $a #Notation ( \kore-symbol-Lbl'Unds'impliesBool'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'impliesBool'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-209-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-209-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds'impliesBool'Unds' ptn0 ptn1 ) $= ( IMP-symbol-209-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-209-is-pattern application-context-app-right application-context-app-left notation-cache-386 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
