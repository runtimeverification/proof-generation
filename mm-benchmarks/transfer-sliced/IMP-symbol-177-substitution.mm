$c #Substitution #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds'-symbol #Variable #Pattern \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds' \app ) ( $.
...
notation-cache-296 $a #Notation ( \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-297 $a #Notation ( \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsSlshEqls'Int'Unds'-symbol ptn3 ) ptn4 ) $.
