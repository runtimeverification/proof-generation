...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-196-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsLSqBUnds-LT-'-'UndsRSqB' ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-196-is-symbol symbol-is-pattern application-context-app-left IMP-symbol-196-is-pattern application-context-app-right notation-cache-353 notation-application-context ) GHBFCFDFBCDJAGHBFCFDAGHBFCAGHBAEKIIBCDLM $. $}
