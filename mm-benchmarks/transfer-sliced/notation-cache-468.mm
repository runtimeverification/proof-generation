...
${ notation-cache-468 $p #Notation ( \kore-symbol-LblinitGeneratedTopCell ptn2 ) ( \app \kore-symbol-LblinitGeneratedTopCell-symbol ptn2 ) $= ( IMP-symbol-243-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-243-is-pattern IMP-symbol-243-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
