...
${ sorting-cache-359 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortBlock ) \top ) ) ) ( \in-sort kore-element-var-K1 \kore-sort-SortBlock ) ) $= ( IMP-sort-18-is-pattern in-sort-is-pattern typecode-cache-Pattern-49 and-is-pattern typecode-cache-Pattern-120 top-is-pattern rule-imp-transitivity typecode-cache-Pattern-121 typecode-cache-Pattern-0 kore-is-sort-is-pattern and-elim-right-sugar and-elim-left-sugar imp-reflexivity ) ABCKBFDECHDEIGGBFDEALMBFDECHDEIGGNBFDECHDEIGGBFDEBFDEBFDECHDEIGOBFDEPJJ $. $}
