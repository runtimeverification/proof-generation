...
${ sorting-cache-414 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \in-sort ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "addressTo" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "12345" ) ) ) \kore-sort-SortStmt ) ) $= ( kore-dv-is-pattern IMP-sort-23-is-pattern IMP-sort-17-is-pattern IMP-sort-13-is-pattern in-sort-is-pattern string-literal-18-is-pattern string-literal-12-is-pattern kore-inj-is-pattern and-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern top-is-pattern IMP-symbol-185-is-pattern IMP-sort-31-is-pattern sorting-cache-413 sorting-cache-320 rule-and-intro-alt2-sugar IMP-symbol-185-sorting rule-imp-transitivity ) AKLMJDGBDFCECHBIEFJDGBCECHBINOFAKLMJDGBDFCECHBIEFAPAQRDGBCECHBIST $. $}
