...
${ notation-cache-19 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'UndsPercUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp0'Unds' ptn1 ) ( \app \kore-symbol-Lbl'Hash'freezer'UndsPercUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp0'Unds'-symbol ptn1 ) $= ( IMP-symbol-74-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-74-is-pattern IMP-symbol-74-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
