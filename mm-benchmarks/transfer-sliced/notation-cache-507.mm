...
${ notation-cache-507 $p #Notation ( \kore-symbol-LblisGeneratedTopCell ptn2 ) ( \app \kore-symbol-LblisGeneratedTopCell-symbol ptn2 ) $= ( IMP-symbol-257-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-257-is-pattern IMP-symbol-257-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
