$c #Notation \kore-symbol-Lbl'UndsStar'Int'Unds'-symbol #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \kore-symbol-Lbl'UndsStar'Int'Unds' \app ) ( $.
...
notation-cache-235 $a #Notation ( \kore-symbol-Lbl'UndsStar'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsStar'Int'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-156-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-156-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsStar'Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-156-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-156-is-pattern application-context-app-right application-context-app-left notation-cache-235 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
