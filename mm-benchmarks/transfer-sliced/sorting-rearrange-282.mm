...
${ sorting-rearrange-282 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ( \kore-valid kore-sort-var-R ( \kore-and kore-sort-var-R ( \kore-equals \kore-sort-SortStateCell kore-sort-var-R \kore-symbol-LblinitStateCell ( \kore-symbol-Lbl'-LT-'state'-GT-' \kore-symbol-Lbl'Stop'Map ) ) ( \kore-top kore-sort-var-R ) ) ) ) $= ( typecode-cache-Pattern-0 top-is-pattern and-is-pattern kore-is-sort-is-pattern IMP-sort-9-is-pattern IMP-symbol-245-is-pattern IMP-symbol-124-is-pattern IMP-symbol-132-is-pattern kore-equals-is-pattern kore-top-is-pattern kore-and-is-pattern kore-valid-is-pattern sorting-cache-527 top-intro rule-weakening rule-and-intro-alt2-sugar sorting-rearrange-281 rule-imp-transitivity ) ABECDCDABECDABABFABGHIJABKLMABECDCDABECANABECDCDCOPQARS $. $}
