$c #Substitution \kore-sort-SortKResult \top #SetVariable #ElementVariable #Symbol #Variable #Pattern ( \kore-is-sort ) \and $.
...
${ substitution-952 $p #Substitution ( \and ( \kore-is-sort \kore-sort-SortKResult ) \top ) ( \and ( \kore-is-sort kore-sort-var-S2 ) \top ) \kore-sort-SortKResult kore-sort-var-S2 $= ( IMP-sort-28-is-pattern element-var-is-var top-is-pattern kore-is-sort-is-pattern typecode-cache-Pattern-1 substitution-var-same substitution-kore-is-sort substitution-disjoint substitution-and ) BBEDAFEDACBAFBACBACGHDBACIJ $. $}
