...
${ substitution-1 $p #Substitution ( \in-sort kore-element-var-T \kore-sort-SortId ) ( \in-sort kore-element-var-T kore-sort-var-S1 ) \kore-sort-SortId kore-sort-var-S1 $= ( IMP-sort-17-is-pattern typecode-cache-Pattern-6 element-var-is-var typecode-cache-Pattern-5 substitution-0 substitution-var-same substitution-in-sort ) CBDCBDAFAEABGCAEHI $. $}
