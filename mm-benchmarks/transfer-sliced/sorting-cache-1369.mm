...
${ sorting-cache-1369 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) \top ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-253 IMP-sort-14-is-pattern top-is-pattern and-is-pattern rule-imp-transitivity typecode-cache-Pattern-308 typecode-cache-Pattern-179 IMP-sort-17-is-pattern and-elim-right-sugar and-elim-left-sugar imp-reflexivity ) ABIBDECFGBDECAJKCBDECFGLBDECFGBDECBDECBDECFMBDECNHH $. $}
