$c \exists "1" #Substitution \top \kore-sort-SortAExp #Variable \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-inj \kore-sort-SortInt ( $.
...
sorting-rearrange-238 $a |- ( \imp ( \and \top ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortAExp kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortAExp kore-sort-var-R kore-element-var-Val ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "1" ) ) ) ) ) ) $.
${ sorting-rearrange-239 $p |- ( \imp \top ( \kore-valid \unit-sort ( \kore-exists \kore-sort-SortAExp \unit-sort kore-element-var-Val ( \kore-equals \kore-sort-SortAExp \unit-sort kore-element-var-Val ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "1" ) ) ) ) ) ) $= ( IMP-sort-13-is-pattern kore-sort-var-R-elementvariable IMP-sort-23-is-pattern unit-sort-is-symbol symbol-is-pattern kore-sort-var-x0-elementvariable typecode-cache-Pattern-0 string-literal-4-is-pattern kore-dv-is-pattern kore-inj-is-pattern typecode-cache-Pattern-14 typecode-cache-Pattern-31 top-is-pattern kore-equals-is-pattern element-var-is-var kore-exists-is-pattern and-is-pattern kore-is-sort-is-pattern kore-valid-is-pattern substitution-var-same x-is-element-var rule-weakening substitution-286 substitution-disjoint substitution-kore-equals substitution-kore-exists-alt substitution-kore-valid substitution-imp substitution-287 top-intro sorting-cache-129 rule-and-intro-alt2-sugar typecode-cache-Pattern-22 exists-is-pattern unit-sort-is-functional sorting-rearrange-238 substitution-83 substitution-141 substitution-87 substitution-145 functional-substitution-alt rule-imp-transitivity )  $. $}
