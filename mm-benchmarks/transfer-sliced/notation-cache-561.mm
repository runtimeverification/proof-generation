...
${ notation-cache-561 $p #Notation ( \kore-symbol-LblisSet ptn2 ) ( \app \kore-symbol-LblisSet-symbol ptn2 ) $= ( IMP-symbol-275-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-275-is-pattern IMP-symbol-275-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
