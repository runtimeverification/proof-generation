...
sorting-cache-1503 $a |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) $.
${ sorting-cache-1504 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-324 typecode-cache-Pattern-178 IMP-sort-9-is-pattern and-is-pattern typecode-cache-Pattern-179 IMP-sort-13-is-pattern typecode-cache-Pattern-253 BASIC-K-sort-1-is-pattern top-is-pattern and-elim-right-sugar sorting-cache-1474 rule-imp-transitivity sorting-cache-1503 rule-and-intro-alt2-sugar ) AFGDBCEHBIJDCKLDMHAFGDBCEHBCEBIJDAFGDBCENBCOPABCQR $. $}
