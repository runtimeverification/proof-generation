...
${ notation-cache-457 $p #Notation ( \kore-symbol-LblfreshInt'LParUndsRParUnds'INT'Unds'Int'Unds'Int ptn1 ) ( \app \kore-symbol-LblfreshInt'LParUndsRParUnds'INT'Unds'Int'Unds'Int-symbol ptn1 ) $= ( IMP-symbol-238-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-238-is-pattern IMP-symbol-238-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
