$c #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-Lbl'UndsEqlsEqls'Bool'Unds'-symbol \kore-symbol-Lbl'UndsEqlsEqls'Bool'Unds' ( $.
...
notation-cache-307 $a #Notation ( \kore-symbol-Lbl'UndsEqlsEqls'Bool'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsEqls'Bool'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-180-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-180-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsEqlsEqls'Bool'Unds' ptn0 ptn1 ) $= ( IMP-symbol-180-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-180-is-pattern application-context-app-right application-context-app-left notation-cache-307 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
