...
${ notation-cache-253 $p #Notation ( \kore-symbol-Lbl'Unds'-Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'-Int'Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-162-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-162-is-pattern IMP-symbol-162-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
