...
${ notation-cache-694 $p #Notation ( \kore-symbol-Lblproject'Coln'List ptn0 ) ( \app \kore-symbol-Lblproject'Coln'List-symbol ptn0 ) $= ( IMP-symbol-324-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-324-is-pattern IMP-symbol-324-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
