...
${ notation-cache-121 $p #Notation ( \kore-symbol-Lbl'Hash'seekEnd'LParUndsCommUndsRParUnds'K-IO'Unds'K'Unds'Int'Unds'Int ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Hash'seekEnd'LParUndsCommUndsRParUnds'K-IO'Unds'K'Unds'Int'Unds'Int-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-108-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-108-is-pattern IMP-symbol-108-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
