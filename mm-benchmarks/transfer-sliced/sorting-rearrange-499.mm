...
${ sorting-rearrange-499 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortStmt ) \top ) ) ( \exists kore-element-var-Val ( \eq kore-element-var-Val ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "addressTo" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "12345" ) ) ) ) ) ) $= ( kore-dv-is-pattern IMP-sort-23-is-pattern top-is-pattern typecode-cache-Pattern-239 IMP-sort-17-is-pattern string-literal-18-is-pattern IMP-sort-13-is-pattern string-literal-12-is-pattern kore-inj-is-pattern IMP-symbol-185-is-pattern typecode-cache-Pattern-31 eq-is-pattern exists-is-pattern top-intro rule-weakening IMP-sort-31-is-pattern sorting-cache-17 sorting-rearrange-122 kore-functional rule-imp-transitivity ) ABGFCNHIDEJEKDLMOCPABGFQRSHIDEJEKDLMFCTCUAUBUC $. $}
