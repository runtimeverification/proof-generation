...
${ notation-cache-76 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'Unds-GT-EqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds' ptn1 ) ( \app \kore-symbol-Lbl'Hash'freezer'Unds-GT-EqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds'-symbol ptn1 ) $= ( IMP-symbol-93-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-93-is-pattern IMP-symbol-93-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
