...
${ typecode-cache-Pattern-98 $p #Pattern ( \kore-symbol-Lbl'UndsUndsUnds'IMP-SYNTAX'Unds'Stmt'Unds'Stmt'Unds'Stmt kore-element-var-K0 kore-element-var-K1 ) $= ( typecode-cache-Pattern-51 typecode-cache-Pattern-49 IMP-symbol-204-is-pattern ) ACBDE $. $}
