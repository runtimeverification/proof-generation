...
${ sorting-cache-1014 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortInt ) \top ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-254 typecode-cache-Pattern-178 IMP-sort-17-is-pattern typecode-cache-Pattern-177 IMP-sort-23-is-pattern top-is-pattern typecode-cache-Pattern-253 IMP-sort-14-is-pattern rule-imp-transitivity and-elim-left-sugar and-elim-right-sugar sorting-cache-966 ) BHIECDGFAJKELFFBHIECDGFDMNEBHIECDGFAJKELFPBHIECDGFCDGDMNEBHIECDGQCDROO $. $}
