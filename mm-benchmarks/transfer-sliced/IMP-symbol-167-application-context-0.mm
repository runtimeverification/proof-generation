$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'Unds-LT--LT-'Int'Unds'-symbol #Variable #Pattern #ApplicationContext \kore-symbol-Lbl'Unds-LT--LT-'Int'Unds' \app ) ( $.
...
notation-cache-268 $a #Notation ( \kore-symbol-Lbl'Unds-LT--LT-'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds-LT--LT-'Int'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-167-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-167-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds-LT--LT-'Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-167-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-167-is-pattern application-context-app-right application-context-app-left notation-cache-268 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
