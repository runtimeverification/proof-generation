$c #Substitution #SetVariable #ElementVariable #Symbol \kore-symbol-kseq #Variable #Pattern \kore-exists \kore-sort-SortK \kore-sort-SortKItem \kore-dv \kore-sort-SortId ) \kore-equals \kore-inj "balanceTo" ( $.
