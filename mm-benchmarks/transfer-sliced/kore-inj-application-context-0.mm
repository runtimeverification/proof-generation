...
$v ph0 xX xX0 ph2 sg0 ptn1 ptn2 ptn0 ph1 $.
...
${ $d xX0 ptn1 $.
   ...
   kore-inj-application-context-0 $p #ApplicationContext xX0 ( \kore-inj ptn0 ptn1 ptn2 ) $= ( app-is-pattern kore-inj-is-symbol symbol-is-pattern application-context-app-left kore-inj-is-pattern application-context-app-right notation-cache-6 notation-application-context ) GHBFCFDFBCDJAGHBFCFDAGHBFCAGHBAEKIIBCDLM $. $}
