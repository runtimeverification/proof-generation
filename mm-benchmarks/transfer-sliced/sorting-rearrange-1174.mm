$c \exists "amount" "balanceSender" \top \ceil \kore-sort-SortAExp \kore-symbol-kseq #Variable \kore-sort-SortK \imp \kore-dv |- \kore-sort-SortId \kore-valid ) \kore-equals \unit-sort \kore-sort-SortKResult #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-sort-SortKItem \kore-inj \kore-symbol-Lbl'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp \in-sort \kore-symbol-dotk ( $.
...
${ sorting-rearrange-1174 $p |- ( \imp ( \in-sort kore-element-var-VE2 \kore-sort-SortKResult ) ( \ceil ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortAExp \kore-sort-SortKItem ( \kore-symbol-Lbl'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) ) ) \kore-symbol-dotk ) ) ) $= ( IMP-sort-17-is-pattern IMP-sort-13-is-pattern kore-inj-is-pattern kore-dv-is-pattern top-is-pattern BASIC-K-sort-1-is-pattern string-literal-10-is-pattern string-literal-14-is-pattern IMP-symbol-164-is-pattern KSEQ-symbol-1-is-pattern KSEQ-symbol-0-is-pattern kore-element-var-V0-elementvariable typecode-cache-Pattern-177 IMP-sort-28-is-pattern in-sort-is-pattern ceil-is-pattern sorting-cache-1192 BASIC-K-sort-0-is-pattern sorting-cache-2016 sorting-rearrange-1170 kore-functional functional-imp-nonempty-alt rule-imp-transitivity ) ANOPFCGBCBHEDBCBIEDJDKLQARCGBCBHEDBCBIEDJDKLFMSCGBCBHEDBCBIEDJDKLFMTMUAUBUCUD $. $}
