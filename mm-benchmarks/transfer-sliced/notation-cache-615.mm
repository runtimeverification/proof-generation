...
${ notation-cache-615 $p #Notation ( \kore-symbol-LblordChar'LParUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String ptn2 ) ( \app \kore-symbol-LblordChar'LParUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String-symbol ptn2 ) $= ( IMP-symbol-298-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-298-is-pattern IMP-symbol-298-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
