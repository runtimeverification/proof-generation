$c \top #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-exists "90" \and \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-sort-SortInt \kore-equals ( $.
...
${ sorting-rearrange-1253 $p |- ( \imp ( \and \top ( \and ( \kore-is-sort kore-sort-var-x0 ) \top ) ) ( \kore-valid kore-sort-var-x0 ( \kore-exists \kore-sort-SortInt kore-sort-var-x0 kore-element-var-x1 ( \kore-equals \kore-sort-SortInt kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "90" ) ) ) ) ) $= ( top-is-pattern typecode-cache-Pattern-14 and-is-pattern kore-is-sort-is-pattern IMP-sort-23-is-pattern typecode-cache-Pattern-23 string-literal-19-is-pattern kore-dv-is-pattern kore-equals-is-pattern kore-exists-is-pattern kore-valid-is-pattern sorting-cache-127 top-intro rule-weakening rule-and-intro-alt2-sugar domain-value-21-functional rule-imp-transitivity ) CADFCEEADFCEADGADGADBHGIJKBLMCADFCEEADFCANCADFCEECOPQABRS $. $}
