...
sorting-cache-358 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortBlock ) \top ) ) ) ( \kore-is-sort kore-sort-var-R ) ) $.
sorting-cache-362 $a |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortBlock ) \top ) ) ) ( \and ( \in-sort kore-element-var-K0 \kore-sort-SortBExp ) \top ) ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortBlock ) \top ) ) ) $.
...
${ sorting-cache-363 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortBlock ) \top ) ) ) ( \and ( \in-sort kore-element-var-K0 \kore-sort-SortBExp ) \top ) ) ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K0 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortBlock ) \top ) ) ) ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-51 IMP-sort-22-is-pattern and-is-pattern top-is-pattern typecode-cache-Pattern-121 rule-imp-transitivity typecode-cache-Pattern-0 kore-is-sort-is-pattern and-elim-left-sugar IMP-sort-18-is-pattern rule-and-intro-alt2-sugar typecode-cache-Pattern-122 sorting-cache-358 typecode-cache-Pattern-49 typecode-cache-Pattern-120 and-elim-right-sugar imp-reflexivity sorting-cache-362 ) ACDJBFGEIHHALMBCDQACDJBFGEIHHACDJALMACDJBFGEIHNACDRKACDJBFGEIHHBFGECSOEDTOEIHHACDJBFGEIHHBFGEIHBFGEACDJBFGEIHUABFGEIHBFGEBFGEBFGEINBFGEUBKKABCDUCPP $. $}
