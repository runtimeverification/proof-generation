...
${ sorting-cache-184 $p |- ( \imp \top ( \in-sort ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortStmt \kore-sort-SortKItem ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "ret" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "1" ) ) ) ) \kore-symbol-dotk ) \kore-sort-SortK ) ) $= ( kore-dv-is-pattern IMP-sort-23-is-pattern kore-inj-is-pattern BASIC-K-sort-1-is-pattern in-sort-is-pattern IMP-sort-31-is-pattern IMP-sort-17-is-pattern string-literal-11-is-pattern IMP-sort-13-is-pattern string-literal-4-is-pattern IMP-symbol-185-is-pattern KSEQ-symbol-1-is-pattern BASIC-K-sort-0-is-pattern top-is-pattern and-is-pattern KSEQ-symbol-0-is-pattern sorting-cache-183 sorting-cache-43 rule-and-intro-alt2-sugar KSEQ-symbol-0-sorting rule-imp-transitivity ) NFDGHABIBJACKCDELMEOFDGHABIBJACKCLPMENFDGHABIBJACKCDELMEQRSFDGHABIBJACKCLTUA $. $}
