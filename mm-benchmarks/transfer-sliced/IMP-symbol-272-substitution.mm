$c #Substitution #Notation \kore-symbol-LblisList #SetVariable #ElementVariable #Symbol \kore-symbol-LblisList-symbol #Variable #Pattern \app ) ( $.
...
notation-cache-551 $a #Notation ( \kore-symbol-LblisList ptn1 ) ( \app \kore-symbol-LblisList-symbol ptn1 ) $.
notation-cache-552 $a #Notation ( \kore-symbol-LblisList ptn2 ) ( \app \kore-symbol-LblisList-symbol ptn2 ) $.
${ IMP-symbol-272-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-272-substitution $p #Substitution ( \kore-symbol-LblisList ptn1 ) ( \kore-symbol-LblisList ptn2 ) ptn0 xX0 $= ( IMP-symbol-272-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-272-is-pattern substitution-disjoint substitution-app notation-cache-551 notation-cache-552 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
