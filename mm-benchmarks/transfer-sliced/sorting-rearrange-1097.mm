$c \top #Variable \kore-sort-SortBool \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals "false" \and \kore-sort-SortKResult #SetVariable #ElementVariable #Symbol #Pattern \kore-exists \kore-inj ( $.
