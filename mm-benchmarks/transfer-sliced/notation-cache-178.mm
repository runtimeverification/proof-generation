$c #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \app \kore-symbol-LblFloat2String'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'Float'Unds'String \kore-symbol-LblFloat2String'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'Float'Unds'String-symbol ) ( $.
...
${ notation-cache-178 $p #Notation ( \kore-symbol-LblFloat2String'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'Float'Unds'String ptn3 ptn4 ) ( \app ( \app \kore-symbol-LblFloat2String'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'Float'Unds'String-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-136-is-symbol symbol-is-pattern IMP-symbol-136-is-pattern IMP-symbol-136-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
