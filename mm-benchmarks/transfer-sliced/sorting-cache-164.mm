...
sorting-cache-163 $a |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ( \and ( \kore-is-sort kore-sort-var-S3 ) \top ) ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) $.
${ sorting-cache-164 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ( \and ( \kore-is-sort kore-sort-var-S3 ) \top ) ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ) $= ( typecode-cache-Pattern-2 kore-is-sort-is-pattern and-is-pattern top-is-pattern typecode-cache-Pattern-30 rule-imp-transitivity typecode-cache-Pattern-6 IMP-sort-23-is-pattern in-sort-is-pattern and-elim-right-sugar and-elim-left-sugar imp-reflexivity sorting-cache-163 rule-and-intro-alt2-sugar ) ACHBDEGFFBDECJKLGFACHBDEGFFBDEGFBDEACHBDEGFMBDEGFBDEBDEBDEGNBDEOIIABCPQ $. $}
