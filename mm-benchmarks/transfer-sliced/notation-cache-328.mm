...
${ notation-cache-328 $p #Notation ( \kore-symbol-Lbl'Unds-GT-Eqls'String'UndsUnds'STRING-COMMON'Unds'Bool'Unds'String'Unds'String ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds-GT-Eqls'String'UndsUnds'STRING-COMMON'Unds'Bool'Unds'String'Unds'String-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-187-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-187-is-pattern IMP-symbol-187-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
