$c #Substitution #Notation #SetVariable \kore-symbol-LblisArray-symbol #ElementVariable #Symbol #Variable #Pattern \app \kore-symbol-LblisArray ) ( $.
...
notation-cache-485 $a #Notation ( \kore-symbol-LblisArray ptn1 ) ( \app \kore-symbol-LblisArray-symbol ptn1 ) $.
notation-cache-486 $a #Notation ( \kore-symbol-LblisArray ptn2 ) ( \app \kore-symbol-LblisArray-symbol ptn2 ) $.
${ IMP-symbol-250-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-250-substitution $p #Substitution ( \kore-symbol-LblisArray ptn1 ) ( \kore-symbol-LblisArray ptn2 ) ptn0 xX0 $= ( IMP-symbol-250-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-250-is-pattern substitution-disjoint substitution-app notation-cache-485 notation-cache-486 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
