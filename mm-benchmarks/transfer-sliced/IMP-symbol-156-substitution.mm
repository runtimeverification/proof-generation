$c #Substitution #Notation \kore-symbol-Lbl'UndsStar'Int'Unds'-symbol #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-Lbl'UndsStar'Int'Unds' \app ) ( $.
...
notation-cache-233 $a #Notation ( \kore-symbol-Lbl'UndsStar'Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsStar'Int'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-234 $a #Notation ( \kore-symbol-Lbl'UndsStar'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsStar'Int'Unds'-symbol ptn3 ) ptn4 ) $.
