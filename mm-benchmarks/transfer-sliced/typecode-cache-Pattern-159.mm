$c \kore-sort-SortK #SetVariable #ElementVariable #Symbol ) \kore-equals \kore-symbol-kseq #Variable #Pattern ( $.
...
${ typecode-cache-Pattern-159 $p #Pattern ( \kore-equals \kore-sort-SortK kore-sort-var-R kore-element-var-V0 ( \kore-symbol-kseq kore-element-var-V1 kore-element-var-V2 ) ) $= ( BASIC-K-sort-0-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-39 typecode-cache-Pattern-158 kore-equals-is-pattern ) EAFBGCDHI $. $}
