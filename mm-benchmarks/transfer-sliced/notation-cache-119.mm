...
${ notation-cache-119 $p #Notation ( \kore-symbol-Lbl'Hash'seekEnd'LParUndsCommUndsRParUnds'K-IO'Unds'K'Unds'Int'Unds'Int ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Hash'seekEnd'LParUndsCommUndsRParUnds'K-IO'Unds'K'Unds'Int'Unds'Int-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-108-is-symbol symbol-is-pattern IMP-symbol-108-is-pattern IMP-symbol-108-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
