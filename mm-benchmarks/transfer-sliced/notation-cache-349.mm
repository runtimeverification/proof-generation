...
${ notation-cache-349 $p #Notation ( \kore-symbol-Lbl'Unds'Map'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'Map'Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-194-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-194-is-pattern IMP-symbol-194-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
