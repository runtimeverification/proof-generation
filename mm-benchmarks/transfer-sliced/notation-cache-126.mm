...
${ notation-cache-126 $p #Notation ( \kore-symbol-Lbl'Hash'system'LParUndsRParUnds'K-IO'Unds'KItem'Unds'String ptn2 ) ( \app \kore-symbol-Lbl'Hash'system'LParUndsRParUnds'K-IO'Unds'KItem'Unds'String-symbol ptn2 ) $= ( IMP-symbol-113-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-113-is-pattern IMP-symbol-113-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
