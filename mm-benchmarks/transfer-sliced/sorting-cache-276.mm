...
${ sorting-cache-276 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortIds ) \top ) ) ( \and ( \in-sort kore-element-var-K0 \kore-sort-SortId ) \top ) ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortIds ) \top ) ) $= ( and-is-pattern in-sort-is-pattern top-is-pattern typecode-cache-Pattern-58 typecode-cache-Pattern-51 IMP-sort-17-is-pattern typecode-cache-Pattern-49 IMP-sort-0-is-pattern and-elim-left-sugar sorting-cache-275 rule-imp-transitivity top-intro rule-weakening rule-and-intro-alt2-sugar ) ACGBHIEFDDCJKEFACGBHIEFDDACGCJKEACGBHIEFDLACMNACGBHIEFDDFOPQ $. $}
