...
${ notation-cache-132 $p #Notation ( \kore-symbol-Lbl'Hash'tempFile ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Hash'tempFile-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-116-is-symbol symbol-is-pattern IMP-symbol-116-is-pattern IMP-symbol-116-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
