$c #Substitution "amount" #SetVariable #ElementVariable #Symbol \kore-symbol-kseq #Variable #Pattern \kore-sort-SortK \kore-sort-SortKItem \kore-dv \kore-sort-SortId ) \kore-equals \kore-inj ( $.
...
${ substitution-899 $p #Substitution ( \kore-equals \kore-sort-SortK kore-sort-var-R kore-element-var-V0 ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "amount" ) ) kore-element-var-x0 ) ) ( \kore-equals \kore-sort-SortK kore-sort-var-R kore-element-var-V0 ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "amount" ) ) kore-element-var-V2 ) ) kore-element-var-x0 kore-element-var-V2 $= ( IMP-sort-17-is-pattern typecode-cache-Pattern-25 BASIC-K-sort-1-is-pattern string-literal-14-is-pattern kore-dv-is-pattern kore-inj-is-pattern element-var-is-var BASIC-K-sort-0-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-39 KSEQ-symbol-0-is-pattern typecode-cache-Pattern-35 substitution-490 substitution-421 substitution-422 substitution-disjoint substitution-var-same KSEQ-symbol-0-substitution substitution-kore-equals ) LAMBNEGEHIJDFOLAMBNEGEHIJCPODFCKCDQACDRBCDSCKDFEGEHIJDFEGEHIJCPEGEHIJDFCKTDFCKUAUBUC $. $}
