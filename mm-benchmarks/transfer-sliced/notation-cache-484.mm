...
${ notation-cache-484 $p #Notation ( \kore-symbol-LblisAExp ptn0 ) ( \app \kore-symbol-LblisAExp-symbol ptn0 ) $= ( IMP-symbol-249-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-249-is-pattern IMP-symbol-249-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
