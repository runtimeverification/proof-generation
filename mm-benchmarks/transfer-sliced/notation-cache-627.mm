...
${ notation-cache-627 $p #Notation ( \kore-symbol-Lblproject'Coln'AExp ptn2 ) ( \app \kore-symbol-Lblproject'Coln'AExp-symbol ptn2 ) $= ( IMP-symbol-302-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-302-is-pattern IMP-symbol-302-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
