...
${ $d xX0 ptn1 $.
   ...
   KSEQ-symbol-0-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-kseq ptn0 ptn1 ) $= ( KSEQ-symbol-0-is-symbol symbol-is-pattern app-is-pattern KSEQ-symbol-0-is-pattern application-context-app-right application-context-app-left notation-cache-2 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
