...
${ sorting-cache-1833 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) \top ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-179 IMP-sort-18-is-pattern top-is-pattern and-is-pattern rule-imp-transitivity typecode-cache-Pattern-382 typecode-cache-Pattern-178 IMP-sort-9-is-pattern and-elim-right-sugar and-elim-left-sugar imp-reflexivity ) ABIBDECFGBDECAJKCBDECFGLBDECFGBDECBDECBDECFMBDECNHH $. $}
