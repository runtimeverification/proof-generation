...
${ notation-cache-232 $p #Notation ( \kore-symbol-Lbl'UndsAnd-'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsAnd-'Int'Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-155-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-155-is-pattern IMP-symbol-155-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
