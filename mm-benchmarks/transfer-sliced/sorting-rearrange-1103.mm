$c \exists \kore-sort-SortKResult \top #SetVariable #ElementVariable #Symbol \eq #Variable #Pattern \kore-sort-SortBool \and \imp \kore-is-sort |- ) \in-sort ( $.
