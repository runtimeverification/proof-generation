...
${ sorting-cache-1736 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) \top ) ) ) ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) \top ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-179 IMP-sort-22-is-pattern typecode-cache-Pattern-357 typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern top-is-pattern typecode-cache-Pattern-253 BASIC-K-sort-1-is-pattern and-elim-left-sugar sorting-cache-1702 rule-imp-transitivity ) BHIFCJKFDELGGAMNFOGGBHIFCJKFDELGGDPQFBHIFCJKFDELGGAMNFOGRBCDEST $. $}
