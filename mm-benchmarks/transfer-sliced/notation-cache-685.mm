...
${ notation-cache-685 $p #Notation ( \kore-symbol-Lblproject'Coln'KCellOpt ptn0 ) ( \app \kore-symbol-Lblproject'Coln'KCellOpt-symbol ptn0 ) $= ( IMP-symbol-321-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-321-is-pattern IMP-symbol-321-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
