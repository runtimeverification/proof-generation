...
${ sorting-cache-1127 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortBlock ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortBlock ) \top ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-263 typecode-cache-Pattern-178 IMP-sort-9-is-pattern and-is-pattern typecode-cache-Pattern-253 IMP-sort-18-is-pattern top-is-pattern and-elim-right-sugar sorting-cache-1100 rule-imp-transitivity top-intro rule-weakening rule-and-intro-alt2-sugar ) AFGDBCEHCIJDKAFGDBCEHBCECIJDAFGDBCELBCMNAFGDBCEHKOPQ $. $}
