$c \kore-sort-SortBExp \top #Variable \kore-sort-SortBool \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals "false" \and #SetVariable #ElementVariable #Symbol #Pattern \kore-exists \kore-inj ( $.
