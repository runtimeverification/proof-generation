$c #Substitution #SetVariable #ElementVariable #Symbol \kore-symbol-kseq #Variable #Pattern \kore-sort-SortBlock \kore-sort-SortKItem ) \kore-symbol-Lbl'-LT-'k'-GT-' \kore-inj \kore-symbol-dotk ( $.
...
${ substitution-1094 $p #Substitution ( \kore-symbol-Lbl'-LT-'k'-GT-' ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortBlock \kore-sort-SortKItem kore-element-var-VE2 ) \kore-symbol-dotk ) ) ( \kore-symbol-Lbl'-LT-'k'-GT-' ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortBlock \kore-sort-SortKItem kore-element-var-VE2 ) kore-element-var-VE1 ) ) \kore-symbol-dotk kore-element-var-VE1 $= ( KSEQ-symbol-1-is-pattern element-var-is-var IMP-sort-18-is-pattern BASIC-K-sort-1-is-pattern typecode-cache-Pattern-177 kore-inj-is-pattern KSEQ-symbol-0-is-pattern typecode-cache-Pattern-384 typecode-cache-Pattern-146 substitution-disjoint substitution-var-same KSEQ-symbol-0-substitution IMP-symbol-131-substitution ) BDCEFAGHCIABJBDCEFAGHCEFAGHBKEFAGHCBDLCBDMNO $. $}
