...
sorting-rearrange-87 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \exists kore-element-var-Val ( \eq kore-element-var-Val ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "ret" ) \kore-symbol-Lbl'Stop'List'LBraQuotUndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids'QuotRBraUnds'Ids ) ) ) ) $.
...
typecode-cache-Pattern-76 $a #Pattern ( \kore-equals \kore-sort-SortIds kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "balanceTo" ) kore-element-var-x0 ) ) $.
substitution-254 $a #Substitution kore-sort-var-R kore-sort-var-R ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "ret" ) \kore-symbol-Lbl'Stop'List'LBraQuotUndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids'QuotRBraUnds'Ids ) kore-element-var-K1 $.
substitution-255 $a #Substitution kore-element-var-Val kore-element-var-Val ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "ret" ) \kore-symbol-Lbl'Stop'List'LBraQuotUndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids'QuotRBraUnds'Ids ) kore-element-var-K1 $.
substitution-256 $a #Substitution ( \kore-equals \kore-sort-SortIds kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "balanceTo" ) kore-element-var-x0 ) ) ( \kore-equals \kore-sort-SortIds kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "balanceTo" ) kore-element-var-K1 ) ) kore-element-var-x0 kore-element-var-K1 $.
sorting-cache-287 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \in-sort ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "ret" ) \kore-symbol-Lbl'Stop'List'LBraQuotUndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids'QuotRBraUnds'Ids ) \kore-sort-SortIds ) \top ) ) $.
${ sorting-rearrange-89 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortIds kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortIds kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "balanceTo" ) ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "ret" ) \kore-symbol-Lbl'Stop'List'LBraQuotUndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids'QuotRBraUnds'Ids ) ) ) ) ) ) $= ( kore-element-var-K1-elementvariable typecode-cache-Pattern-0 IMP-sort-0-is-pattern IMP-sort-17-is-pattern kore-dv-is-pattern IMP-symbol-161-is-pattern string-literal-11-is-pattern IMP-symbol-123-is-pattern top-is-pattern element-var-is-var and-is-pattern kore-element-var-x0-elementvariable kore-exists-is-pattern in-sort-is-pattern string-literal-17-is-pattern kore-valid-is-pattern typecode-cache-Pattern-31 typecode-cache-Pattern-67 typecode-cache-Pattern-49 kore-is-sort-is-pattern kore-equals-is-pattern typecode-cache-Pattern-25 substitution-disjoint typecode-cache-Pattern-76 substitution-254 substitution-var-same substitution-kore-exists-alt substitution-kore-valid substitution-imp substitution-249 sorting-cache-133 sorting-cache-287 rule-and-intro-alt2-sugar sorting-rearrange-87 sorting-rearrange-88 substitution-in-sort substitution-and substitution-255 IMP-symbol-161-substitution substitution-kore-equals substitution-248 substitution-245 substitution-256 functional-substitution-alt rule-imp-transitivity )  $. $}
