$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'-LT-'k'-GT-'-symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-Lbl'-LT-'k'-GT-' ( $.
...
notation-cache-164 $a #Notation ( \kore-symbol-Lbl'-LT-'k'-GT-' ptn0 ) ( \app \kore-symbol-Lbl'-LT-'k'-GT-'-symbol ptn0 ) $.
${ IMP-symbol-131-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-131-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'-LT-'k'-GT-' ptn0 ) $= ( IMP-symbol-131-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-131-is-pattern application-context-app-right notation-cache-164 notation-application-context ) DEBFBGADEBACHBIJ $. $}
