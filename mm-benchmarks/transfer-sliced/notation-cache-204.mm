...
${ notation-cache-204 $p #Notation ( \kore-symbol-LblSetItem ptn2 ) ( \app \kore-symbol-LblSetItem-symbol ptn2 ) $= ( IMP-symbol-146-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-146-is-pattern IMP-symbol-146-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
