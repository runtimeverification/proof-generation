...
${ sorting-cache-1096 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortBlock ) \top ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-179 IMP-sort-22-is-pattern typecode-cache-Pattern-263 typecode-cache-Pattern-253 IMP-sort-18-is-pattern top-is-pattern and-is-pattern and-elim-left-sugar imp-reflexivity rule-imp-transitivity ) ABFADECADECADECBGHCIJKADECLM $. $}
