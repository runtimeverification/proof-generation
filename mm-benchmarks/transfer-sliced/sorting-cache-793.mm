...
${ sorting-cache-793 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortStmt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) \top ) ) ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern top-is-pattern and-is-pattern rule-imp-transitivity typecode-cache-Pattern-225 typecode-cache-Pattern-177 IMP-sort-31-is-pattern and-elim-right-sugar and-elim-left-sugar imp-reflexivity ) ABIBDECFGBDECAJKCBDECFGLBDECFGBDECBDECBDECFMBDECNHH $. $}
