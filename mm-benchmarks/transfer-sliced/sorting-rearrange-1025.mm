$c \exists \top \kore-sort-SortAExp #Variable "10" \kore-sort-SortK \imp \kore-dv |- \kore-valid ) \kore-equals \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-sort-SortKItem \kore-inj \kore-sort-SortInt \in-sort \kore-sort-SortStateCell ( $.
...
${ sorting-rearrange-1025 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ) ) ( \exists kore-element-var-Val ( \eq kore-element-var-Val ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "10" ) ) ) ) ) $= ( in-sort-is-pattern and-is-pattern IMP-sort-23-is-pattern top-is-pattern IMP-sort-13-is-pattern typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-324 string-literal-13-is-pattern kore-dv-is-pattern kore-inj-is-pattern typecode-cache-Pattern-31 eq-is-pattern exists-is-pattern top-intro rule-weakening sorting-cache-19 sorting-rearrange-130 kore-functional rule-imp-transitivity ) AKLFBMNFCEOGGIDSHJHPQRTDUAAKLFBMNFCEOGGIUBUCJHJHPQRIDUDDUEUFUG $. $}
