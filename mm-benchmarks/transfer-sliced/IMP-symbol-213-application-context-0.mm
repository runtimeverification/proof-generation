...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-213-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds'modInt'Unds' ptn0 ptn1 ) $= ( IMP-symbol-213-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-213-is-pattern application-context-app-right application-context-app-left notation-cache-398 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
