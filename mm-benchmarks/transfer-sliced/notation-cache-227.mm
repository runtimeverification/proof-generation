...
${ notation-cache-227 $p #Notation ( \kore-symbol-Lbl'UndsAnd-And-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp'Unds'BExp ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsAnd-And-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp'Unds'BExp-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-154-is-symbol symbol-is-pattern IMP-symbol-154-is-pattern IMP-symbol-154-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
