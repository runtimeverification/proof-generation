...
${ $d xX0 ptn0 $.
   ...
   IMP-symbol-126-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'-LT-'T'-GT-' ptn0 ptn1 ) $= ( app-is-pattern IMP-symbol-126-is-symbol symbol-is-pattern IMP-symbol-126-is-pattern application-context-app-right notation-cache-149 notation-application-context ) FGBECEBCHAFGBECADIBCJK $. $}
