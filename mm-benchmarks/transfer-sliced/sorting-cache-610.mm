...
${ sorting-cache-610 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \in-sort kore-element-var-K0 \kore-sort-SortInt ) \top ) ) ( \in-sort kore-element-var-K0 \kore-sort-SortInt ) ) $= ( typecode-cache-Pattern-51 IMP-sort-23-is-pattern in-sort-is-pattern top-is-pattern and-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern rule-imp-transitivity and-elim-right-sugar and-elim-left-sugar imp-reflexivity ) AHIFGBCDEFGGBCDEFGBCDEAHIFGBCDEFGKBCDEFGBCDEBCDEBCDEFLBCDEMJJ $. $}
