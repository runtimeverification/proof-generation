...
${ notation-cache-422 $p #Notation ( \kore-symbol-Lbl'UndsPipeUndsPipeUnds'IMP-SYNTAX'Unds'AExp'Unds'Id'Unds'Id ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsPipeUndsPipeUnds'IMP-SYNTAX'Unds'AExp'Unds'Id'Unds'Id-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-221-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-221-is-pattern IMP-symbol-221-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
