...
${ sorting-cache-411 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \in-sort ( \kore-symbol-Lbl'Unds-GT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ) \kore-sort-SortBExp ) ) $= ( IMP-sort-17-is-pattern IMP-sort-13-is-pattern kore-dv-is-pattern kore-inj-is-pattern in-sort-is-pattern string-literal-14-is-pattern string-literal-10-is-pattern and-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern top-is-pattern IMP-symbol-192-is-pattern IMP-sort-22-is-pattern sorting-cache-388 sorting-cache-357 rule-and-intro-alt2-sugar IMP-symbol-192-sorting rule-imp-transitivity ) AJKLIBCBGDECFBCBHDECFIBCBGDEBCBHDEMNFAJKLIBCBGDECFBCBHDECFAOAPQBCBGDEBCBHDERS $. $}
