$c #Substitution #Notation \kore-symbol-LblMap'Coln'lookup-symbol #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-LblMap'Coln'lookup \app ) ( $.
...
notation-cache-193 $a #Notation ( \kore-symbol-LblMap'Coln'lookup ptn1 ptn2 ) ( \app ( \app \kore-symbol-LblMap'Coln'lookup-symbol ptn1 ) ptn2 ) $.
notation-cache-194 $a #Notation ( \kore-symbol-LblMap'Coln'lookup ptn3 ptn4 ) ( \app ( \app \kore-symbol-LblMap'Coln'lookup-symbol ptn3 ) ptn4 ) $.
${ IMP-symbol-142-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   IMP-symbol-142-substitution $p #Substitution ( \kore-symbol-LblMap'Coln'lookup ptn1 ptn2 ) ( \kore-symbol-LblMap'Coln'lookup ptn3 ptn4 ) ptn0 xX0 $= ( IMP-symbol-142-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-142-is-pattern substitution-app substitution-disjoint notation-cache-193 notation-cache-194 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
