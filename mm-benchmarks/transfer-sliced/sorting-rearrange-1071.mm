$c \exists \kore-sort-SortBExp \top #Variable \kore-sort-SortK \imp |- \kore-valid ) \kore-equals \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-sort-SortBlock \kore-exists \kore-sort-SortKItem \in-sort \kore-symbol-dotk \kore-sort-SortStateCell ( $.
$v ph0 kore-element-var-V0 ph2 x kore-element-var-VE3 th0 kore-element-var-VE6 kore-element-var-VE5 kore-element-var-VE4 ph1 $.
...
${ sorting-rearrange-1071 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) \top ) ) ) ) ( \exists kore-element-var-V0 ( \eq kore-element-var-V0 \kore-symbol-dotk ) ) ) $= ( in-sort-is-pattern and-is-pattern top-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-179 IMP-sort-22-is-pattern typecode-cache-Pattern-357 KSEQ-symbol-1-is-pattern typecode-cache-Pattern-39 eq-is-pattern exists-is-pattern top-intro rule-weakening BASIC-K-sort-0-is-pattern sorting-cache-43 sorting-rearrange-275 kore-functional rule-imp-transitivity ) AIJFBKLFDEMGGHCONPCQAIJFBKLFDEMGGHRSTNHCUACUBUCUD $. $}
