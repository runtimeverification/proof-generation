$c #Notation #SetVariable \kore-symbol-Lbl'Unds'List'Unds'-symbol #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app \kore-symbol-Lbl'Unds'List'Unds' ) ( $.
...
notation-cache-346 $a #Notation ( \kore-symbol-Lbl'Unds'List'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'List'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-193-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-193-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds'List'Unds' ptn0 ptn1 ) $= ( IMP-symbol-193-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-193-is-pattern application-context-app-right application-context-app-left notation-cache-346 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
