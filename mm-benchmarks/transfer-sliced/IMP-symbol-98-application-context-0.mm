...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-98-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Hash'if'UndsHash'then'UndsHash'else'UndsHash'fi'Unds'K-EQUAL-SYNTAX'Unds'Sort'Unds'Bool'Unds'Sort'Unds'Sort ptn0 ptn1 ptn2 ptn3 ) $= ( app-is-pattern IMP-symbol-98-is-symbol symbol-is-pattern application-context-app-left IMP-symbol-98-is-pattern application-context-app-right notation-cache-91 notation-application-context ) HIBGCGDGEGBCDEKAHIBGCGDGEAHIBGCGDAHIBGCAHIBAFLJJJBCDEMN $. $}
