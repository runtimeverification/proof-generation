...
sorting-cache-474 $a |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ( \kore-is-sort \kore-sort-SortKConfigVar ) ) $.
sorting-cache-475 $a |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ( \kore-is-sort \kore-sort-SortKItem ) ) $.
${ sorting-cache-476 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ( \and ( \kore-is-sort \kore-sort-SortKConfigVar ) ( \kore-is-sort \kore-sort-SortKItem ) ) ) $= ( kore-is-sort-is-pattern top-is-pattern and-is-pattern typecode-cache-Pattern-0 IMP-sort-20-is-pattern BASIC-K-sort-1-is-pattern sorting-cache-474 sorting-cache-475 rule-and-intro-alt2-sugar ) AEBCDCDFBGBAHAIJ $. $}
