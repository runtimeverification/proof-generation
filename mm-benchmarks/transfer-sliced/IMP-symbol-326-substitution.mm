$c #Substitution #Notation \kore-symbol-Lblproject'Coln'Pgm #SetVariable \kore-symbol-Lblproject'Coln'Pgm-symbol #ElementVariable #Symbol #Variable #Pattern \app ) ( $.
...
notation-cache-698 $a #Notation ( \kore-symbol-Lblproject'Coln'Pgm ptn1 ) ( \app \kore-symbol-Lblproject'Coln'Pgm-symbol ptn1 ) $.
notation-cache-699 $a #Notation ( \kore-symbol-Lblproject'Coln'Pgm ptn2 ) ( \app \kore-symbol-Lblproject'Coln'Pgm-symbol ptn2 ) $.
${ IMP-symbol-326-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-326-substitution $p #Substitution ( \kore-symbol-Lblproject'Coln'Pgm ptn1 ) ( \kore-symbol-Lblproject'Coln'Pgm ptn2 ) ptn0 xX0 $= ( IMP-symbol-326-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-326-is-pattern substitution-disjoint substitution-app notation-cache-698 notation-cache-699 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
