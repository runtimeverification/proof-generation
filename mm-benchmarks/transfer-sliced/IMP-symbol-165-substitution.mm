$c #Substitution #Notation #SetVariable \kore-symbol-Lbl'UndsSlsh'Int'Unds' #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-Lbl'UndsSlsh'Int'Unds'-symbol ( $.
...
notation-cache-260 $a #Notation ( \kore-symbol-Lbl'UndsSlsh'Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsSlsh'Int'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-261 $a #Notation ( \kore-symbol-Lbl'UndsSlsh'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsSlsh'Int'Unds'-symbol ptn3 ) ptn4 ) $.
