$c \exists #Substitution "amount" \top \kore-sort-SortAExp \kore-symbol-LblisKResult \kore-symbol-kseq #Variable \kore-sort-SortBool \imp \kore-dv \kore-is-sort |- \kore-sort-SortId \kore-valid ) \kore-equals \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp "false" \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-sort-SortKItem \kore-inj \kore-symbol-dotk "balanceTo" ( $.
