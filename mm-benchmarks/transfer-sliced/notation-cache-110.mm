...
${ notation-cache-110 $p #Notation ( \kore-symbol-Lbl'Hash'read'LParUndsCommUndsRParUnds'K-IO'Unds'IOString'Unds'Int'Unds'Int ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Hash'read'LParUndsCommUndsRParUnds'K-IO'Unds'IOString'Unds'Int'Unds'Int-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-105-is-symbol symbol-is-pattern IMP-symbol-105-is-pattern IMP-symbol-105-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
