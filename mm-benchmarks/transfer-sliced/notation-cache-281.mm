...
${ notation-cache-281 $p #Notation ( \kore-symbol-Lbl'Unds-LT-EqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds-LT-EqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-172-is-symbol symbol-is-pattern IMP-symbol-172-is-pattern IMP-symbol-172-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
