...
${ sorting-cache-1818 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ) ( \and ( \kore-is-sort \kore-sort-SortBool ) ( \kore-is-sort \kore-sort-SortKResult ) ) ) $= ( and-is-pattern kore-is-sort-is-pattern top-is-pattern typecode-cache-Pattern-0 IMP-sort-32-is-pattern IMP-sort-28-is-pattern imp-is-pattern proof-rule-prop-1 proof-rule-mp IMP-sort-32-sort IMP-sort-28-sort rule-and-intro-alt2-sugar ) AECDBAECDBDBBFCGCFCAECDBAECDBDBBFCHFCAECDBAECDBDBBIKJGCAECDBAECDBDBBGCHGCAECDBAECDBDBBILJM $. $}
