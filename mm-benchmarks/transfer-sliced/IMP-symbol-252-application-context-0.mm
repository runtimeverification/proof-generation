$c \kore-symbol-LblisBlock #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \kore-symbol-LblisBlock-symbol \app ) ( $.
...
notation-cache-493 $a #Notation ( \kore-symbol-LblisBlock ptn0 ) ( \app \kore-symbol-LblisBlock-symbol ptn0 ) $.
${ IMP-symbol-252-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-252-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblisBlock ptn0 ) $= ( IMP-symbol-252-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-252-is-pattern application-context-app-right notation-cache-493 notation-application-context ) DEBFBGADEBACHBIJ $. $}
