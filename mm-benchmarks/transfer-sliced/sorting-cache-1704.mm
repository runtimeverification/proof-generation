...
${ sorting-cache-1704 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) \top ) ) ) ) ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-179 IMP-sort-22-is-pattern typecode-cache-Pattern-357 typecode-cache-Pattern-146 IMP-sort-18-is-pattern typecode-cache-Pattern-253 BASIC-K-sort-1-is-pattern and-elim-right-sugar sorting-cache-1703 rule-imp-transitivity ) BPQGAIJGCKLGDMNGEFOHHHHAIJGCKLGDMNGEFOHHHERSGBPQGAIJGCKLGDMNGEFOHHHTACDEFUAUB $. $}
