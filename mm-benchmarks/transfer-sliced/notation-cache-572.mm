...
${ notation-cache-572 $p #Notation ( \kore-symbol-LblisStream ptn1 ) ( \app \kore-symbol-LblisStream-symbol ptn1 ) $= ( IMP-symbol-279-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-279-is-pattern IMP-symbol-279-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
