...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-116-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Hash'tempFile ptn0 ptn1 ) $= ( IMP-symbol-116-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-116-is-pattern application-context-app-right application-context-app-left notation-cache-134 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
