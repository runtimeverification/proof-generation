...
${ substitution-1064 $p #Substitution ( \kore-inj \kore-sort-SortBool \kore-sort-SortKResult kore-element-var-T ) ( \kore-inj \kore-sort-SortBool kore-sort-var-S2 kore-element-var-T ) \kore-sort-SortKResult kore-sort-var-S2 $= ( IMP-sort-28-is-pattern IMP-sort-32-is-pattern element-var-is-var typecode-cache-Pattern-6 typecode-cache-Pattern-1 substitution-disjoint substitution-var-same substitution-955 substitution-kore-inj ) DCBFDAGBFCAEDCAEHCAEIABJK $. $}
