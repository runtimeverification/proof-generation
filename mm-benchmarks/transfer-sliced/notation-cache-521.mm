...
${ notation-cache-521 $p #Notation ( \kore-symbol-LblisIOString ptn1 ) ( \app \kore-symbol-LblisIOString-symbol ptn1 ) $= ( IMP-symbol-262-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-262-is-pattern IMP-symbol-262-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
