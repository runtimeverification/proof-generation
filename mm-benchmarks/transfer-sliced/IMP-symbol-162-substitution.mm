$c #Substitution #Notation #SetVariable \kore-symbol-Lbl'Unds'-Int'Unds' #ElementVariable #Symbol #Variable #Pattern \kore-symbol-Lbl'Unds'-Int'Unds'-symbol \app ) ( $.
...
notation-cache-251 $a #Notation ( \kore-symbol-Lbl'Unds'-Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds'-Int'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-252 $a #Notation ( \kore-symbol-Lbl'Unds'-Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds'-Int'Unds'-symbol ptn3 ) ptn4 ) $.
