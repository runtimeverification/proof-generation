...
notation-cache-738 $a #Notation ( \kore-symbol-LblrfindString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String'Unds'Int ptn0 ptn1 ptn2 ) ( \app ( \app ( \app \kore-symbol-LblrfindString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String'Unds'Int-symbol ptn0 ) ptn1 ) ptn2 ) $.
${ $d xX0 ptn1 $.
   $d xX0 ptn2 $.
   IMP-symbol-342-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-342-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblrfindString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String'Unds'Int ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-342-is-symbol symbol-is-pattern application-context-app-left IMP-symbol-342-is-pattern application-context-app-right notation-cache-738 notation-application-context ) GHBFCFDFBCDJAGHBFCFDAGHBFCAGHBAEKIIBCDLM $. $}
