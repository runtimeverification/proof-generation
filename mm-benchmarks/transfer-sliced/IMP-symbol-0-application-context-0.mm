$c \kore-symbol-Lbl'BangUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp-symbol #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-Lbl'BangUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp ( $.
...
notation-cache-9 $a #Notation ( \kore-symbol-Lbl'BangUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp ptn0 ) ( \app \kore-symbol-Lbl'BangUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp-symbol ptn0 ) $.
