$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-Lbl'Hash'unknownIOError \kore-symbol-Lbl'Hash'unknownIOError-symbol ( $.
...
notation-cache-135 $a #Notation ( \kore-symbol-Lbl'Hash'unknownIOError ptn1 ) ( \app \kore-symbol-Lbl'Hash'unknownIOError-symbol ptn1 ) $.
notation-cache-136 $a #Notation ( \kore-symbol-Lbl'Hash'unknownIOError ptn2 ) ( \app \kore-symbol-Lbl'Hash'unknownIOError-symbol ptn2 ) $.
${ IMP-symbol-118-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-118-substitution $p #Substitution ( \kore-symbol-Lbl'Hash'unknownIOError ptn1 ) ( \kore-symbol-Lbl'Hash'unknownIOError ptn2 ) ptn0 xX0 $= ( IMP-symbol-118-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-118-is-pattern substitution-disjoint substitution-app notation-cache-135 notation-cache-136 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
