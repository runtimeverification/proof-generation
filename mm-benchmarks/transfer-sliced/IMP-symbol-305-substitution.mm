$c #Substitution #Notation #SetVariable \kore-symbol-Lblproject'Coln'Block-symbol #ElementVariable #Symbol \kore-symbol-Lblproject'Coln'Block #Variable #Pattern \app ) ( $.
...
notation-cache-635 $a #Notation ( \kore-symbol-Lblproject'Coln'Block ptn1 ) ( \app \kore-symbol-Lblproject'Coln'Block-symbol ptn1 ) $.
notation-cache-636 $a #Notation ( \kore-symbol-Lblproject'Coln'Block ptn2 ) ( \app \kore-symbol-Lblproject'Coln'Block-symbol ptn2 ) $.
${ IMP-symbol-305-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-305-substitution $p #Substitution ( \kore-symbol-Lblproject'Coln'Block ptn1 ) ( \kore-symbol-Lblproject'Coln'Block ptn2 ) ptn0 xX0 $= ( IMP-symbol-305-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-305-is-pattern substitution-disjoint substitution-app notation-cache-635 notation-cache-636 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
