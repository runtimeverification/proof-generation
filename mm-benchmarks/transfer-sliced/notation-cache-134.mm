...
${ notation-cache-134 $p #Notation ( \kore-symbol-Lbl'Hash'tempFile ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Hash'tempFile-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-116-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-116-is-pattern IMP-symbol-116-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
