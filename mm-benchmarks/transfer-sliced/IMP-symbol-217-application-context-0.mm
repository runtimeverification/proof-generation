...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-217-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds'xorInt'Unds' ptn0 ptn1 ) $= ( IMP-symbol-217-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-217-is-pattern application-context-app-right application-context-app-left notation-cache-410 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
