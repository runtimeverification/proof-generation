...
${ notation-cache-594 $p #Notation ( \kore-symbol-LbllengthString'LParUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String ptn2 ) ( \app \kore-symbol-LbllengthString'LParUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String-symbol ptn2 ) $= ( IMP-symbol-286-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-286-is-pattern IMP-symbol-286-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
