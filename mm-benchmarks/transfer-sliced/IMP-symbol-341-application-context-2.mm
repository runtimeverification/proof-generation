...
${ $d xX0 ptn0 $.
   $d xX0 ptn1 $.
   IMP-symbol-341-application-context-2.0 $e #ApplicationContext xX0 ptn2 $.
   IMP-symbol-341-application-context-2 $p #ApplicationContext xX0 ( \kore-symbol-LblrfindChar'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String'Unds'Int ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-341-is-symbol symbol-is-pattern IMP-symbol-341-is-pattern application-context-app-right notation-cache-737 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAEJBCDKL $. $}
