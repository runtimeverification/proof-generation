$c \exists \kore-sort-SortBExp \top #SetVariable #ElementVariable #Symbol \eq #Variable #Pattern \kore-sort-SortBool \and \imp \kore-is-sort |- ) \in-sort ( $.
...
${ sorting-rearrange-1120 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) ( \exists x ( \eq x \kore-sort-SortBExp ) ) ) $= ( top-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern typecode-cache-Pattern-379 and-is-pattern IMP-sort-22-is-pattern typecode-cache-Pattern-4 eq-is-pattern exists-is-pattern top-intro rule-weakening sorting-cache-87 kore-sort-functional rule-imp-transitivity ) BFGCDHIEAKJLAMBFGCDHIENOJEAPQR $. $}
