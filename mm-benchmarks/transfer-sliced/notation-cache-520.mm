...
${ notation-cache-520 $p #Notation ( \kore-symbol-LblisIOInt ptn0 ) ( \app \kore-symbol-LblisIOInt-symbol ptn0 ) $= ( IMP-symbol-261-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-261-is-pattern IMP-symbol-261-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
