...
${ notation-cache-40 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp0'Unds' ptn1 ) ( \app \kore-symbol-Lbl'Hash'freezer'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp0'Unds'-symbol ptn1 ) $= ( IMP-symbol-81-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-81-is-pattern IMP-symbol-81-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
