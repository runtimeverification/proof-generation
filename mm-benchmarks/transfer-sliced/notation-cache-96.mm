...
${ notation-cache-96 $p #Notation ( \kore-symbol-Lbl'Hash'logToFile ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Hash'logToFile-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-100-is-symbol symbol-is-pattern IMP-symbol-100-is-pattern IMP-symbol-100-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
