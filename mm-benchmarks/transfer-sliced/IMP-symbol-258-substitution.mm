$c \kore-symbol-LblisGeneratedTopCellFragment #Substitution #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-LblisGeneratedTopCellFragment-symbol #Variable #Pattern \app ) ( $.
...
notation-cache-509 $a #Notation ( \kore-symbol-LblisGeneratedTopCellFragment ptn1 ) ( \app \kore-symbol-LblisGeneratedTopCellFragment-symbol ptn1 ) $.
notation-cache-510 $a #Notation ( \kore-symbol-LblisGeneratedTopCellFragment ptn2 ) ( \app \kore-symbol-LblisGeneratedTopCellFragment-symbol ptn2 ) $.
${ IMP-symbol-258-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-258-substitution $p #Substitution ( \kore-symbol-LblisGeneratedTopCellFragment ptn1 ) ( \kore-symbol-LblisGeneratedTopCellFragment ptn2 ) ptn0 xX0 $= ( IMP-symbol-258-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-258-is-pattern substitution-disjoint substitution-app notation-cache-509 notation-cache-510 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
