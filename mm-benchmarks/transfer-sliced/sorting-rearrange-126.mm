$c \exists "amount" \top \kore-sort-SortAExp #Variable \imp \kore-dv \kore-is-sort |- \kore-sort-SortId \kore-valid ) \kore-equals \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \in-sort ( $.
...
${ sorting-rearrange-126 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortAExp ) \top ) ) ( \exists kore-element-var-x1 ( \eq kore-element-var-x1 ( \kore-dv \kore-sort-SortId "amount" ) ) ) ) $= ( top-is-pattern IMP-sort-17-is-pattern typecode-cache-Pattern-86 string-literal-14-is-pattern kore-dv-is-pattern typecode-cache-Pattern-23 eq-is-pattern exists-is-pattern top-intro rule-weakening sorting-cache-3 sorting-rearrange-9 kore-functional rule-imp-transitivity ) ABFDCIEGHJCKABFDLMEEGHDCNCOPQ $. $}
