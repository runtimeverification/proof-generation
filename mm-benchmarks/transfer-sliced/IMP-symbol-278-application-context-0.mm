$c #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ( \kore-symbol-LblisStmt ) \kore-symbol-LblisStmt-symbol $.
...
notation-cache-571 $a #Notation ( \kore-symbol-LblisStmt ptn0 ) ( \app \kore-symbol-LblisStmt-symbol ptn0 ) $.
${ IMP-symbol-278-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-278-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblisStmt ptn0 ) $= ( IMP-symbol-278-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-278-is-pattern application-context-app-right notation-cache-571 notation-application-context ) DEBFBGADEBACHBIJ $. $}
