$c \exists "1" #Substitution \top #Variable \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-sort-SortInt ( $.
...
sorting-rearrange-234 $a |- ( \imp ( \and \top ( \and ( \kore-is-sort kore-sort-var-x0 ) \top ) ) ( \kore-valid kore-sort-var-x0 ( \kore-exists \kore-sort-SortInt kore-sort-var-x0 kore-element-var-x1 ( \kore-equals \kore-sort-SortInt kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "1" ) ) ) ) ) $.
substitution-391 $a #Substitution ( \kore-equals \kore-sort-SortInt \unit-sort kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "1" ) ) ( \kore-equals \kore-sort-SortInt kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "1" ) ) \unit-sort kore-sort-var-x0 $.
substitution-392 $a #Substitution ( \kore-equals \kore-sort-SortInt kore-sort-var-x1 kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "1" ) ) ( \kore-equals \kore-sort-SortInt kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "1" ) ) kore-sort-var-x1 kore-sort-var-x0 $.
${ sorting-rearrange-235 $p |- ( \imp \top ( \kore-valid \unit-sort ( \kore-exists \kore-sort-SortInt \unit-sort kore-element-var-x1 ( \kore-equals \kore-sort-SortInt \unit-sort kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "1" ) ) ) ) ) $= ( IMP-sort-23-is-pattern kore-sort-var-x0-elementvariable unit-sort-is-symbol symbol-is-pattern typecode-cache-Pattern-14 kore-sort-var-x1-elementvariable typecode-cache-Pattern-24 top-is-pattern typecode-cache-Pattern-23 string-literal-4-is-pattern kore-dv-is-pattern kore-equals-is-pattern kore-exists-is-pattern and-is-pattern element-var-is-var kore-is-sort-is-pattern kore-valid-is-pattern x-is-element-var substitution-var-same rule-weakening substitution-kore-exists-alt substitution-kore-valid substitution-imp top-intro sorting-cache-129 rule-and-intro-alt2-sugar typecode-cache-Pattern-22 exists-is-pattern unit-sort-is-functional sorting-rearrange-234 substitution-60 substitution-116 substitution-391 substitution-66 substitution-118 substitution-392 functional-substitution-alt rule-imp-transitivity )  $. $}
