...
${ sorting-cache-120 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortId ) \top ) ) ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortId ) \top ) ) $= ( typecode-cache-Pattern-19 typecode-cache-Pattern-0 kore-is-sort-is-pattern and-is-pattern typecode-cache-Pattern-6 IMP-sort-17-is-pattern in-sort-is-pattern top-is-pattern and-elim-right-sugar sorting-cache-111 rule-imp-transitivity top-intro rule-weakening rule-and-intro-alt2-sugar ) AEFBCDGCHIJKAEFBCDGBCDCHIJAEFBCDLBCMNAEFBCDGKOPQ $. $}
