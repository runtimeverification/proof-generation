...
${ notation-cache-692 $p #Notation ( \kore-symbol-Lblproject'Coln'List ptn1 ) ( \app \kore-symbol-Lblproject'Coln'List-symbol ptn1 ) $= ( IMP-symbol-324-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-324-is-pattern IMP-symbol-324-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
