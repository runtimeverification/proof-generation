...
${ sorting-cache-1215 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortKResult ) \top ) ) \top ) ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortKResult ) \top ) ) ) $= ( top-is-pattern typecode-cache-Pattern-284 and-is-pattern typecode-cache-Pattern-177 IMP-sort-28-is-pattern in-sort-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern and-elim-left-sugar rule-imp-transitivity rule-and-intro-alt2-sugar sorting-cache-1214 sorting-cache-1213 top-intro rule-weakening ) ABDCEAIJBFGHCEABDCEABDAIJABDCKABNLABDCEBFGHCABDCEABDBFGHABDCKABOLABDCECPQMM $. $}
