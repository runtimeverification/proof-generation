...
${ sorting-rearrange-742 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \exists kore-element-var-Val ( \eq kore-element-var-Val ( \kore-symbol-Lbl'Unds-GT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ) ) ) ) $= ( IMP-sort-17-is-pattern top-is-pattern IMP-sort-13-is-pattern kore-dv-is-pattern kore-inj-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern and-is-pattern string-literal-14-is-pattern string-literal-10-is-pattern IMP-symbol-192-is-pattern typecode-cache-Pattern-31 eq-is-pattern exists-is-pattern top-intro rule-weakening IMP-sort-22-is-pattern sorting-cache-31 sorting-rearrange-182 kore-functional rule-imp-transitivity ) AHIDJDBNCECKFGCECLFGMOBPAHIDJDQRSCECKFGCECLFGMDBTBUAUBUC $. $}
