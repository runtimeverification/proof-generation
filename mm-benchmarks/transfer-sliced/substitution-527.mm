$c #Substitution #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-exists \kore-symbol-Lbl'-LT-'generatedCounter'-GT-' \kore-valid ) \kore-sort-SortGeneratedCounterCell \kore-equals ( $.
