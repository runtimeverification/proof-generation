...
${ notation-cache-530 $p #Notation ( \kore-symbol-LblisInt ptn1 ) ( \app \kore-symbol-LblisInt-symbol ptn1 ) $= ( IMP-symbol-265-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-265-is-pattern IMP-symbol-265-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
