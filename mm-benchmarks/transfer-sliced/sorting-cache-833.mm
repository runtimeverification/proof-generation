...
${ sorting-cache-833 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) \top ) ( \and ( \and ( \kore-is-sort \kore-sort-SortId ) ( \kore-is-sort \kore-sort-SortAExp ) ) ( \in-sort ( \kore-dv \kore-sort-SortId "balanceSender" ) \kore-sort-SortId ) ) ) $= ( IMP-sort-17-is-pattern in-sort-is-pattern and-is-pattern kore-is-sort-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern top-is-pattern IMP-sort-13-is-pattern string-literal-10-is-pattern kore-dv-is-pattern sorting-cache-830 sorting-cache-818 rule-and-intro-alt2-sugar ) AFGCHDBEIEDBJKBCALAMN $. $}
