...
${ sorting-cache-1933 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) \top ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-179 IMP-sort-17-is-pattern top-is-pattern and-is-pattern rule-imp-transitivity typecode-cache-Pattern-397 typecode-cache-Pattern-178 IMP-sort-9-is-pattern and-elim-right-sugar and-elim-left-sugar imp-reflexivity ) ABIBDECFGBDECAJKCBDECFGLBDECFGBDECBDECBDECFMBDECNHH $. $}
