...
${ notation-cache-577 $p #Notation ( \kore-symbol-LblisString ptn0 ) ( \app \kore-symbol-LblisString-symbol ptn0 ) $= ( IMP-symbol-280-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-280-is-pattern IMP-symbol-280-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
