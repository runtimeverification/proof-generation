...
${ sorting-cache-1835 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) \top ) ) ) ) ( \and ( \in-sort kore-element-var-VE0 \kore-sort-SortGeneratedCounterCell ) \top ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) ) $= ( in-sort-is-pattern and-is-pattern IMP-sort-18-is-pattern typecode-cache-Pattern-146 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-177 typecode-cache-Pattern-382 typecode-cache-Pattern-148 IMP-sort-10-is-pattern top-is-pattern typecode-cache-Pattern-179 and-elim-left-sugar sorting-cache-1834 rule-imp-transitivity ) CIJFBKHFDELGGAMNFOGGCIJFBKHFDELGGEPHFCIJFBKHFDELGGAMNFOGQBCDERS $. $}
