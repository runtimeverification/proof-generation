$c #Substitution #SetVariable #ElementVariable #Symbol \kore-sort-SortStmt #Variable #Pattern \kore-exists \kore-symbol-Lbl'UndsUndsUnds'IMP-SYNTAX'Unds'Stmt'Unds'Stmt'Unds'Stmt \kore-valid ) \kore-equals ( $.
