$c \top \kore-sort-SortAExp #Variable \imp \kore-dv \kore-is-sort |- \kore-sort-SortId \kore-valid ) \kore-equals \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp \and #SetVariable #ElementVariable #Symbol #Pattern \kore-exists \kore-inj \in-sort "balanceTo" ( $.
...
sorting-rearrange-223 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortAExp ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortAExp kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortAExp kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceTo" ) ) kore-element-var-K1 ) ) ) ) ) $.
${ sorting-rearrange-224 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortAExp ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortAExp kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortAExp kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsPlusUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceTo" ) ) kore-element-var-K1 ) ) ) ) ) $= ( typecode-cache-Pattern-0 IMP-sort-13-is-pattern and-is-pattern top-is-pattern typecode-cache-Pattern-49 IMP-sort-17-is-pattern kore-is-sort-is-pattern in-sort-is-pattern typecode-cache-Pattern-86 typecode-cache-Pattern-31 string-literal-17-is-pattern kore-dv-is-pattern kore-inj-is-pattern IMP-symbol-160-is-pattern kore-equals-is-pattern kore-exists-is-pattern kore-valid-is-pattern sorting-cache-315 sorting-rearrange-223 rule-imp-transitivity ) ADJGFCHEKGFFACLADEADEADBMIEINOPCHQRBSTACUAABCUBUC $. $}
