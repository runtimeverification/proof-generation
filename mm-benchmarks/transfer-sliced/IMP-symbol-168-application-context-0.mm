...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-168-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds-LT-Eqls'Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-168-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-168-is-pattern application-context-app-right application-context-app-left notation-cache-271 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
