$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'Hash'tell'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'Int-symbol #Variable #Pattern \kore-symbol-Lbl'Hash'tell'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'Int \app ) ( $.
...
${ notation-cache-131 $p #Notation ( \kore-symbol-Lbl'Hash'tell'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'Int ptn0 ) ( \app \kore-symbol-Lbl'Hash'tell'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'Int-symbol ptn0 ) $= ( IMP-symbol-115-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-115-is-pattern IMP-symbol-115-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
