$c #Substitution #Notation "amount" \iff \top "balanceSender" \ceil \kore-sort-SortAExp \or \kore-symbol-kseq #Variable #ApplicationContext \included \floor \inh \kore-sort-SortBool \kore-sort-SortK \imp \kore-dv \kore-is-sort |- \kore-sort-SortId \kore-valid \bot ) \in-sort \and \kore-sort-SortKResult #SetVariable #ElementVariable #Symbol \eq \sorted-exists #Pattern \is-predicate \kore-not \kore-sort-SortKItem \kore-in \not \kore-inj \kore-sort-SortInt \kore-symbol-Lbl'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp \kore-symbol-dotk ( $.
...
hooked-sort-no-confusion-IMP-sort-23-IMP-symbol-164 $a |- ( \not ( \and ( \kore-symbol-Lbl'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ptn0 ptn1 ) ( \inh \kore-sort-SortInt ) ) ) $.
hooked-sort-no-confusion-IMP-sort-32-IMP-symbol-164 $a |- ( \not ( \and ( \kore-symbol-Lbl'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ptn0 ptn1 ) ( \inh \kore-sort-SortBool ) ) ) $.
sorting-rearrange-1174 $a |- ( \imp ( \in-sort kore-element-var-VE2 \kore-sort-SortKResult ) ( \ceil ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortAExp \kore-sort-SortKItem ( \kore-symbol-Lbl'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) ) ) \kore-symbol-dotk ) ) ) $.
sorting-cache-2026 $a |- ( \imp ( \in-sort kore-element-var-VE2 \kore-sort-SortKResult ) ( \in-sort ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortAExp \kore-sort-SortKItem ( \kore-symbol-Lbl'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) ) ) \kore-symbol-dotk ) \kore-sort-SortK ) ) $.
${ sorting-rearrange-1175 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortKResult ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-not kore-sort-var-R ( \kore-in \kore-sort-SortK kore-sort-var-R ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortAExp \kore-sort-SortKItem ( \kore-symbol-Lbl'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) ) ) \kore-symbol-dotk ) ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortKResult \kore-sort-SortKItem kore-element-var-VE2 ) \kore-symbol-dotk ) ) ) ) ) $= ( IMP-sort-28-is-pattern kore-inj-is-pattern IMP-sort-17-is-pattern typecode-cache-Pattern-177 BASIC-K-sort-1-is-pattern KSEQ-symbol-1-is-pattern IMP-sort-13-is-pattern x0-is-element-var kore-dv-is-pattern and-is-pattern sorted-exists-is-pattern element-var-is-var KSEQ-symbol-0-is-pattern string-literal-10-is-pattern string-literal-14-is-pattern IMP-symbol-164-is-pattern kore-element-var-x0-elementvariable typecode-cache-Pattern-283 in-sort-is-pattern inh-is-pattern bot-is-pattern substitution-var-same substitution-disjoint typecode-cache-Pattern-25 KSEQ-symbol-0-substitution imp-is-pattern included-is-pattern floor-is-pattern IMP-sort-23-is-pattern IMP-sort-32-is-pattern top-is-pattern rule-imp-transitivity typecode-cache-Pattern-0 is-predicate-is-pattern application-context-var KSEQ-symbol-0-application-context-0 or-is-pattern disjointness-sort disjointness-simplify BASIC-K-sort-0-is-pattern notation-is-predicate notation-proof kore-inj-id imp-reflexivity imp-compat-in-sorted-exists substitution-kore-inj sorted-exists-propagation-converse typecode-cache-Pattern-284 kore-in-is-pattern kore-not-is-pattern kore-valid-is-pattern sorting-cache-1213 lemma-floor-is-predicate included-is-sugar notation-reflexivity notation-transitivity notation-cache-770 sorting-rearrange-1174 sorting-cache-2026 sorting-cache-1212 KSEQ-symbol-0-no-confusion hooked-sort-no-confusion-IMP-sort-23-IMP-symbol-164 hooked-sort-no-confusion-IMP-sort-32-IMP-symbol-164 disjointness-case no-junk-axiom-30 rule-eq-to-iff rule-iff-elim-left disjointness-eq kore-inj-application-context-2 substitution-853 substitution-854 substitution-857 desugar-not-to-imp proof-rule-frame proof-rule-propagation-bot sugar-imp-to-not substitution-858 substitution-859 disjointness-exists disjointness-to-not-in )  $. $}
