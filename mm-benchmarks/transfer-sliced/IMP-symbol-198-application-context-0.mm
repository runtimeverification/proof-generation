$c #Notation #SetVariable \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB' #ElementVariable #Symbol \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB'-symbol #Variable #Pattern #ApplicationContext \app ) ( $.
...
notation-cache-357 $a #Notation ( \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-198-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-198-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB' ptn0 ptn1 ) $= ( IMP-symbol-198-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-198-is-pattern application-context-app-right application-context-app-left notation-cache-357 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
