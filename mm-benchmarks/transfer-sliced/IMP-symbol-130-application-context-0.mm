$c \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment-symbol ( $.
...
notation-cache-161 $a #Notation ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-130-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-130-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment ptn0 ptn1 ) $= ( IMP-symbol-130-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-130-is-pattern application-context-app-right application-context-app-left notation-cache-161 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
