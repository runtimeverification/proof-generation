...
${ sorting-cache-2108 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ) ( \in-sort ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "90" ) ) \kore-sort-SortKItem ) ) $= ( and-is-pattern IMP-sort-23-is-pattern kore-is-sort-is-pattern top-is-pattern typecode-cache-Pattern-0 string-literal-19-is-pattern kore-dv-is-pattern in-sort-is-pattern BASIC-K-sort-1-is-pattern kore-inj-is-pattern sorting-cache-1573 imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp rule-and-intro-alt2-sugar INJ-symbol-0-sorting rule-imp-transitivity ) AFDEBAFDEBEBBCDJDBCGHCIBCJCGHKJIAFDEBAFDEBEBBCDJDBCGHCIALCGHCIAFDEBAFDEBEBBCGHCIMCGHCIAFDEBAFDEBEBBNCGOPQCJCGHRS $. $}
