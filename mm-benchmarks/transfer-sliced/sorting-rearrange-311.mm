$c \exists #Substitution \top #Variable \imp \kore-is-sort |- \kore-valid ) \kore-equals \and \unit-sort \kore-symbol-Lbl'Stop'Map #SetVariable #ElementVariable \kore-symbol-Lbl'Unds'Map'Unds' #Symbol \eq #Pattern \kore-sort-SortMap ( $.
...
substitution-142 $a #Substitution \kore-symbol-Lbl'Stop'Map \kore-symbol-Lbl'Stop'Map \unit-sort kore-sort-var-R $.
sorting-rearrange-310 $a |- ( \imp ( \and \top ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-equals \kore-sort-SortMap kore-sort-var-R \kore-symbol-Lbl'Stop'Map ( \kore-symbol-Lbl'Unds'Map'Unds' \kore-symbol-Lbl'Stop'Map \kore-symbol-Lbl'Stop'Map ) ) ) ) $.
substitution-593 $a #Substitution ( \kore-equals \kore-sort-SortMap kore-sort-var-x0 \kore-symbol-Lbl'Stop'Map ( \kore-symbol-Lbl'Unds'Map'Unds' \kore-symbol-Lbl'Stop'Map \kore-symbol-Lbl'Stop'Map ) ) ( \kore-equals \kore-sort-SortMap kore-sort-var-R \kore-symbol-Lbl'Stop'Map ( \kore-symbol-Lbl'Unds'Map'Unds' \kore-symbol-Lbl'Stop'Map \kore-symbol-Lbl'Stop'Map ) ) kore-sort-var-x0 kore-sort-var-R $.
${ sorting-rearrange-311 $p |- ( \imp \top ( \kore-valid \unit-sort ( \kore-equals \kore-sort-SortMap \unit-sort \kore-symbol-Lbl'Stop'Map ( \kore-symbol-Lbl'Unds'Map'Unds' \kore-symbol-Lbl'Stop'Map \kore-symbol-Lbl'Stop'Map ) ) ) ) $= ( IMP-symbol-124-is-pattern kore-sort-var-R-elementvariable unit-sort-is-symbol symbol-is-pattern top-is-pattern IMP-symbol-194-is-pattern IMP-sort-14-is-pattern typecode-cache-Pattern-0 kore-sort-var-x0-elementvariable kore-equals-is-pattern typecode-cache-Pattern-14 and-is-pattern kore-is-sort-is-pattern element-var-is-var kore-valid-is-pattern x-is-element-var substitution-var-same rule-weakening substitution-kore-valid substitution-imp top-intro sorting-cache-129 rule-and-intro-alt2-sugar typecode-cache-Pattern-22 exists-is-pattern unit-sort-is-functional sorting-rearrange-310 substitution-83 substitution-140 substitution-142 substitution-disjoint substitution-kore-equals substitution-87 substitution-593 functional-substitution-alt rule-imp-transitivity )  $. $}
