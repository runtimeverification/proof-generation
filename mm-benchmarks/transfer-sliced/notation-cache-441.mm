...
${ notation-cache-441 $p #Notation ( \kore-symbol-LblcountAllOccurrences'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String ptn3 ptn4 ) ( \app ( \app \kore-symbol-LblcountAllOccurrences'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-229-is-symbol symbol-is-pattern IMP-symbol-229-is-pattern IMP-symbol-229-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
