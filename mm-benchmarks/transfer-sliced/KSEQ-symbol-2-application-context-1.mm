...
${ $d xX0 ptn0 $.
   ...
   KSEQ-symbol-2-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-append ptn0 ptn1 ) $= ( app-is-pattern KSEQ-symbol-2-is-symbol symbol-is-pattern KSEQ-symbol-2-is-pattern application-context-app-right notation-cache-5 notation-application-context ) FGBECEBCHAFGBECADIBCJK $. $}
