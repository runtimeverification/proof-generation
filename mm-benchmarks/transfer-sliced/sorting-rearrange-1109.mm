$c \exists #Substitution \top #Variable \kore-sort-SortBool \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals "false" \and \unit-sort \kore-sort-SortKResult #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-sort-SortKItem \kore-inj ( $.
...
sorting-rearrange-1108 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \kore-valid kore-sort-var-R ( \kore-equals \kore-sort-SortKItem kore-sort-var-R ( \kore-inj \kore-sort-SortKResult \kore-sort-SortKItem ( \kore-inj \kore-sort-SortBool \kore-sort-SortKResult ( \kore-dv \kore-sort-SortBool "false" ) ) ) ( \kore-inj \kore-sort-SortBool \kore-sort-SortKItem ( \kore-dv \kore-sort-SortBool "false" ) ) ) ) ) $.
${ sorting-rearrange-1109 $p |- ( \imp \top ( \kore-valid \unit-sort ( \kore-equals \kore-sort-SortKItem \unit-sort ( \kore-inj \kore-sort-SortKResult \kore-sort-SortKItem ( \kore-inj \kore-sort-SortBool \kore-sort-SortKResult ( \kore-dv \kore-sort-SortBool "false" ) ) ) ( \kore-inj \kore-sort-SortBool \kore-sort-SortKItem ( \kore-dv \kore-sort-SortBool "false" ) ) ) ) ) $= ( IMP-sort-32-is-pattern kore-inj-is-pattern BASIC-K-sort-1-is-pattern kore-sort-var-R-elementvariable IMP-sort-28-is-pattern string-literal-5-is-pattern kore-dv-is-pattern top-is-pattern typecode-cache-Pattern-0 unit-sort-is-symbol symbol-is-pattern kore-sort-var-x0-elementvariable and-is-pattern typecode-cache-Pattern-14 kore-is-sort-is-pattern element-var-is-var kore-equals-is-pattern kore-valid-is-pattern x-is-element-var substitution-var-same substitution-disjoint rule-weakening top-intro rule-and-intro-alt2-sugar rule-imp-transitivity substitution-kore-equals substitution-kore-valid substitution-imp sorting-cache-129 typecode-cache-Pattern-22 exists-is-pattern unit-sort-is-functional sorting-cache-136 sorting-rearrange-1108 substitution-83 substitution-84 substitution-87 substitution-88 functional-substitution-alt )  $. $}
