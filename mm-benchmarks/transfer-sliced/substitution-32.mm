...
${ substitution-32 $p #Substitution ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp kore-element-var-T ) ( \kore-inj \kore-sort-SortId kore-sort-var-S2 kore-element-var-T ) \kore-sort-SortAExp kore-sort-var-S2 $= ( IMP-sort-13-is-pattern IMP-sort-17-is-pattern element-var-is-var typecode-cache-Pattern-6 typecode-cache-Pattern-1 substitution-disjoint substitution-var-same substitution-31 substitution-kore-inj ) DCBFDAGBFCAEDCAEHCAEIABJK $. $}
