...
sorting-rearrange-1362 $a |- ( \imp ( \in-sort kore-element-var-VE2 \kore-sort-SortKResult ) ( \ceil ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "balanceTo" ) ) \kore-symbol-dotk ) ) ) $.
sorting-cache-2170 $a |- ( \imp ( \in-sort kore-element-var-VE2 \kore-sort-SortKResult ) ( \in-sort ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "balanceTo" ) ) \kore-symbol-dotk ) \kore-sort-SortK ) ) $.
${ sorting-rearrange-1363 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortKResult ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-not kore-sort-var-R ( \kore-in \kore-sort-SortK kore-sort-var-R ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "balanceTo" ) ) \kore-symbol-dotk ) ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortKResult \kore-sort-SortKItem kore-element-var-VE2 ) \kore-symbol-dotk ) ) ) ) ) $= ( IMP-sort-28-is-pattern typecode-cache-Pattern-177 BASIC-K-sort-1-is-pattern KSEQ-symbol-1-is-pattern kore-inj-is-pattern x0-is-element-var IMP-sort-17-is-pattern and-is-pattern sorted-exists-is-pattern element-var-is-var KSEQ-symbol-0-is-pattern string-literal-17-is-pattern kore-dv-is-pattern kore-element-var-x0-elementvariable inh-is-pattern in-sort-is-pattern typecode-cache-Pattern-283 bot-is-pattern typecode-cache-Pattern-25 substitution-var-same substitution-disjoint KSEQ-symbol-0-substitution IMP-sort-23-is-pattern IMP-sort-32-is-pattern top-is-pattern imp-is-pattern included-is-pattern floor-is-pattern rule-imp-transitivity typecode-cache-Pattern-0 is-predicate-is-pattern application-context-var KSEQ-symbol-0-application-context-0 or-is-pattern disjointness-sort disjointness-simplify BASIC-K-sort-0-is-pattern notation-is-predicate notation-proof kore-inj-id sorting-cache-5 top-intro proof-rule-mp disjointness-symmetry disjointness-in-sort imp-reflexivity imp-compat-in-sorted-exists substitution-kore-inj sorted-exists-propagation-converse typecode-cache-Pattern-284 kore-in-is-pattern kore-not-is-pattern kore-valid-is-pattern sorting-cache-1213 lemma-floor-is-predicate included-is-sugar notation-reflexivity notation-transitivity notation-cache-770 sorting-rearrange-1362 sorting-cache-2170 sorting-cache-1212 KSEQ-symbol-0-no-confusion IMP-sort-23-hooked-sort-disjoint-with-SortId IMP-sort-32-hooked-sort-disjoint-with-SortId disjointness-case no-junk-axiom-30 rule-eq-to-iff rule-iff-elim-left disjointness-eq kore-inj-application-context-2 substitution-853 substitution-854 substitution-857 desugar-not-to-imp proof-rule-frame proof-rule-propagation-bot sugar-imp-to-not substitution-858 substitution-859 disjointness-exists disjointness-to-not-in )  $. $}
