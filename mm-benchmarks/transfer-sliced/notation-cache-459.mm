...
${ notation-cache-459 $p #Notation ( \kore-symbol-LblfreshInt'LParUndsRParUnds'INT'Unds'Int'Unds'Int ptn0 ) ( \app \kore-symbol-LblfreshInt'LParUndsRParUnds'INT'Unds'Int'Unds'Int-symbol ptn0 ) $= ( IMP-symbol-238-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-238-is-pattern IMP-symbol-238-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
