...
${ sorting-rearrange-289 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-and kore-sort-var-R ( \kore-equals \kore-sort-SortGeneratedCounterCell kore-sort-var-R \kore-symbol-LblinitGeneratedCounterCell ( \kore-symbol-Lbl'-LT-'generatedCounter'-GT-' ( \kore-dv \kore-sort-SortInt "0" ) ) ) ( \kore-top kore-sort-var-R ) ) ) ) $= ( typecode-cache-Pattern-0 and-is-pattern top-is-pattern kore-is-sort-is-pattern rule-imp-transitivity and-elim-left-sugar IMP-sort-10-is-pattern IMP-symbol-242-is-pattern IMP-sort-23-is-pattern string-literal-1-is-pattern kore-dv-is-pattern IMP-symbol-128-is-pattern kore-equals-is-pattern kore-top-is-pattern kore-and-is-pattern kore-valid-is-pattern imp-reflexivity top-intro rule-weakening rule-and-intro-alt2-sugar sorting-rearrange-287 ) ABEDCABEDCDCCABEDCABABHABIJKLMNABOPQABEDCABEDCDCCABEDABEDCABEDCDCCABEDCABEABEDCABEDCDCGABEDCABEABEABEDGABERFFABEDCABEDCDCCDSTUAAUBF $. $}
