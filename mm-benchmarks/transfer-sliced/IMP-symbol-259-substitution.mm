$c #Substitution #Notation #SetVariable \kore-symbol-LblisIOError #ElementVariable #Symbol #Variable #Pattern \app \kore-symbol-LblisIOError-symbol ) ( $.
...
notation-cache-512 $a #Notation ( \kore-symbol-LblisIOError ptn1 ) ( \app \kore-symbol-LblisIOError-symbol ptn1 ) $.
notation-cache-513 $a #Notation ( \kore-symbol-LblisIOError ptn2 ) ( \app \kore-symbol-LblisIOError-symbol ptn2 ) $.
${ IMP-symbol-259-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-259-substitution $p #Substitution ( \kore-symbol-LblisIOError ptn1 ) ( \kore-symbol-LblisIOError ptn2 ) ptn0 xX0 $= ( IMP-symbol-259-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-259-is-pattern substitution-disjoint substitution-app notation-cache-512 notation-cache-513 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
