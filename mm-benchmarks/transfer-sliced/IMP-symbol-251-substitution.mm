$c #Substitution #Notation #SetVariable \kore-symbol-LblisBExp #ElementVariable #Symbol \kore-symbol-LblisBExp-symbol #Variable #Pattern \app ) ( $.
...
notation-cache-488 $a #Notation ( \kore-symbol-LblisBExp ptn1 ) ( \app \kore-symbol-LblisBExp-symbol ptn1 ) $.
notation-cache-489 $a #Notation ( \kore-symbol-LblisBExp ptn2 ) ( \app \kore-symbol-LblisBExp-symbol ptn2 ) $.
${ IMP-symbol-251-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-251-substitution $p #Substitution ( \kore-symbol-LblisBExp ptn1 ) ( \kore-symbol-LblisBExp ptn2 ) ptn0 xX0 $= ( IMP-symbol-251-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-251-is-pattern substitution-disjoint substitution-app notation-cache-488 notation-cache-489 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
