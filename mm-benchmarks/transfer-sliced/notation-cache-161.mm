...
${ notation-cache-161 $p #Notation ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-fragment-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-130-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-130-is-pattern IMP-symbol-130-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
