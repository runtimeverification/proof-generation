...
${ notation-cache-90 $p #Notation ( \kore-symbol-Lbl'Hash'getc'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'Int ptn0 ) ( \app \kore-symbol-Lbl'Hash'getc'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'Int-symbol ptn0 ) $= ( IMP-symbol-97-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-97-is-pattern IMP-symbol-97-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
