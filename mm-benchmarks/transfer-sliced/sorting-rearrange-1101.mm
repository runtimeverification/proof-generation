$c \exists \top #SetVariable #ElementVariable #Symbol \eq #Variable #Pattern \kore-sort-SortBool \imp ( \kore-is-sort |- ) \and $.
...
${ sorting-rearrange-1101 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S2 ) ( \and ( \kore-is-sort kore-sort-var-S3 ) \top ) ) ) ( \exists x ( \eq x \kore-sort-SortBool ) ) ) $= ( top-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern typecode-cache-Pattern-3 and-is-pattern IMP-sort-32-is-pattern typecode-cache-Pattern-4 eq-is-pattern exists-is-pattern top-intro rule-weakening sorting-cache-176 kore-sort-functional rule-imp-transitivity ) BFGCDHIEAKJLAMBFGCDHIENOJEAPQR $. $}
