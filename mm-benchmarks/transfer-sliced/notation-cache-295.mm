...
${ notation-cache-295 $p #Notation ( \kore-symbol-Lbl'UndsEqlsSlshEqls'Bool'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsSlshEqls'Bool'Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-176-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-176-is-pattern IMP-symbol-176-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
