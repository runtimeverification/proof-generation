$c \kore-symbol-LblisBool-symbol #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-LblisBool ( $.
...
notation-cache-496 $a #Notation ( \kore-symbol-LblisBool ptn0 ) ( \app \kore-symbol-LblisBool-symbol ptn0 ) $.
${ IMP-symbol-253-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-253-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblisBool ptn0 ) $= ( IMP-symbol-253-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-253-is-pattern application-context-app-right notation-cache-496 notation-application-context ) DEBFBGADEBACHBIJ $. $}
