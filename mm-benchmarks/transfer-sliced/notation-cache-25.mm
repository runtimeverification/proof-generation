...
${ notation-cache-25 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'UndsAnd-And-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp'Unds'BExp0'Unds' ptn1 ) ( \app \kore-symbol-Lbl'Hash'freezer'UndsAnd-And-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp'Unds'BExp0'Unds'-symbol ptn1 ) $= ( IMP-symbol-76-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-76-is-pattern IMP-symbol-76-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
