...
sorting-cache-1805 $a |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) ( \and ( \kore-is-sort kore-sort-var-S2 ) \top ) ) ( \in-sort kore-element-var-T \kore-sort-SortBool ) ) $.
${ sorting-cache-1806 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) ( \and ( \kore-is-sort kore-sort-var-S2 ) \top ) ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) $= ( and-is-pattern kore-is-sort-is-pattern top-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-379 typecode-cache-Pattern-1 typecode-cache-Pattern-6 IMP-sort-32-is-pattern in-sort-is-pattern sorting-cache-1805 top-intro rule-weakening rule-and-intro-alt2-sugar ) AHFBDIECJFGEEDKLMGABCDNAHFBDIECJFGEEGOPQ $. $}
