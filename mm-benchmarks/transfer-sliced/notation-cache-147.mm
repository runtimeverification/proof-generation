...
${ notation-cache-147 $p #Notation ( \kore-symbol-Lbl'-LT-'T'-GT-' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'-LT-'T'-GT-'-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-126-is-symbol symbol-is-pattern IMP-symbol-126-is-pattern IMP-symbol-126-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
