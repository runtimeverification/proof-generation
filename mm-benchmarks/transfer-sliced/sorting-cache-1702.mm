...
${ sorting-cache-1702 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) \top ) ) ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-357 typecode-cache-Pattern-179 IMP-sort-22-is-pattern and-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-253 BASIC-K-sort-1-is-pattern and-elim-right-sugar rule-imp-transitivity sorting-cache-1701 ) AJKEBGHECDFIIBGHECDFICLMEAJKEBGHECDFINBGHECDFICDFCLMEBGHECDFNCDPOO $. $}
