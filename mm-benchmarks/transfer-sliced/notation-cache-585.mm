...
${ notation-cache-585 $p #Notation ( \kore-symbol-LblisTCellOpt ptn2 ) ( \app \kore-symbol-LblisTCellOpt-symbol ptn2 ) $= ( IMP-symbol-283-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-283-is-pattern IMP-symbol-283-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
