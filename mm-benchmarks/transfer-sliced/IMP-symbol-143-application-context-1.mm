...
${ $d xX0 ptn0 $.
   ...
   IMP-symbol-143-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-LblMap'Coln'update ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-143-is-symbol symbol-is-pattern IMP-symbol-143-is-pattern application-context-app-right application-context-app-left notation-cache-196 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAGHBFCAEJKBCDLM $. $}
