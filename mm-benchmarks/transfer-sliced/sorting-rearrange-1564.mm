...
${ sorting-rearrange-1564 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortInt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) \top ) ) ) ) ( \exists kore-element-var-V0 ( \eq kore-element-var-V0 ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortStmt \kore-sort-SortKItem ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "ret" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "1" ) ) ) ) \kore-symbol-dotk ) ) ) ) $= ( IMP-sort-23-is-pattern in-sort-is-pattern IMP-sort-17-is-pattern and-is-pattern kore-dv-is-pattern kore-inj-is-pattern top-is-pattern typecode-cache-Pattern-177 typecode-cache-Pattern-178 typecode-cache-Pattern-254 IMP-sort-31-is-pattern BASIC-K-sort-1-is-pattern string-literal-11-is-pattern IMP-sort-13-is-pattern string-literal-4-is-pattern IMP-symbol-185-is-pattern KSEQ-symbol-1-is-pattern KSEQ-symbol-0-is-pattern typecode-cache-Pattern-39 eq-is-pattern exists-is-pattern top-intro rule-weakening BASIC-K-sort-0-is-pattern sorting-cache-184 sorting-rearrange-1147 kore-functional rule-imp-transitivity ) AMFGBNHGCEOIILDUDPQHRJFSFTJKUAKUBUCUEDUFAMFGBNHGCEOIILUGUHUIPQHRJFSFTJKUAKUBUCLDUJDUKULUM $. $}
