$c "1" #Substitution \unit-sort #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-dv ) \kore-equals \kore-sort-SortInt ( $.
...
${ substitution-391 $p #Substitution ( \kore-equals \kore-sort-SortInt \unit-sort kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "1" ) ) ( \kore-equals \kore-sort-SortInt kore-sort-var-x0 kore-element-var-x1 ( \kore-dv \kore-sort-SortInt "1" ) ) \unit-sort kore-sort-var-x0 $= ( IMP-sort-23-is-pattern unit-sort-is-symbol symbol-is-pattern string-literal-4-is-pattern kore-dv-is-pattern element-var-is-var typecode-cache-Pattern-23 typecode-cache-Pattern-14 substitution-116 substitution-var-same substitution-62 substitution-disjoint substitution-kore-equals ) CDEBICFGCAJBICFGDEAHAKDEAHLABMCFGDEAHNO $. $}
