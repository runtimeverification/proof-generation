...
substitution-956 $a #Substitution ( \kore-inj \kore-sort-SortInt \kore-sort-SortKResult kore-element-var-T ) ( \kore-inj \kore-sort-SortInt kore-sort-var-S2 kore-element-var-T ) \kore-sort-SortKResult kore-sort-var-S2 $.
${ substitution-957 $p #Substitution ( \kore-inj \kore-sort-SortKResult kore-sort-var-S3 ( \kore-inj \kore-sort-SortInt \kore-sort-SortKResult kore-element-var-T ) ) ( \kore-inj kore-sort-var-S2 kore-sort-var-S3 ( \kore-inj \kore-sort-SortInt kore-sort-var-S2 kore-element-var-T ) ) \kore-sort-SortKResult kore-sort-var-S2 $= ( IMP-sort-28-is-pattern typecode-cache-Pattern-2 element-var-is-var IMP-sort-23-is-pattern typecode-cache-Pattern-6 kore-inj-is-pattern typecode-cache-Pattern-1 typecode-cache-Pattern-26 substitution-var-same substitution-954 substitution-956 substitution-kore-inj ) DAEGDCHIBJAEBCKDBFDBFLABMBCNO $. $}
