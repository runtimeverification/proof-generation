...
sorting-cache-150 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ( \in-sort kore-element-var-T \kore-sort-SortInt ) ) $.
${ sorting-cache-159 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) $= ( typecode-cache-Pattern-28 typecode-cache-Pattern-0 kore-is-sort-is-pattern and-is-pattern typecode-cache-Pattern-6 IMP-sort-23-is-pattern in-sort-is-pattern top-is-pattern and-elim-right-sugar sorting-cache-150 rule-imp-transitivity top-intro rule-weakening rule-and-intro-alt2-sugar ) AEFBCDGCHIJKAEFBCDGBCDCHIJAEFBCDLBCMNAEFBCDGKOPQ $. $}
