$c \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' "12345" \top "amount" #Variable "10" \imp \kore-dv \kore-is-sort |- \kore-sort-SortId ) \and #SetVariable #ElementVariable \kore-symbol-Lbl'Unds'Map'Unds' #Symbol #Pattern \kore-sort-SortKItem \kore-inj \kore-sort-SortInt "addressTo" \in-sort \kore-sort-SortMap ( $.
...
${ sorting-cache-1080 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \in-sort ( \kore-symbol-Lbl'Unds'Map'Unds' ( \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "addressTo" ) ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "12345" ) ) ) ( \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "amount" ) ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "10" ) ) ) ) \kore-sort-SortMap ) \top ) ) $= ( IMP-sort-17-is-pattern BASIC-K-sort-1-is-pattern kore-dv-is-pattern kore-inj-is-pattern IMP-sort-23-is-pattern IMP-symbol-218-is-pattern top-is-pattern IMP-sort-14-is-pattern in-sort-is-pattern and-is-pattern string-literal-18-is-pattern string-literal-12-is-pattern string-literal-14-is-pattern string-literal-13-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern IMP-symbol-194-is-pattern rule-and-intro-alt2-sugar sorting-cache-1041 sorting-cache-1056 IMP-symbol-194-sorting rule-imp-transitivity top-intro rule-weakening ) APQHKBCBLDEFCFMDEGBCBNDEFCFODEGRIJHAPQHKBCBLDEFCFMDEGIJBCBNDEFCFODEGIJKBCBLDEFCFMDEGBCBNDEFCFODEGRIJAPQHKBCBLDEFCFMDEGIJBCBNDEFCFODEGIJATAUASBCBLDEFCFMDEGBCBNDEFCFODEGUBUCAPQHKHUDUES $. $}
