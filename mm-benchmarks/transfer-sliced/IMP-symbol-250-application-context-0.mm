$c #Notation #SetVariable \kore-symbol-LblisArray-symbol #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app \kore-symbol-LblisArray ) ( $.
...
notation-cache-487 $a #Notation ( \kore-symbol-LblisArray ptn0 ) ( \app \kore-symbol-LblisArray-symbol ptn0 ) $.
${ IMP-symbol-250-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-250-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblisArray ptn0 ) $= ( IMP-symbol-250-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-250-is-pattern application-context-app-right notation-cache-487 notation-application-context ) DEBFBGADEBACHBIJ $. $}
