...
${ sorting-cache-1834 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) \top ) ) ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) ) $= ( in-sort-is-pattern IMP-sort-18-is-pattern typecode-cache-Pattern-382 typecode-cache-Pattern-177 and-is-pattern typecode-cache-Pattern-146 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-179 and-elim-right-sugar rule-imp-transitivity sorting-cache-1833 ) BJKEAHFECDGIIAHFECDGIDLFEBJKEAHFECDGIMAHFECDGICDGDLFEAHFECDGMCDONN $. $}
