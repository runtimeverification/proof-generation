$c #Notation #SetVariable #ElementVariable \kore-symbol-LblmaxInt'LParUndsCommUndsRParUnds'INT-COMMON'Unds'Int'Unds'Int'Unds'Int #Symbol \kore-symbol-LblmaxInt'LParUndsCommUndsRParUnds'INT-COMMON'Unds'Int'Unds'Int'Unds'Int-symbol #Variable #Pattern \app ) ( $.
...
${ notation-cache-607 $p #Notation ( \kore-symbol-LblmaxInt'LParUndsCommUndsRParUnds'INT-COMMON'Unds'Int'Unds'Int'Unds'Int ptn0 ptn1 ) ( \app ( \app \kore-symbol-LblmaxInt'LParUndsCommUndsRParUnds'INT-COMMON'Unds'Int'Unds'Int'Unds'Int-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-290-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-290-is-pattern IMP-symbol-290-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
