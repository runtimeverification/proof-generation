...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-236-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblfindString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String'Unds'Int ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-236-is-symbol symbol-is-pattern application-context-app-left IMP-symbol-236-is-pattern application-context-app-right notation-cache-453 notation-application-context ) GHBFCFDFBCDJAGHBFCFDAGHBFCAGHBAEKIIBCDLM $. $}
