...
${ sorting-cache-1628 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortInt ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortInt ) \top ) ) ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortInt ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-347 typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern and-is-pattern IMP-sort-23-is-pattern typecode-cache-Pattern-146 typecode-cache-Pattern-179 and-elim-right-sugar rule-imp-transitivity sorting-cache-1627 ) BKJEAGHECDFIIAGHECDFIDLJEBKJEAGHECDFIMAGHECDFICDFDLJEAGHECDFMCDONN $. $}
