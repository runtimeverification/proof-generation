...
${ notation-cache-449 $p #Notation ( \kore-symbol-Lblexp'LParUndsCommUndsRParUnds'VERIFICAITON'Unds'Int'Unds'Int'Unds'Int ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lblexp'LParUndsCommUndsRParUnds'VERIFICAITON'Unds'Int'Unds'Int'Unds'Int-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-232-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-232-is-pattern IMP-symbol-232-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
