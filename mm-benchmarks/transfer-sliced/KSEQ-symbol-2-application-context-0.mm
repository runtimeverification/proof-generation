$c #Notation #SetVariable \kore-symbol-append #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-append-symbol ( $.
...
notation-cache-5 $a #Notation ( \kore-symbol-append ptn0 ptn1 ) ( \app ( \app \kore-symbol-append-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   KSEQ-symbol-2-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   KSEQ-symbol-2-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-append ptn0 ptn1 ) $= ( KSEQ-symbol-2-is-symbol symbol-is-pattern app-is-pattern KSEQ-symbol-2-is-pattern application-context-app-right application-context-app-left notation-cache-5 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
