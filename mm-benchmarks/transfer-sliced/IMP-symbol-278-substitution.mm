$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \app ( \kore-symbol-LblisStmt ) \kore-symbol-LblisStmt-symbol $.
...
notation-cache-569 $a #Notation ( \kore-symbol-LblisStmt ptn1 ) ( \app \kore-symbol-LblisStmt-symbol ptn1 ) $.
notation-cache-570 $a #Notation ( \kore-symbol-LblisStmt ptn2 ) ( \app \kore-symbol-LblisStmt-symbol ptn2 ) $.
${ IMP-symbol-278-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-278-substitution $p #Substitution ( \kore-symbol-LblisStmt ptn1 ) ( \kore-symbol-LblisStmt ptn2 ) ptn0 xX0 $= ( IMP-symbol-278-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-278-is-pattern substitution-disjoint substitution-app notation-cache-569 notation-cache-570 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
