...
${ notation-cache-602 $p #Notation ( \kore-symbol-LblmakeList'LParUndsCommUndsRParUnds'LIST'Unds'List'Unds'Int'Unds'KItem ptn1 ptn2 ) ( \app ( \app \kore-symbol-LblmakeList'LParUndsCommUndsRParUnds'LIST'Unds'List'Unds'Int'Unds'KItem-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-289-is-symbol symbol-is-pattern IMP-symbol-289-is-pattern IMP-symbol-289-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
