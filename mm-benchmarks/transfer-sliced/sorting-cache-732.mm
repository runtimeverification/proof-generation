...
sorting-cache-731 $a |- ( \imp ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortMap ) ( \and ( \in-sort kore-element-var-K3 \kore-sort-SortMap ) \top ) ) ( \in-sort kore-element-var-K3 \kore-sort-SortMap ) ) $.
${ sorting-cache-732 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortMap ) ( \and ( \in-sort kore-element-var-K3 \kore-sort-SortMap ) \top ) ) ) ( \in-sort kore-element-var-K3 \kore-sort-SortMap ) ) $= ( IMP-sort-14-is-pattern in-sort-is-pattern and-is-pattern typecode-cache-Pattern-209 typecode-cache-Pattern-120 top-is-pattern typecode-cache-Pattern-210 typecode-cache-Pattern-0 kore-is-sort-is-pattern and-elim-right-sugar sorting-cache-731 rule-imp-transitivity ) ABCJBHDECGDEIFFCGDEAKLBHDECGDEIFFMBCNO $. $}
