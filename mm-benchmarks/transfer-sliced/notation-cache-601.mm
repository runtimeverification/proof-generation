...
${ notation-cache-601 $p #Notation ( \kore-symbol-LblmakeArray'LParUndsCommUndsRParUnds'ARRAY-IN-K'Unds'Array'Unds'Int'Unds'KItem ptn0 ptn1 ) ( \app ( \app \kore-symbol-LblmakeArray'LParUndsCommUndsRParUnds'ARRAY-IN-K'Unds'Array'Unds'Int'Unds'KItem-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-288-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-288-is-pattern IMP-symbol-288-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
