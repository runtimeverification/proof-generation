...
${ notation-cache-241 $p #Notation ( \kore-symbol-Lbl'UndsPlus'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsPlus'Int'Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-158-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-158-is-pattern IMP-symbol-158-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
