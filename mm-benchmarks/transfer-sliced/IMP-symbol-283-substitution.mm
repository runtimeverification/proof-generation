$c #Substitution #Notation \kore-symbol-LblisTCellOpt #SetVariable #ElementVariable #Symbol #Variable #Pattern \app \kore-symbol-LblisTCellOpt-symbol ) ( $.
...
notation-cache-584 $a #Notation ( \kore-symbol-LblisTCellOpt ptn1 ) ( \app \kore-symbol-LblisTCellOpt-symbol ptn1 ) $.
notation-cache-585 $a #Notation ( \kore-symbol-LblisTCellOpt ptn2 ) ( \app \kore-symbol-LblisTCellOpt-symbol ptn2 ) $.
${ IMP-symbol-283-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-283-substitution $p #Substitution ( \kore-symbol-LblisTCellOpt ptn1 ) ( \kore-symbol-LblisTCellOpt ptn2 ) ptn0 xX0 $= ( IMP-symbol-283-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-283-is-pattern substitution-disjoint substitution-app notation-cache-584 notation-cache-585 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
