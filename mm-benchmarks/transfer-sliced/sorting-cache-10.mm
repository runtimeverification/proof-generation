...
${ sorting-cache-10 $p |- ( \imp \top ( \in-sort ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "balanceSender" ) ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "balanceTo" ) ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "ret" ) \kore-symbol-Lbl'Stop'List'LBraQuotUndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids'QuotRBraUnds'Ids ) ) ) \kore-sort-SortIds ) ) $= ( IMP-sort-17-is-pattern kore-dv-is-pattern IMP-symbol-161-is-pattern in-sort-is-pattern string-literal-10-is-pattern string-literal-17-is-pattern string-literal-11-is-pattern IMP-symbol-123-is-pattern IMP-sort-0-is-pattern top-is-pattern and-is-pattern sorting-cache-4 sorting-cache-9 rule-and-intro-alt2-sugar IMP-symbol-161-sorting rule-imp-transitivity ) JAEBADAFBAGBHCCIDKAEBAFBAGBHCCCIDJAEBADAFBAGBHCCIDLMNAEBAFBAGBHCCOP $. $}
