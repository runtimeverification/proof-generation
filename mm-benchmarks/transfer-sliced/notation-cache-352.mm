...
${ notation-cache-352 $p #Notation ( \kore-symbol-Lbl'Unds'Set'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'Set'Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-195-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-195-is-pattern IMP-symbol-195-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
