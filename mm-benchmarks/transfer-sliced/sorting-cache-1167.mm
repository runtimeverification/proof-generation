...
${ sorting-cache-1167 $p |- ( \imp ( \and \top ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortBlock ) \top ) ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortBlock ) \top ) ) $= ( top-is-pattern typecode-cache-Pattern-253 IMP-sort-18-is-pattern in-sort-is-pattern and-is-pattern rule-imp-transitivity and-elim-right-sugar and-elim-left-sugar imp-reflexivity top-intro rule-weakening rule-and-intro-alt2-sugar ) BACDEBFFACDEBBACDEBFFACDEBFACDEBACDEBFHACDEBFACDEACDEACDEBIACDEJGGBACDEBFFBKLM $. $}
