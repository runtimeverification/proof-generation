...
${ sorting-cache-519 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ( \in-sort ( \kore-symbol-Lbl'Unds'-'UndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "amount" ) ) ) \kore-sort-SortAExp ) ) $= ( IMP-sort-17-is-pattern IMP-sort-13-is-pattern kore-dv-is-pattern kore-inj-is-pattern and-is-pattern in-sort-is-pattern top-is-pattern string-literal-10-is-pattern string-literal-14-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern IMP-symbol-164-is-pattern sorting-cache-513 sorting-cache-512 rule-and-intro-alt2-sugar IMP-symbol-164-sorting rule-imp-transitivity ) AKLHFHFBCBIDECGBCBJDECGFBCBIDEBCBJDEMCGAKLHFHFBCBIDECGBCBJDECGANAOPBCBIDEBCBJDEQR $. $}
