...
${ notation-cache-169 $p #Notation ( \kore-symbol-LblBase2String'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int'Unds'Int ptn3 ptn4 ) ( \app ( \app \kore-symbol-LblBase2String'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int'Unds'Int-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-133-is-symbol symbol-is-pattern IMP-symbol-133-is-pattern IMP-symbol-133-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
