...
${ notation-cache-508 $p #Notation ( \kore-symbol-LblisGeneratedTopCell ptn0 ) ( \app \kore-symbol-LblisGeneratedTopCell-symbol ptn0 ) $= ( IMP-symbol-257-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-257-is-pattern IMP-symbol-257-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
