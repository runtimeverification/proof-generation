...
${ sorting-cache-1831 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortBlock ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) \top ) ) ) ) ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-382 typecode-cache-Pattern-177 IMP-sort-18-is-pattern and-is-pattern typecode-cache-Pattern-146 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern and-elim-right-sugar rule-imp-transitivity sorting-cache-1830 ) BJKEAGHECDFIIAGHECDFICLMEBJKEAGHECDFINAGHECDFICDFCLMEAGHECDFNCDPOO $. $}
