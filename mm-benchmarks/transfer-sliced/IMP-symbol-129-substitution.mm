$c #Substitution #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'-LT-'generatedTop'-GT-' #Variable #Pattern \app \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-symbol ) ( $.
...
notation-cache-156 $a #Notation ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-symbol ptn1 ) ptn2 ) $.
notation-cache-157 $a #Notation ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'-LT-'generatedTop'-GT-'-symbol ptn3 ) ptn4 ) $.
${ IMP-symbol-129-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   IMP-symbol-129-substitution $p #Substitution ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-' ptn1 ptn2 ) ( \kore-symbol-Lbl'-LT-'generatedTop'-GT-' ptn3 ptn4 ) ptn0 xX0 $= ( IMP-symbol-129-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-129-is-pattern substitution-app substitution-disjoint notation-cache-156 notation-cache-157 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
