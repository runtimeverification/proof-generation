...
${ notation-cache-370 $p #Notation ( \kore-symbol-Lbl'UndsUndsUnds'IMP-SYNTAX'Unds'Stmt'Unds'Stmt'Unds'Stmt ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsUndsUnds'IMP-SYNTAX'Unds'Stmt'Unds'Stmt'Unds'Stmt-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-204-is-symbol symbol-is-pattern IMP-symbol-204-is-pattern IMP-symbol-204-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
