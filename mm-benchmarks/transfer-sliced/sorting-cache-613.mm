...
${ sorting-cache-613 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortMap ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStmt ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortIds ) \top ) ) ) ) ( \in-sort kore-element-var-VE3 \kore-sort-SortStmt ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-180 typecode-cache-Pattern-177 IMP-sort-17-is-pattern and-is-pattern typecode-cache-Pattern-146 IMP-sort-14-is-pattern typecode-cache-Pattern-178 IMP-sort-31-is-pattern and-elim-right-sugar rule-imp-transitivity sorting-cache-612 ) BJKEAGHECDFIIAGHECDFICLMEBJKEAGHECDFINAGHECDFICDFCLMEAGHECDFNCDPOO $. $}
