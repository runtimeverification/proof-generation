$c #Substitution #Notation #SetVariable \kore-symbol-Lbl'-LT-'state'-GT-' #ElementVariable #Symbol #Variable #Pattern \app \kore-symbol-Lbl'-LT-'state'-GT-'-symbol ) ( $.
...
notation-cache-165 $a #Notation ( \kore-symbol-Lbl'-LT-'state'-GT-' ptn1 ) ( \app \kore-symbol-Lbl'-LT-'state'-GT-'-symbol ptn1 ) $.
notation-cache-166 $a #Notation ( \kore-symbol-Lbl'-LT-'state'-GT-' ptn2 ) ( \app \kore-symbol-Lbl'-LT-'state'-GT-'-symbol ptn2 ) $.
${ IMP-symbol-132-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-132-substitution $p #Substitution ( \kore-symbol-Lbl'-LT-'state'-GT-' ptn1 ) ( \kore-symbol-Lbl'-LT-'state'-GT-' ptn2 ) ptn0 xX0 $= ( IMP-symbol-132-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-132-is-pattern substitution-disjoint substitution-app notation-cache-165 notation-cache-166 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
