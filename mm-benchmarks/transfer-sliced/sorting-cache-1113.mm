...
${ sorting-cache-1113 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortBlock ) \top ) ) ) ) ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortBlock ) \top ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortBlock ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-263 IMP-sort-18-is-pattern typecode-cache-Pattern-146 top-is-pattern typecode-cache-Pattern-253 and-elim-left-sugar sorting-cache-1101 rule-imp-transitivity ) AHIFCJKFDELGGBNMFOGGAHIFCJKFDELGGEPMFAHIFCJKFDELGGBNMFOGQACDERS $. $}
