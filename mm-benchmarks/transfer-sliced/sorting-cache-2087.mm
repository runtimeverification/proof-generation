$c \top #SetVariable \kore-sort-SortAExp #ElementVariable #Symbol #Variable #Pattern \and \kore-sort-SortK \imp \kore-sort-SortKItem \kore-dv \kore-symbol-Lbl'-LT-'generatedCounter'-GT-' "0" |- \kore-sort-SortId ) \kore-sort-SortInt \kore-sort-SortGeneratedCounterCell \in-sort \kore-sort-SortStateCell ( $.
...
${ sorting-cache-2087 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ) ) ) ( \in-sort ( \kore-symbol-Lbl'-LT-'generatedCounter'-GT-' ( \kore-dv \kore-sort-SortInt "0" ) ) \kore-sort-SortGeneratedCounterCell ) ) $= ( in-sort-is-pattern IMP-sort-23-is-pattern and-is-pattern string-literal-1-is-pattern kore-dv-is-pattern typecode-cache-Pattern-146 IMP-sort-17-is-pattern typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-324 IMP-symbol-128-is-pattern IMP-sort-10-is-pattern imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp IMP-symbol-128-sorting rule-imp-transitivity ) BKLFAMNFCOPFDEQHHHGIJGFGIJRSFGIJGFBKLFAMNFCOPFDEQHHHGIJGFTGIJGFBKLFAMNFCOPFDEQHHHUAGIUBUCGIJUDUE $. $}
