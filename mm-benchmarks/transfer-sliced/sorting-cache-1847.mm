...
${ sorting-cache-1847 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) \top ) ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) \top ) ) ) $= ( typecode-cache-Pattern-382 in-sort-is-pattern top-is-pattern typecode-cache-Pattern-179 IMP-sort-18-is-pattern rule-and-intro-alt2-sugar typecode-cache-Pattern-178 IMP-sort-9-is-pattern and-is-pattern sorting-cache-1830 sorting-cache-1833 top-intro rule-weakening ) ABCAIJDBFGDEKABLABCBFGDEABMABCENOHH $. $}
