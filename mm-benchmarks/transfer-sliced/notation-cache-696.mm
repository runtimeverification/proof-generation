...
${ notation-cache-696 $p #Notation ( \kore-symbol-Lblproject'Coln'Map ptn2 ) ( \app \kore-symbol-Lblproject'Coln'Map-symbol ptn2 ) $= ( IMP-symbol-325-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-325-is-pattern IMP-symbol-325-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
