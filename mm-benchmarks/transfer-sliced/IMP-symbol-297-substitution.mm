$c #Substitution #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-LblnotBool'Unds' #Variable #Pattern \app \kore-symbol-LblnotBool'Unds'-symbol ) ( $.
...
notation-cache-611 $a #Notation ( \kore-symbol-LblnotBool'Unds' ptn1 ) ( \app \kore-symbol-LblnotBool'Unds'-symbol ptn1 ) $.
notation-cache-612 $a #Notation ( \kore-symbol-LblnotBool'Unds' ptn2 ) ( \app \kore-symbol-LblnotBool'Unds'-symbol ptn2 ) $.
${ IMP-symbol-297-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-297-substitution $p #Substitution ( \kore-symbol-LblnotBool'Unds' ptn1 ) ( \kore-symbol-LblnotBool'Unds' ptn2 ) ptn0 xX0 $= ( IMP-symbol-297-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-297-is-pattern substitution-disjoint substitution-app notation-cache-611 notation-cache-612 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
