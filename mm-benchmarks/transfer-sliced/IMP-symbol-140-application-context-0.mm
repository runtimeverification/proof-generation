...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-140-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblList'Coln'range ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-140-is-symbol symbol-is-pattern application-context-app-left IMP-symbol-140-is-pattern application-context-app-right notation-cache-189 notation-application-context ) GHBFCFDFBCDJAGHBFCFDAGHBFCAGHBAEKIIBCDLM $. $}
