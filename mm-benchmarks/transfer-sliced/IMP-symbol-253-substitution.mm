$c #Substitution \kore-symbol-LblisBool-symbol #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-LblisBool ( $.
...
notation-cache-494 $a #Notation ( \kore-symbol-LblisBool ptn1 ) ( \app \kore-symbol-LblisBool-symbol ptn1 ) $.
notation-cache-495 $a #Notation ( \kore-symbol-LblisBool ptn2 ) ( \app \kore-symbol-LblisBool-symbol ptn2 ) $.
${ IMP-symbol-253-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-253-substitution $p #Substitution ( \kore-symbol-LblisBool ptn1 ) ( \kore-symbol-LblisBool ptn2 ) ptn0 xX0 $= ( IMP-symbol-253-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-253-is-pattern substitution-disjoint substitution-app notation-cache-494 notation-cache-495 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
