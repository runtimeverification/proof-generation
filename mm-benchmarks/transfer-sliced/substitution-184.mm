$c #Substitution \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' #SetVariable \kore-sort-SortKConfigVar #ElementVariable "%24PGM" #Symbol #Variable #Pattern \kore-exists \kore-sort-SortKItem \kore-dv ) \kore-equals \kore-inj \kore-sort-SortMap ( $.
