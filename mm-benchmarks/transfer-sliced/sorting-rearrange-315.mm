...
$v kore-sort-var-R ph0 ph2 ptn1 ph3 ptn0 ph1 kore-element-var-K2 $.
...
${ sorting-rearrange-315 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortMap ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-equals \kore-sort-SortMap kore-sort-var-R ( \kore-symbol-Lbl'Unds'Map'Unds' \kore-symbol-Lbl'Stop'Map kore-element-var-K2 ) ( \kore-symbol-Lbl'Unds'Map'Unds' kore-element-var-K2 \kore-symbol-Lbl'Stop'Map ) ) ) ) $= ( typecode-cache-Pattern-0 and-is-pattern typecode-cache-Pattern-120 top-is-pattern IMP-sort-14-is-pattern IMP-symbol-124-is-pattern IMP-symbol-194-is-pattern kore-is-sort-is-pattern in-sort-is-pattern typecode-cache-Pattern-191 kore-equals-is-pattern kore-valid-is-pattern sorting-cache-695 sorting-rearrange-314 rule-imp-transitivity ) ACJFDBEGKFDDABLACGACHBEIBEHIMNABOABPQ $. $}
