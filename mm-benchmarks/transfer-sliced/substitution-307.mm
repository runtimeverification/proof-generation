$c #Substitution "amount" #SetVariable #ElementVariable #Symbol \kore-sort-SortStmt #Variable #Pattern \kore-dv \kore-sort-SortId ) \kore-equals \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( $.
