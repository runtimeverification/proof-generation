$c #Notation #SetVariable \kore-symbol-Lbl'Hash'open'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'String #ElementVariable \kore-symbol-Lbl'Hash'open'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'String-symbol #Symbol #Variable #Pattern #ApplicationContext \app ) ( $.
...
notation-cache-103 $a #Notation ( \kore-symbol-Lbl'Hash'open'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'String ptn0 ) ( \app \kore-symbol-Lbl'Hash'open'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'String-symbol ptn0 ) $.
${ IMP-symbol-102-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-102-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Hash'open'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'String ptn0 ) $= ( IMP-symbol-102-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-102-is-pattern application-context-app-right notation-cache-103 notation-application-context ) DEBFBGADEBACHBIJ $. $}
