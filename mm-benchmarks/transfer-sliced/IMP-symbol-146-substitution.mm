$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-LblSetItem \kore-symbol-LblSetItem-symbol ( $.
...
notation-cache-203 $a #Notation ( \kore-symbol-LblSetItem ptn1 ) ( \app \kore-symbol-LblSetItem-symbol ptn1 ) $.
notation-cache-204 $a #Notation ( \kore-symbol-LblSetItem ptn2 ) ( \app \kore-symbol-LblSetItem-symbol ptn2 ) $.
${ IMP-symbol-146-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-146-substitution $p #Substitution ( \kore-symbol-LblSetItem ptn1 ) ( \kore-symbol-LblSetItem ptn2 ) ptn0 xX0 $= ( IMP-symbol-146-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-146-is-pattern substitution-disjoint substitution-app notation-cache-203 notation-cache-204 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
