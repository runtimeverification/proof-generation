...
${ notation-cache-123 $p #Notation ( \kore-symbol-Lbl'Hash'shutdownWrite'LParUndsRParUnds'K-IO'Unds'K'Unds'Int ptn2 ) ( \app \kore-symbol-Lbl'Hash'shutdownWrite'LParUndsRParUnds'K-IO'Unds'K'Unds'Int-symbol ptn2 ) $= ( IMP-symbol-109-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-109-is-pattern IMP-symbol-109-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
