...
${ notation-cache-597 $p #Notation ( \kore-symbol-Lbllog2Int'LParUndsRParUnds'INT-COMMON'Unds'Int'Unds'Int ptn2 ) ( \app \kore-symbol-Lbllog2Int'LParUndsRParUnds'INT-COMMON'Unds'Int'Unds'Int-symbol ptn2 ) $= ( IMP-symbol-287-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-287-is-pattern IMP-symbol-287-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
