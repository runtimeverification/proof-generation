...
${ notation-cache-218 $p #Notation ( \kore-symbol-LblString2Int'LParUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String ptn1 ) ( \app \kore-symbol-LblString2Int'LParUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String-symbol ptn1 ) $= ( IMP-symbol-151-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-151-is-pattern IMP-symbol-151-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
