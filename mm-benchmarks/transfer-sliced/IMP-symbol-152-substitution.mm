$c #Substitution #Notation #SetVariable \kore-symbol-Lbl'UndsPerc'Int'Unds'-symbol \kore-symbol-Lbl'UndsPerc'Int'Unds' #ElementVariable #Symbol #Variable #Pattern \app ) ( $.
...
notation-cache-221 $a #Notation ( \kore-symbol-Lbl'UndsPerc'Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsPerc'Int'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-222 $a #Notation ( \kore-symbol-Lbl'UndsPerc'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsPerc'Int'Unds'-symbol ptn3 ) ptn4 ) $.
