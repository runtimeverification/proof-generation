...
${ notation-cache-763 $p #Notation ( \kore-symbol-Lblwhile'LParUndsRParUndsUnds'IMP-SYNTAX'Unds'Stmt'Unds'BExp'Unds'Block ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lblwhile'LParUndsRParUndsUnds'IMP-SYNTAX'Unds'Stmt'Unds'BExp'Unds'Block-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-353-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-353-is-pattern IMP-symbol-353-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
