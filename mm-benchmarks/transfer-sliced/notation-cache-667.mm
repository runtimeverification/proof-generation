...
${ notation-cache-667 $p #Notation ( \kore-symbol-Lblproject'Coln'IOString ptn0 ) ( \app \kore-symbol-Lblproject'Coln'IOString-symbol ptn0 ) $= ( IMP-symbol-315-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-315-is-pattern IMP-symbol-315-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
