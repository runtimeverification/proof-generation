...
sorting-cache-1801 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S2 ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) $.
${ sorting-cache-1802 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S2 ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) ) ( \and ( \kore-is-sort \kore-sort-SortBool ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) $= ( kore-is-sort-is-pattern and-is-pattern IMP-sort-32-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-1 typecode-cache-Pattern-379 typecode-cache-Pattern-6 in-sort-is-pattern top-is-pattern imp-is-pattern proof-rule-prop-1 IMP-sort-32-sort proof-rule-mp sorting-cache-1801 rule-and-intro-alt2-sugar ) AHECIEBDJFFGEDKGLMFGEAHECIEBDJFFGENGEAHECIEBDJFFOPQABCDRS $. $}
