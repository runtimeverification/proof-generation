...
sorting-cache-1800 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S2 ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) ) ( \in-sort kore-element-var-T \kore-sort-SortBool ) ) $.
${ sorting-cache-1801 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S2 ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) $= ( kore-is-sort-is-pattern and-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-1 typecode-cache-Pattern-379 top-is-pattern typecode-cache-Pattern-6 IMP-sort-32-is-pattern in-sort-is-pattern sorting-cache-1800 top-intro rule-weakening rule-and-intro-alt2-sugar ) AGECHEBDIFFDKLMJABCDNAGECHEBDIFFJOPQ $. $}
