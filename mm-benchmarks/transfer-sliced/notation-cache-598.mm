$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbllog2Int'LParUndsRParUnds'INT-COMMON'Unds'Int'Unds'Int-symbol #Variable #Pattern \app ) \kore-symbol-Lbllog2Int'LParUndsRParUnds'INT-COMMON'Unds'Int'Unds'Int ( $.
...
${ notation-cache-598 $p #Notation ( \kore-symbol-Lbllog2Int'LParUndsRParUnds'INT-COMMON'Unds'Int'Unds'Int ptn0 ) ( \app \kore-symbol-Lbllog2Int'LParUndsRParUnds'INT-COMMON'Unds'Int'Unds'Int-symbol ptn0 ) $= ( IMP-symbol-287-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-287-is-pattern IMP-symbol-287-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
