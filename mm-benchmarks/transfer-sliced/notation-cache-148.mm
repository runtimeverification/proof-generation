...
${ notation-cache-148 $p #Notation ( \kore-symbol-Lbl'-LT-'T'-GT-' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'-LT-'T'-GT-'-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-126-is-symbol symbol-is-pattern IMP-symbol-126-is-pattern IMP-symbol-126-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
