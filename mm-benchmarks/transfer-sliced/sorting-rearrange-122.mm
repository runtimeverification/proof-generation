...
${ sorting-rearrange-122 $p |- ( \imp \top ( \kore-valid \unit-sort ( \kore-exists \kore-sort-SortStmt \unit-sort kore-element-var-Val ( \kore-equals \kore-sort-SortStmt \unit-sort kore-element-var-Val ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "addressTo" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "12345" ) ) ) ) ) ) ) $= ( kore-sort-var-R-elementvariable kore-dv-is-pattern IMP-sort-23-is-pattern IMP-sort-31-is-pattern unit-sort-is-symbol symbol-is-pattern kore-sort-var-x0-elementvariable typecode-cache-Pattern-0 IMP-sort-17-is-pattern string-literal-18-is-pattern IMP-sort-13-is-pattern string-literal-12-is-pattern kore-inj-is-pattern IMP-symbol-185-is-pattern typecode-cache-Pattern-14 typecode-cache-Pattern-31 top-is-pattern kore-equals-is-pattern element-var-is-var kore-exists-is-pattern and-is-pattern kore-is-sort-is-pattern kore-valid-is-pattern substitution-var-same x-is-element-var rule-weakening substitution-294 substitution-disjoint substitution-kore-equals substitution-kore-exists-alt substitution-kore-valid substitution-imp substitution-295 top-intro sorting-cache-129 rule-and-intro-alt2-sugar typecode-cache-Pattern-22 exists-is-pattern unit-sort-is-functional sorting-rearrange-121 substitution-83 substitution-141 substitution-87 substitution-145 functional-substitution-alt rule-imp-transitivity )  $. $}
