...
${ notation-cache-210 $p #Notation ( \kore-symbol-LblString2Bool'LParUndsRParUnds'STRING-COMMON'Unds'Bool'Unds'String ptn2 ) ( \app \kore-symbol-LblString2Bool'LParUndsRParUnds'STRING-COMMON'Unds'Bool'Unds'String-symbol ptn2 ) $= ( IMP-symbol-148-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-148-is-pattern IMP-symbol-148-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
