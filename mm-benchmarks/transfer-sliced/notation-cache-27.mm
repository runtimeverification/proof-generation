...
${ notation-cache-27 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'UndsAnd-And-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp'Unds'BExp0'Unds' ptn0 ) ( \app \kore-symbol-Lbl'Hash'freezer'UndsAnd-And-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp'Unds'BExp0'Unds'-symbol ptn0 ) $= ( IMP-symbol-76-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-76-is-pattern IMP-symbol-76-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
