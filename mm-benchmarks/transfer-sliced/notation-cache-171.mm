...
${ notation-cache-171 $p #Notation ( \kore-symbol-LblBool2String'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Bool ptn1 ) ( \app \kore-symbol-LblBool2String'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Bool-symbol ptn1 ) $= ( IMP-symbol-134-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-134-is-pattern IMP-symbol-134-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
