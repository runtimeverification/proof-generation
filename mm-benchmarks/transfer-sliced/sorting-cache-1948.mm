...
${ sorting-cache-1948 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortK ) \top ) ) ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-397 typecode-cache-Pattern-177 IMP-sort-13-is-pattern typecode-cache-Pattern-146 BASIC-K-sort-0-is-pattern top-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern rule-imp-transitivity and-elim-left-sugar and-elim-right-sugar sorting-cache-1930 ) AHIECDGFBJKELFFAHIECDGFCMNEAHIECDGFBJKELFPAHIECDGFCDGCMNEAHIECDGQCDROO $. $}
