$c #Substitution \kore-sort-SortBExp \top #SetVariable #ElementVariable #Symbol #Variable #Pattern ( \kore-is-sort ) \and $.
...
${ substitution-1082 $p #Substitution ( \and ( \kore-is-sort \kore-sort-SortBExp ) \top ) ( \and ( \kore-is-sort kore-sort-var-S2 ) \top ) \kore-sort-SortBExp kore-sort-var-S2 $= ( IMP-sort-22-is-pattern element-var-is-var top-is-pattern kore-is-sort-is-pattern typecode-cache-Pattern-1 substitution-var-same substitution-kore-is-sort substitution-disjoint substitution-and ) BBEDAFEDACBAFBACBACGHDBACIJ $. $}
