...
${ sorting-cache-1262 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \in-sort ( \kore-symbol-Lbl'LBraUndsRBraUnds'IMP-SYNTAX'Unds'Block'Unds'Stmt ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "ret" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "0" ) ) ) ) \kore-sort-SortBlock ) \top ) ) $= ( top-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern and-is-pattern kore-dv-is-pattern IMP-sort-23-is-pattern IMP-sort-17-is-pattern string-literal-11-is-pattern IMP-sort-13-is-pattern string-literal-1-is-pattern kore-inj-is-pattern IMP-symbol-185-is-pattern IMP-symbol-354-is-pattern IMP-sort-18-is-pattern in-sort-is-pattern sorting-cache-412 top-intro rule-weakening rule-and-intro-alt2-sugar ) ACDBEHIFGJGKFLMNOPBAQACDBEBRST $. $}
