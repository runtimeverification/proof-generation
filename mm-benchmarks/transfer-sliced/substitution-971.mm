$c #Substitution \kore-symbol-Lbl'Hash'freezer'Unds-GT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds' #SetVariable \kore-sort-SortAExp #ElementVariable #Symbol \kore-symbol-kseq #Variable #Pattern \kore-sort-SortKItem ) \kore-inj \kore-symbol-dotk ( $.
...
${ substitution-971 $p #Substitution ( \kore-symbol-kseq ( \kore-symbol-Lbl'Hash'freezer'Unds-GT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds' ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortAExp \kore-sort-SortKItem kore-element-var-x0 ) \kore-symbol-dotk ) ) kore-element-var-VE2 ) ( \kore-symbol-kseq ( \kore-symbol-Lbl'Hash'freezer'Unds-GT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp1'Unds' ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortAExp \kore-sort-SortKItem kore-element-var-VE1 ) \kore-symbol-dotk ) ) kore-element-var-VE2 ) kore-element-var-x0 kore-element-var-VE1 $= ( typecode-cache-Pattern-25 IMP-sort-13-is-pattern BASIC-K-sort-1-is-pattern kore-inj-is-pattern KSEQ-symbol-1-is-pattern KSEQ-symbol-0-is-pattern element-var-is-var IMP-symbol-95-is-pattern typecode-cache-Pattern-177 typecode-cache-Pattern-146 substitution-872 IMP-symbol-95-substitution substitution-806 KSEQ-symbol-0-substitution ) BJCDEFCDGHIKALEFBMGHIKALBJCDEFCDGHIEFBMGHIBCNOABCPQ $. $}
