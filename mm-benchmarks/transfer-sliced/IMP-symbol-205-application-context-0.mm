$c #Notation #SetVariable #ElementVariable \kore-symbol-Lbl'Unds'andBool'Unds'-symbol #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-Lbl'Unds'andBool'Unds' ( $.
...
notation-cache-374 $a #Notation ( \kore-symbol-Lbl'Unds'andBool'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'andBool'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-205-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-205-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds'andBool'Unds' ptn0 ptn1 ) $= ( IMP-symbol-205-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-205-is-pattern application-context-app-right application-context-app-left notation-cache-374 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
