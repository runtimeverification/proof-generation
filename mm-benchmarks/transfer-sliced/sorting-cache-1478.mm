...
${ sorting-cache-1478 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-253 BASIC-K-sort-1-is-pattern top-is-pattern and-is-pattern rule-imp-transitivity typecode-cache-Pattern-324 typecode-cache-Pattern-179 IMP-sort-13-is-pattern and-elim-right-sugar and-elim-left-sugar imp-reflexivity ) ABIBDECFGBDECAJKCBDECFGLBDECFGBDECBDECBDECFMBDECNHH $. $}
