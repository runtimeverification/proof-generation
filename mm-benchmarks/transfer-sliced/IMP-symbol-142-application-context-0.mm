$c #Notation \kore-symbol-LblMap'Coln'lookup-symbol #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \kore-symbol-LblMap'Coln'lookup \app ) ( $.
...
notation-cache-195 $a #Notation ( \kore-symbol-LblMap'Coln'lookup ptn0 ptn1 ) ( \app ( \app \kore-symbol-LblMap'Coln'lookup-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-142-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-142-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblMap'Coln'lookup ptn0 ptn1 ) $= ( IMP-symbol-142-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-142-is-pattern application-context-app-right application-context-app-left notation-cache-195 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
