$c \exists #Substitution \top \kore-symbol-LblisKResult \kore-symbol-kseq #Variable \kore-sort-SortBool "200" \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-sort-SortKItem "true" \kore-inj \kore-sort-SortInt \kore-symbol-dotk ( $.
...
sorting-rearrange-1436 $a |- ( \imp ( \and \top ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-equals \kore-sort-SortBool kore-sort-var-R ( \kore-symbol-LblisKResult ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "200" ) ) \kore-symbol-dotk ) ) ( \kore-dv \kore-sort-SortBool "true" ) ) ) ) $.
${ sorting-rearrange-1437 $p |- ( \imp \top ( \kore-valid \unit-sort ( \kore-equals \kore-sort-SortBool \unit-sort ( \kore-symbol-LblisKResult ( \kore-symbol-kseq ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "200" ) ) \kore-symbol-dotk ) ) ( \kore-dv \kore-sort-SortBool "true" ) ) ) ) $= ( IMP-sort-23-is-pattern kore-dv-is-pattern kore-sort-var-R-elementvariable IMP-sort-32-is-pattern unit-sort-is-symbol symbol-is-pattern kore-sort-var-x0-elementvariable BASIC-K-sort-1-is-pattern string-literal-15-is-pattern kore-inj-is-pattern KSEQ-symbol-1-is-pattern KSEQ-symbol-0-is-pattern IMP-symbol-271-is-pattern string-literal-0-is-pattern top-is-pattern typecode-cache-Pattern-14 typecode-cache-Pattern-0 element-var-is-var kore-equals-is-pattern and-is-pattern kore-is-sort-is-pattern kore-valid-is-pattern x-is-element-var substitution-var-same substitution-disjoint rule-weakening substitution-kore-equals substitution-kore-valid substitution-imp top-intro sorting-cache-129 rule-and-intro-alt2-sugar typecode-cache-Pattern-22 exists-is-pattern unit-sort-is-functional sorting-rearrange-1436 substitution-83 substitution-127 substitution-87 substitution-128 functional-substitution-alt rule-imp-transitivity )  $. $}
