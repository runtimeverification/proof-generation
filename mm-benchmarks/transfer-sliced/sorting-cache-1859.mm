...
${ sorting-cache-1859 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) \top ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) \top ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortBlock ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-179 IMP-sort-18-is-pattern top-is-pattern and-is-pattern typecode-cache-Pattern-178 IMP-sort-9-is-pattern and-elim-left-sugar rule-imp-transitivity imp-reflexivity ) BDECFGAHICFGGBDECFGBDECBDECFGAHICFGJBDECFGBDECBDECBDECFJBDECLKK $. $}
