...
${ notation-cache-731 $p #Notation ( \kore-symbol-LblremoveAll'LParUndsCommUndsRParUnds'MAP'Unds'Map'Unds'Map'Unds'Set ptn1 ptn2 ) ( \app ( \app \kore-symbol-LblremoveAll'LParUndsCommUndsRParUnds'MAP'Unds'Map'Unds'Map'Unds'Set-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-337-is-symbol symbol-is-pattern IMP-symbol-337-is-pattern IMP-symbol-337-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
