...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-139-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblList'Coln'get ptn0 ptn1 ) $= ( IMP-symbol-139-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-139-is-pattern application-context-app-right application-context-app-left notation-cache-188 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
