$c #Substitution #Notation #SetVariable \kore-symbol-LblinitTCell #ElementVariable #Symbol #Variable #Pattern \app \kore-symbol-LblinitTCell-symbol ) ( $.
...
notation-cache-473 $a #Notation ( \kore-symbol-LblinitTCell ptn1 ) ( \app \kore-symbol-LblinitTCell-symbol ptn1 ) $.
notation-cache-474 $a #Notation ( \kore-symbol-LblinitTCell ptn2 ) ( \app \kore-symbol-LblinitTCell-symbol ptn2 ) $.
${ IMP-symbol-246-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-246-substitution $p #Substitution ( \kore-symbol-LblinitTCell ptn1 ) ( \kore-symbol-LblinitTCell ptn2 ) ptn0 xX0 $= ( IMP-symbol-246-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-246-is-pattern substitution-disjoint substitution-app notation-cache-473 notation-cache-474 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
