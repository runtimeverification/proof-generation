...
${ notation-cache-603 $p #Notation ( \kore-symbol-LblmakeList'LParUndsCommUndsRParUnds'LIST'Unds'List'Unds'Int'Unds'KItem ptn3 ptn4 ) ( \app ( \app \kore-symbol-LblmakeList'LParUndsCommUndsRParUnds'LIST'Unds'List'Unds'Int'Unds'KItem-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-289-is-symbol symbol-is-pattern IMP-symbol-289-is-pattern IMP-symbol-289-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
