$c #Notation #SetVariable \kore-symbol-Lbl'UndsAnd-'Int'Unds'-symbol #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-Lbl'UndsAnd-'Int'Unds' ( $.
...
notation-cache-232 $a #Notation ( \kore-symbol-Lbl'UndsAnd-'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsAnd-'Int'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-155-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-155-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsAnd-'Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-155-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-155-is-pattern application-context-app-right application-context-app-left notation-cache-232 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
