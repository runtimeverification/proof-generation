$c \top \kore-sort-SortAExp #Variable \imp \kore-dv "0" \kore-is-sort |- \kore-sort-SortId ) \and #SetVariable #ElementVariable #Symbol #Pattern \kore-sort-SortKItem \kore-sort-SortInt \in-sort \kore-sort-SortMap \kore-sort-SortStateCell ( $.
