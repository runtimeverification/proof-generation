$c #Notation #SetVariable #ElementVariable \kore-symbol-Lbl'Unds'Map'Unds' #Symbol #Variable #Pattern \kore-symbol-Lbl'Unds'Map'Unds'-symbol #ApplicationContext \app ) ( $.
...
notation-cache-349 $a #Notation ( \kore-symbol-Lbl'Unds'Map'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'Map'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-194-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-194-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds'Map'Unds' ptn0 ptn1 ) $= ( IMP-symbol-194-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-194-is-pattern application-context-app-right application-context-app-left notation-cache-349 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
