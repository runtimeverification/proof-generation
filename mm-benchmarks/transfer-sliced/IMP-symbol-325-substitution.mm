$c #Substitution \kore-symbol-Lblproject'Coln'Map #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-Lblproject'Coln'Map-symbol ( $.
...
notation-cache-695 $a #Notation ( \kore-symbol-Lblproject'Coln'Map ptn1 ) ( \app \kore-symbol-Lblproject'Coln'Map-symbol ptn1 ) $.
notation-cache-696 $a #Notation ( \kore-symbol-Lblproject'Coln'Map ptn2 ) ( \app \kore-symbol-Lblproject'Coln'Map-symbol ptn2 ) $.
${ IMP-symbol-325-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-325-substitution $p #Substitution ( \kore-symbol-Lblproject'Coln'Map ptn1 ) ( \kore-symbol-Lblproject'Coln'Map ptn2 ) ptn0 xX0 $= ( IMP-symbol-325-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-325-is-pattern substitution-disjoint substitution-app notation-cache-695 notation-cache-696 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
