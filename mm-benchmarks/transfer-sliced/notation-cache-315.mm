$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'UndsEqlsEqls'String'UndsUnds'STRING-COMMON'Unds'Bool'Unds'String'Unds'String \kore-symbol-Lbl'UndsEqlsEqls'String'UndsUnds'STRING-COMMON'Unds'Bool'Unds'String'Unds'String-symbol #Variable #Pattern \app ) ( $.
...
${ notation-cache-315 $p #Notation ( \kore-symbol-Lbl'UndsEqlsEqls'String'UndsUnds'STRING-COMMON'Unds'Bool'Unds'String'Unds'String ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsEqls'String'UndsUnds'STRING-COMMON'Unds'Bool'Unds'String'Unds'String-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-183-is-symbol symbol-is-pattern IMP-symbol-183-is-pattern IMP-symbol-183-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
