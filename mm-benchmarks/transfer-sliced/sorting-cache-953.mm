...
${ sorting-cache-953 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-V2 \kore-sort-SortK ) \top ) ) ( \in-sort ( \kore-inj \kore-sort-SortStmt \kore-sort-SortKItem ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "100" ) ) ) ) \kore-sort-SortKItem ) ) $= ( kore-dv-is-pattern IMP-sort-23-is-pattern IMP-sort-31-is-pattern BASIC-K-sort-1-is-pattern kore-inj-is-pattern kore-is-sort-is-pattern IMP-sort-17-is-pattern string-literal-10-is-pattern IMP-sort-13-is-pattern string-literal-16-is-pattern IMP-symbol-185-is-pattern and-is-pattern in-sort-is-pattern typecode-cache-Pattern-156 sorting-cache-929 sorting-cache-550 rule-and-intro-alt2-sugar INJ-symbol-0-sorting rule-imp-transitivity ) ABPEHFHNIJCDKDLCGMEONEFIJCDKDLCGMGFOABPEHFHNIJCDKDLCGMEOABQABRSEFIJCDKDLCGMTUA $. $}
