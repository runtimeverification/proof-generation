...
${ notation-cache-275 $p #Notation ( \kore-symbol-Lbl'Unds-LT-Eqls'Set'UndsUnds'SET'Unds'Bool'Unds'Set'Unds'Set ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds-LT-Eqls'Set'UndsUnds'SET'Unds'Bool'Unds'Set'Unds'Set-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-170-is-symbol symbol-is-pattern IMP-symbol-170-is-pattern IMP-symbol-170-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
