...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-184-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsEqlsEqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp ptn0 ptn1 ) $= ( IMP-symbol-184-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-184-is-pattern application-context-app-right application-context-app-left notation-cache-319 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
