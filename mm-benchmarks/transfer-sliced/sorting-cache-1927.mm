...
${ sorting-cache-1927 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortStmt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortStmt ) \top ) ) ) ( \and ( \and ( \kore-is-sort \kore-sort-SortStmt ) ( \kore-is-sort \kore-sort-SortKItem ) ) ( \in-sort ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "ret" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "1" ) ) ) \kore-sort-SortStmt ) ) ) $= ( IMP-sort-31-is-pattern kore-is-sort-is-pattern in-sort-is-pattern and-is-pattern typecode-cache-Pattern-177 typecode-cache-Pattern-239 BASIC-K-sort-1-is-pattern kore-dv-is-pattern IMP-sort-23-is-pattern imp-is-pattern proof-rule-prop-1 proof-rule-mp rule-and-intro-alt2-sugar IMP-sort-17-is-pattern string-literal-11-is-pattern IMP-sort-13-is-pattern string-literal-4-is-pattern kore-inj-is-pattern IMP-symbol-185-is-pattern IMP-sort-31-sort BASIC-K-sort-1-sort sorting-cache-943 ) AHDFBCIGDEJEGQRKLSLTKUAUBDFAHDFBCIGDEJEDEAHDFBCIGDEMDEAHDFBCIGNUCOJEAHDFBCIGJEMJEAHDFBCIGNUDOPABCUEP $. $}
