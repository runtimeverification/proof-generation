$c \kore-symbol-Lbl'UndsPlus'Int'Unds' #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'UndsPlus'Int'Unds'-symbol #Variable #Pattern #ApplicationContext \app ) ( $.
...
notation-cache-241 $a #Notation ( \kore-symbol-Lbl'UndsPlus'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsPlus'Int'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-158-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-158-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsPlus'Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-158-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-158-is-pattern application-context-app-right application-context-app-left notation-cache-241 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
