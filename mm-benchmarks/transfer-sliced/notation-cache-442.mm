$c #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-LblcountAllOccurrences'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String-symbol #Variable #Pattern \app ) \kore-symbol-LblcountAllOccurrences'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String ( $.
...
${ notation-cache-442 $p #Notation ( \kore-symbol-LblcountAllOccurrences'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String ptn0 ptn1 ) ( \app ( \app \kore-symbol-LblcountAllOccurrences'LParUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-229-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-229-is-pattern IMP-symbol-229-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
