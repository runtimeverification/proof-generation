...
sorting-cache-539 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-V2 \kore-sort-SortK ) \top ) ) ( \in-sort ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "ret" ) \kore-symbol-Lbl'Stop'List'LBraQuotUndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids'QuotRBraUnds'Ids ) \kore-sort-SortIds ) ) $.
${ sorting-cache-540 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-V2 \kore-sort-SortK ) \top ) ) ( \in-sort ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "balanceTo" ) ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "ret" ) \kore-symbol-Lbl'Stop'List'LBraQuotUndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids'QuotRBraUnds'Ids ) ) \kore-sort-SortIds ) ) $= ( IMP-sort-17-is-pattern kore-dv-is-pattern string-literal-17-is-pattern in-sort-is-pattern IMP-symbol-161-is-pattern typecode-cache-Pattern-156 string-literal-11-is-pattern IMP-symbol-123-is-pattern IMP-sort-0-is-pattern and-is-pattern imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp sorting-cache-539 rule-and-intro-alt2-sugar IMP-symbol-161-sorting rule-imp-transitivity ) ABHCEDCFCIDJGKFLCEDCIDJGGKFABHCEDCFCIDJGKFCEDCFABHCEDCFMCEDCFABHNCEOPABQRCEDCIDJGST $. $}
