...
${ notation-cache-80 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'Unds-GT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp0'Unds' ptn2 ) ( \app \kore-symbol-Lbl'Hash'freezer'Unds-GT-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp0'Unds'-symbol ptn2 ) $= ( IMP-symbol-94-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-94-is-pattern IMP-symbol-94-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
