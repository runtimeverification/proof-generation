...
${ notation-cache-652 $p #Notation ( \kore-symbol-Lblproject'Coln'GeneratedTopCell ptn0 ) ( \app \kore-symbol-Lblproject'Coln'GeneratedTopCell-symbol ptn0 ) $= ( IMP-symbol-310-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-310-is-pattern IMP-symbol-310-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
