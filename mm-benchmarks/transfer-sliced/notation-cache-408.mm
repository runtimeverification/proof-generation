...
${ notation-cache-408 $p #Notation ( \kore-symbol-Lbl'Unds'xorInt'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds'xorInt'Unds'-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-217-is-symbol symbol-is-pattern IMP-symbol-217-is-pattern IMP-symbol-217-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
