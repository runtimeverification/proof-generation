$c \kore-sort-SortBExp \top #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-sort-SortBlock \and \kore-sort-SortKItem \imp \kore-is-sort |- ) \kore-sort-SortInt \in-sort ( $.
...
${ sorting-cache-1750 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortBExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) \top ) ) ) ( \and ( \kore-is-sort \kore-sort-SortInt ) ( \kore-is-sort \kore-sort-SortKItem ) ) ) $= ( kore-is-sort-is-pattern typecode-cache-Pattern-179 IMP-sort-22-is-pattern in-sort-is-pattern typecode-cache-Pattern-357 and-is-pattern IMP-sort-23-is-pattern BASIC-K-sort-1-is-pattern imp-is-pattern proof-rule-prop-1 proof-rule-mp IMP-sort-23-sort BASIC-K-sort-1-sort rule-and-intro-alt2-sugar ) AEFGBCHIJDKDJDAEFGBCHIJDLJDAEFGBCHIMONKDAEFGBCHIKDLKDAEFGBCHIMPNQ $. $}
