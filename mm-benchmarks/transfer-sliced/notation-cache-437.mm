...
${ notation-cache-437 $p #Notation ( \kore-symbol-LblchrChar'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int ptn1 ) ( \app \kore-symbol-LblchrChar'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int-symbol ptn1 ) $= ( IMP-symbol-228-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-228-is-pattern IMP-symbol-228-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
