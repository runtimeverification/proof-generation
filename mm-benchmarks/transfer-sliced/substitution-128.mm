...
${ substitution-128 $p #Substitution \kore-sort-SortBool \kore-sort-SortBool kore-sort-var-x0 kore-sort-var-R $= ( IMP-sort-32-is-pattern typecode-cache-Pattern-14 element-var-is-var substitution-disjoint ) CBDAEF $. $}
