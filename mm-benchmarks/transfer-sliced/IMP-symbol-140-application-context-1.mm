...
${ $d xX0 ptn0 $.
   ...
   IMP-symbol-140-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-LblList'Coln'range ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-140-is-symbol symbol-is-pattern IMP-symbol-140-is-pattern application-context-app-right application-context-app-left notation-cache-189 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAGHBFCAEJKBCDLM $. $}
