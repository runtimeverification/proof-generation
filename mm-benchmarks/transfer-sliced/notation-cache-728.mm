...
${ notation-cache-728 $p #Notation ( \kore-symbol-LblrandInt'LParUndsRParUnds'INT'Unds'Int'Unds'Int ptn1 ) ( \app \kore-symbol-LblrandInt'LParUndsRParUnds'INT'Unds'Int'Unds'Int-symbol ptn1 ) $= ( IMP-symbol-336-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-336-is-pattern IMP-symbol-336-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
