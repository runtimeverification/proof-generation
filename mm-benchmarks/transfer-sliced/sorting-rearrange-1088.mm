$c \exists \top #Variable \kore-sort-SortBool \kore-sort-SortK \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals "false" \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-sort-SortKItem \kore-inj \in-sort ( $.
...
${ sorting-rearrange-1088 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-V2 \kore-sort-SortK ) \top ) ) ( \exists kore-element-var-Val ( \eq kore-element-var-Val ( \kore-inj \kore-sort-SortBool \kore-sort-SortKItem ( \kore-dv \kore-sort-SortBool "false" ) ) ) ) ) $= ( IMP-sort-32-is-pattern top-is-pattern BASIC-K-sort-1-is-pattern typecode-cache-Pattern-156 string-literal-5-is-pattern kore-dv-is-pattern kore-inj-is-pattern typecode-cache-Pattern-31 eq-is-pattern exists-is-pattern top-intro rule-weakening sorting-cache-1696 sorting-rearrange-1084 kore-functional rule-imp-transitivity ) ABGECKDFDHIJLCMABGENOFDFDHIJECPCQRS $. $}
