...
sorting-cache-1795 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ( \kore-is-sort kore-sort-var-S3 ) ) $.
sorting-cache-1808 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) $.
${ sorting-cache-1809 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) $= ( kore-is-sort-is-pattern typecode-cache-Pattern-379 typecode-cache-Pattern-0 and-is-pattern typecode-cache-Pattern-2 typecode-cache-Pattern-6 IMP-sort-32-is-pattern in-sort-is-pattern top-is-pattern and-elim-right-sugar sorting-cache-1795 rule-imp-transitivity sorting-cache-1808 rule-and-intro-alt2-sugar ) AFDBCEGBHDCIJKLGAFDBCEGBCEBHDAFDBCEMBCNOABCPQ $. $}
