...
${ notation-cache-564 $p #Notation ( \kore-symbol-LblisStateCell ptn2 ) ( \app \kore-symbol-LblisStateCell-symbol ptn2 ) $= ( IMP-symbol-276-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-276-is-pattern IMP-symbol-276-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
