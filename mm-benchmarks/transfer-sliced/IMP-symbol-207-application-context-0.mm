$c #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \app ) \kore-symbol-Lbl'Unds'divInt'Unds' \kore-symbol-Lbl'Unds'divInt'Unds'-symbol ( $.
...
notation-cache-380 $a #Notation ( \kore-symbol-Lbl'Unds'divInt'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'divInt'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-207-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-207-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds'divInt'Unds' ptn0 ptn1 ) $= ( IMP-symbol-207-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-207-is-pattern application-context-app-right application-context-app-left notation-cache-380 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
