$c #Substitution #Notation #SetVariable #ElementVariable \kore-symbol-LblisIOString #Symbol #Variable #Pattern \kore-symbol-LblisIOString-symbol \app ) ( $.
...
notation-cache-521 $a #Notation ( \kore-symbol-LblisIOString ptn1 ) ( \app \kore-symbol-LblisIOString-symbol ptn1 ) $.
notation-cache-522 $a #Notation ( \kore-symbol-LblisIOString ptn2 ) ( \app \kore-symbol-LblisIOString-symbol ptn2 ) $.
${ IMP-symbol-262-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-262-substitution $p #Substitution ( \kore-symbol-LblisIOString ptn1 ) ( \kore-symbol-LblisIOString ptn2 ) ptn0 xX0 $= ( IMP-symbol-262-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-262-is-pattern substitution-disjoint substitution-app notation-cache-521 notation-cache-522 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
