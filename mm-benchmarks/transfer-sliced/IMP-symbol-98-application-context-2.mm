...
${ $d xX0 ptn0 $.
   $d xX0 ptn1 $.
   $d xX0 ptn3 $.
   IMP-symbol-98-application-context-2.0 $e #ApplicationContext xX0 ptn2 $.
   IMP-symbol-98-application-context-2 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Hash'if'UndsHash'then'UndsHash'else'UndsHash'fi'Unds'K-EQUAL-SYNTAX'Unds'Sort'Unds'Bool'Unds'Sort'Unds'Sort ptn0 ptn1 ptn2 ptn3 ) $= ( app-is-pattern IMP-symbol-98-is-symbol symbol-is-pattern IMP-symbol-98-is-pattern application-context-app-right application-context-app-left notation-cache-91 notation-application-context ) HIBGCGDGEGBCDEJAHIBGCGDGEAHIBGCGDAFKLBCDEMN $. $}
