...
${ notation-cache-164 $p #Notation ( \kore-symbol-Lbl'-LT-'k'-GT-' ptn0 ) ( \app \kore-symbol-Lbl'-LT-'k'-GT-'-symbol ptn0 ) $= ( IMP-symbol-131-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-131-is-pattern IMP-symbol-131-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
