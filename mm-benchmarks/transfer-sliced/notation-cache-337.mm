...
${ notation-cache-337 $p #Notation ( \kore-symbol-Lbl'Unds-GT-'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds-GT-'Int'Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-190-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-190-is-pattern IMP-symbol-190-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
