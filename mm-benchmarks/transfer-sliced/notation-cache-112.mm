$c #Notation \kore-symbol-Lbl'Hash'read'LParUndsCommUndsRParUnds'K-IO'Unds'IOString'Unds'Int'Unds'Int \kore-symbol-Lbl'Hash'read'LParUndsCommUndsRParUnds'K-IO'Unds'IOString'Unds'Int'Unds'Int-symbol #SetVariable #ElementVariable #Symbol #Variable #Pattern \app ) ( $.
...
${ notation-cache-112 $p #Notation ( \kore-symbol-Lbl'Hash'read'LParUndsCommUndsRParUnds'K-IO'Unds'IOString'Unds'Int'Unds'Int ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Hash'read'LParUndsCommUndsRParUnds'K-IO'Unds'IOString'Unds'Int'Unds'Int-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-105-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-105-is-pattern IMP-symbol-105-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
