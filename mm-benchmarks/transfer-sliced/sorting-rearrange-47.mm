$c \exists #Substitution \top \kore-sort-SortAExp #Variable "200" \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals \and #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-sort-SortKItem \kore-inj \kore-sort-SortInt \in-sort ( $.
...
${ sorting-rearrange-47 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \kore-valid kore-sort-var-R ( \kore-equals \kore-sort-SortKItem kore-sort-var-R ( \kore-inj \kore-sort-SortAExp \kore-sort-SortKItem ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "200" ) ) ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortKItem ( \kore-dv \kore-sort-SortInt "200" ) ) ) ) ) $= ( IMP-sort-23-is-pattern kore-element-var-T-elementvariable BASIC-K-sort-1-is-pattern kore-inj-is-pattern IMP-sort-13-is-pattern string-literal-15-is-pattern kore-dv-is-pattern typecode-cache-Pattern-0 typecode-cache-Pattern-6 element-var-is-var kore-element-var-x0-elementvariable top-is-pattern and-is-pattern kore-equals-is-pattern typecode-cache-Pattern-25 in-sort-is-pattern kore-valid-is-pattern substitution-disjoint kore-is-sort-is-pattern substitution-var-same substitution-kore-inj kore-element-var-x1-elementvariable rule-imp-transitivity substitution-139 substitution-kore-equals substitution-kore-valid substitution-imp substitution-75 sorting-cache-133 sorting-cache-231 rule-and-intro-alt2-sugar sorting-rearrange-46 typecode-cache-Pattern-30 sorting-cache-168 sorting-rearrange-24 substitution-in-sort substitution-and substitution-123 substitution-76 substitution-125 substitution-126 functional-substitution-alt )  $. $}
