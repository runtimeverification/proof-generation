...
${ sorting-cache-1499 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortK ) \top ) ) ( \in-sort kore-element-var-VE4 \kore-sort-SortAExp ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-324 typecode-cache-Pattern-178 IMP-sort-9-is-pattern typecode-cache-Pattern-177 BASIC-K-sort-0-is-pattern top-is-pattern typecode-cache-Pattern-179 IMP-sort-13-is-pattern rule-imp-transitivity and-elim-left-sugar and-elim-right-sugar sorting-cache-1474 ) BHIECDGFAJKELFFBHIECDGFCMNEBHIECDGFAJKELFPBHIECDGFCDGCMNEBHIECDGQCDROO $. $}
