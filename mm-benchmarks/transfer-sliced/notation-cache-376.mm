...
${ notation-cache-376 $p #Notation ( \kore-symbol-Lbl'Unds'andThenBool'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds'andThenBool'Unds'-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-206-is-symbol symbol-is-pattern IMP-symbol-206-is-pattern IMP-symbol-206-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
