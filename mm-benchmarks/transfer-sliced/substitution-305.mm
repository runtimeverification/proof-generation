...
${ substitution-305 $p #Substitution kore-element-var-Val kore-element-var-Val ( \kore-dv \kore-sort-SortInt "10" ) kore-element-var-From $= ( typecode-cache-Pattern-31 IMP-sort-23-is-pattern string-literal-13-is-pattern kore-dv-is-pattern element-var-is-var substitution-disjoint ) ACDEFBGH $. $}
