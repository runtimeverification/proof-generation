...
${ $d xX0 ptn0 $.
   $d xX0 ptn2 $.
   IMP-symbol-340-application-context-1.0 $e #ApplicationContext xX0 ptn1 $.
   IMP-symbol-340-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-LblreplaceFirst'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-340-is-symbol symbol-is-pattern IMP-symbol-340-is-pattern application-context-app-right application-context-app-left notation-cache-736 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAGHBFCAEJKBCDLM $. $}
