$c #Substitution #Notation #SetVariable \kore-symbol-Lbl'Unds'List'Unds'-symbol #ElementVariable #Symbol #Variable #Pattern \app \kore-symbol-Lbl'Unds'List'Unds' ) ( $.
...
notation-cache-344 $a #Notation ( \kore-symbol-Lbl'Unds'List'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds'List'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-345 $a #Notation ( \kore-symbol-Lbl'Unds'List'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds'List'Unds'-symbol ptn3 ) ptn4 ) $.
${ IMP-symbol-193-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   IMP-symbol-193-substitution $p #Substitution ( \kore-symbol-Lbl'Unds'List'Unds' ptn1 ptn2 ) ( \kore-symbol-Lbl'Unds'List'Unds' ptn3 ptn4 ) ptn0 xX0 $= ( IMP-symbol-193-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-193-is-pattern substitution-app substitution-disjoint notation-cache-344 notation-cache-345 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
