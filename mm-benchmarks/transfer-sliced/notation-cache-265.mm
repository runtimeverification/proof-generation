...
${ notation-cache-265 $p #Notation ( \kore-symbol-Lbl'UndsSlshUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsSlshUndsUnds'IMP-SYNTAX'Unds'AExp'Unds'AExp'Unds'AExp-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-166-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-166-is-pattern IMP-symbol-166-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
