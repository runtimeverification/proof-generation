...
${ notation-cache-91 $p #Notation ( \kore-symbol-Lbl'Hash'if'UndsHash'then'UndsHash'else'UndsHash'fi'Unds'K-EQUAL-SYNTAX'Unds'Sort'Unds'Bool'Unds'Sort'Unds'Sort ptn0 ptn1 ptn2 ptn3 ) ( \app ( \app ( \app ( \app \kore-symbol-Lbl'Hash'if'UndsHash'then'UndsHash'else'UndsHash'fi'Unds'K-EQUAL-SYNTAX'Unds'Sort'Unds'Bool'Unds'Sort'Unds'Sort-symbol ptn0 ) ptn1 ) ptn2 ) ptn3 ) $= ( app-is-pattern IMP-symbol-98-is-symbol symbol-is-pattern notation-reflexivity notation-app IMP-symbol-98-is-pattern IMP-symbol-98-is-sugar notation-transitivity ) ABCDJFGAEBECEDEFGAEBECEDEABCDKFGAEBECEDFGAEBECEDFGAEBECFGAEBECFGAEBFGAEBFGAFGAFGHAHIBHICHIDHIL $. $}
