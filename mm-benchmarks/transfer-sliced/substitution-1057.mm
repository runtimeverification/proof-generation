...
${ substitution-1057 $p #Substitution kore-sort-var-S2 kore-sort-var-S2 \kore-sort-SortBool kore-sort-var-S1 $= ( typecode-cache-Pattern-1 IMP-sort-32-is-pattern element-var-is-var substitution-disjoint ) ACDBEF $. $}
