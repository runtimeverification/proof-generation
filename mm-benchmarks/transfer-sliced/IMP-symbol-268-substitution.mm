$c \kore-symbol-LblisKCellOpt #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-LblisKCellOpt-symbol \app ) ( $.
...
notation-cache-539 $a #Notation ( \kore-symbol-LblisKCellOpt ptn1 ) ( \app \kore-symbol-LblisKCellOpt-symbol ptn1 ) $.
notation-cache-540 $a #Notation ( \kore-symbol-LblisKCellOpt ptn2 ) ( \app \kore-symbol-LblisKCellOpt-symbol ptn2 ) $.
${ IMP-symbol-268-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-268-substitution $p #Substitution ( \kore-symbol-LblisKCellOpt ptn1 ) ( \kore-symbol-LblisKCellOpt ptn2 ) ptn0 xX0 $= ( IMP-symbol-268-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-268-is-pattern substitution-disjoint substitution-app notation-cache-539 notation-cache-540 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
