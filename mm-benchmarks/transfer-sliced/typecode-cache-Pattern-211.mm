$c \top #SetVariable #ElementVariable #Symbol #Variable #Pattern ( \kore-is-sort ) \in-sort \kore-sort-SortMap \and $.
$v kore-sort-var-R ph0 kore-element-var-K3 kore-element-var-K1 ph1 kore-element-var-K2 $.
...
${ typecode-cache-Pattern-211 $p #Pattern ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortMap ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortMap ) ( \and ( \in-sort kore-element-var-K3 \kore-sort-SortMap ) \top ) ) ) ) $= ( and-is-pattern IMP-sort-14-is-pattern in-sort-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern typecode-cache-Pattern-49 typecode-cache-Pattern-120 typecode-cache-Pattern-209 top-is-pattern ) AHIBJFGCKFGDLFGMEEEE $. $}
