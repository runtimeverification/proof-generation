...
${ notation-cache-106 $p #Notation ( \kore-symbol-Lbl'Hash'open'LParUndsCommUndsRParUnds'K-IO'Unds'IOInt'Unds'String'Unds'String ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Hash'open'LParUndsCommUndsRParUnds'K-IO'Unds'IOInt'Unds'String'Unds'String-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-103-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-103-is-pattern IMP-symbol-103-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
