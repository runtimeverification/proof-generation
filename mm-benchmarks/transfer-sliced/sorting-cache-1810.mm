...
${ sorting-cache-1810 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ( \kore-is-sort kore-sort-var-R ) ) $= ( typecode-cache-Pattern-0 kore-is-sort-is-pattern typecode-cache-Pattern-381 typecode-cache-Pattern-6 IMP-sort-32-is-pattern in-sort-is-pattern top-is-pattern and-is-pattern and-elim-left-sugar imp-reflexivity rule-imp-transitivity ) ABEACDACDACDBFGHIJKACDLM $. $}
