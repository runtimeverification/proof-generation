...
${ notation-cache-628 $p #Notation ( \kore-symbol-Lblproject'Coln'AExp ptn0 ) ( \app \kore-symbol-Lblproject'Coln'AExp-symbol ptn0 ) $= ( IMP-symbol-302-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-302-is-pattern IMP-symbol-302-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
