...
${ $d xX0 ptn0 $.
   ...
   kore-inj-application-context-1 $p #ApplicationContext xX0 ( \kore-inj ptn0 ptn1 ptn2 ) $= ( app-is-pattern kore-inj-is-symbol symbol-is-pattern kore-inj-is-pattern application-context-app-right application-context-app-left notation-cache-6 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAGHBFCAEJKBCDLM $. $}
