...
${ notation-cache-429 $p #Notation ( \kore-symbol-LblcategoryChar'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'String ptn2 ) ( \app \kore-symbol-LblcategoryChar'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'String-symbol ptn2 ) $= ( IMP-symbol-225-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-225-is-pattern IMP-symbol-225-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
