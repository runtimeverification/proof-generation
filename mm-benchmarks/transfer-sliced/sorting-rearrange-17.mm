...
${ sorting-rearrange-17 $p |- ( \imp \top ( \kore-valid \unit-sort ( \kore-equals \kore-sort-SortKItem \unit-sort ( \kore-inj \kore-sort-SortAExp \kore-sort-SortKItem ( \kore-inj \kore-sort-SortId \kore-sort-SortAExp ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ) ( \kore-inj \kore-sort-SortId \kore-sort-SortKItem ( \kore-dv \kore-sort-SortId "balanceSender" ) ) ) ) ) $= ( IMP-sort-17-is-pattern kore-inj-is-pattern BASIC-K-sort-1-is-pattern kore-sort-var-R-elementvariable IMP-sort-13-is-pattern string-literal-10-is-pattern kore-dv-is-pattern top-is-pattern typecode-cache-Pattern-0 unit-sort-is-symbol symbol-is-pattern kore-sort-var-x0-elementvariable and-is-pattern typecode-cache-Pattern-14 kore-is-sort-is-pattern element-var-is-var kore-equals-is-pattern kore-valid-is-pattern x-is-element-var substitution-var-same substitution-disjoint rule-weakening top-intro rule-and-intro-alt2-sugar rule-imp-transitivity substitution-kore-equals substitution-kore-valid substitution-imp sorting-cache-129 typecode-cache-Pattern-22 exists-is-pattern unit-sort-is-functional sorting-cache-136 sorting-rearrange-16 substitution-83 substitution-84 substitution-87 substitution-88 functional-substitution-alt )  $. $}
