...
${ notation-cache-152 $p #Notation ( \kore-symbol-Lbl'-LT-'T'-GT-'-fragment ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'-LT-'T'-GT-'-fragment-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-127-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-127-is-pattern IMP-symbol-127-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
