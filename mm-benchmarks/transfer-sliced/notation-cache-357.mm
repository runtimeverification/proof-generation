...
${ notation-cache-357 $p #Notation ( \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-198-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-198-is-pattern IMP-symbol-198-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
