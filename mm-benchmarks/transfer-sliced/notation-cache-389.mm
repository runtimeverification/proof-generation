...
${ notation-cache-389 $p #Notation ( \kore-symbol-Lbl'Unds'in'UndsUnds'LIST'Unds'Bool'Unds'KItem'Unds'List ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'in'UndsUnds'LIST'Unds'Bool'Unds'KItem'Unds'List-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-210-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-210-is-pattern IMP-symbol-210-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
