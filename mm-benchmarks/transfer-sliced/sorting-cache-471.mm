...
${ sorting-cache-471 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \in-sort \kore-symbol-Lbl'Stop'Map \kore-sort-SortMap ) ) $= ( IMP-symbol-124-is-pattern IMP-sort-14-is-pattern in-sort-is-pattern typecode-cache-Pattern-0 kore-is-sort-is-pattern top-is-pattern and-is-pattern imp-is-pattern proof-rule-prop-1 IMP-symbol-124-sorting proof-rule-mp ) BCDAEFGHBCDIBCDAEFGHJKL $. $}
