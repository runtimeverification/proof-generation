$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-Lbl'Unds'Set'Unds' \kore-symbol-Lbl'Unds'Set'Unds'-symbol \app ) ( $.
...
notation-cache-350 $a #Notation ( \kore-symbol-Lbl'Unds'Set'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds'Set'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-351 $a #Notation ( \kore-symbol-Lbl'Unds'Set'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds'Set'Unds'-symbol ptn3 ) ptn4 ) $.
${ IMP-symbol-195-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   IMP-symbol-195-substitution $p #Substitution ( \kore-symbol-Lbl'Unds'Set'Unds' ptn1 ptn2 ) ( \kore-symbol-Lbl'Unds'Set'Unds' ptn3 ptn4 ) ptn0 xX0 $= ( IMP-symbol-195-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-195-is-pattern substitution-app substitution-disjoint notation-cache-350 notation-cache-351 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
