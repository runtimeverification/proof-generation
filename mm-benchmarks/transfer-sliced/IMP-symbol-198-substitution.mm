$c #Substitution #Notation #SetVariable \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB' #ElementVariable #Symbol \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB'-symbol #Variable #Pattern \app ) ( $.
...
notation-cache-355 $a #Notation ( \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB'-symbol ptn1 ) ptn2 ) $.
notation-cache-356 $a #Notation ( \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB'-symbol ptn3 ) ptn4 ) $.
${ IMP-symbol-198-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   IMP-symbol-198-substitution $p #Substitution ( \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB' ptn1 ptn2 ) ( \kore-symbol-Lbl'UndsLSqBUnds-LT-'-undef'RSqB' ptn3 ptn4 ) ptn0 xX0 $= ( IMP-symbol-198-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-198-is-pattern substitution-app substitution-disjoint notation-cache-355 notation-cache-356 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
