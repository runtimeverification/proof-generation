...
notation-cache-734 $a #Notation ( \kore-symbol-Lblreplace'LParUndsCommUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String'Unds'Int ptn0 ptn1 ptn2 ptn3 ) ( \app ( \app ( \app ( \app \kore-symbol-Lblreplace'LParUndsCommUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String'Unds'Int-symbol ptn0 ) ptn1 ) ptn2 ) ptn3 ) $.
${ $d xX0 ptn1 $.
   $d xX0 ptn2 $.
   $d xX0 ptn3 $.
   IMP-symbol-338-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-338-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lblreplace'LParUndsCommUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String'Unds'String'Unds'Int ptn0 ptn1 ptn2 ptn3 ) $= ( app-is-pattern IMP-symbol-338-is-symbol symbol-is-pattern application-context-app-left IMP-symbol-338-is-pattern application-context-app-right notation-cache-734 notation-application-context ) HIBGCGDGEGBCDEKAHIBGCGDGEAHIBGCGDAHIBGCAHIBAFLJJJBCDEMN $. $}
