$c \top #SetVariable #ElementVariable #Symbol "210" #Variable #Pattern \and \kore-sort-SortKItem \imp \kore-dv \kore-is-sort |- ) \kore-sort-SortInt \in-sort \kore-sort-SortMap ( $.
...
${ sorting-cache-2275 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K2 \kore-sort-SortMap ) ( \and ( \in-sort kore-element-var-K3 \kore-sort-SortMap ) \top ) ) ) ( \and ( \and ( \kore-is-sort \kore-sort-SortInt ) ( \kore-is-sort \kore-sort-SortKItem ) ) ( \in-sort ( \kore-dv \kore-sort-SortInt "210" ) \kore-sort-SortInt ) ) ) $= ( IMP-sort-23-is-pattern kore-is-sort-is-pattern typecode-cache-Pattern-210 BASIC-K-sort-1-is-pattern string-literal-20-is-pattern kore-dv-is-pattern in-sort-is-pattern imp-is-pattern proof-rule-prop-1 proof-rule-mp rule-and-intro-alt2-sugar and-is-pattern IMP-sort-23-sort BASIC-K-sort-1-sort kore-dv-sorting ) ABCFDEGEODHIDJABCFDEGEDEABCFDEKDEABCFLPMGEABCFGEKGEABCFLQMNDHIDJABCFDHIDJKDHIDJABCFLDHRMN $. $}
