...
${ sorting-cache-1618 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ) ( \in-sort ( \kore-inj \kore-sort-SortInt \kore-sort-SortKResult ( \kore-dv \kore-sort-SortInt "100" ) ) \kore-sort-SortKResult ) ) $= ( and-is-pattern IMP-sort-23-is-pattern kore-is-sort-is-pattern top-is-pattern typecode-cache-Pattern-0 string-literal-16-is-pattern kore-dv-is-pattern in-sort-is-pattern IMP-sort-28-is-pattern kore-inj-is-pattern sorting-cache-1570 imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp rule-and-intro-alt2-sugar INJ-symbol-0-sorting rule-imp-transitivity ) AFDEBAFDEBEBBCDJDBCGHCIBCJCGHKJIAFDEBAFDEBEBBCDJDBCGHCIALCGHCIAFDEBAFDEBEBBCGHCIMCGHCIAFDEBAFDEBEBBNCGOPQCJCGHRS $. $}
