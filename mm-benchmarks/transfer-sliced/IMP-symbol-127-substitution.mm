$c #Substitution #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'-LT-'T'-GT-'-fragment-symbol #Variable #Pattern \app ) \kore-symbol-Lbl'-LT-'T'-GT-'-fragment ( $.
...
notation-cache-150 $a #Notation ( \kore-symbol-Lbl'-LT-'T'-GT-'-fragment ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'-LT-'T'-GT-'-fragment-symbol ptn1 ) ptn2 ) $.
notation-cache-151 $a #Notation ( \kore-symbol-Lbl'-LT-'T'-GT-'-fragment ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'-LT-'T'-GT-'-fragment-symbol ptn3 ) ptn4 ) $.
