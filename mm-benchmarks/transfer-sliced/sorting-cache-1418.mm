$c \top \kore-sort-SortAExp #Variable \imp \kore-dv \kore-is-sort |- \kore-sort-SortId ) \and #SetVariable #ElementVariable #Symbol #Pattern \kore-sort-SortKItem \in-sort \kore-sort-SortMap \kore-sort-SortStateCell "balanceTo" ( $.
...
${ sorting-cache-1418 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) \top ) ) ) ) ( \and ( \and ( \kore-is-sort \kore-sort-SortId ) ( \kore-is-sort \kore-sort-SortAExp ) ) ( \in-sort ( \kore-dv \kore-sort-SortId "balanceTo" ) \kore-sort-SortId ) ) ) $= ( in-sort-is-pattern IMP-sort-17-is-pattern and-is-pattern string-literal-17-is-pattern kore-dv-is-pattern typecode-cache-Pattern-177 IMP-sort-9-is-pattern typecode-cache-Pattern-178 BASIC-K-sort-1-is-pattern typecode-cache-Pattern-308 kore-is-sort-is-pattern IMP-sort-13-is-pattern sorting-cache-1411 imp-is-pattern proof-rule-prop-1 kore-dv-sorting proof-rule-mp rule-and-intro-alt2-sugar ) AJKEBLMECDNGGFOPOGFHIFEABCDQFHIFEAJKEBLMECDNGGFHIFERFHIFEAJKEBLMECDNGGSFHTUAUB $. $}
