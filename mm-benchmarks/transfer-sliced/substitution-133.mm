...
${ substitution-133 $p #Substitution \kore-sort-SortInt \kore-sort-SortInt kore-sort-var-x0 kore-sort-var-R $= ( IMP-sort-23-is-pattern typecode-cache-Pattern-14 element-var-is-var substitution-disjoint ) CBDAEF $. $}
