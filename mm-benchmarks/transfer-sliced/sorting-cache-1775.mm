...
${ sorting-cache-1775 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE6 \kore-sort-SortBlock ) \top ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) \top ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortKItem ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-253 BASIC-K-sort-1-is-pattern top-is-pattern and-is-pattern typecode-cache-Pattern-356 IMP-sort-18-is-pattern rule-imp-transitivity and-elim-right-sugar and-elim-left-sugar imp-reflexivity ) BHICFGADECFGGADECFGADECBHICFGADECFGKADECFGADECADECADECFLADECMJJ $. $}
