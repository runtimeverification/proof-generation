$c #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \kore-symbol-Lbl'Unds-GT-'Int'Unds'-symbol \app \kore-symbol-Lbl'Unds-GT-'Int'Unds' ) ( $.
...
notation-cache-337 $a #Notation ( \kore-symbol-Lbl'Unds-GT-'Int'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds-GT-'Int'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-190-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-190-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds-GT-'Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-190-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-190-is-pattern application-context-app-right application-context-app-left notation-cache-337 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
