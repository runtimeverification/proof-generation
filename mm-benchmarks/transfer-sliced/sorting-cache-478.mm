...
sorting-cache-476 $a |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ( \and ( \kore-is-sort \kore-sort-SortKConfigVar ) ( \kore-is-sort \kore-sort-SortKItem ) ) ) $.
sorting-cache-477 $a |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ( \in-sort ( \kore-dv \kore-sort-SortKConfigVar "%24PGM" ) \kore-sort-SortKConfigVar ) ) $.
${ sorting-cache-478 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) \top ) ( \in-sort ( \kore-inj \kore-sort-SortKConfigVar \kore-sort-SortKItem ( \kore-dv \kore-sort-SortKConfigVar "%24PGM" ) ) \kore-sort-SortKItem ) ) $= ( IMP-sort-20-is-pattern and-is-pattern kore-is-sort-is-pattern BASIC-K-sort-1-is-pattern top-is-pattern string-literal-9-is-pattern kore-dv-is-pattern in-sort-is-pattern typecode-cache-Pattern-0 kore-inj-is-pattern sorting-cache-476 sorting-cache-477 rule-and-intro-alt2-sugar INJ-symbol-0-sorting rule-imp-transitivity ) AJDFCFCBDEDCBGHBICBEBGHKEIAJDFCFCBDEDCBGHBIALAMNBEBGHOP $. $}
