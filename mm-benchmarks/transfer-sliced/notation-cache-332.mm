...
${ notation-cache-332 $p #Notation ( \kore-symbol-Lbl'Unds-GT--GT-'Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds-GT--GT-'Int'Unds'-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-189-is-symbol symbol-is-pattern IMP-symbol-189-is-pattern IMP-symbol-189-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
