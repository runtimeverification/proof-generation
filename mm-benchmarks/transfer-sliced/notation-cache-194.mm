...
${ notation-cache-194 $p #Notation ( \kore-symbol-LblMap'Coln'lookup ptn3 ptn4 ) ( \app ( \app \kore-symbol-LblMap'Coln'lookup-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-142-is-symbol symbol-is-pattern IMP-symbol-142-is-pattern IMP-symbol-142-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
