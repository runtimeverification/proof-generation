...
${ notation-cache-314 $p #Notation ( \kore-symbol-Lbl'UndsEqlsEqls'String'UndsUnds'STRING-COMMON'Unds'Bool'Unds'String'Unds'String ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsEqls'String'UndsUnds'STRING-COMMON'Unds'Bool'Unds'String'Unds'String-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-183-is-symbol symbol-is-pattern IMP-symbol-183-is-pattern IMP-symbol-183-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
