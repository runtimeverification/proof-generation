...
${ notation-cache-402 $p #Notation ( \kore-symbol-Lbl'Unds'orElseBool'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds'orElseBool'Unds'-symbol ptn1 ) ptn2 ) $= ( app-is-pattern IMP-symbol-215-is-symbol symbol-is-pattern IMP-symbol-215-is-pattern IMP-symbol-215-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
