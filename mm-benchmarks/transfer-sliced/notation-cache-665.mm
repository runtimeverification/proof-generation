...
${ notation-cache-665 $p #Notation ( \kore-symbol-Lblproject'Coln'IOString ptn1 ) ( \app \kore-symbol-Lblproject'Coln'IOString-symbol ptn1 ) $= ( IMP-symbol-315-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-315-is-pattern IMP-symbol-315-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
