$c #Notation #SetVariable \kore-symbol-LblsubstrString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'Int'Unds'Int #ElementVariable #Symbol #Variable #Pattern #ApplicationContext \kore-symbol-LblsubstrString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'Int'Unds'Int-symbol \app ) ( $.
...
notation-cache-752 $a #Notation ( \kore-symbol-LblsubstrString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'Int'Unds'Int ptn0 ptn1 ptn2 ) ( \app ( \app ( \app \kore-symbol-LblsubstrString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'Int'Unds'Int-symbol ptn0 ) ptn1 ) ptn2 ) $.
${ $d xX0 ptn1 $.
   $d xX0 ptn2 $.
   IMP-symbol-348-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-348-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblsubstrString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'String'Unds'String'Unds'Int'Unds'Int ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-348-is-symbol symbol-is-pattern application-context-app-left IMP-symbol-348-is-pattern application-context-app-right notation-cache-752 notation-application-context ) GHBFCFDFBCDJAGHBFCFDAGHBFCAGHBAEKIIBCDLM $. $}
