$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable \kore-symbol-LblisSet #Pattern \kore-symbol-LblisSet-symbol \app ) ( $.
...
notation-cache-560 $a #Notation ( \kore-symbol-LblisSet ptn1 ) ( \app \kore-symbol-LblisSet-symbol ptn1 ) $.
notation-cache-561 $a #Notation ( \kore-symbol-LblisSet ptn2 ) ( \app \kore-symbol-LblisSet-symbol ptn2 ) $.
${ IMP-symbol-275-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-275-substitution $p #Substitution ( \kore-symbol-LblisSet ptn1 ) ( \kore-symbol-LblisSet ptn2 ) ptn0 xX0 $= ( IMP-symbol-275-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-275-is-pattern substitution-disjoint substitution-app notation-cache-560 notation-cache-561 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
