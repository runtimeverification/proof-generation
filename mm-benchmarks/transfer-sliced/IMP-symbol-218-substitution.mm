$c #Substitution #Notation \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' #SetVariable #ElementVariable #Symbol #Variable #Pattern \app \kore-symbol-Lbl'UndsPipe'-'-GT-Unds'-symbol ) ( $.
...
notation-cache-411 $a #Notation ( \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'UndsPipe'-'-GT-Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-412 $a #Notation ( \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsPipe'-'-GT-Unds'-symbol ptn3 ) ptn4 ) $.
${ IMP-symbol-218-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   IMP-symbol-218-substitution $p #Substitution ( \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' ptn1 ptn2 ) ( \kore-symbol-Lbl'UndsPipe'-'-GT-Unds' ptn3 ptn4 ) ptn0 xX0 $= ( IMP-symbol-218-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-218-is-pattern substitution-app substitution-disjoint notation-cache-411 notation-cache-412 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
