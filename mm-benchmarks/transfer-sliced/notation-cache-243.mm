...
${ notation-cache-243 $p #Notation ( \kore-symbol-Lbl'UndsPlus'String'UndsUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsPlus'String'UndsUnds'STRING-COMMON'Unds'String'Unds'String'Unds'String-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-159-is-symbol symbol-is-pattern IMP-symbol-159-is-pattern IMP-symbol-159-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
