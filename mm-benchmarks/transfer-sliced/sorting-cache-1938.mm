...
${ sorting-cache-1938 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortAExp ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) \top ) ) ) ) ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortId ) \top ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-146 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-177 IMP-sort-13-is-pattern typecode-cache-Pattern-397 top-is-pattern typecode-cache-Pattern-179 IMP-sort-17-is-pattern sorting-cache-1934 top-intro rule-weakening rule-and-intro-alt2-sugar ) BGHEAIJECDKFFDMNELABCDOBGHEAIJECDKFFLPQR $. $}
