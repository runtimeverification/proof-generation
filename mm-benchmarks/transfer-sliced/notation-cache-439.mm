$c #Notation \kore-symbol-LblchrChar'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int #SetVariable #ElementVariable #Symbol #Variable #Pattern \app \kore-symbol-LblchrChar'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int-symbol ) ( $.
...
${ notation-cache-439 $p #Notation ( \kore-symbol-LblchrChar'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int ptn0 ) ( \app \kore-symbol-LblchrChar'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int-symbol ptn0 ) $= ( IMP-symbol-228-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity IMP-symbol-228-is-pattern IMP-symbol-228-is-sugar notation-app notation-transitivity ) AFBCADBCADAGBCABCABCEAEHI $. $}
