...
${ notation-cache-213 $p #Notation ( \kore-symbol-LblString2Float'LParUndsRParUnds'STRING-COMMON'Unds'Float'Unds'String ptn2 ) ( \app \kore-symbol-LblString2Float'LParUndsRParUnds'STRING-COMMON'Unds'Float'Unds'String-symbol ptn2 ) $= ( IMP-symbol-149-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-149-is-pattern IMP-symbol-149-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
