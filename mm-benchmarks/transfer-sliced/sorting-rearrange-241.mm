...
sorting-rearrange-240 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \exists kore-element-var-Val ( \eq kore-element-var-Val ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "1" ) ) ) ) ) $.
sorting-cache-404 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \in-sort ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "1" ) ) \kore-sort-SortAExp ) ) $.
${ sorting-rearrange-241 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortStmt kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortStmt kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ( \kore-dv \kore-sort-SortId "ret" ) ( \kore-inj \kore-sort-SortInt \kore-sort-SortAExp ( \kore-dv \kore-sort-SortInt "1" ) ) ) ) ) ) ) $= ( IMP-sort-23-is-pattern IMP-sort-13-is-pattern kore-dv-is-pattern typecode-cache-Pattern-0 string-literal-4-is-pattern kore-inj-is-pattern kore-element-var-K1-elementvariable top-is-pattern IMP-sort-31-is-pattern element-var-is-var and-is-pattern in-sort-is-pattern IMP-sort-17-is-pattern string-literal-11-is-pattern substitution-disjoint typecode-cache-Pattern-31 kore-exists-is-pattern kore-is-sort-is-pattern IMP-symbol-185-is-pattern kore-valid-is-pattern typecode-cache-Pattern-49 kore-equals-is-pattern typecode-cache-Pattern-127 kore-element-var-x0-elementvariable rule-and-intro-alt2-sugar substitution-var-same sorting-cache-133 sorting-cache-404 top-intro rule-weakening typecode-cache-Pattern-128 typecode-cache-Pattern-25 sorting-rearrange-240 sorting-rearrange-194 substitution-in-sort substitution-and IMP-symbol-185-substitution substitution-kore-equals substitution-kore-exists-alt substitution-kore-valid substitution-imp substitution-366 functional-substitution-alt rule-imp-transitivity )  $. $}
