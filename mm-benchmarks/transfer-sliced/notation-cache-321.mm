...
${ notation-cache-321 $p #Notation ( \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-185-is-symbol symbol-is-pattern IMP-symbol-185-is-pattern IMP-symbol-185-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
