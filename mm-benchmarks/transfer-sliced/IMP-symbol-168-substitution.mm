$c #Substitution #Notation \kore-symbol-Lbl'Unds-LT-Eqls'Int'Unds' #SetVariable #ElementVariable #Symbol #Variable #Pattern \app \kore-symbol-Lbl'Unds-LT-Eqls'Int'Unds'-symbol ) ( $.
...
notation-cache-269 $a #Notation ( \kore-symbol-Lbl'Unds-LT-Eqls'Int'Unds' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'Unds-LT-Eqls'Int'Unds'-symbol ptn1 ) ptn2 ) $.
notation-cache-270 $a #Notation ( \kore-symbol-Lbl'Unds-LT-Eqls'Int'Unds' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds-LT-Eqls'Int'Unds'-symbol ptn3 ) ptn4 ) $.
