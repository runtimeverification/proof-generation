$c #Substitution \kore-symbol-Lbl'-LT-'T'-GT-' #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lbl'-LT-'T'-GT-'-symbol #Variable #Pattern \app ) ( $.
...
notation-cache-147 $a #Notation ( \kore-symbol-Lbl'-LT-'T'-GT-' ptn1 ptn2 ) ( \app ( \app \kore-symbol-Lbl'-LT-'T'-GT-'-symbol ptn1 ) ptn2 ) $.
notation-cache-148 $a #Notation ( \kore-symbol-Lbl'-LT-'T'-GT-' ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'-LT-'T'-GT-'-symbol ptn3 ) ptn4 ) $.
${ IMP-symbol-126-substitution.0 $e #Substitution ptn1 ptn3 ptn0 xX0 $.
   ...
   IMP-symbol-126-substitution $p #Substitution ( \kore-symbol-Lbl'-LT-'T'-GT-' ptn1 ptn2 ) ( \kore-symbol-Lbl'-LT-'T'-GT-' ptn3 ptn4 ) ptn0 xX0 $= ( IMP-symbol-126-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-126-is-pattern substitution-app substitution-disjoint notation-cache-147 notation-cache-148 notation-reflexivity notation-substitution ) IJCKDKIJEKFKBCDLEFLBABIJCKDIJEKFABIJCIJEAIJBANGMHMCDOEFPBQR $. $}
