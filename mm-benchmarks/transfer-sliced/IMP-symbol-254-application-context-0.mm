$c #Notation #SetVariable \kore-symbol-LblisFloat-symbol #ElementVariable #Symbol \kore-symbol-LblisFloat #Variable #Pattern #ApplicationContext \app ) ( $.
...
notation-cache-499 $a #Notation ( \kore-symbol-LblisFloat ptn0 ) ( \app \kore-symbol-LblisFloat-symbol ptn0 ) $.
${ IMP-symbol-254-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-254-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblisFloat ptn0 ) $= ( IMP-symbol-254-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-254-is-pattern application-context-app-right notation-cache-499 notation-application-context ) DEBFBGADEBACHBIJ $. $}
