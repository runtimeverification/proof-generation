...
${ notation-cache-183 $p #Notation ( \kore-symbol-LblInt2String'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int ptn1 ) ( \app \kore-symbol-LblInt2String'LParUndsRParUnds'STRING-COMMON'Unds'String'Unds'Int-symbol ptn1 ) $= ( IMP-symbol-138-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-138-is-pattern IMP-symbol-138-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
