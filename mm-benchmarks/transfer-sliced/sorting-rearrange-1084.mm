$c \exists #Substitution \top #Variable \kore-sort-SortBool \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals "false" \and \unit-sort #SetVariable #ElementVariable #Symbol \eq #Pattern \kore-exists \kore-sort-SortKItem \kore-inj ( $.
...
sorting-rearrange-1083 $a |- ( \imp ( \and \top ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortKItem kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortKItem kore-sort-var-R kore-element-var-Val ( \kore-inj \kore-sort-SortBool \kore-sort-SortKItem ( \kore-dv \kore-sort-SortBool "false" ) ) ) ) ) ) $.
${ sorting-rearrange-1084 $p |- ( \imp \top ( \kore-valid \unit-sort ( \kore-exists \kore-sort-SortKItem \unit-sort kore-element-var-Val ( \kore-equals \kore-sort-SortKItem \unit-sort kore-element-var-Val ( \kore-inj \kore-sort-SortBool \kore-sort-SortKItem ( \kore-dv \kore-sort-SortBool "false" ) ) ) ) ) ) $= ( BASIC-K-sort-1-is-pattern kore-sort-var-R-elementvariable IMP-sort-32-is-pattern unit-sort-is-symbol symbol-is-pattern kore-sort-var-x0-elementvariable typecode-cache-Pattern-0 string-literal-5-is-pattern kore-dv-is-pattern kore-inj-is-pattern typecode-cache-Pattern-14 typecode-cache-Pattern-31 top-is-pattern kore-equals-is-pattern element-var-is-var kore-exists-is-pattern and-is-pattern kore-is-sort-is-pattern kore-valid-is-pattern substitution-var-same x-is-element-var rule-weakening substitution-84 substitution-disjoint substitution-kore-equals substitution-kore-exists-alt substitution-kore-valid substitution-imp substitution-88 top-intro sorting-cache-129 rule-and-intro-alt2-sugar typecode-cache-Pattern-22 exists-is-pattern unit-sort-is-functional sorting-rearrange-1083 substitution-83 substitution-141 substitution-87 substitution-145 functional-substitution-alt rule-imp-transitivity )  $. $}
