$c \exists #Substitution \top #Variable \kore-sort-SortBool \imp \kore-dv \kore-is-sort |- \kore-valid ) \kore-equals "false" \and \unit-sort #SetVariable #ElementVariable #Symbol \kore-symbol-LblnotBool'Unds' \eq #Pattern "true" ( $.
...
sorting-rearrange-767 $a |- ( \imp ( \and \top ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-equals \kore-sort-SortBool kore-sort-var-R ( \kore-symbol-LblnotBool'Unds' ( \kore-dv \kore-sort-SortBool "false" ) ) ( \kore-dv \kore-sort-SortBool "true" ) ) ) ) $.
${ sorting-rearrange-768 $p |- ( \imp \top ( \kore-valid \unit-sort ( \kore-equals \kore-sort-SortBool \unit-sort ( \kore-symbol-LblnotBool'Unds' ( \kore-dv \kore-sort-SortBool "false" ) ) ( \kore-dv \kore-sort-SortBool "true" ) ) ) ) $= ( IMP-sort-32-is-pattern kore-dv-is-pattern kore-sort-var-R-elementvariable unit-sort-is-symbol symbol-is-pattern kore-sort-var-x0-elementvariable string-literal-5-is-pattern IMP-symbol-297-is-pattern string-literal-0-is-pattern top-is-pattern typecode-cache-Pattern-14 typecode-cache-Pattern-0 element-var-is-var kore-equals-is-pattern and-is-pattern kore-is-sort-is-pattern kore-valid-is-pattern x-is-element-var substitution-var-same substitution-disjoint rule-weakening substitution-kore-equals substitution-kore-valid substitution-imp top-intro sorting-cache-129 rule-and-intro-alt2-sugar typecode-cache-Pattern-22 exists-is-pattern unit-sort-is-functional sorting-rearrange-767 substitution-83 substitution-127 substitution-87 substitution-128 functional-substitution-alt rule-imp-transitivity )  $. $}
