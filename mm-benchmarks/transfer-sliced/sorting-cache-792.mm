...
${ sorting-cache-792 $p |- ( \imp ( \and ( \and ( \in-sort kore-element-var-VE1 \kore-sort-SortK ) ( \and ( \in-sort kore-element-var-VE2 \kore-sort-SortStmt ) ( \and ( \in-sort kore-element-var-VE3 \kore-sort-SortStateCell ) \top ) ) ) ( \and ( \in-sort kore-element-var-VE0 \kore-sort-SortGeneratedCounterCell ) \top ) ) ( \in-sort kore-element-var-VE2 \kore-sort-SortStmt ) ) $= ( in-sort-is-pattern and-is-pattern typecode-cache-Pattern-225 typecode-cache-Pattern-146 BASIC-K-sort-0-is-pattern typecode-cache-Pattern-148 IMP-sort-10-is-pattern top-is-pattern typecode-cache-Pattern-177 IMP-sort-31-is-pattern rule-imp-transitivity and-elim-left-sugar and-elim-right-sugar sorting-cache-791 ) CHIEBDGFAJKELFFCHIEBDGFBMNECHIEBDGFAJKELFPCHIEBDGFBDGBMNECHIEBDGQBDROO $. $}
