...
sorting-cache-1812 $a |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ( \and ( \kore-is-sort kore-sort-var-S3 ) \top ) ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) $.
${ sorting-cache-1813 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ( \and ( \kore-is-sort kore-sort-var-S3 ) \top ) ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ) $= ( typecode-cache-Pattern-2 kore-is-sort-is-pattern and-is-pattern top-is-pattern typecode-cache-Pattern-381 rule-imp-transitivity typecode-cache-Pattern-6 IMP-sort-32-is-pattern in-sort-is-pattern and-elim-right-sugar and-elim-left-sugar imp-reflexivity sorting-cache-1812 rule-and-intro-alt2-sugar ) ACHBDEGFFBDECJKLGFACHBDEGFFBDEGFBDEACHBDEGFMBDEGFBDEBDEBDEGNBDEOIIABCPQ $. $}
