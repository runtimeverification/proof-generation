$c \kore-symbol-LblfindString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String'Unds'Int-symbol #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-LblfindString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String'Unds'Int #ApplicationContext \app ) ( $.
...
notation-cache-453 $a #Notation ( \kore-symbol-LblfindString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String'Unds'Int ptn0 ptn1 ptn2 ) ( \app ( \app ( \app \kore-symbol-LblfindString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String'Unds'Int-symbol ptn0 ) ptn1 ) ptn2 ) $.
${ $d xX0 ptn0 $.
   $d xX0 ptn2 $.
   IMP-symbol-236-application-context-1.0 $e #ApplicationContext xX0 ptn1 $.
   IMP-symbol-236-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-LblfindString'LParUndsCommUndsCommUndsRParUnds'STRING-COMMON'Unds'Int'Unds'String'Unds'String'Unds'Int ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-236-is-symbol symbol-is-pattern IMP-symbol-236-is-pattern application-context-app-right application-context-app-left notation-cache-453 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAGHBFCAEJKBCDLM $. $}
