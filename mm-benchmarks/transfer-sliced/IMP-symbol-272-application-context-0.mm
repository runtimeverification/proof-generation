$c #Notation \kore-symbol-LblisList #SetVariable #ElementVariable #Symbol \kore-symbol-LblisList-symbol #Variable #Pattern #ApplicationContext \app ) ( $.
...
notation-cache-553 $a #Notation ( \kore-symbol-LblisList ptn0 ) ( \app \kore-symbol-LblisList-symbol ptn0 ) $.
${ IMP-symbol-272-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-272-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-LblisList ptn0 ) $= ( IMP-symbol-272-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-272-is-pattern application-context-app-right notation-cache-553 notation-application-context ) DEBFBGADEBACHBIJ $. $}
