...
${ notation-cache-455 $p #Notation ( \kore-symbol-LblfreshId'LParUndsRParUnds'ID-COMMON'Unds'Id'Unds'Int ptn2 ) ( \app \kore-symbol-LblfreshId'LParUndsRParUnds'ID-COMMON'Unds'Id'Unds'Int-symbol ptn2 ) $= ( IMP-symbol-237-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-237-is-pattern IMP-symbol-237-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
