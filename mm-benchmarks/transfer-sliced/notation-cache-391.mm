...
${ notation-cache-391 $p #Notation ( \kore-symbol-Lbl'Unds'in'Unds'keys'LParUndsRParUnds'ARRAY-SYNTAX'Unds'Bool'Unds'Int'Unds'Array ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'Unds'in'Unds'keys'LParUndsRParUnds'ARRAY-SYNTAX'Unds'Bool'Unds'Int'Unds'Array-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-211-is-symbol symbol-is-pattern IMP-symbol-211-is-pattern IMP-symbol-211-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
