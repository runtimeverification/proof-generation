...
${ notation-cache-313 $p #Notation ( \kore-symbol-Lbl'UndsEqlsEqls'K'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsEqls'K'Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-182-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-182-is-pattern IMP-symbol-182-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
