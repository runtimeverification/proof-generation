...
${ $d xX0 ptn0 $.
   ...
   IMP-symbol-196-application-context-1 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsLSqBUnds-LT-'-'UndsRSqB' ptn0 ptn1 ptn2 ) $= ( app-is-pattern IMP-symbol-196-is-symbol symbol-is-pattern IMP-symbol-196-is-pattern application-context-app-right application-context-app-left notation-cache-353 notation-application-context ) GHBFCFDFBCDIAGHBFCFDAGHBFCAEJKBCDLM $. $}
