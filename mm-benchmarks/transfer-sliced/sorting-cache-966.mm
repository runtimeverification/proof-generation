...
${ sorting-cache-966 $p |- ( \imp ( \and ( \in-sort kore-element-var-VE4 \kore-sort-SortKItem ) ( \and ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) \top ) ) ( \in-sort kore-element-var-VE5 \kore-sort-SortMap ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-253 IMP-sort-14-is-pattern top-is-pattern and-is-pattern rule-imp-transitivity typecode-cache-Pattern-254 typecode-cache-Pattern-179 BASIC-K-sort-1-is-pattern and-elim-right-sugar and-elim-left-sugar imp-reflexivity ) ABIBDECFGBDECAJKCBDECFGLBDECFGBDECBDECBDECFMBDECNHH $. $}
