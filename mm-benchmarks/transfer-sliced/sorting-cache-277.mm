$c \top #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-sort-SortIds \and \imp \kore-is-sort |- \kore-sort-SortId ) \in-sort ( $.
...
sorting-cache-276 $a |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortIds ) \top ) ) ( \and ( \in-sort kore-element-var-K0 \kore-sort-SortId ) \top ) ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortIds ) \top ) ) $.
...
${ sorting-cache-277 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortIds ) \top ) ) ( \and ( \in-sort kore-element-var-K0 \kore-sort-SortId ) \top ) ) ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \in-sort kore-element-var-K0 \kore-sort-SortId ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortIds ) \top ) ) ) ) $= ( in-sort-is-pattern typecode-cache-Pattern-51 IMP-sort-17-is-pattern and-is-pattern top-is-pattern typecode-cache-Pattern-58 rule-imp-transitivity typecode-cache-Pattern-0 kore-is-sort-is-pattern and-elim-left-sugar rule-and-intro-alt2-sugar typecode-cache-Pattern-59 sorting-cache-274 typecode-cache-Pattern-49 IMP-sort-0-is-pattern and-elim-right-sugar imp-reflexivity sorting-cache-276 ) ACIBEFDHGGAKLBCOACIBEFDHGGACIAKLACIBEFDHGMACPJACIBEFDHGGBEFDCQRDHGACIBEFDHGGBEFDHGBEFDACIBEFDHGSBEFDHGBEFDBEFDBEFDHMBEFDTJJABCUANN $. $}
