$c \kore-symbol-Lbl'UndsEqlsSlshEqls'K'Unds' #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-Lbl'UndsEqlsSlshEqls'K'Unds'-symbol #ApplicationContext \app ) ( $.
...
notation-cache-301 $a #Notation ( \kore-symbol-Lbl'UndsEqlsSlshEqls'K'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsSlshEqls'K'Unds'-symbol ptn0 ) ptn1 ) $.
${ $d xX0 ptn1 $.
   IMP-symbol-178-application-context-0.0 $e #ApplicationContext xX0 ptn0 $.
   IMP-symbol-178-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'UndsEqlsSlshEqls'K'Unds' ptn0 ptn1 ) $= ( IMP-symbol-178-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-178-is-pattern application-context-app-right application-context-app-left notation-cache-301 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
