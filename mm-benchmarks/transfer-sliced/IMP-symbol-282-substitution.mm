$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-symbol-LblisTCellFragment \app ) \kore-symbol-LblisTCellFragment-symbol ( $.
...
notation-cache-581 $a #Notation ( \kore-symbol-LblisTCellFragment ptn1 ) ( \app \kore-symbol-LblisTCellFragment-symbol ptn1 ) $.
notation-cache-582 $a #Notation ( \kore-symbol-LblisTCellFragment ptn2 ) ( \app \kore-symbol-LblisTCellFragment-symbol ptn2 ) $.
${ IMP-symbol-282-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-282-substitution $p #Substitution ( \kore-symbol-LblisTCellFragment ptn1 ) ( \kore-symbol-LblisTCellFragment ptn2 ) ptn0 xX0 $= ( IMP-symbol-282-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-282-is-pattern substitution-disjoint substitution-app notation-cache-581 notation-cache-582 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
