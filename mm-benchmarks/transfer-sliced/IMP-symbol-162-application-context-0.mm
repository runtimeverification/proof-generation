...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-162-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds'-Int'Unds' ptn0 ptn1 ) $= ( IMP-symbol-162-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-162-is-pattern application-context-app-right application-context-app-left notation-cache-253 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
