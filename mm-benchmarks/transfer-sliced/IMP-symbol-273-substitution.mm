$c #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-LblisMap \kore-symbol-LblisMap-symbol ( $.
...
notation-cache-554 $a #Notation ( \kore-symbol-LblisMap ptn1 ) ( \app \kore-symbol-LblisMap-symbol ptn1 ) $.
notation-cache-555 $a #Notation ( \kore-symbol-LblisMap ptn2 ) ( \app \kore-symbol-LblisMap-symbol ptn2 ) $.
${ IMP-symbol-273-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-273-substitution $p #Substitution ( \kore-symbol-LblisMap ptn1 ) ( \kore-symbol-LblisMap ptn2 ) ptn0 xX0 $= ( IMP-symbol-273-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-273-is-pattern substitution-disjoint substitution-app notation-cache-554 notation-cache-555 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
