...
${ notation-cache-229 $p #Notation ( \kore-symbol-Lbl'UndsAnd-And-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp'Unds'BExp ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsAnd-And-UndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp'Unds'BExp-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-154-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-154-is-pattern IMP-symbol-154-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
