...
${ $d xX0 ptn0 $.
   $d xX0 ptn1 $.
   $d xX0 ptn3 $.
   IMP-symbol-233-application-context-2.0 $e #ApplicationContext xX0 ptn2 $.
   IMP-symbol-233-application-context-2 $p #ApplicationContext xX0 ( \kore-symbol-LblfillArray'LParUndsCommUndsCommUndsCommUndsRParUnds'ARRAY-SYNTAX'Unds'Array'Unds'Array'Unds'Int'Unds'Int'Unds'KItem ptn0 ptn1 ptn2 ptn3 ) $= ( app-is-pattern IMP-symbol-233-is-symbol symbol-is-pattern IMP-symbol-233-is-pattern application-context-app-right application-context-app-left notation-cache-450 notation-application-context ) HIBGCGDGEGBCDEJAHIBGCGDGEAHIBGCGDAFKLBCDEMN $. $}
