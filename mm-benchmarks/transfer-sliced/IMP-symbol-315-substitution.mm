$c #Substitution #Notation #SetVariable #ElementVariable #Symbol \kore-symbol-Lblproject'Coln'IOString \kore-symbol-Lblproject'Coln'IOString-symbol #Variable #Pattern \app ) ( $.
...
notation-cache-665 $a #Notation ( \kore-symbol-Lblproject'Coln'IOString ptn1 ) ( \app \kore-symbol-Lblproject'Coln'IOString-symbol ptn1 ) $.
notation-cache-666 $a #Notation ( \kore-symbol-Lblproject'Coln'IOString ptn2 ) ( \app \kore-symbol-Lblproject'Coln'IOString-symbol ptn2 ) $.
${ IMP-symbol-315-substitution.0 $e #Substitution ptn1 ptn2 ptn0 xX0 $.
   IMP-symbol-315-substitution $p #Substitution ( \kore-symbol-Lblproject'Coln'IOString ptn1 ) ( \kore-symbol-Lblproject'Coln'IOString ptn2 ) ptn0 xX0 $= ( IMP-symbol-315-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-315-is-pattern substitution-disjoint substitution-app notation-cache-665 notation-cache-666 notation-reflexivity notation-substitution ) FGCHFGDHBCIDIBABFGCFGDAFGBAJEKCLDMBNO $. $}
