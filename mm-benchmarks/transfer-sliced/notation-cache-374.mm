...
${ notation-cache-374 $p #Notation ( \kore-symbol-Lbl'Unds'andBool'Unds' ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'Unds'andBool'Unds'-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-205-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-205-is-pattern IMP-symbol-205-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
