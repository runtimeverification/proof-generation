$c #Substitution \top #SetVariable #ElementVariable #Symbol #Variable #Pattern \kore-sort-SortBool ( \kore-is-sort ) \in-sort \and $.
...
substitution-1053 $a #Substitution ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ( \and ( \in-sort kore-element-var-T kore-sort-var-S1 ) \top ) \kore-sort-SortBool kore-sort-var-S1 $.
${ substitution-1054 $p #Substitution ( \and ( \kore-is-sort \kore-sort-SortBool ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortBool ) \top ) ) ( \and ( \kore-is-sort kore-sort-var-S1 ) ( \and ( \in-sort kore-element-var-T kore-sort-var-S1 ) \top ) ) \kore-sort-SortBool kore-sort-var-S1 $= ( IMP-sort-32-is-pattern element-var-is-var kore-is-sort-is-pattern top-is-pattern and-is-pattern typecode-cache-Pattern-5 typecode-cache-Pattern-6 in-sort-is-pattern typecode-cache-Pattern-7 substitution-var-same substitution-kore-is-sort substitution-1053 substitution-and ) CCEBICJFGAHEABKFGADCAHCADCADLMABNO $. $}
