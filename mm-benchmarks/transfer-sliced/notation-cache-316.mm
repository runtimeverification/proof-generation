...
${ notation-cache-316 $p #Notation ( \kore-symbol-Lbl'UndsEqlsEqls'String'UndsUnds'STRING-COMMON'Unds'Bool'Unds'String'Unds'String ptn0 ptn1 ) ( \app ( \app \kore-symbol-Lbl'UndsEqlsEqls'String'UndsUnds'STRING-COMMON'Unds'Bool'Unds'String'Unds'String-symbol ptn0 ) ptn1 ) $= ( IMP-symbol-183-is-symbol symbol-is-pattern app-is-pattern notation-reflexivity notation-app IMP-symbol-183-is-pattern IMP-symbol-183-is-sugar notation-transitivity ) ABHCDAEBECDAEBEABICDAEBCDAEBCDACDACDFAFGBFGJ $. $}
