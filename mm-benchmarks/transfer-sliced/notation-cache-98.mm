...
${ notation-cache-98 $p #Notation ( \kore-symbol-Lbl'Hash'mkstemp'LParUndsRParUnds'K-IO'Unds'IOFile'Unds'String ptn1 ) ( \app \kore-symbol-Lbl'Hash'mkstemp'LParUndsRParUnds'K-IO'Unds'IOFile'Unds'String-symbol ptn1 ) $= ( IMP-symbol-101-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-101-is-pattern IMP-symbol-101-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
