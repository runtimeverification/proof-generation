...
${ notation-cache-70 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp1'Unds' ptn1 ) ( \app \kore-symbol-Lbl'Hash'freezer'UndsEqlsUndsSClnUnds'IMP-SYNTAX'Unds'Stmt'Unds'Id'Unds'AExp1'Unds'-symbol ptn1 ) $= ( IMP-symbol-91-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-91-is-pattern IMP-symbol-91-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
