...
sorting-cache-159 $a |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) $.
${ sorting-cache-160 $p |- ( \imp ( \and ( \kore-is-sort kore-sort-var-R ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ) ( \and ( \kore-is-sort kore-sort-var-S3 ) ( \and ( \in-sort kore-element-var-T \kore-sort-SortInt ) \top ) ) ) $= ( kore-is-sort-is-pattern typecode-cache-Pattern-28 typecode-cache-Pattern-0 and-is-pattern typecode-cache-Pattern-2 typecode-cache-Pattern-6 IMP-sort-23-is-pattern in-sort-is-pattern top-is-pattern and-elim-right-sugar sorting-cache-146 rule-imp-transitivity sorting-cache-159 rule-and-intro-alt2-sugar ) AFDBCEGBHDCIJKLGAFDBCEGBCEBHDAFDBCEMBCNOABCPQ $. $}
