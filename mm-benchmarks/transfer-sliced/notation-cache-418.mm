...
${ notation-cache-418 $p #Notation ( \kore-symbol-Lbl'UndsPipe'Set'UndsUnds'SET'Unds'Set'Unds'Set'Unds'Set ptn3 ptn4 ) ( \app ( \app \kore-symbol-Lbl'UndsPipe'Set'UndsUnds'SET'Unds'Set'Unds'Set'Unds'Set-symbol ptn3 ) ptn4 ) $= ( app-is-pattern IMP-symbol-220-is-symbol symbol-is-pattern IMP-symbol-220-is-pattern IMP-symbol-220-is-sugar notation-reflexivity notation-transitivity ) ABFDEACBCDEACBCABGDEACBCHI $. $}
