...
${ $d xX0 ptn1 $.
   ...
   IMP-symbol-191-application-context-0 $p #ApplicationContext xX0 ( \kore-symbol-Lbl'Unds-GT-'String'UndsUnds'STRING-COMMON'Unds'Bool'Unds'String'Unds'String ptn0 ptn1 ) $= ( IMP-symbol-191-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-191-is-pattern application-context-app-right application-context-app-left notation-cache-340 notation-application-context ) EFBGCGBCHAEFBGCAEFBADIJBCKL $. $}
