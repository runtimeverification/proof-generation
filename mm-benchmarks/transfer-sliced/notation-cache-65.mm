...
${ notation-cache-65 $p #Notation ( \kore-symbol-Lbl'Hash'freezer'UndsEqlsEqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp0'Unds' ptn2 ) ( \app \kore-symbol-Lbl'Hash'freezer'UndsEqlsEqlsUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'AExp'Unds'AExp0'Unds'-symbol ptn2 ) $= ( IMP-symbol-89-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-89-is-pattern IMP-symbol-89-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
