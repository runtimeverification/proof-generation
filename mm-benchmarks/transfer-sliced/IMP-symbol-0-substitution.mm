$c \kore-symbol-Lbl'BangUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp-symbol #Substitution #Notation #SetVariable #ElementVariable #Symbol #Variable #Pattern \app ) \kore-symbol-Lbl'BangUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp ( $.
...
notation-cache-7 $a #Notation ( \kore-symbol-Lbl'BangUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp ptn1 ) ( \app \kore-symbol-Lbl'BangUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp-symbol ptn1 ) $.
notation-cache-8 $a #Notation ( \kore-symbol-Lbl'BangUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp ptn2 ) ( \app \kore-symbol-Lbl'BangUndsUnds'IMP-SYNTAX'Unds'BExp'Unds'BExp-symbol ptn2 ) $.
