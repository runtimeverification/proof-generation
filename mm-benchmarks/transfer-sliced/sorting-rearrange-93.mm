$c \top "balanceSender" #Variable \kore-sort-SortIds \imp \kore-dv \kore-is-sort |- \kore-sort-SortId \kore-valid ) \kore-equals \and #SetVariable #ElementVariable #Symbol #Pattern \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids \kore-exists \in-sort ( $.
...
${ sorting-rearrange-93 $p |- ( \imp ( \and ( \and ( \kore-is-sort kore-sort-var-R ) \top ) ( \and ( \in-sort kore-element-var-K1 \kore-sort-SortIds ) \top ) ) ( \kore-valid kore-sort-var-R ( \kore-exists \kore-sort-SortIds kore-sort-var-R kore-element-var-Val ( \kore-equals \kore-sort-SortIds kore-sort-var-R kore-element-var-Val ( \kore-symbol-Lbl'UndsCommUndsUnds'IMP-SYNTAX'Unds'Ids'Unds'Id'Unds'Ids ( \kore-dv \kore-sort-SortId "balanceSender" ) kore-element-var-K1 ) ) ) ) ) $= ( typecode-cache-Pattern-0 and-is-pattern top-is-pattern IMP-sort-0-is-pattern kore-is-sort-is-pattern typecode-cache-Pattern-49 in-sort-is-pattern typecode-cache-Pattern-58 typecode-cache-Pattern-66 kore-exists-is-pattern kore-valid-is-pattern sorting-cache-281 sorting-rearrange-74 rule-imp-transitivity ) ADHFECIGJFEEACKADGADABCLBMNACOABCPQ $. $}
