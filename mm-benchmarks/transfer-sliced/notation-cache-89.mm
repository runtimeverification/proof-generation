...
${ notation-cache-89 $p #Notation ( \kore-symbol-Lbl'Hash'getc'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'Int ptn2 ) ( \app \kore-symbol-Lbl'Hash'getc'LParUndsRParUnds'K-IO'Unds'IOInt'Unds'Int-symbol ptn2 ) $= ( IMP-symbol-97-is-symbol symbol-is-pattern app-is-pattern IMP-symbol-97-is-pattern IMP-symbol-97-is-sugar notation-reflexivity notation-transitivity ) AEBCADBCADAFBCADGH $. $}
