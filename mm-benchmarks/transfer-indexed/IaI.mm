$c ) #ElementVariable Cbk #Symbol #Pattern A6o #Variable #SetVariable ( Eh0 $.
...
${ IaI $p #Pattern ( A6o Cbk kore-sort-var-R kore-element-var-Val ( Eh0 kore-element-var-x0 kore-element-var-K1 ) ) $= ( Cbg Huk IHs IaE A6k )  EAFBGCDHI $. $}
