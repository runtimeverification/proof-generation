$c ) #ElementVariable #Symbol #Pattern DQs A6o CHs #Variable #SetVariable ( $.
...
${ K8I $p #Pattern ( A6o CHs kore-sort-var-R kore-element-var-Val ( DQs kore-element-var-x0 kore-element-var-K1 ) ) $= ( CHo Huk IHs K8E A6k )  EAFBGCDHI $. $}
