...
IjI $a rg ( Lg ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K1 Cbk ) .A ) ) ( ASI ( BAM CXQ CSA ( A-c CXQ HnY ) ) CSA ) ) $.
${ IjM $p rg ( Lg ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K1 Cbk ) .A ) ) ( ASI ( Eh0 ( A-c CUE Hkw ) ( BAM CXQ CSA ( A-c CXQ HnY ) ) ) Cbk ) ) $= ( CUA A-Y Hks ASE CXM CR8 IX0 HnU BAI wQ Ehw Cbg LQ xA A-k yQ IjI AZk Eik AW8 )  ABICEDCFGHGJDKHFLCEDGHGJDKMNFABICEDCFGHGJDKHFCEDCFABICEDCFOCEDCFABIPCEQRABSTCEDGHGJDKUAUB $. $}
