...
LxY $a rg ( Lg ( wg ( ASI kore-element-var-VE4 CXQ ) .A ) ( ASI ( A-c CXQ HnY ) CXQ ) ) $.
${ Lxc $p rg ( Lg ( wg ( ASI kore-element-var-VE4 CXQ ) .A ) ( ASI ( BAM CXQ CHs ( A-c CXQ HnY ) ) CHs ) ) $= ( CXM ASE wQ CHo A-o HnU A-Y JO4 9w BAI Lw8 LxY AZk CMA AW8 )  AIBCJDBFEFDBGHBCDBEBGHKECAIBCJDBFEFDBGHBCALAMNBEBGHOP $. $}
