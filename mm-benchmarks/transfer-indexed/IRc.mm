...
$v ph1 ph0 x kore-sort-var-R kore-element-var-K0 xX $.
...
${ IRc $p Zw kore-sort-var-R kore-sort-var-R ( A-c CUE Hkw ) kore-element-var-K0 $= ( Huk CUA Hks A-Y Jw Afg )  ACDEFBGH $. $}
