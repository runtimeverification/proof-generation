...
$v ph1 ph2 ph0 ptn0 ptn1 kore-element-var-x0 kore-element-var-VE4 $.
...
${ MUg $p #Pattern ( CIM ( DMo ( CIM ( BAM CUE CHs kore-element-var-VE4 ) CJY ) ) kore-element-var-x0 ) $= ( CII CUA CHo JO4 BAI CJU DMk H3g )  DEAFGHCIBJC $. $}
