$c Zw Duw BAM FDE HlM A-c CHs #Variable ) #ElementVariable #Symbol Eq0 CUE #Pattern #SetVariable ( $.
...
${ NbA $p Zw ( Duw ( Eq0 ( FDE ( BAM CUE CHs ( A-c CUE HlM ) ) kore-element-var-x0 ) kore-element-var-VE5 ) ) ( Duw ( Eq0 ( FDE ( BAM CUE CHs ( A-c CUE HlM ) ) kore-element-var-VE4 ) kore-element-var-VE5 ) ) kore-element-var-x0 kore-element-var-VE4 $= ( CUA H3g CHo HlI A-Y BAI Jw FDA KFk JO4 Eqw Afg bQ FDc KM4 ErM DvE )  AJCEDFDGHICEKBLNDFDGHIAMKBLNAJCEDFDGHICEKBLDFDGHIAMKBLAJCEDFDGHICEDFDGHIAMDFDGHICEAJOCEAJPQABCRST $. $}
