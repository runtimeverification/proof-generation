$c DpI BAM A-c CHs #Variable ) #ElementVariable HmE #Symbol Dt8 #Pattern CIM CXQ EG0 #SetVariable ( $.
...
${ NRA $p #Pattern ( DpI ( Dt8 ( CIM ( BAM CXQ CHs ( EG0 kore-element-var-VE4 ( A-c CXQ HmE ) ) ) kore-element-var-VE2 ) ) kore-element-var-VE3 ) $= ( CXM CHo JO4 HmA A-Y EGw BAI JOw CII Dt4 JO0 DpE )  DECFDGHIJAKLMBNO $. $}
