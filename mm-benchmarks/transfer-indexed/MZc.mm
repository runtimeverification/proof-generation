$c BAM CHs #Variable ) #ElementVariable #Symbol #Pattern CSA A6o #SetVariable ( $.
...
${ MZc $p #Pattern ( A6o CHs kore-sort-var-R kore-element-var-Val ( BAM CSA CHs kore-element-var-From ) ) $= ( CHo Huk IHs CR8 ILQ BAI A6k )  DAEBFGDCHIJ $. $}
