$c Zw #Variable ) #ElementVariable #Symbol CUE #Pattern Hmg #SetVariable A-c ( $.
...
${ Ilw $p Zw kore-element-var-Val kore-element-var-Val ( A-c CUE Hmg ) kore-element-var-From $= ( IHs CUA Hmc A-Y Jw Afg )  ACDEFBGH $. $}
