$c BAM CHs #Variable ) #ElementVariable #Symbol #Pattern A6o CXQ #SetVariable ( $.
...
${ Jdo $p #Pattern ( A6o CHs kore-sort-var-R kore-element-var-Val ( BAM CXQ CHs kore-element-var-From ) ) $= ( CHo Huk IHs CXM ILQ BAI A6k )  DAEBFGDCHIJ $. $}
