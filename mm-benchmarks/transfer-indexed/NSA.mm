$c DpI Zw BAM CHs #Variable HKc ) #ElementVariable HmE #Symbol Dt8 #Pattern CIM EG0 CXQ #SetVariable A-c ( Dr8 DrI $.
...
${ NSA $p Zw ( Dr8 ( DpI ( Dt8 ( CIM ( BAM CXQ CHs ( EG0 kore-element-var-VE4 ( A-c CXQ HmE ) ) ) kore-element-var-x0 ) ) kore-element-var-VE3 ) ( DrI ( A-c CXQ HKc ) ) ) ( Dr8 ( DpI ( Dt8 ( CIM ( BAM CXQ CHs ( EG0 kore-element-var-VE4 ( A-c CXQ HmE ) ) ) kore-element-var-VE2 ) ) kore-element-var-VE3 ) ( DrI ( A-c CXQ HKc ) ) ) kore-element-var-x0 kore-element-var-VE2 $= ( CXM H3g A-Y Jw CHo JO4 HmA EGw BAI CII HKY DrE JOw Dt4 JO0 Afg NR8 NRA bQ CIw DuQ JSQ Dpg DsU )  AHDFBCDUAEOGPABCUBEOGPAHDFEICJEKGLMDFNRBSEICJEKGLMAQNRBSAHDFEICJEKGLMDFNEICJEKGLMAQNAHDFEICJEKGLMDFEICJEKGLMAQEICJEKGLMDFAHTDFAHUCUDUEABDUFUGEOGPDFAHTUH $. $}
