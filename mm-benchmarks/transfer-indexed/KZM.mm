$c Lg A-c CHs #Variable CSc ) ASI #ElementVariable HmE #Symbol A-s #Pattern wg CXQ .A rg #SetVariable ( $.
...
${ KZM $p rg ( Lg ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K2 CSc ) ( wg ( ASI kore-element-var-K3 CSc ) .A ) ) ) ( wg ( wg ( A-s CXQ ) ( A-s CHs ) ) ( ASI ( A-c CXQ HmE ) CXQ ) ) ) $= ( CXM A-o Jj8 CHo HmA A-Y ASE LQ xA yQ AZk wQ CXc CH4 A-k )  ABCFDEGEODHIDJABCFDEGEDEABCFDEKDEABCFLPMGEABCFGEKGEABCFLQMNDHIDJABCFDHIDJKDHIDJABCFLDHRMN $. $}
