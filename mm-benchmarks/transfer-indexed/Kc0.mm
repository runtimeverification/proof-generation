$c Zw Duw BAM FDE Hn0 A-c CHs #Variable ) #ElementVariable #Symbol Eq0 CUE #Pattern #SetVariable ( $.
$v kore-element-var-VE5 ph1 ptn3 kore-element-var-VE4 ptn2 kore-element-var-x0 xX ph2 ph0 x ptn0 ptn1 ptn4 xX0 $.
...
${ Kc0 $p Zw ( Duw ( Eq0 ( FDE ( BAM CUE CHs ( A-c CUE Hn0 ) ) kore-element-var-x0 ) kore-element-var-VE5 ) ) ( Duw ( Eq0 ( FDE ( BAM CUE CHs ( A-c CUE Hn0 ) ) kore-element-var-VE4 ) kore-element-var-VE5 ) ) kore-element-var-x0 kore-element-var-VE4 $= ( CUA H3g CHo Hnw A-Y BAI Jw FDA KFk JO4 Eqw Afg bQ FDc KM4 ErM DvE )  AJCEDFDGHICEKBLNDFDGHIAMKBLNAJCEDFDGHICEKBLDFDGHIAMKBLAJCEDFDGHICEDFDGHIAMDFDGHICEAJOCEAJPQABCRST $. $}
