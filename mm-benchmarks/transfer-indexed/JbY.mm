...
$v ph4 kore-element-var-K2 xX ph1 ph2 ph0 x ph3 $.
...
${ JbY $p Zw ( wg ( ASI DoQ CSc ) .A ) ( wg ( ASI kore-element-var-K2 CSc ) .A ) DoQ kore-element-var-K2 $= ( DoM CSY Jw 9w ASE Io4 Afg bQ AhM AgE )  BBCFEAGCFEADBBCAGCADBADICBADHJEBADHK $. $}
