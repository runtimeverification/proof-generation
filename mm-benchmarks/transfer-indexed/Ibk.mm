$c Zw #Variable ) #ElementVariable #Symbol #Pattern Hlo CXQ #SetVariable A-c ( $.
...
${ Ibk $p Zw kore-element-var-Val kore-element-var-Val ( A-c CXQ Hlo ) kore-element-var-From $= ( IHs CXM Hlk A-Y Jw Afg )  ACDEFBGH $. $}
