$c BAM CHs #Variable ) #ElementVariable #Symbol #Pattern A6o #SetVariable ( CW0 $.
...
${ Kq0 $p #Pattern ( A6o CHs kore-sort-var-R kore-element-var-Val ( BAM CW0 CHs kore-element-var-From ) ) $= ( CHo Huk IHs CWw ILQ BAI A6k )  DAEBFGDCHIJ $. $}
