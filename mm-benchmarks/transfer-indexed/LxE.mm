...
LxA $a rg ( Lg ( wg ( ASI kore-element-var-VE4 CXQ ) .A ) ( ASI ( A-c CXQ HKc ) CXQ ) ) $.
${ LxE $p rg ( Lg ( wg ( ASI kore-element-var-VE4 CXQ ) .A ) ( ASI ( BAM CXQ CHs ( A-c CXQ HKc ) ) CHs ) ) $= ( CXM ASE wQ CHo A-o HKY A-Y JO4 9w BAI Lw8 LxA AZk CMA AW8 )  AIBCJDBFEFDBGHBCDBEBGHKECAIBCJDBFEFDBGHBCALAMNBEBGHOP $. $}
