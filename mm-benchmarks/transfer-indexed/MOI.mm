$c Zw BAM CHs #Variable ) #ElementVariable #Symbol Dt8 #Pattern CIM CUw #SetVariable ( G2w $.
...
${ MOI $p Zw ( Dt8 ( CIM ( BAM CUw CHs ( G2w kore-element-var-VE2 ) ) kore-element-var-x0 ) ) ( Dt8 ( CIM ( BAM CUw CHs ( G2w kore-element-var-VE2 ) ) kore-element-var-VE1 ) ) kore-element-var-x0 kore-element-var-VE1 $= ( H3g Jw CUs CHo JOw G2s BAI MOA MNw I5I Afg bQ CIw DuQ )  BECDACKABLBECDFGAHIJCDFGAHIJBMFGAHIJCDBENCDBEOPQ $. $}
