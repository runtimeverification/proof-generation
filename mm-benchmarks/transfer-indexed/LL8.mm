$c Lg CHs #Variable CSc ) ASI #ElementVariable #Symbol A-s CUE #Pattern wg .A CUw rg #SetVariable ( CQM $.
...
${ LL8 $p rg ( Lg ( wg ( ASI kore-element-var-VE2 CQM ) ( wg ( ASI kore-element-var-VE3 CHs ) ( wg ( ASI kore-element-var-VE4 CUE ) ( wg ( ASI kore-element-var-VE5 CSc ) .A ) ) ) ) ( wg ( A-s CUw ) ( A-s CHs ) ) ) $= ( ASE wQ CHo A-o JOw CQI JO0 LGk CUs LQ xA yQ CU8 CH4 AZk )  AIJEBKGECDLFFMHGHMHAIJEBKGECDLFFMHNMHAIJEBKGECDLFFOQPGHAIJEBKGECDLFFGHNGHAIJEBKGECDLFFORPS $. $}
