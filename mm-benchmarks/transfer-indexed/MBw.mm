...
MBs $a rg ( Lg ( wg ( wg ( A-s kore-sort-var-R ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) ( wg ( A-s kore-sort-var-S2 ) .A ) ) ( ASI kore-element-var-T CcA ) ) $.
${ MBw $p rg ( Lg ( wg ( wg ( A-s kore-sort-var-R ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) ( wg ( A-s kore-sort-var-S2 ) .A ) ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) $= ( wQ A-o 9w Huk MA4 Huo HvA Cb8 ASE MBs AXM Aw8 AZk )  AHFBDIECJFGEEDKLMGABCDNAHFBDIECJFGEEGOPQ $. $}
