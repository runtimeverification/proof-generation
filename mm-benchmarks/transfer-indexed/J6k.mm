$c BAM CHs #Variable ) #ElementVariable Cbk #Symbol #Pattern CIM #SetVariable ( $.
...
${ J6k $p #Pattern ( CIM ( BAM Cbk CHs kore-element-var-VE4 ) kore-element-var-VE1 ) $= ( Cbg CHo JO4 BAI I5I CII )  CDBEFAGH $. $}
