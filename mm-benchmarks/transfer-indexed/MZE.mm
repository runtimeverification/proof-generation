...
${ MZE $p Zw ( CIM ( BAM CUE CHs kore-element-var-x0 ) CJY ) ( CIM ( BAM CUE CHs kore-element-var-VE4 ) CJY ) kore-element-var-x0 kore-element-var-VE4 $= ( H3g CUA CHo BAI CJU Jw JO4 LQw JXk CIw )  AHBCDEBCFGDEAIFGABJABKL $. $}
