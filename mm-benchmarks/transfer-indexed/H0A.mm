...
$v ph1 kore-sort-var-x0 ph0 x kore-sort-var-S2 kore-sort-var-R xX $.
...
${ H0A $p Zw kore-sort-var-R kore-sort-var-R kore-sort-var-x0 kore-sort-var-S2 $= ( Huk HwM Jw Afg )  ADBECFG $. $}
