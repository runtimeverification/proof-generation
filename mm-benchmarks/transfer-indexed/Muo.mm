$c Zw ICM #Variable ) #ElementVariable #Symbol #Pattern CXQ #SetVariable A-c ( $.
...
${ Muo $p Zw kore-element-var-Val kore-element-var-Val ( A-c CXQ ICM ) kore-element-var-From $= ( IHs CXM ICI A-Y Jw Afg )  ACDEFBGH $. $}
