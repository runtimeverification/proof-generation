...
Kls $a rg ( Lg ( wg ( A-s kore-sort-var-R ) .A ) ( wg ( wg ( A-s CXQ ) ( A-s CHs ) ) ( ASI ( A-c CXQ Hm8 ) CXQ ) ) ) $.
${ Klw $p rg ( Lg ( wg ( A-s kore-sort-var-R ) .A ) ( ASI ( BAM CXQ CHs ( A-c CXQ Hm8 ) ) CHs ) ) $= ( CXM CHo A-o wQ Hm4 A-Y ASE Huk 9w BAI Kls CMA AW8 )  AIDJEBDCDEBFGBHEBCBFGKCHALBCBFGMN $. $}
