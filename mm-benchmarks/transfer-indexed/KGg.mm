$c BAM #Variable Eh0 ) #ElementVariable #Symbol #Pattern CSA CXQ #SetVariable ( $.
...
${ KGg $p #Pattern ( Eh0 kore-element-var-VE3 ( BAM CXQ CSA kore-element-var-VE2 ) ) $= ( JO0 CXM CR8 JOw BAI Ehw )  BCDEAFGH $. $}
