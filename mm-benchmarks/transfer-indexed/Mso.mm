$c BAM CHs #Variable Hkw Eh0 ) #ElementVariable Cbk #Symbol CUE #Pattern CIM #SetVariable A-c ( $.
...
${ Mso $p #Pattern ( CIM ( BAM Cbk CHs ( Eh0 ( A-c CUE Hkw ) kore-element-var-VE4 ) ) kore-element-var-VE2 ) $= ( Cbg CHo CUA Hks A-Y JO4 Ehw BAI JOw CII )  CDEFGBHIJAKL $. $}
