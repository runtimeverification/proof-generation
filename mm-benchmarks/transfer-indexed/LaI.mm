...
${ LaI $p #Pattern ( A60 CHI kore-sort-var-R kore-element-var-x0 ( CIM ( BAM CaQ CHs kore-element-var-VE1 ) CJY ) ) $= ( CHE Huk H3g CaM CHo I5I BAI CJU CII A6w )  DAECFGHBIJKLM $. $}
