...
$v ph1 ph0 kore-sort-var-R kore-element-var-K2 $.
...
${ JZc $p #Pattern ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K2 CSc ) .A ) ) $= ( wQ Huk A-o Io4 CSY ASE 9w )  ADEBFGHICC $. $}
