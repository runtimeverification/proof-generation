...
Lyg $a rg ( Lg ( wg ( ASI kore-element-var-VE4 CXQ ) .A ) ( ASI ( A-c CXQ HmE ) CXQ ) ) $.
${ Lyk $p rg ( Lg ( wg ( ASI kore-element-var-VE4 CXQ ) .A ) ( ASI ( BAM CXQ CHs ( A-c CXQ HmE ) ) CHs ) ) $= ( CXM ASE wQ CHo A-o HmA A-Y JO4 9w BAI Lw8 Lyg AZk CMA AW8 )  AIBCJDBFEFDBGHBCDBEBGHKECAIBCJDBFEFDBGHBCALAMNBEBGHOP $. $}
