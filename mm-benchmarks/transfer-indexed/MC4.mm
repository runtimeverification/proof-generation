...
MC0 $a rg ( Lg ( wg ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ( wg ( A-s kore-sort-var-S3 ) .A ) ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) $.
${ MC4 $p rg ( Lg ( wg ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ( wg ( A-s kore-sort-var-S3 ) .A ) ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) $= ( Hus A-o wQ 9w MCo AW8 HvA Cb8 ASE AZI AZE AWw MC0 AZk )  ACHBDEGFFBDECJKLGFACHBDEGFFBDEGFBDEACHBDEGFMBDEGFBDEBDEBDEGNBDEOIIABCPQ $. $}
