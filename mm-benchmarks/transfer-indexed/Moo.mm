$c DpI BAM CHs #Variable ) #ElementVariable #Symbol Dt8 #Pattern EK0 CIM CXQ #SetVariable ( $.
...
${ Moo $p #Pattern ( DpI ( Dt8 ( CIM ( BAM CXQ CHs ( EK0 kore-element-var-VE4 kore-element-var-VE1 ) ) kore-element-var-VE2 ) ) kore-element-var-VE3 ) $= ( CXM CHo Mok BAI JOw CII Dt4 JO0 DpE )  EFBDGHAIJKCLM $. $}
