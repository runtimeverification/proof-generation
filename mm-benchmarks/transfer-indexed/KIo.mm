$c Lg CHs #Variable CSc ) ASI #ElementVariable #Symbol A-s CUE #Pattern CSA wg CXQ .A rg #SetVariable ( $.
...
${ KIo $p rg ( Lg ( wg ( ASI kore-element-var-VE2 CXQ ) ( wg ( ASI kore-element-var-VE3 CUE ) ( wg ( ASI kore-element-var-VE4 CHs ) ( wg ( ASI kore-element-var-VE5 CSc ) .A ) ) ) ) ( wg ( A-s CXQ ) ( A-s CSA ) ) ) $= ( ASE wQ CXM A-o JOw JO0 CUA KFo CR8 LQ xA yQ CXc CSM AZk )  AIGEBJKECDLFFGHMHGHAIGEBJKECDLFFGHNGHAIGEBJKECDLFFOQPMHAIGEBJKECDLFFMHNMHAIGEBJKECDLFFORPS $. $}
