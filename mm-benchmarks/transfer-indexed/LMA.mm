$c Lg CHs #Variable CSc ) ASI #ElementVariable #Symbol A-s CUE #Pattern CSA wg CXQ .A rg #SetVariable ( CQM $.
...
${ LMA $p rg ( Lg ( wg ( ASI kore-element-var-VE2 CQM ) ( wg ( ASI kore-element-var-VE3 CHs ) ( wg ( ASI kore-element-var-VE4 CUE ) ( wg ( ASI kore-element-var-VE5 CSc ) .A ) ) ) ) ( wg ( A-s CXQ ) ( A-s CSA ) ) ) $= ( ASE wQ A-o JOw CQI JO0 CHo LGk CXM CR8 LQ xA yQ CXc CSM AZk )  AHIEBJKECDLFFMGNGMGAHIEBJKECDLFFMGOMGAHIEBJKECDLFFPRQNGAHIEBJKECDLFFNGONGAHIEBJKECDLFFPSQT $. $}
