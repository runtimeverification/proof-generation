$c DpI BAM Eo0 A-c CHs #Variable ) #ElementVariable HmE #Symbol Dt8 #Pattern CSA CIM CXQ #SetVariable ( CW0 $.
...
${ LhY $p #Pattern ( DpI ( Dt8 ( CIM ( BAM CW0 CHs ( Eo0 ( BAM CXQ CSA ( A-c CXQ HmE ) ) kore-element-var-VE4 ) ) kore-element-var-VE2 ) ) kore-element-var-VE3 ) $= ( CXM BAI CWw CHo CR8 HmA A-Y JO4 Eow JOw CII Dt4 JO0 DpE )  FGDHDIJECKLEAMNOBPQ $. $}
