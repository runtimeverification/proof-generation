$c ) #ElementVariable #Symbol CQo #Pattern A6o #Variable #SetVariable ( DrI $.
...
${ JNc $p #Pattern ( A6o CQo kore-sort-var-R kore-element-var-Val ( DrI kore-element-var-K0 ) ) $= ( CQk Huk IHs INE DrE A6k )  DAEBFCGHI $. $}
