...
${ LCw $p Zw ( wg ( ASI kore-element-var-x0 CSA ) .A ) ( wg ( ASI kore-element-var-VE4 CSA ) .A ) kore-element-var-x0 kore-element-var-VE4 $= ( H3g CR8 ASE 9w JO4 Jw LCs JXQ AgE )  BCBCDEFAGDEFAHABIABJK $. $}
