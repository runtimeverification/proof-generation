$c ) #ElementVariable #Symbol #Pattern A6o Eo0 #Variable #SetVariable ( CW0 $.
...
${ Ims $p #Pattern ( A6o CW0 kore-sort-var-R kore-element-var-Val ( Eo0 kore-element-var-K0 kore-element-var-K1 ) ) $= ( CWw Huk IHs Imo A6k )  EAFBGCDHI $. $}
