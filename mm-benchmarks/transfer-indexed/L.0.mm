$c CaQ BAM CcA #Variable ) #ElementVariable #Symbol #Pattern A6o #SetVariable ( $.
...
${ L.0 $p #Pattern ( A6o CaQ kore-sort-var-R kore-element-var-Val ( BAM CcA CaQ kore-element-var-From ) ) $= ( CaM Huk IHs Cb8 ILQ BAI A6k )  DAEBFGDCHIJ $. $}
