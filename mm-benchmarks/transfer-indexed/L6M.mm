$c BAM CcA #Variable ) #ElementVariable #Symbol #Pattern A6o #SetVariable ( CW0 $.
...
${ L6M $p #Pattern ( A6o CW0 kore-sort-var-R kore-element-var-Val ( BAM CcA CW0 kore-element-var-From ) ) $= ( CWw Huk IHs Cb8 ILQ BAI A6k )  DAEBFGDCHIJ $. $}
