$c DpI BAM CHs #Variable ) #ElementVariable #Symbol Dt8 #Pattern CIM CXQ EG0 #SetVariable ( $.
...
${ NQw $p #Pattern ( DpI ( Dt8 ( CIM ( BAM CXQ CHs ( EG0 kore-element-var-VE4 kore-element-var-VE1 ) ) kore-element-var-VE2 ) ) kore-element-var-VE3 ) $= ( CXM CHo NQs BAI JOw CII Dt4 JO0 DpE )  EFBDGHAIJKCLM $. $}
