$c BAM CHs #Variable ) #ElementVariable Cbk #Symbol #Pattern A6o #SetVariable ( $.
...
${ J-4 $p #Pattern ( A6o CHs kore-sort-var-R kore-element-var-Val ( BAM Cbk CHs kore-element-var-From ) ) $= ( CHo Huk IHs Cbg ILQ BAI A6k )  DAEBFGDCHIJ $. $}
