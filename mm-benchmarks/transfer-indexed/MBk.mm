$c Mg CaQ Lg CcA #Variable ) ASI #ElementVariable ARU #Symbol A-s #Pattern wg .A rg #SetVariable ( $.
...
${ MBk $p rg ( Lg ( wg ( A-s kore-sort-var-R ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) ( Mg x ( ARU x CaQ ) ) ) $= ( 9w Huk A-o MA4 wQ CaM Hu0 ARQ MQ AXM Aw8 Lbg BmQ AW8 )  BFGCDHIEAKJLAMBFGCDHIENOJEAPQR $. $}
