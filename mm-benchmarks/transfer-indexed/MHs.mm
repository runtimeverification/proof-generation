$c BAM CHs #Variable ) #ElementVariable #Symbol #Pattern CIM CUw #SetVariable ( $.
...
${ MHs $p #Pattern ( CIM ( BAM CUw CHs kore-element-var-VE2 ) kore-element-var-VE1 ) $= ( CUs CHo JOw BAI I5I CII )  CDAEFBGH $. $}
