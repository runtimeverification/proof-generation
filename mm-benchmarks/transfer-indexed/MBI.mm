...
MBE $a rg ( Lg ( wg ( A-s kore-sort-var-R ) ( wg ( A-s kore-sort-var-S2 ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) ) ( wg ( A-s kore-sort-var-S3 ) .A ) ) $.
${ MBI $p rg ( Lg ( wg ( A-s kore-sort-var-R ) ( wg ( A-s kore-sort-var-S2 ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) ) ( wg ( A-s kore-sort-var-S2 ) ( wg ( A-s kore-sort-var-S3 ) .A ) ) ) $= ( A-o Huo wQ MA4 Huk AW8 Hus 9w AZI AZE AWw MBE AZk )  AIECFEBDHGGCFEBKELGAIECFEBDHGGCFEBDHGCFEAIECFEBDHGMCFEBDHGCFECFECFEBDHNCFEOJJABCDPQ $. $}
