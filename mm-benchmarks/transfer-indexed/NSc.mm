...
NSY $a rg ( Lg ( wg ( ASI kore-element-var-VE4 CXQ ) .A ) ( ASI ( A-c CXQ ICM ) CXQ ) ) $.
${ NSc $p rg ( Lg ( wg ( ASI kore-element-var-VE4 CXQ ) .A ) ( ASI ( BAM CXQ CHs ( A-c CXQ ICM ) ) CHs ) ) $= ( CXM ASE wQ CHo A-o ICI A-Y JO4 9w BAI Lw8 NSY AZk CMA AW8 )  AIBCJDBFEFDBGHBCDBEBGHKECAIBCJDBFEFDBGHBCALAMNBEBGHOP $. $}
