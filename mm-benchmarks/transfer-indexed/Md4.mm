$c ) #ElementVariable #Symbol #Pattern A6o DMo CHs #Variable #SetVariable ( $.
...
${ Md4 $p #Pattern ( A6o CHs kore-sort-var-R kore-element-var-Val ( DMo kore-element-var-K0 ) ) $= ( CHo Huk IHs INE DMk A6k )  DAEBFCGHI $. $}
