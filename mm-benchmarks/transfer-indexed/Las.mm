$c CaQ BAM #Variable ) #ElementVariable #Symbol #Pattern A6o CXQ #SetVariable ( $.
...
${ Las $p #Pattern ( A6o CaQ kore-sort-var-R kore-element-var-Val ( BAM CXQ CaQ kore-element-var-From ) ) $= ( CaM Huk IHs CXM ILQ BAI A6k )  DAEBFGDCHIJ $. $}
