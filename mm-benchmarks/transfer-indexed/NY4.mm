$c AUo Mg BAM HMc CSc ) ARU #Pattern A6o CIM wg .A rg A-c A4Y Lg HlM A4w CHs #Variable CHI Eh0 ASI #ElementVariable Cbk #Symbol CUE CSA CXQ CJY #SetVariable ( $.
$v kore-element-var-VE5 kore-element-var-V0 th0 ph1 ph2 kore-element-var-VE2 kore-element-var-VE3 ph0 ptn0 ptn1 x kore-element-var-VE4 $.
...
${ NY4 $p rg ( Lg ( wg ( ASI kore-element-var-VE2 CXQ ) ( wg ( ASI kore-element-var-VE3 CUE ) ( wg ( ASI kore-element-var-VE4 CHs ) ( wg ( ASI kore-element-var-VE5 CSc ) .A ) ) ) ) ( Mg kore-element-var-V0 ( ARU kore-element-var-V0 ( CIM ( BAM Cbk CHs ( Eh0 ( A-c CUE HlM ) ( BAM CXQ CSA ( A-c CXQ HMc ) ) ) ) CJY ) ) ) ) $= ( CXM ASE CUA wQ A-Y BAI 9w JOw JO0 KFo Cbg CHo HlI CR8 HMY Ehw CJU CII IJI ARQ MQ AXM Aw8 CHE IAI MRc Bpg AW8 )  AMFGBNHGCEOIILDUDPQHRJFSFTJKUAKUBUCUEDUFAMFGBNHGCEOIILUGUHUIPQHRJFSFTJKUAKUBUCLDUJDUKULUM $. $}
