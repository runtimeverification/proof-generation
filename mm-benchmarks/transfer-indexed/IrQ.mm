$c Zw #Variable HKc ) #ElementVariable #Symbol #Pattern CXQ #SetVariable A-c ( $.
...
${ IrQ $p Zw kore-element-var-Val kore-element-var-Val ( A-c CXQ HKc ) kore-element-var-From $= ( IHs CXM HKY A-Y Jw Afg )  ACDEFBGH $. $}
