$c ) #ElementVariable #Symbol A-s #Pattern wg .A #Variable #SetVariable ( $.
$v ph1 ph0 kore-sort-var-S3 kore-sort-var-S2 $.
...
${ Huw $p #Pattern ( wg ( A-s kore-sort-var-S2 ) ( wg ( A-s kore-sort-var-S3 ) .A ) ) $= ( A-o wQ Huo Hus 9w )  BECAFCGDD $. $}
