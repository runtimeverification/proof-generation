$c BAM CcA CHs #Variable ) #ElementVariable #Symbol #Pattern A6o #SetVariable ( $.
...
${ L7s $p #Pattern ( A6o CHs kore-sort-var-R kore-element-var-Val ( BAM CcA CHs kore-element-var-From ) ) $= ( CHo Huk IHs Cb8 ILQ BAI A6k )  DAEBFGDCHIJ $. $}
