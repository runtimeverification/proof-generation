...
${ NR8 $p #Pattern ( DpI ( Dt8 ( CIM ( BAM CXQ CHs ( EG0 kore-element-var-VE4 ( A-c CXQ HmE ) ) ) kore-element-var-x0 ) ) kore-element-var-VE3 ) $= ( CXM CHo JO4 HmA A-Y EGw BAI H3g CII Dt4 JO0 DpE )  DEBFDGHIJCKLMANO $. $}
