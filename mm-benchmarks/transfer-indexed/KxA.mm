...
$v ph1 kore-element-var-VE2 ph0 kore-sort-var-R $.
...
${ KxA $p #Pattern ( wg ( ASI kore-element-var-VE2 CaQ ) ( wg ( A-s kore-sort-var-R ) .A ) ) $= ( wQ JOw CaM ASE Huk A-o 9w )  BDEFAGHICC $. $}
