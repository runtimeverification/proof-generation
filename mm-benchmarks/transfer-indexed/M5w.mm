$c DpI EI0 BAM CHs #Variable ) #ElementVariable #Symbol Dt8 #Pattern CSA CIM #SetVariable ( $.
...
${ M5w $p #Pattern ( DpI ( Dt8 ( CIM ( BAM CSA CHs ( EI0 kore-element-var-VE4 kore-element-var-VE1 ) ) kore-element-var-VE2 ) ) kore-element-var-VE3 ) $= ( CR8 CHo M5s BAI JOw CII Dt4 JO0 DpE )  EFBDGHAIJKCLM $. $}
