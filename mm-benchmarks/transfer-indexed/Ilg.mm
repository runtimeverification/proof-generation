$c BAM #Variable ) #ElementVariable #Symbol CUE #Pattern CSA A6o #SetVariable ( $.
...
${ Ilg $p #Pattern ( A6o CSA kore-sort-var-R kore-element-var-Val ( BAM CUE CSA kore-element-var-From ) ) $= ( CR8 Huk IHs CUA ILQ BAI A6k )  DAEBFGDCHIJ $. $}
