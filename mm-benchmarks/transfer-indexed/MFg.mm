$c Mg Lg CcA #Variable ) ASI #ElementVariable ARU #Symbol A-s #Pattern wg .A rg #SetVariable ( CW0 $.
...
${ MFg $p rg ( Lg ( wg ( A-s kore-sort-var-R ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) ( Mg x ( ARU x CW0 ) ) ) $= ( 9w Huk A-o MA4 wQ CWw Hu0 ARQ MQ AXM Aw8 Ht8 BmQ AW8 )  BFGCDHIEAKJLAMBFGCDHIENOJEAPQR $. $}
