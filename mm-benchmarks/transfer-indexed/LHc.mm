$c BAM CHs #Variable ) #ElementVariable #Symbol CUE #Pattern CIM #SetVariable ( $.
...
${ LHc $p #Pattern ( CIM ( BAM CUE CHs kore-element-var-VE4 ) kore-element-var-VE1 ) $= ( CUA CHo JO4 BAI I5I CII )  CDBEFAGH $. $}
