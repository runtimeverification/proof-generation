...
${ MBA $p rg ( Lg ( wg ( A-s kore-sort-var-R ) ( wg ( A-s kore-sort-var-S2 ) ( wg ( A-s kore-sort-var-S3 ) ( wg ( ASI kore-element-var-T CcA ) .A ) ) ) ) ( A-s kore-sort-var-S3 ) ) $= ( A-o MA4 Huo wQ Huk Hus AZI AW8 MA8 )  AIECGEBDFHHCGEBDFHBJEAIECGEBDFHKCGEBDFHBDFBJECGEBDFKBDMLL $. $}
