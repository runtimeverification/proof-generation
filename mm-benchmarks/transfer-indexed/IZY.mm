...
$v ph1 ph0 kore-element-var-K1 kore-sort-var-R $.
...
${ IZY $p #Pattern ( wg ( A-s kore-sort-var-R ) ( wg ( ASI kore-element-var-K1 CSA ) .A ) ) $= ( wQ Huk A-o IM4 CR8 ASE 9w )  ADEBFGHICC $. $}
