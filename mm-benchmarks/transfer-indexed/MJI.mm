$c DpI HPI BAM A-c CcA CHs #Variable ) #ElementVariable FZM Cbk #Symbol Dt8 #Pattern CIM CJY #SetVariable ( CW0 $.
$v ptn2 kore-element-var-x0 ph1 ph2 ph0 kore-element-var-VE3 ptn0 ptn1 kore-element-var-VE4 $.
...
${ MJI $p #Pattern ( DpI ( Dt8 ( CIM ( BAM Cbk CHs ( FZM ( BAM CcA CW0 ( A-c CcA HPI ) ) kore-element-var-VE4 kore-element-var-x0 ) ) CJY ) ) kore-element-var-VE3 ) $= ( Cb8 BAI Cbg CHo CWw HPE A-Y JO4 H3g FZI CJU CII Dt4 JO0 DpE )  FGDHDIJEBKCLMENOPAQR $. $}
