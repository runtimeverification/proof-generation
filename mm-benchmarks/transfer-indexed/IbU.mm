$c BAM #Variable ) #ElementVariable #Symbol #Pattern CSA A6o CXQ #SetVariable ( $.
...
${ IbU $p #Pattern ( A6o CSA kore-sort-var-R kore-element-var-Val ( BAM CXQ CSA kore-element-var-From ) ) $= ( CR8 Huk IHs CXM ILQ BAI A6k )  DAEBFGDCHIJ $. $}
