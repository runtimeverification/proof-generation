$c BAM CHs #Variable ) #ElementVariable CVo #Symbol #Pattern A6o #SetVariable ( $.
...
${ ILk $p #Pattern ( A6o CHs kore-sort-var-R kore-element-var-Val ( BAM CVo CHs kore-element-var-From ) ) $= ( CHo Huk IHs CVk ILQ BAI A6k )  DAEBFGDCHIJ $. $}
