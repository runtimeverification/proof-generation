...
${ MpE $p #Pattern ( DpI ( Dt8 ( CIM ( BAM CXQ CHs ( EK0 kore-element-var-VE4 kore-element-var-x0 ) ) kore-element-var-VE2 ) ) kore-element-var-VE3 ) $= ( CXM CHo MpA BAI JOw CII Dt4 JO0 DpE )  EFCDGHAIJKBLM $. $}
