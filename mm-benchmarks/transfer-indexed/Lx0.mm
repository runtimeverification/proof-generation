...
Lxw $a rg ( Lg ( wg ( ASI kore-element-var-VE4 CXQ ) .A ) ( ASI ( A-c CXQ Hlo ) CXQ ) ) $.
${ Lx0 $p rg ( Lg ( wg ( ASI kore-element-var-VE4 CXQ ) .A ) ( ASI ( BAM CXQ CHs ( A-c CXQ Hlo ) ) CHs ) ) $= ( CXM ASE wQ CHo A-o Hlk A-Y JO4 9w BAI Lw8 Lxw AZk CMA AW8 )  AIBCJDBFEFDBGHBCDBEBGHKECAIBCJDBFEFDBGHBCALAMNBEBGHOP $. $}
