$c BAM CHs #Variable ) #ElementVariable #Symbol CUE #Pattern A6o #SetVariable ( $.
...
${ Jcc $p #Pattern ( A6o CHs kore-sort-var-R kore-element-var-Val ( BAM CUE CHs kore-element-var-From ) ) $= ( CHo Huk IHs CUA ILQ BAI A6k )  DAEBFGDCHIJ $. $}
