$c ) #ElementVariable #Symbol #Pattern A6o CSc FDE #Variable #SetVariable ( $.
...
${ INc $p #Pattern ( A6o CSc kore-sort-var-R kore-element-var-Val ( FDE kore-element-var-K0 kore-element-var-K1 ) ) $= ( CSY Huk IHs INY A6k )  EAFBGCDHI $. $}
