$c BAM CHs #Variable ) #ElementVariable #Symbol CUE #Pattern CIM DMo CJY #SetVariable ( $.
...
${ Mrs $p #Pattern ( CIM ( DMo ( CIM ( BAM CUE CHs kore-element-var-VE1 ) CJY ) ) kore-element-var-VE2 ) $= ( CII CUA CHo I5I BAI CJU DMk JOw )  DEBFGHCIAJC $. $}
